 ...
 * </p>
 * <ul>
 * <li>{@link org.archstudio.xadl3.lookupimplementation_3_0.LookupImplementation#getExt <em>Ext</em>
 * }</li>
 * <li>{@link org.archstudio.xadl3.lookupimplementation_3_0.LookupImplementation#getLookup
 * <em>Lookup</em>}</li>
 * </ul>
 *
...
public interface LookupImplementation extends Implementation {
   ...
   * <p>
   * If the meaning of the '<em>Lookup</em>' attribute isn't clear, there really should be more of a
   * description here...
   * </p>
   * <!-- end-user-doc -->
   * 
