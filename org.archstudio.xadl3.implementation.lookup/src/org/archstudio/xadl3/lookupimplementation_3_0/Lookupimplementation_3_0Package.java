...
public interface Lookupimplementation_3_0Package extends EPackage {
  ...
  /**
   * The feature id for the '<em><b>Lookup</b></em>' attribute. <!-- begin-user-doc --> <!--
   * end-user-doc -->
   * 
   * @generated
   * @ordered
   ...
   * @ordered
   */
  int LOOKUP_IMPLEMENTATION_FEATURE_COUNT =
      Implementation_3_0Package.IMPLEMENTATION_FEATURE_COUNT + 2;

  /**
   * The number of operations of the '<em>Lookup Implementation</em>' class. <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * 
   * @generated
   * @ordered
   */
  int LOOKUP_IMPLEMENTATION_OPERATION_COUNT =
      Implementation_3_0Package.IMPLEMENTATION_OPERATION_COUNT + 0;


  /**
   * Returns the meta object for class '
   * {@link org.archstudio.xadl3.lookupimplementation_3_0.LookupImplementation
   ...
   * <em>Lookup</em>}'. <!-- begin-user-doc --> <!-- end-user-doc -->
   * 
