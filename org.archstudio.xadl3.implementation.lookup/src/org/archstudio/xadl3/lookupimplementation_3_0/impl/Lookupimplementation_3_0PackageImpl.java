...
public class Lookupimplementation_3_0PackageImpl extends EPackageImpl implements Lookupimplementation_3_0Package
{
   ...
   * 
   * <p>This method is used to initialize {@link Lookupimplementation_3_0Package#eINSTANCE} when that field is accessed.
  ...
  {
    if (isInited) return (Lookupimplementation_3_0Package)EPackage.Registry.INSTANCE.getEPackage(Lookupimplementation_3_0Package.eNS_URI);

    // Obtain or create and register package
    Lookupimplementation_3_0PackageImpl theLookupimplementation_3_0Package = (Lookupimplementation_3_0PackageImpl)(EPackage.Registry.INSTANCE.get(eNS_URI) instanceof Lookupimplementation_3_0PackageImpl ? EPackage.Registry.INSTANCE.get(eNS_URI) : new Lookupimplementation_3_0PackageImpl());
  ...
  public void initializePackageContents()
  {
    ...
    initEClass(lookupImplementationEClass, LookupImplementation.class, "LookupImplementation", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
    initEReference(getLookupImplementation_Ext(), theXadlcore_3_0Package.getExtension(), null, "ext", null, 0, -1, LookupImplementation.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
    initEAttribute(getLookupImplementation_Lookup(), theXMLTypePackage.getString(), "lookup", null, 0, 1, LookupImplementation.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
  ...
  protected void createExtendedMetaDataAnnotations()
  {
    ...
    addAnnotation
      (lookupImplementationEClass, 
       source, 
       new String[] 
       {
       "name", "LookupImplementation",
       "kind", "elementOnly"
       });		
    addAnnotation
      (getLookupImplementation_Ext(), 
       source, 
       new String[] 
       {
       "kind", "element",
    ...
    addAnnotation
      (getLookupImplementation_Lookup(), 
       source, 
       new String[] 
       {
       "kind", "attribute",
