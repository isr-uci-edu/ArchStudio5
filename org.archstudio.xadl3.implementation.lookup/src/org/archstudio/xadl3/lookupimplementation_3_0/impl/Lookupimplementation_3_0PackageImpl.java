 ...
 * @generated
 */
public class Lookupimplementation_3_0PackageImpl extends EPackageImpl
    implements Lookupimplementation_3_0Package {
  /**
   ...
   * 
   * <p>
   * This method is used to initialize {@link Lookupimplementation_3_0Package#eINSTANCE} when that
  ...
  public static Lookupimplementation_3_0Package init() {
    ...
    EPackage.Registry.INSTANCE.put(Lookupimplementation_3_0Package.eNS_URI,
        theLookupimplementation_3_0Package);
  ...
  public void initializePackageContents() {
    ...
    lookupImplementationEClass.getESuperTypes()
        .add(theImplementation_3_0Package.getImplementation());

    // Initialize classes, features, and operations; add parameters
    initEClass(lookupImplementationEClass, LookupImplementation.class, "LookupImplementation",
        !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
    initEReference(getLookupImplementation_Ext(), theXadlcore_3_0Package.getExtension(), null,
        "ext", null, 0, -1, LookupImplementation.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE,
        IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
    initEAttribute(getLookupImplementation_Lookup(), theXMLTypePackage.getString(), "lookup", null,
        0, 1, LookupImplementation.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE,
