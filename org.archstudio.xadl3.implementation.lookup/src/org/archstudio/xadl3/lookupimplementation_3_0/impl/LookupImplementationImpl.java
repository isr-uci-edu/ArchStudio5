...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>Lookup Implementation</b></em>'.
 * <!-- end-user-doc -->
 * <p>
...
public class LookupImplementationImpl extends ImplementationImpl implements LookupImplementation
{
  ...
  public EList<Extension> getExt()
  {
    if (ext == null)
    {
      ext = new EObjectContainmentEList<Extension>(Extension.class, this, Lookupimplementation_3_0Package.LOOKUP_IMPLEMENTATION__EXT);
    }
    return ext;
  }
  ...
  public void setLookup(String newLookup)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, Lookupimplementation_3_0Package.LOOKUP_IMPLEMENTATION__LOOKUP, oldLookup, lookup));
  }
