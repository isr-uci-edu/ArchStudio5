...
public abstract class NumericSurfaceGraphThingBase extends org.archstudio.bna.things.AbstractThing
  ...
  public static final IThingKey<org.archstudio.bna.things.graphs.NumericSurfaceGraphThing.Data> DATA_KEY =
      ThingKey.create(
          com.google.common.collect.Lists.newArrayList("data", NumericSurfaceGraphThingBase.class));

  public static final IThingKey<java.lang.Boolean> FLIP_DATA_KEY = ThingKey.create(
      com.google.common.collect.Lists.newArrayList("flipData", NumericSurfaceGraphThingBase.class));

  public static final IThingKey<java.lang.Double> GRID_ALPHA_KEY =
      ThingKey.create(com.google.common.collect.Lists.newArrayList("gridAlpha",
          NumericSurfaceGraphThingBase.class));

  public static final IThingKey<java.lang.Double> MAJOR_CONTOUR_ALPHA_KEY =
      ThingKey.create(com.google.common.collect.Lists.newArrayList("majorContourAlpha",
          NumericSurfaceGraphThingBase.class));

  public static final IThingKey<java.lang.Double> MINOR_CONTOUR_ALPHA_KEY =
      ThingKey.create(com.google.common.collect.Lists.newArrayList("minorContourAlpha",
          NumericSurfaceGraphThingBase.class));

  public static final IThingKey<org.archstudio.bna.things.graphs.NumericAxis> X_MAJOR_AXIS_KEY =
      ThingKey.create(com.google.common.collect.Lists.newArrayList("xMajorAxis",
          NumericSurfaceGraphThingBase.class));

  public static final IThingKey<org.archstudio.bna.things.graphs.NumericAxis> X_MINOR_AXIS_KEY =
      ThingKey.create(com.google.common.collect.Lists.newArrayList("xMinorAxis",
          NumericSurfaceGraphThingBase.class));

  public static final IThingKey<java.lang.Integer> X_ROTATION_KEY =
      ThingKey.create(com.google.common.collect.Lists.newArrayList("xRotation",
          NumericSurfaceGraphThingBase.class));

  public static final IThingKey<org.archstudio.bna.things.graphs.NumericAxis> Y_MAJOR_AXIS_KEY =
      ThingKey.create(com.google.common.collect.Lists.newArrayList("yMajorAxis",
          NumericSurfaceGraphThingBase.class));

  public static final IThingKey<org.archstudio.bna.things.graphs.NumericAxis> Y_MINOR_AXIS_KEY =
      ThingKey.create(com.google.common.collect.Lists.newArrayList("yMinorAxis",
          NumericSurfaceGraphThingBase.class));

  public static final IThingKey<java.lang.Integer> Y_ROTATION_KEY =
      ThingKey.create(com.google.common.collect.Lists.newArrayList("yRotation",
          NumericSurfaceGraphThingBase.class));

  public static final IThingKey<org.archstudio.bna.things.graphs.NumericAxis> Z_MAJOR_AXIS_KEY =
      ThingKey.create(com.google.common.collect.Lists.newArrayList("zMajorAxis",
          NumericSurfaceGraphThingBase.class));

  public static final IThingKey<org.archstudio.bna.things.graphs.NumericAxis> Z_MINOR_AXIS_KEY =
      ThingKey.create(com.google.common.collect.Lists.newArrayList("zMinorAxis",
          NumericSurfaceGraphThingBase.class));
  ...
  @Override
  public IThingPeer<? extends NumericSurfaceGraphThing> createPeer(IBNAView view,
  ...
  protected void initProperties() {
    ...
    initProperty(org.archstudio.bna.things.graphs.NumericSurfaceGraphThing.DATA_KEY,
        new org.archstudio.bna.things.graphs.NumericSurfaceGraphThing.Data());
    ...
    initProperty(org.archstudio.bna.things.graphs.NumericSurfaceGraphThing.MAJOR_CONTOUR_ALPHA_KEY,
        0d);
    initProperty(org.archstudio.bna.things.graphs.NumericSurfaceGraphThing.MINOR_CONTOUR_ALPHA_KEY,
        0d);
    ...
    initProperty(org.archstudio.bna.things.graphs.NumericSurfaceGraphThing.Y_MAJOR_AXIS_KEY,
        new org.archstudio.bna.things.graphs.NumericAxis());
    initProperty(org.archstudio.bna.things.graphs.NumericSurfaceGraphThing.Y_MINOR_AXIS_KEY,
        new org.archstudio.bna.things.graphs.NumericAxis());
    initProperty(org.archstudio.bna.things.graphs.NumericSurfaceGraphThing.Y_ROTATION_KEY, 20);
    initProperty(org.archstudio.bna.things.graphs.NumericSurfaceGraphThing.Z_MAJOR_AXIS_KEY,
        new org.archstudio.bna.things.graphs.NumericAxis());
    initProperty(org.archstudio.bna.things.graphs.NumericSurfaceGraphThing.Z_MINOR_AXIS_KEY,
        new org.archstudio.bna.things.graphs.NumericAxis());
  ...
  /* package */ org.archstudio.bna.things.graphs.NumericSurfaceGraphThing.Data setRawData(
      org.archstudio.bna.things.graphs.NumericSurfaceGraphThing.Data data) {
  ...
  /* package */ boolean isRawFlipData(boolean flipData) {
    return setRaw(org.archstudio.bna.things.graphs.NumericSurfaceGraphThing.FLIP_DATA_KEY,
        flipData);
  }
  ...
  /* package */ double setRawGridAlpha(double gridAlpha) {
    return setRaw(org.archstudio.bna.things.graphs.NumericSurfaceGraphThing.GRID_ALPHA_KEY,
        gridAlpha);
  }
  ...
  /* package */ double getRawMajorContourAlpha() {
    return getRaw(
        org.archstudio.bna.things.graphs.NumericSurfaceGraphThing.MAJOR_CONTOUR_ALPHA_KEY);
  }

  public void setMajorContourAlpha(double majorContourAlpha) {
    set(org.archstudio.bna.things.graphs.NumericSurfaceGraphThing.MAJOR_CONTOUR_ALPHA_KEY,
        majorContourAlpha);
  }

  /* package */ double setRawMajorContourAlpha(double majorContourAlpha) {
    return setRaw(org.archstudio.bna.things.graphs.NumericSurfaceGraphThing.MAJOR_CONTOUR_ALPHA_KEY,
        majorContourAlpha);
  }
  ...
  /* package */ double getRawMinorContourAlpha() {
    return getRaw(
        org.archstudio.bna.things.graphs.NumericSurfaceGraphThing.MINOR_CONTOUR_ALPHA_KEY);
  }

  public void setMinorContourAlpha(double minorContourAlpha) {
    set(org.archstudio.bna.things.graphs.NumericSurfaceGraphThing.MINOR_CONTOUR_ALPHA_KEY,
        minorContourAlpha);
  }

  /* package */ double setRawMinorContourAlpha(double minorContourAlpha) {
    return setRaw(org.archstudio.bna.things.graphs.NumericSurfaceGraphThing.MINOR_CONTOUR_ALPHA_KEY,
        minorContourAlpha);
  }
  ...
  /* package */ org.archstudio.bna.things.graphs.NumericAxis setRawXMajorAxis(
      org.archstudio.bna.things.graphs.NumericAxis xMajorAxis) {
    return setRaw(org.archstudio.bna.things.graphs.NumericSurfaceGraphThing.X_MAJOR_AXIS_KEY,
        xMajorAxis);
  }
  ...
  /* package */ org.archstudio.bna.things.graphs.NumericAxis setRawXMinorAxis(
      org.archstudio.bna.things.graphs.NumericAxis xMinorAxis) {
    return setRaw(org.archstudio.bna.things.graphs.NumericSurfaceGraphThing.X_MINOR_AXIS_KEY,
        xMinorAxis);
  }
  ...
  /* package */ int setRawXRotation(int xRotation) {
    return setRaw(org.archstudio.bna.things.graphs.NumericSurfaceGraphThing.X_ROTATION_KEY,
        xRotation);
  }
  ...
  /* package */ org.archstudio.bna.things.graphs.NumericAxis setRawYMajorAxis(
      org.archstudio.bna.things.graphs.NumericAxis yMajorAxis) {
    return setRaw(org.archstudio.bna.things.graphs.NumericSurfaceGraphThing.Y_MAJOR_AXIS_KEY,
        yMajorAxis);
  }
  ...
  /* package */ org.archstudio.bna.things.graphs.NumericAxis setRawYMinorAxis(
      org.archstudio.bna.things.graphs.NumericAxis yMinorAxis) {
    return setRaw(org.archstudio.bna.things.graphs.NumericSurfaceGraphThing.Y_MINOR_AXIS_KEY,
        yMinorAxis);
  }
  ...
  /* package */ int setRawYRotation(int yRotation) {
    return setRaw(org.archstudio.bna.things.graphs.NumericSurfaceGraphThing.Y_ROTATION_KEY,
        yRotation);
  }
  ...
  /* package */ org.archstudio.bna.things.graphs.NumericAxis setRawZMajorAxis(
      org.archstudio.bna.things.graphs.NumericAxis zMajorAxis) {
    return setRaw(org.archstudio.bna.things.graphs.NumericSurfaceGraphThing.Z_MAJOR_AXIS_KEY,
        zMajorAxis);
  }
  ...
  /* package */ org.archstudio.bna.things.graphs.NumericAxis setRawZMinorAxis(
      org.archstudio.bna.things.graphs.NumericAxis zMinorAxis) {
