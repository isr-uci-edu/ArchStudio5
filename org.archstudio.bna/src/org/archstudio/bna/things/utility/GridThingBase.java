...
public abstract class GridThingBase extends org.archstudio.bna.things.AbstractThing
  ...
  public static final IThingKey<org.archstudio.bna.constants.GridDisplayType> GRID_DISPLAY_TYPE_KEY =
      ThingKey.create(
          com.google.common.collect.Lists.newArrayList("gridDisplayType", GridThingBase.class));

  public static final IThingKey<java.lang.Integer> GRID_SPACING_KEY = ThingKey
      .create(com.google.common.collect.Lists.newArrayList("gridSpacing", GridThingBase.class));
  ...
  /* package */ org.archstudio.bna.constants.GridDisplayType setRawGridDisplayType(
      org.archstudio.bna.constants.GridDisplayType gridDisplayType) {
    return setRaw(org.archstudio.bna.things.utility.GridThing.GRID_DISPLAY_TYPE_KEY,
        gridDisplayType);
  }
