...
public class EnvironmentPropertiesThing extends NoThing {
	...
	public static final IThingKey<Point> NEW_THING_SPOT_KEY = CloneThingKey.create("#newThingSpot", false, CloneThingKey.point());
	public static final IThingKey<Rectangle> MODEL_BOUNDS_KEY = CloneThingKey.create("modelBounds", false, CloneThingKey.rectangle());
