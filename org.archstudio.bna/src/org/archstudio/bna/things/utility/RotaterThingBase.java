...
public abstract class RotaterThingBase extends org.archstudio.bna.things.AbstractThing
  ...
  public static final IThingKey<java.lang.Integer> ADJUSTMENT_INCREMENT_KEY = ThingKey.create(
      com.google.common.collect.Lists.newArrayList("adjustmentIncrement", RotaterThingBase.class));
  ...
  public void setAdjustmentIncrement(int adjustmentIncrement) {
    set(org.archstudio.bna.things.utility.RotaterThing.ADJUSTMENT_INCREMENT_KEY,
        adjustmentIncrement);
  }

  /* package */ int setRawAdjustmentIncrement(int adjustmentIncrement) {
    return setRaw(org.archstudio.bna.things.utility.RotaterThing.ADJUSTMENT_INCREMENT_KEY,
        adjustmentIncrement);
  }
