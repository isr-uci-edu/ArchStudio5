...
@NonNullByDefault
public abstract class SWTScrollBarThingBase extends
    org.archstudio.bna.things.swt.AbstractControlThing implements org.archstudio.bna.IThing {

  public static final IThingKey<java.lang.Integer> MAX_KEY = ThingKey
      .create(com.google.common.collect.Lists.newArrayList("max", SWTScrollBarThingBase.class));

  public static final IThingKey<java.lang.Integer> MIN_KEY = ThingKey
      .create(com.google.common.collect.Lists.newArrayList("min", SWTScrollBarThingBase.class));

  public static final IThingKey<org.archstudio.bna.things.swt.SWTScrollBarThing.Type> TYPE_KEY =
      ThingKey.create(
          com.google.common.collect.Lists.newArrayList("type", SWTScrollBarThingBase.class));

  public static final IThingKey<java.lang.Integer> VALUE_KEY = ThingKey
      .create(com.google.common.collect.Lists.newArrayList("value", SWTScrollBarThingBase.class));
  ...
  /* package */ org.archstudio.bna.things.swt.SWTScrollBarThing.Type setRawType(
      org.archstudio.bna.things.swt.SWTScrollBarThing.Type type) {
