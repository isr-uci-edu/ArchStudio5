...
public class EllipseGlassThing extends AbstractEllipseThing implements IHasMutableSelected, IHasMutableRotatingOffset {

	public EllipseGlassThing(@Nullable Object id) {
		super(id);
	}
