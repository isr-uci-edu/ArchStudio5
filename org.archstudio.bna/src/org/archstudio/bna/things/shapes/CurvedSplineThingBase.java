...
public abstract class CurvedSplineThingBase extends org.archstudio.bna.things.AbstractThing
  ...
  protected void initProperties() {
    ...
    initProperty(org.archstudio.bna.facets.IHasEndpoints.ENDPOINT_1_KEY,
        new java.awt.geom.Point2D.Double(10, 0));
    addShapeModifyingKey(org.archstudio.bna.facets.IHasEndpoints.ENDPOINT_1_KEY);
    initProperty(org.archstudio.bna.facets.IHasEndpoints.ENDPOINT_2_KEY,
        new java.awt.geom.Point2D.Double(0, 10));
  ...
  /* package */ @Nullable
  org.eclipse.swt.graphics.RGB setRawArrowhead1Color(
      @Nullable org.eclipse.swt.graphics.RGB arrowhead1Color) {
  ...
  /* package */ @Nullable
  org.eclipse.swt.graphics.RGB setRawArrowhead1EdgeColor(
      @Nullable org.eclipse.swt.graphics.RGB arrowhead1EdgeColor) {
    return setRaw(org.archstudio.bna.facets.IHasArrowheads.ARROWHEAD_1_EDGE_COLOR_KEY,
        arrowhead1EdgeColor);
  }
  ...
  /* package */ int setRawArrowhead1Length(int arrowhead1Length) {
    return setRaw(org.archstudio.bna.facets.IHasArrowheads.ARROWHEAD_1_LENGTH_KEY,
        arrowhead1Length);
  }
  ...
  /* package */ org.archstudio.bna.constants.ArrowheadShape setRawArrowhead1Shape(
      org.archstudio.bna.constants.ArrowheadShape arrowhead1Shape) {
  ...
  /* package */ @Nullable
  org.eclipse.swt.graphics.RGB setRawArrowhead2Color(
      @Nullable org.eclipse.swt.graphics.RGB arrowhead2Color) {
  ...
  /* package */ @Nullable
  org.eclipse.swt.graphics.RGB setRawArrowhead2EdgeColor(
      @Nullable org.eclipse.swt.graphics.RGB arrowhead2EdgeColor) {
    return setRaw(org.archstudio.bna.facets.IHasArrowheads.ARROWHEAD_2_EDGE_COLOR_KEY,
        arrowhead2EdgeColor);
  }
  ...
  /* package */ int setRawArrowhead2Length(int arrowhead2Length) {
    return setRaw(org.archstudio.bna.facets.IHasArrowheads.ARROWHEAD_2_LENGTH_KEY,
        arrowhead2Length);
  }
  ...
  /* package */ org.archstudio.bna.constants.ArrowheadShape setRawArrowhead2Shape(
      org.archstudio.bna.constants.ArrowheadShape arrowhead2Shape) {
  ...
  /* package */ org.archstudio.swtutils.constants.Orientation setRawLoopOrientation(
      org.archstudio.swtutils.constants.Orientation loopOrientation) {
    return setRaw(org.archstudio.bna.facets.IHasLoopOrientation.LOOP_ORIENTATION_KEY,
        loopOrientation);
  }
