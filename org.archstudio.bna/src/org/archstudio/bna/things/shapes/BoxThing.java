...
import org.archstudio.bna.things.AbstractRoundedBoxThing;
import org.eclipse.swt.graphics.RGB;

public class BoxThing extends AbstractRoundedBoxThing implements IHasMutableColor, IHasMutableSecondaryColor,
		IHasMutableGradientFill, IHasMutableEdgeColor {

	public BoxThing(Object id) {
		super(id);
	}
