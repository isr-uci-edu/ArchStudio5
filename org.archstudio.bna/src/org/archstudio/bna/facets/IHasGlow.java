 ...
 * thingdefinition extension at org.archstudio.bna/Package[name=org.archstudio.bna.facets]/Facet[name=Glow].
 */
...
public interface IHasGlow extends org.archstudio.bna.IThing {
	...
	public static final IThingKey<org.eclipse.swt.graphics.RGB> GLOW_COLOR_KEY =
			ThingKey.create(com.google.common.collect.Lists.newArrayList("glowColor", IHasGlow.class), true);

	public static final IThingKey<java.lang.Integer> GLOW_WIDTH_KEY =
			ThingKey.create(com.google.common.collect.Lists.newArrayList("glowWidth", IHasGlow.class));
