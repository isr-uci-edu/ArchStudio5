...
public interface IHasMutableRotatingOffset extends IHasRotatingOffset {
	 ...
	 * glass things that are not selected, e.g., {@link RectangleGlassThing}. Conversely, {@link #incrementRotatingOffset()}
	 * must always be called on {@link MarqueeBoxBorderThing}.
	 * 
