 ...
 * thingdefinition extension at org.archstudio.bna/Package[name=org.archstudio.bna.facets]/Facet[name=Orientation].
 */
...
public interface IHasOrientation extends org.archstudio.bna.IThing {
	public static final IThingKey<org.archstudio.swtutils.constants.Orientation> ORIENTATION_KEY =
			ThingKey.create(com.google.common.collect.Lists.newArrayList("orientation", IHasOrientation.class));
