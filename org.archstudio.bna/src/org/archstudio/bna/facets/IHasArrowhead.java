...
public interface IHasArrowhead extends org.archstudio.bna.IThing {
  ...
  public static final IThingKey<org.eclipse.swt.graphics.RGB> ARROWHEAD_EDGE_COLOR_KEY =
      ThingKey.create(
          com.google.common.collect.Lists.newArrayList("arrowheadEdgeColor", IHasArrowhead.class),
          true);

  public static final IThingKey<java.lang.Integer> ARROWHEAD_LENGTH_KEY = ThingKey
      .create(com.google.common.collect.Lists.newArrayList("arrowheadLength", IHasArrowhead.class));

  public static final IThingKey<org.archstudio.bna.constants.ArrowheadShape> ARROWHEAD_SHAPE_KEY =
      ThingKey.create(
          com.google.common.collect.Lists.newArrayList("arrowheadShape", IHasArrowhead.class));

  public static final IThingKey<java.lang.Integer> ARROWHEAD_WIDTH_KEY = ThingKey
      .create(com.google.common.collect.Lists.newArrayList("arrowheadWidth", IHasArrowhead.class));
