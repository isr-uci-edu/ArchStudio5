...
public class BNASWTSynchDemo {
	...
	public BNASWTSynchDemo() {
		...
		// class BNA
		BoxAssembly classBox = BoxAssembly.create(m, null);
		...
		classBox.getBoxGlassThing().setProperty(IHasSWTLayout.SWT_LAYOUT_PROPERTY_NAME, new GridLayout(3, false));
		...
		classTitle.setProperty(IHasSWTLayoutData.SWT_LAYOUT_DATA_PROPERTY_NAME, new GridData(SWT.FILL, SWT.CENTER, true, false, 3, 1));
		classTitle.setProperty(IHasSWTLayoutData.LAYOUT_TARGET_ID_PROPERTY_NAME, classBox.getBoxGlassThing().getID());
		...
		for (int i = 0; i < classOperations.length; i++) {
			...
			classOperation.setProperty(IHasSWTLayoutData.SWT_LAYOUT_DATA_PROPERTY_NAME, new GridData(SWT.LEFT, SWT.CENTER, true, false, 3, 1));
			classOperation.setProperty(IHasSWTLayoutData.LAYOUT_TARGET_ID_PROPERTY_NAME, classBox.getBoxGlassThing().getID());
		...
		for (int i = 0; i < classFields.length; i++) {
			...
			classField.setProperty(IHasSWTLayoutData.SWT_LAYOUT_DATA_PROPERTY_NAME, new GridData(SWT.RIGHT, SWT.CENTER, true, false, 3, 1));
			classField.setProperty(IHasSWTLayoutData.LAYOUT_TARGET_ID_PROPERTY_NAME, classBox.getBoxGlassThing().getID());
