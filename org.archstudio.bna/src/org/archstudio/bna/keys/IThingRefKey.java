...
/**
 * Describes a key that expects to store a reference to a thing as its value.
 * This is a convenience class, which could be accomplished using
 * <code>{@link IThingKey}&lt;Object&gt;</code>. However, using this class has
 * the following advantages:
 * <ul>
 * <li>{@link AbstractThingRefKey#preWrite(Object)} prohibits {@link IThing}s to
 * prevent accidentally setting a thing as a property value,</li>
 * <li>{@link #get(IThing, IBNAModel)} retrieves the the corresponding thing and
 * automatically typecasts it,</li>
