...
public class BooleanHintSynchronizer extends PropertyHintSynchronizer {
	...
	public BooleanHintSynchronizer(Class<? extends IThing> thingInterface, String propertyName,
			String... userProperties) {
		this(null, thingInterface, propertyName, userProperties);
	}

	public BooleanHintSynchronizer(String hintSuffix, Class<? extends IThing> thingInterface, String propertyName,
			String... userProperties) {
		super(hintSuffix, thingInterface, propertyName, userProperties);
	}

	@Override
	protected void storeHint(IHintRepository repository, Object context, String hintName, IThing thing,
	...
	protected void restoreHint(IHintRepository repository, Object context, String partPath, String[] parts,
		...
		super.restoreHint(repository, context, partPath, parts, thing, propertyName, hintName,
				Boolean.TRUE.equals(hintValue));
	}
}
