...
public class MaintainStickyEndpointsLogic extends AbstractThingLogic implements IStickyBoxTrackingListener,
	...
	public MaintainStickyEndpointsLogic(ThingRefTrackingLogic trtl, ThingTypeTrackingLogic ttstl,
			StickyBoxTrackingLogic sbtl) {
		this.trtl = trtl;
		this.ttstl = ttstl;
		this.sbtl = sbtl;
	}
		...
		if (t instanceof IHasStickyEndpoints) {
			...
			if (te != null) {
				...
				if (propertyName != null) {
					if (propertyName.equals(IHasStickyEndpoints.ENDPOINT_1_STUCK_TO_THING_ID_KEY)
							|| propertyName.equals(IHasStickyEndpoints.ENDPOINT_2_STUCK_TO_THING_ID_KEY)) {
						checkEndpoints(st);
					}
	...
	public void stickyBoxChanged(StickyBoxChangedEvent evt) {
		...
		if (m != null) {
			...
			if (t instanceof IHasStickyBox) {
				...
				String[] ep1stIDs = trtl.findReferencingThings(sbt,
						IHasStickyEndpoints.ENDPOINT_1_STUCK_TO_THING_ID_KEY);
				...
				String[] ep2stIDs = trtl.findReferencingThings(sbt,
						IHasStickyEndpoints.ENDPOINT_2_STUCK_TO_THING_ID_KEY);
