...
public class AlignAndDistributeLogic extends AbstractThingLogic implements IBNAMenuListener {
	...
	protected void loadImages(IBNAView view) {
		...
		imageRegistry.put(ALIGN_LEFT, new Image(comp.getDisplay(), AlignAndDistributeLogic.class.getClassLoader()
				.getResourceAsStream("edu/uci/isr/bna4/res/align-left.gif")));
		imageRegistry.put(ALIGN_CENTER, new Image(comp.getDisplay(), AlignAndDistributeLogic.class.getClassLoader()
				.getResourceAsStream("edu/uci/isr/bna4/res/align-center.gif")));
		imageRegistry.put(ALIGN_RIGHT, new Image(comp.getDisplay(), AlignAndDistributeLogic.class.getClassLoader()
				.getResourceAsStream("edu/uci/isr/bna4/res/align-right.gif")));
		imageRegistry.put(ALIGN_TOP, new Image(comp.getDisplay(), AlignAndDistributeLogic.class.getClassLoader()
				.getResourceAsStream("edu/uci/isr/bna4/res/align-top.gif")));
		imageRegistry.put(ALIGN_MIDDLE, new Image(comp.getDisplay(), AlignAndDistributeLogic.class.getClassLoader()
				.getResourceAsStream("edu/uci/isr/bna4/res/align-middle.gif")));
		imageRegistry.put(ALIGN_BOTTOM, new Image(comp.getDisplay(), AlignAndDistributeLogic.class.getClassLoader()
				.getResourceAsStream("edu/uci/isr/bna4/res/align-bottom.gif")));

		imageRegistry.put(DISTRIBUTE_HORIZONTAL_LOOSE, new Image(comp.getDisplay(), AlignAndDistributeLogic.class
				.getClassLoader().getResourceAsStream("edu/uci/isr/bna4/res/distribute-horizontal-loose.gif")));
		imageRegistry.put(DISTRIBUTE_HORIZONTAL_TIGHT, new Image(comp.getDisplay(), AlignAndDistributeLogic.class
				.getClassLoader().getResourceAsStream("edu/uci/isr/bna4/res/distribute-horizontal-tight.gif")));
		imageRegistry.put(DISTRIBUTE_VERTICAL_LOOSE, new Image(comp.getDisplay(), AlignAndDistributeLogic.class
				.getClassLoader().getResourceAsStream("edu/uci/isr/bna4/res/distribute-vertical-loose.gif")));
		imageRegistry.put(DISTRIBUTE_VERTICAL_TIGHT, new Image(comp.getDisplay(), AlignAndDistributeLogic.class
				.getClassLoader().getResourceAsStream("edu/uci/isr/bna4/res/distribute-vertical-tight.gif")));
	}
