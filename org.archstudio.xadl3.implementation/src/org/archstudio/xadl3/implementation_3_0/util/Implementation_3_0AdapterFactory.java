 ...
 * @generated
 */
public class Implementation_3_0AdapterFactory extends AdapterFactoryImpl {
  /**
   ...
   * @generated
   */
  public Implementation_3_0AdapterFactory() {
   ...
   * @generated
   */
  protected Implementation_3_0Switch<Adapter> modelSwitch =
      new Implementation_3_0Switch<Adapter>() {
        @Override
        ...
        @Override
        public Adapter caseInitializationParametersImplementation(
            InitializationParametersImplementation object) {
   ...
   * <em>Implementation Extension</em>}'. <!-- begin-user-doc --> This default implementation
   ...
   * <em>Initialization Parameter</em>}'. <!-- begin-user-doc --> This default implementation
   * returns null so that we can easily ignore cases; it's useful to ignore a case when inheritance
   * will catch all the cases anyway. <!-- end-user-doc -->
   * 
   * @return the new adapter.
   ...
   * @generated
   */
  public Adapter createInitializationParameterAdapter() {
    return null;
  }
   ...
   * <em>Initialization Parameters Implementation</em>}'. <!-- begin-user-doc --> This default
   ...
   * @generated
   */
  public Adapter createInitializationParametersImplementationAdapter() {
    return null;
  }
