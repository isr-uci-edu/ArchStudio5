...
public class Implementation_3_0AdapterFactory extends AdapterFactoryImpl {
	 ...
	 * {@link org.archstudio.xadl3.implementation_3_0.ImplementationExtension <em>Implementation Extension</em>}'. <!--
	...
	/**
	 * Creates a new adapter for an object of class '
	 * {@link org.archstudio.xadl3.implementation_3_0.InitializationParameter <em>Initialization Parameter</em>}'. <!--
	 * begin-user-doc --> This default implementation returns null so that we can easily ignore cases; it's useful to
	 * ignore a case when inheritance will catch all the cases anyway. <!-- end-user-doc -->
	 * 
	 * @return the new adapter.
	 ...
	 * <em>Initialization Parameters Implementation</em>}'. <!-- begin-user-doc --> This default implementation returns
