...
public class Implementation_3_0Switch<T> extends Switch<T> {
  ...
  protected T doSwitch(int classifierID, EObject theEObject) {
    switch (classifierID) {
      ...
      case Implementation_3_0Package.INITIALIZATION_PARAMETERS_IMPLEMENTATION: {
        ...
        T result =
            caseInitializationParametersImplementation(initializationParametersImplementation);
        if (result == null) {
   ...
   * <em>Implementation Extension</em>'. <!-- begin-user-doc --> This implementation returns null;
   * returning a non-null result will terminate the switch. <!-- end-user-doc -->
   * 
   * @param object the target of the switch.
   * @return the result of interpreting the object as an instance of '
   *         <em>Implementation Extension</em>'.
   * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
   * @generated
   */
  ...
  /**
   * Returns the result of interpreting the object as an instance of '
   * <em>Initialization Parameter</em>'. <!-- begin-user-doc --> This implementation returns null;
   * returning a non-null result will terminate the switch. <!-- end-user-doc -->
   * 
   * @param object the target of the switch.
   * @return the result of interpreting the object as an instance of '
  ...
  /**
   * Returns the result of interpreting the object as an instance of '
   * <em>Initialization Parameters Implementation</em>'. <!-- begin-user-doc --> This implementation
   ...
   * @generated
   */
  public T caseInitializationParametersImplementation(
