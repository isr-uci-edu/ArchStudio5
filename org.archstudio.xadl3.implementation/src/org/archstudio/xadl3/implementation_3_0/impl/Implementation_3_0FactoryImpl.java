...
public class Implementation_3_0FactoryImpl extends EFactoryImpl implements Implementation_3_0Factory
{
  ...
  public EObject create(EClass eClass)
  {
    switch (eClass.getClassifierID())
    {
      ...
      case Implementation_3_0Package.INITIALIZATION_PARAMETER: return createInitializationParameter();
      case Implementation_3_0Package.INITIALIZATION_PARAMETERS_IMPLEMENTATION: return createInitializationParametersImplementation();
      default:
