...
public class InitializationParameterImpl extends EObjectImpl implements InitializationParameter
{
  ...
  public EList<Extension> getExt()
  {
    if (ext == null)
    {
      ext = new EObjectContainmentEList<Extension>(Extension.class, this, Implementation_3_0Package.INITIALIZATION_PARAMETER__EXT);
    }
    return ext;
  }
  ...
  public void setKey(String newKey)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, Implementation_3_0Package.INITIALIZATION_PARAMETER__KEY, oldKey, key));
  }
  ...
  public void setValue(String newValue)
  {
    ...
    value = newValue;
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, Implementation_3_0Package.INITIALIZATION_PARAMETER__VALUE, oldValue, value));
  }
