...
public class Implementation_3_0PackageImpl extends EPackageImpl implements Implementation_3_0Package
{
  ...
  public void createPackageContents()
  {
    ...
    createEReference(initializationParametersImplementationEClass, INITIALIZATION_PARAMETERS_IMPLEMENTATION__INITIALIZATION_PARAMETER);
  }
  ...
  public void initializePackageContents()
  {
    ...
    initEAttribute(getInitializationParameter_Key(), theXMLTypePackage.getString(), "key", null, 0, 1, InitializationParameter.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
    ...
    initEClass(initializationParametersImplementationEClass, InitializationParametersImplementation.class, "InitializationParametersImplementation", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
    initEReference(getInitializationParametersImplementation_InitializationParameter(), this.getInitializationParameter(), null, "initializationParameter", null, 0, -1, InitializationParametersImplementation.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
  ...
  protected void createExtendedMetaDataAnnotations()
  {
    ...
    addAnnotation
      (getInitializationParameter_Key(), 
       source, 
       new String[] 
       {
       "kind", "attribute",
    ...
    addAnnotation
      (initializationParametersImplementationEClass, 
       ...
       new String[] 
       {
       "name", "InitializationParametersImplementation",
       "kind", "elementOnly"
       });		
    addAnnotation
