 ...
 * @generated
 */
public class Implementation_3_0PackageImpl extends EPackageImpl
    implements Implementation_3_0Package {
  /**
   ...
   * 
   * <p>
   * This method is used to initialize {@link Implementation_3_0Package#eINSTANCE} when that field
  ...
  public static Implementation_3_0Package init() {
    ...
    Implementation_3_0PackageImpl theImplementation_3_0Package =
        (Implementation_3_0PackageImpl) (EPackage.Registry.INSTANCE
            .get(eNS_URI) instanceof Implementation_3_0PackageImpl
                ? EPackage.Registry.INSTANCE.get(eNS_URI) : new Implementation_3_0PackageImpl());
  ...
  public EReference getInitializationParametersImplementation_InitializationParameter() {
    return (EReference) initializationParametersImplementationEClass.getEStructuralFeatures()
        .get(0);
  }
  ...
  public void createPackageContents() {
    ...
    initializationParametersImplementationEClass =
        createEClass(INITIALIZATION_PARAMETERS_IMPLEMENTATION);
  ...
  public void initializePackageContents() {
    ...
    initEClass(implementationEClass, Implementation.class, "Implementation", IS_ABSTRACT,
        !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
    initEAttribute(getImplementation_Id(), theXMLTypePackage.getID(), "id", null, 0, 1,
        Implementation.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, IS_ID,
        IS_UNIQUE, !IS_DERIVED, IS_ORDERED);

    initEClass(implementationExtensionEClass, ImplementationExtension.class,
        "ImplementationExtension", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
    initEReference(getImplementationExtension_Implementation(), this.getImplementation(), null,
        "implementation", null, 0, -1, ImplementationExtension.class, !IS_TRANSIENT, !IS_VOLATILE,
        IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED,
        IS_ORDERED);

    initEClass(initializationParameterEClass, InitializationParameter.class,
        "InitializationParameter", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
    initEReference(getInitializationParameter_Ext(), theXadlcore_3_0Package.getExtension(), null,
        "ext", null, 0, -1, InitializationParameter.class, !IS_TRANSIENT, !IS_VOLATILE,
        IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED,
        IS_ORDERED);
    initEAttribute(getInitializationParameter_Key(), theXMLTypePackage.getString(), "key", null, 0,
        1, InitializationParameter.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE,
        !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
    initEAttribute(getInitializationParameter_Value(), theXMLTypePackage.getString(), "value", null,
        0, 1, InitializationParameter.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE,
        !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);

    initEClass(initializationParametersImplementationEClass,
        InitializationParametersImplementation.class, "InitializationParametersImplementation",
    ...
    initEReference(getInitializationParametersImplementation_InitializationParameter(),
        ...
        InitializationParametersImplementation.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE,
  ...
  protected void createExtendedMetaDataAnnotations() {
    ...
    addAnnotation(implementationEClass, source,
        new String[] {"name", "Implementation", "kind", "empty"});
    ...
    addAnnotation(getImplementationExtension_Implementation(), source, new String[] {"kind",
        "element", "name", "implementation", "namespace", "##targetNamespace"});
    ...
    addAnnotation(getInitializationParametersImplementation_InitializationParameter(), source,
        new String[] {"kind", "element", "name", "initializationParameter", "namespace",
            "##targetNamespace"});
  }
