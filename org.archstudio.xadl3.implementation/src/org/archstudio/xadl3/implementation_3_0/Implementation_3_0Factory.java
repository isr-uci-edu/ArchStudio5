...
public interface Implementation_3_0Factory extends EFactory {
   ...
   * @generated
   */
  Implementation_3_0Factory eINSTANCE =
      org.archstudio.xadl3.implementation_3_0.impl.Implementation_3_0FactoryImpl.init();

  /**
   * Returns a new object of class '<em>Implementation Extension</em>'. <!-- begin-user-doc --> <!--
   * end-user-doc -->
   * 
  ...
  /**
   * Returns a new object of class '<em>Initialization Parameter</em>'. <!-- begin-user-doc --> <!--
   * end-user-doc -->
   * 
  ...
  /**
   * Returns a new object of class '<em>Initialization Parameters Implementation</em>'. <!--
