 ...
 * 
 * This schema defines the concept of an implementation. The concept is abstract, so it is intended
 * to be specialized by various specific types of implementations. However, it exists so that
...
public interface Implementation_3_0Package extends EPackage {
   ...
   * {@link org.archstudio.xadl3.implementation_3_0.impl.ImplementationImpl <em>Implementation</em>}
  ...
  /**
   * The number of structural features of the '<em>Implementation</em>' class. <!-- begin-user-doc
   * --> <!-- end-user-doc -->
   * 
   * @generated
   * @ordered
  ...
  /**
   * The number of operations of the '<em>Implementation</em>' class. <!-- begin-user-doc --> <!--
   * end-user-doc -->
   * 
   * @generated
   * @ordered
  ...
  /**
   * The meta object id for the '
   * {@link org.archstudio.xadl3.implementation_3_0.impl.ImplementationExtensionImpl
  ...
  /**
   * The meta object id for the '
   * {@link org.archstudio.xadl3.implementation_3_0.impl.InitializationParameterImpl
   * <em>Initialization Parameter</em>}' class. <!-- begin-user-doc --> <!-- end-user-doc -->
   * 
   ...
   * <em>Initialization Parameters Implementation</em>}' class. <!-- begin-user-doc --> <!--
   * end-user-doc -->
   * 
   ...
   * @ordered
   */
  int INITIALIZATION_PARAMETERS_IMPLEMENTATION__INITIALIZATION_PARAMETER =
      IMPLEMENTATION_FEATURE_COUNT + 0;

  /**
   * The number of structural features of the '<em>Initialization Parameters Implementation</em>'
   * class. <!-- begin-user-doc --> <!-- end-user-doc -->
   * 
   * @generated
   * @ordered
  ...
  /**
   * The number of operations of the '<em>Initialization Parameters Implementation</em>' class. <!--
   * begin-user-doc --> <!-- end-user-doc -->
   * 
   * @generated
   * @ordered
   ...
   * {@link org.archstudio.xadl3.implementation_3_0.Implementation <em>Implementation</em>}'. <!--
   * begin-user-doc --> <!-- end-user-doc -->
   * 
   ...
   * {@link org.archstudio.xadl3.implementation_3_0.Implementation#getId <em>Id</em>}'. <!--
   * begin-user-doc --> <!-- end-user-doc -->
   * 
  ...
  /**
   * Returns the meta object for class '
   * {@link org.archstudio.xadl3.implementation_3_0.ImplementationExtension
   * <em>Implementation Extension</em>}'. <!-- begin-user-doc --> <!-- end-user-doc -->
   * 
   ...
   * {@link org.archstudio.xadl3.implementation_3_0.ImplementationExtension#getImplementation
   ...
   * <em>Initialization Parameter</em>}'. <!-- begin-user-doc --> <!-- end-user-doc -->
   * 
  ...
  /**
   * Returns the meta object for the containment reference list '
   * {@link org.archstudio.xadl3.implementation_3_0.InitializationParameter#getExt <em>Ext</em>}'.
   * <!-- begin-user-doc --> <!-- end-user-doc -->
   * 
  ...
  /**
   * Returns the meta object for the attribute '
   * {@link org.archstudio.xadl3.implementation_3_0.InitializationParameter#getKey <em>Key</em>}'.
   * <!-- begin-user-doc --> <!-- end-user-doc -->
   * 
  ...
  /**
   * Returns the meta object for the attribute '
   * {@link org.archstudio.xadl3.implementation_3_0.InitializationParameter#getValue <em>Value</em>}
   * '. <!-- begin-user-doc --> <!-- end-user-doc -->
   * 
  ...
  /**
   * Returns the meta object for class '
   * {@link org.archstudio.xadl3.implementation_3_0.InitializationParametersImplementation
   * <em>Initialization Parameters Implementation</em>}'. <!-- begin-user-doc --> <!-- end-user-doc
   * -->
   * 
  ...
  interface Literals {
     ...
     * {@link org.archstudio.xadl3.implementation_3_0.impl.ImplementationImpl
     * <em>Implementation</em>}' class. <!-- begin-user-doc --> <!-- end-user-doc -->
     * 
     * @see org.archstudio.xadl3.implementation_3_0.impl.ImplementationImpl
     * @see org.archstudio.xadl3.implementation_3_0.impl.Implementation_3_0PackageImpl#getImplementation()
     * @generated
    ...
    /**
     * The meta object literal for the '<em><b>Implementation</b></em>' containment reference list
     * feature. <!-- begin-user-doc --> <!-- end-user-doc -->
     * 
     * @generated
     */
    EReference IMPLEMENTATION_EXTENSION__IMPLEMENTATION =
        eINSTANCE.getImplementationExtension_Implementation();
     ...
     * @generated
     */
    EClass INITIALIZATION_PARAMETERS_IMPLEMENTATION =
        eINSTANCE.getInitializationParametersImplementation();

    /**
     * The meta object literal for the '<em><b>Initialization Parameter</b></em>' containment
