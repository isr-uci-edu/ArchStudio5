...
import org.archstudio.xadl3.myxgen_3_0.*;
 ...
 * @generated
 */
public class Myxgen_3_0Switch<T> extends Switch<T>
{
  /**
  ...
  protected T doSwitch(int classifierID, EObject theEObject)
  {
    switch (classifierID)
    {
      ...
      {
        MyxGen myxGen = (MyxGen)theEObject;
        T result = caseMyxGen(myxGen);
        if (result == null) result = caseImplementation(myxGen);
  ...
  /**
   * Returns the result of interpreting the object as an instance of '<em>Myx Gen</em>'.
   * <!-- begin-user-doc -->
   * This implementation returns null;
   * returning a non-null result will terminate the switch.
   * <!-- end-user-doc -->
   * @param object the target of the switch.
   * @return the result of interpreting the object as an instance of '<em>Myx Gen</em>'.
   * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
   * @generated
   */
  public T caseMyxGen(MyxGen object)
  {
    return null;
  }
