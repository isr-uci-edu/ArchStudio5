 ...
 * begin-model-doc --> This type defines a reference to a MyxGen brick. <!-- end-model-doc -->
 * <p>
 ...
 * @generated
 */
public interface MyxGen extends
		Implementation {
					/**
					 * Returns the value of the '<em><b>Brick ID</b></em>' attribute. <!-- begin-user-doc -->
					 * <p>
					 * If the meaning of the '<em>Brick ID</em>' attribute isn't clear, there really should be more of a
					 * description here...
					 * </p>
					 * <!-- end-user-doc -->
					 * 
					 ...
					 * @model dataType="org.eclipse.emf.ecore.xml.type.IDREF" required="true" extendedMetaData=
	...
	/**
	 * Sets the value of the '{@link org.archstudio.xadl3.myxgen_3_0.MyxGen#getBrickID <em>Brick ID</em>}' attribute.
	 * <!-- begin-user-doc --> <!-- end-user-doc -->
	 * 
	 * @param value the new value of the '<em>Brick ID</em>' attribute.
	 * @see #getBrickID()
	 * @generated
	 */
