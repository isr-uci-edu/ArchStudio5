...
public interface Myxgen_3_0Package extends EPackage {
  ...
  /**
   * The meta object id for the '{@link org.archstudio.xadl3.myxgen_3_0.impl.MyxGenImpl
  ...
  /**
   * The feature id for the '<em><b>Brick ID</b></em>' attribute. <!-- begin-user-doc --> <!--
   * end-user-doc -->
   * 
   * @generated
   * @ordered
  ...
  /**
   * The number of structural features of the '<em>Myx Gen</em>' class. <!-- begin-user-doc --> <!--
   * end-user-doc -->
   * 
   * @generated
   * @ordered
  ...
  /**
   * The number of operations of the '<em>Myx Gen</em>' class. <!-- begin-user-doc --> <!--
   * end-user-doc -->
   * 
   * @generated
   * @ordered
  ...
  /**
   * Returns the meta object for class '{@link org.archstudio.xadl3.myxgen_3_0.MyxGen
   * <em>Myx Gen</em>}'. <!-- begin-user-doc --> <!-- end-user-doc -->
   * 
   ...
   * {@link org.archstudio.xadl3.myxgen_3_0.MyxGen#getBrickID <em>Brick ID</em>}'. <!--
  ...
  interface Literals {
    /**
     * The meta object literal for the '{@link org.archstudio.xadl3.myxgen_3_0.impl.MyxGenImpl
     * <em>Myx Gen</em>}' class. <!-- begin-user-doc --> <!-- end-user-doc -->
     * 
     * @see org.archstudio.xadl3.myxgen_3_0.impl.MyxGenImpl
     * @see org.archstudio.xadl3.myxgen_3_0.impl.Myxgen_3_0PackageImpl#getMyxGen()
    ...
    /**
     * The meta object literal for the '<em><b>Brick ID</b></em>' attribute feature. <!--
     * begin-user-doc --> <!-- end-user-doc -->
     * 
     * @generated
     */
