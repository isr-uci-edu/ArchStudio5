...
public class Myxgen_3_0PackageImpl extends EPackageImpl implements Myxgen_3_0Package
{
   ...
   * 
   * <p>This method is used to initialize {@link Myxgen_3_0Package#eINSTANCE} when that field is accessed.
  ...
  {
    if (isInited) return (Myxgen_3_0Package)EPackage.Registry.INSTANCE.getEPackage(Myxgen_3_0Package.eNS_URI);

    // Obtain or create and register package
    Myxgen_3_0PackageImpl theMyxgen_3_0Package = (Myxgen_3_0PackageImpl)(EPackage.Registry.INSTANCE.get(eNS_URI) instanceof Myxgen_3_0PackageImpl ? EPackage.Registry.INSTANCE.get(eNS_URI) : new Myxgen_3_0PackageImpl());
  ...
  public void initializePackageContents()
  {
    ...
    initEAttribute(getMyxGen_BrickID(), theXMLTypePackage.getIDREF(), "brickID", null, 1, 1, MyxGen.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
