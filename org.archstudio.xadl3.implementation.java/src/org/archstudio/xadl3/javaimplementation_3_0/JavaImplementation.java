 ...
 * <ul>
 *   <li>{@link org.archstudio.xadl3.javaimplementation_3_0.JavaImplementation#getMainClass <em>Main Class</em>}</li>
 *   <li>{@link org.archstudio.xadl3.javaimplementation_3_0.JavaImplementation#getAuxClass <em>Aux Class</em>}</li>
...
public interface JavaImplementation extends Implementation
{
   ...
   *        extendedMetaData="kind='element' name='mainClass' namespace='##targetNamespace'"
   * @generated
   */
  JavaClass getMainClass();

  /**
   * Sets the value of the '{@link org.archstudio.xadl3.javaimplementation_3_0.JavaImplementation#getMainClass <em>Main Class</em>}' containment reference.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
  ...
  /**
   * Returns the value of the '<em><b>Aux Class</b></em>' containment reference list.
   * The list contents are of type {@link org.archstudio.xadl3.javaimplementation_3_0.JavaClass}.
   * <!-- begin-user-doc -->
   * <p>
   * If the meaning of the '<em>Aux Class</em>' containment reference list isn't clear,
   * there really should be more of a description here...
   * </p>
   * <!-- end-user-doc -->
   ...
   *        extendedMetaData="kind='element' name='auxClass' namespace='##targetNamespace'"
   * @generated
   */
