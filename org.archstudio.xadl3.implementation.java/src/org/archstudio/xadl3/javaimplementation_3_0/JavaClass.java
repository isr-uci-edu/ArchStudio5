...
/**
 * <!-- begin-user-doc --> A representation of the model object '<em><b>Java Class</b></em>'. <!--
 * end-user-doc -->
 *
 * <!-- begin-model-doc -->
 * 
 ...
 * </p>
 * <ul>
 * <li>{@link org.archstudio.xadl3.javaimplementation_3_0.JavaClass#getClassPathEntry
 * <em>Class Path Entry</em>}</li>
 * <li>{@link org.archstudio.xadl3.javaimplementation_3_0.JavaClass#getExt <em>Ext</em>}</li>
 * <li>{@link org.archstudio.xadl3.javaimplementation_3_0.JavaClass#getClassName <em>Class Name</em>
 * }</li>
...
public interface JavaClass extends EObject {
  /**
   * Returns the value of the '<em><b>Class Path Entry</b></em>' containment reference list. The
   * list contents are of type {@link org.archstudio.xadl3.javaimplementation_3_0.ClassPathEntry}.
   * <!-- begin-user-doc -->
   * <p>
   * If the meaning of the '<em>Class Path Entry</em>' containment reference list isn't clear, there
   ...
   * <p>
   * If the meaning of the '<em>Class Name</em>' attribute isn't clear, there really should be more
  ...
  /**
   * Sets the value of the '{@link org.archstudio.xadl3.javaimplementation_3_0.JavaClass#getId
