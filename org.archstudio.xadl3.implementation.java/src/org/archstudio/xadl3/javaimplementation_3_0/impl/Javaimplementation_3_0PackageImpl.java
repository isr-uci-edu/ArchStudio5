 ...
 * @generated
 */
public class Javaimplementation_3_0PackageImpl extends EPackageImpl
    implements Javaimplementation_3_0Package {
  /**
   ...
   * 
   * <p>
   * This method is used to initialize {@link Javaimplementation_3_0Package#eINSTANCE} when that
  ...
  public static Javaimplementation_3_0Package init() {
    ...
    EPackage.Registry.INSTANCE.put(Javaimplementation_3_0Package.eNS_URI,
        theJavaimplementation_3_0Package);
  ...
  public void initializePackageContents() {
    ...
    Implementation_3_0Package theImplementation_3_0Package =
        (Implementation_3_0Package) EPackage.Registry.INSTANCE
    ...
    initEClass(classPathEntryEClass, ClassPathEntry.class, "ClassPathEntry", !IS_ABSTRACT,
        !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
    initEReference(getClassPathEntry_Ext(), theXadlcore_3_0Package.getExtension(), null, "ext",
        null, 0, -1, ClassPathEntry.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE,
        !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
    initEAttribute(getClassPathEntry_Entry(), theXMLTypePackage.getString(), "entry", null, 0, 1,
        ClassPathEntry.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID,
        IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
    initEAttribute(getClassPathEntry_Id(), theXMLTypePackage.getID(), "id", null, 0, 1,
        ClassPathEntry.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, IS_ID,
        IS_UNIQUE, !IS_DERIVED, IS_ORDERED);

    initEClass(javaClassEClass, JavaClass.class, "JavaClass", !IS_ABSTRACT, !IS_INTERFACE,
        IS_GENERATED_INSTANCE_CLASS);
    initEReference(getJavaClass_ClassPathEntry(), this.getClassPathEntry(), null, "classPathEntry",
        null, 0, -1, JavaClass.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE,
        !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
    initEReference(getJavaClass_Ext(), theXadlcore_3_0Package.getExtension(), null, "ext", null, 0,
        -1, JavaClass.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE,
        !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
    initEAttribute(getJavaClass_ClassName(), theXMLTypePackage.getString(), "className", null, 0, 1,
        JavaClass.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID,
        IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
    initEAttribute(getJavaClass_Id(), theXMLTypePackage.getID(), "id", null, 0, 1, JavaClass.class,
        !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, IS_ID, IS_UNIQUE, !IS_DERIVED,
        IS_ORDERED);

    initEClass(javaImplementationEClass, JavaImplementation.class, "JavaImplementation",
        !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
    initEReference(getJavaImplementation_MainClass(), this.getJavaClass(), null, "mainClass", null,
        1, 1, JavaImplementation.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE,
        !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
    initEReference(getJavaImplementation_AuxClass(), this.getJavaClass(), null, "auxClass", null, 0,
        -1, JavaImplementation.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE,
        !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
    initEReference(getJavaImplementation_Ext(), theXadlcore_3_0Package.getExtension(), null, "ext",
        null, 0, -1, JavaImplementation.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE,
  ...
  protected void createExtendedMetaDataAnnotations() {
    ...
    addAnnotation(classPathEntryEClass, source,
        new String[] {"name", "ClassPathEntry", "kind", "elementOnly"});
    ...
    addAnnotation(javaClassEClass, source,
        new String[] {"name", "JavaClass", "kind", "elementOnly"});
