...
public class JavaImplementationImpl extends ImplementationImpl implements JavaImplementation
{
  ...
  public NotificationChain basicSetMainClass(JavaClass newMainClass, NotificationChain msgs)
  {
    ...
    {
      ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, Javaimplementation_3_0Package.JAVA_IMPLEMENTATION__MAIN_CLASS, oldMainClass, newMainClass);
  ...
  public void setMainClass(JavaClass newMainClass)
  {
    if (newMainClass != mainClass)
    {
      ...
      if (mainClass != null)
        msgs = ((InternalEObject)mainClass).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - Javaimplementation_3_0Package.JAVA_IMPLEMENTATION__MAIN_CLASS, null, msgs);
      if (newMainClass != null)
        msgs = ((InternalEObject)newMainClass).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - Javaimplementation_3_0Package.JAVA_IMPLEMENTATION__MAIN_CLASS, null, msgs);
      msgs = basicSetMainClass(newMainClass, msgs);
      if (msgs != null) msgs.dispatch();
    }
    else if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, Javaimplementation_3_0Package.JAVA_IMPLEMENTATION__MAIN_CLASS, newMainClass, newMainClass));
  }
  ...
  public EList<JavaClass> getAuxClass()
  {
    if (auxClass == null)
    {
      auxClass = new EObjectContainmentEList<JavaClass>(JavaClass.class, this, Javaimplementation_3_0Package.JAVA_IMPLEMENTATION__AUX_CLASS);
    }
    return auxClass;
  }
  ...
  public EList<Extension> getExt()
  {
    if (ext == null)
    {
      ext = new EObjectContainmentEList<Extension>(Extension.class, this, Javaimplementation_3_0Package.JAVA_IMPLEMENTATION__EXT);
    }
    return ext;
  }
