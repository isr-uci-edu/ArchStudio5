...
public class ClassPathEntryImpl extends EObjectImpl implements ClassPathEntry
{
  ...
  public EList<Extension> getExt()
  {
    if (ext == null)
    {
      ext = new EObjectContainmentEList<Extension>(Extension.class, this, Javaimplementation_3_0Package.CLASS_PATH_ENTRY__EXT);
    }
    return ext;
  }
  ...
  public void setEntry(String newEntry)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, Javaimplementation_3_0Package.CLASS_PATH_ENTRY__ENTRY, oldEntry, entry));
  }
  ...
  public void setId(String newId)
  {
    ...
    id = newId;
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, Javaimplementation_3_0Package.CLASS_PATH_ENTRY__ID, oldId, id));
  }
