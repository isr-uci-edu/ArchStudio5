...
public class Xadlcore_3_0PackageImpl extends EPackageImpl implements Xadlcore_3_0Package
{
   ...
   * 
   * <p>This method is used to initialize {@link Xadlcore_3_0Package#eINSTANCE} when that field is accessed.
  ...
  {
    if (isInited) return (Xadlcore_3_0Package)EPackage.Registry.INSTANCE.getEPackage(Xadlcore_3_0Package.eNS_URI);

    // Obtain or create and register package
    Xadlcore_3_0PackageImpl theXadlcore_3_0Package = (Xadlcore_3_0PackageImpl)(EPackage.Registry.INSTANCE.get(eNS_URI) instanceof Xadlcore_3_0PackageImpl ? EPackage.Registry.INSTANCE.get(eNS_URI) : new Xadlcore_3_0PackageImpl());
  ...
  public void initializePackageContents()
  {
    ...
    initEReference(getDocumentRoot_TopLevelElement(), ecorePackage.getEObject(), null, "topLevelElement", null, 0, -2, null, IS_TRANSIENT, IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, IS_DERIVED, IS_ORDERED);
    initEReference(getDocumentRoot_XADL(), this.getXADLType(), null, "xADL", null, 0, -2, null, IS_TRANSIENT, IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, IS_DERIVED, IS_ORDERED);

    initEClass(extensionEClass, Extension.class, "Extension", IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
    initEAttribute(getExtension_Id(), theXMLTypePackage.getID(), "id", null, 1, 1, Extension.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
    ...
    initEAttribute(getSimpleLink_Id(), theXMLTypePackage.getID(), "id", null, 1, 1, SimpleLink.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
    initEAttribute(getSimpleLink_Type(), theXMLTypePackage.getString(), "type", "simple", 1, 1, SimpleLink.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);

    initEClass(xadlTypeEClass, XADLType.class, "XADLType", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
    initEReference(getXADLType_TopLevelElement(), ecorePackage.getEObject(), null, "topLevelElement", null, 0, -1, XADLType.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
  ...
  protected void createExtendedMetaDataAnnotations()
  {
    ...
    addAnnotation
      (getDocumentRoot_TopLevelElement(), 
       source, 
       new String[] 
       {
       "kind", "element",
