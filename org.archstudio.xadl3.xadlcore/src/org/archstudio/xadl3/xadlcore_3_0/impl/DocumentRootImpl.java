 ...
 * <li>{@link org.archstudio.xadl3.xadlcore_3_0.impl.DocumentRootImpl#getXMLNSPrefixMap
 * <em>XMLNS Prefix Map</em>}</li>
 * <li>{@link org.archstudio.xadl3.xadlcore_3_0.impl.DocumentRootImpl#getXSISchemaLocation
 * <em>XSI Schema Location</em>}</li>
 * <li>{@link org.archstudio.xadl3.xadlcore_3_0.impl.DocumentRootImpl#getTopLevelElement
...
public class DocumentRootImpl extends MinimalEObjectImpl.Container implements DocumentRoot {
  ...
  public EMap<String, String> getXMLNSPrefixMap() {
    if (xMLNSPrefixMap == null) {
      xMLNSPrefixMap = new EcoreEMap<String, String>(
          ...
          this, Xadlcore_3_0Package.DOCUMENT_ROOT__XMLNS_PREFIX_MAP);
    }
  ...
  public EMap<String, String> getXSISchemaLocation() {
    if (xSISchemaLocation == null) {
      xSISchemaLocation = new EcoreEMap<String, String>(
          EcorePackage.Literals.ESTRING_TO_STRING_MAP_ENTRY, EStringToStringMapEntryImpl.class,
          this, Xadlcore_3_0Package.DOCUMENT_ROOT__XSI_SCHEMA_LOCATION);
    }
  ...
  public EObject getTopLevelElement() {
    return (EObject) getMixed().get(Xadlcore_3_0Package.Literals.DOCUMENT_ROOT__TOP_LEVEL_ELEMENT,
        true);
  }
   ...
   * @generated
   */
  public NotificationChain basicSetTopLevelElement(EObject newTopLevelElement,
  ...
  public void setTopLevelElement(EObject newTopLevelElement) {
    ((FeatureMap.Internal) getMixed())
        .set(Xadlcore_3_0Package.Literals.DOCUMENT_ROOT__TOP_LEVEL_ELEMENT, newTopLevelElement);
  }
  ...
  public NotificationChain basicSetXADL(XADLType newXADL, NotificationChain msgs) {
    return ((FeatureMap.Internal) getMixed())
        .basicAdd(Xadlcore_3_0Package.Literals.DOCUMENT_ROOT__XADL, newXADL, msgs);
  }
  ...
  public void setXADL(XADLType newXADL) {
    ((FeatureMap.Internal) getMixed()).set(Xadlcore_3_0Package.Literals.DOCUMENT_ROOT__XADL,
        newXADL);
  }
