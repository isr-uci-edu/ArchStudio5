...
/**
 * <!-- begin-user-doc --> An implementation of the model object '<em><b>Simple Link</b></em>'. <!--
 * end-user-doc -->
 * <p>
...
public class SimpleLinkImpl extends MinimalEObjectImpl.Container implements SimpleLink {
  /**
   * The default value of the '{@link #getHref() <em>Href</em>}' attribute. <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * 
   * @see #getHref()
   * @generated
  ...
  /**
   * The cached value of the '{@link #getHref() <em>Href</em>}' attribute. <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * 
   * @see #getHref()
   * @generated
  ...
  public void setHref(String newHref) {
    ...
    if (eNotificationRequired()) {
      eNotify(new ENotificationImpl(this, Notification.SET, Xadlcore_3_0Package.SIMPLE_LINK__HREF,
          oldHref, href));
    }
  }
  ...
  public void setId(String newId) {
    ...
    id = newId;
    if (eNotificationRequired()) {
      eNotify(new ENotificationImpl(this, Notification.SET, Xadlcore_3_0Package.SIMPLE_LINK__ID,
          oldId, id));
    }
  }
  ...
  public void setType(String newType) {
    ...
    typeESet = true;
    if (eNotificationRequired()) {
      eNotify(new ENotificationImpl(this, Notification.SET, Xadlcore_3_0Package.SIMPLE_LINK__TYPE,
  ...
  public void unsetType() {
    ...
    typeESet = false;
    if (eNotificationRequired()) {
      eNotify(new ENotificationImpl(this, Notification.UNSET, Xadlcore_3_0Package.SIMPLE_LINK__TYPE,
