...
public class SimpleLinkImpl extends EObjectImpl implements SimpleLink
{
  ...
  public void setType(String newType)
  {
    ...
    typeESet = true;
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, Xadlcore_3_0Package.SIMPLE_LINK__TYPE, oldType, type, !oldTypeESet));
  }
  ...
  public void unsetType()
  {
    ...
    typeESet = false;
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.UNSET, Xadlcore_3_0Package.SIMPLE_LINK__TYPE, oldType, TYPE_EDEFAULT, oldTypeESet));
  }
