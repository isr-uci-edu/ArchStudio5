...
public class Xadlcore_3_0AdapterFactory extends AdapterFactoryImpl {
   ...
   * {@link org.archstudio.xadl3.xadlcore_3_0.DocumentRoot <em>Document Root</em>}'. <!--
  ...
  /**
   * Creates a new adapter for an object of class '
   * {@link org.archstudio.xadl3.xadlcore_3_0.SimpleLink <em>Simple Link</em>}'. <!-- begin-user-doc
   * --> This default implementation returns null so that we can easily ignore cases; it's useful to
   * ignore a case when inheritance will catch all the cases anyway. <!-- end-user-doc -->
   * 
   * @return the new adapter.
   ...
   * <em>XADL Type</em>}'. <!-- begin-user-doc --> This default implementation returns null so that
