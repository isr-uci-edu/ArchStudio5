 ...
 * <!-- begin-model-doc --> This type is meant to describe elements that are simple outbound links outside the current
 * document (internal links should use IDREFs). Elements of this type are simple-type XLinks that can use a simple href
 * to link to a document, or XPointer to refer to an element within a document. <!-- end-model-doc -->
 * <p>
