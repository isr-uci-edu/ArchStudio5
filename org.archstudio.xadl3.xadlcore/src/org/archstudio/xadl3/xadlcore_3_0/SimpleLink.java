...
/**
 * <!-- begin-user-doc --> A representation of the model object '<em><b>Simple Link</b></em>'. <!--
 * end-user-doc -->
 *
 * <!-- begin-model-doc -->
 * 
 * This type is meant to describe elements that are simple outbound links outside the current
 * document (internal links should use IDREFs). Elements of this type are simple-type XLinks that
 * can use a simple href to link to a document, or XPointer to refer to an element within a
 * document.
 * 
 * <!-- end-model-doc -->
 *
...
public interface SimpleLink extends EObject {
  ...
  /**
   * Sets the value of the '{@link org.archstudio.xadl3.xadlcore_3_0.SimpleLink#getHref
   * <em>Href</em>}' attribute. <!-- begin-user-doc --> <!-- end-user-doc -->
   * 
  ...
  /**
   * Sets the value of the '{@link org.archstudio.xadl3.xadlcore_3_0.SimpleLink#getId <em>Id</em>}'
   ...
   * <code>"simple"</code>. <!-- begin-user-doc -->
   * <p>
   ...
   *        "kind='attribute' name='type' namespace='http://www.w3.org/1999/xlink'"
   * @generated
   */
  String getType();

  /**
   * Sets the value of the '{@link org.archstudio.xadl3.xadlcore_3_0.SimpleLink#getType
  ...
  /**
   * Unsets the value of the '{@link org.archstudio.xadl3.xadlcore_3_0.SimpleLink#getType
   * <em>Type</em>}' attribute. <!-- begin-user-doc --> <!-- end-user-doc -->
   * 
   * @see #isSetType()
   * @see #getType()
  ...
  /**
   * Returns whether the value of the '{@link org.archstudio.xadl3.xadlcore_3_0.SimpleLink#getType
