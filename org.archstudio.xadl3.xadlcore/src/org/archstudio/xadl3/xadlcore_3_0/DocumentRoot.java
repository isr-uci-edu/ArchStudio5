 ...
 * <li>{@link org.archstudio.xadl3.xadlcore_3_0.DocumentRoot#getXSISchemaLocation
...
public interface DocumentRoot extends EObject {
  ...
  /**
   * Returns the value of the '<em><b>Top Level Element</b></em>' containment reference. <!--
   * begin-user-doc --> <!-- end-user-doc --> <!-- begin-model-doc -->
   * 
   * This is a placeholder element for xADL top-level elements (i.e., elements that are direct
   * children of the document root element. Elements that are intended to be top-level elements
   * should be in the topLevelElement substitutionGroup to declare their intent to be used as
   * top-level elements.
   * 
   * <!-- end-model-doc -->
   * 
   ...
   * -->
   * 
   * @param value the new value of the '<em>Top Level Element</em>' containment reference.
  ...
  /**
   * Returns the value of the '<em><b>XADL</b></em>' containment reference. <!-- begin-user-doc -->
   * <!-- end-user-doc --> <!-- begin-model-doc -->
   * 
   * This is the root element for all xADL documents. It is a container element, so it can contain a
   * number of top-level xADL elements via the use of a substitution group.
   * 
   * <!-- end-model-doc -->
   * 
  ...
  /**
   * Sets the value of the '{@link org.archstudio.xadl3.xadlcore_3_0.DocumentRoot#getXADL
   * <em>XADL</em>}' containment reference. <!-- begin-user-doc --> <!-- end-user-doc -->
   * 
   * @param value the new value of the '<em>XADL</em>' containment reference.
   * @see #getXADL()
   * @generated
   */
