...
public interface DocumentRoot extends EObject {
	 ...
	 * end-user-doc --> <!-- begin-model-doc --> This is a placeholder element for xADL top-level elements (i.e.,
	 * elements that are direct children of the document root element. Elements that are intended to be top-level
	 * elements should be in the topLevelElement substitutionGroup to declare their intent to be used as top-level
	 ...
	 * --> <!-- begin-model-doc --> This is the root element for all xADL documents. It is a container element, so it
	 * can contain a number of top-level xADL elements via the use of a substitution group. <!-- end-model-doc -->
	 * 
