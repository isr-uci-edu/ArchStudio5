...
public interface XADLType extends EObject {
	/**
	 * Returns the value of the '<em><b>Top Level Element</b></em>' containment reference list. The list contents are of
	 * type {@link org.eclipse.emf.ecore.EObject}. <!-- begin-user-doc --> <!-- end-user-doc --> <!-- begin-model-doc
	 ...
	 * substitutionGroup to declare their intent to be used as top-level elements. <!-- end-model-doc -->
	 * 
	 ...
	 * @model containment="true" extendedMetaData="kind='element' name='topLevelElement' namespace='##targetNamespace'"
	 * @generated
	 */
