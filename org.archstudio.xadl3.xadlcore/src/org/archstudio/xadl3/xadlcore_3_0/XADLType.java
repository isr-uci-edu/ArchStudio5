 ...
 * @generated
 */
public interface XADLType extends
		EObject {
					/**
					 * Returns the value of the '<em><b>Top Level Element</b></em>' containment reference list. The list
					 * contents are of type {@link org.eclipse.emf.ecore.EObject}. <!-- begin-user-doc --> <!--
					 * end-user-doc --> <!-- begin-model-doc --> This is a placeholder element for xADL top-level
					 * elements (i.e., elements that are direct children of the document root element. Elements that are
					 * intended to be top-level elements should be in the topLevelElement substitutionGroup to declare
					 * their intent to be used as top-level elements. <!-- end-model-doc -->
					 * 
