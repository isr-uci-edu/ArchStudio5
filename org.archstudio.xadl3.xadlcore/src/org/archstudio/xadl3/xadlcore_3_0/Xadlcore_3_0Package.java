...
public interface Xadlcore_3_0Package extends EPackage {
  ...
  Xadlcore_3_0Package eINSTANCE =
      org.archstudio.xadl3.xadlcore_3_0.impl.Xadlcore_3_0PackageImpl.init();
  ...
  /**
   * The feature id for the '<em><b>Top Level Element</b></em>' containment reference. <!--
  ...
  /**
   * The feature id for the '<em><b>XADL</b></em>' containment reference. <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * 
   * @generated
   * @ordered
  ...
  /**
   * The meta object id for the '{@link org.archstudio.xadl3.xadlcore_3_0.impl.ExtensionImpl
  ...
  /**
   * The number of structural features of the '<em>Extension</em>' class. <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * 
   * @generated
   * @ordered
  ...
  /**
   * The number of operations of the '<em>Extension</em>' class. <!-- begin-user-doc --> <!--
   * end-user-doc -->
   * 
   * @generated
   * @ordered
  ...
  /**
   * The meta object id for the '{@link org.archstudio.xadl3.xadlcore_3_0.impl.SimpleLinkImpl
  ...
  /**
   * The feature id for the '<em><b>Href</b></em>' attribute. <!-- begin-user-doc --> <!--
   * end-user-doc -->
   * 
   * @generated
   * @ordered
  ...
  /**
   * The number of structural features of the '<em>Simple Link</em>' class. <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * 
   * @generated
   * @ordered
  ...
  /**
   * The number of operations of the '<em>Simple Link</em>' class. <!-- begin-user-doc --> <!--
   * end-user-doc -->
   * 
   * @generated
   * @ordered
  ...
  /**
   * The meta object id for the '{@link org.archstudio.xadl3.xadlcore_3_0.impl.XADLTypeImpl
  ...
  /**
   * The feature id for the '<em><b>Top Level Element</b></em>' containment reference list. <!--
   * begin-user-doc --> <!-- end-user-doc -->
   * 
   * @generated
   * @ordered
  ...
  /**
   * The number of structural features of the '<em>XADL Type</em>' class. <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * 
   * @generated
   * @ordered
  ...
  /**
   * The number of operations of the '<em>XADL Type</em>' class. <!-- begin-user-doc --> <!--
   * end-user-doc -->
   * 
   * @generated
   * @ordered
  ...
  /**
   * Returns the meta object for class '{@link org.archstudio.xadl3.xadlcore_3_0.DocumentRoot
   ...
   * {@link org.archstudio.xadl3.xadlcore_3_0.DocumentRoot#getMixed <em>Mixed</em>}'. <!--
   * begin-user-doc --> <!-- end-user-doc -->
   * 
   ...
   * {@link org.archstudio.xadl3.xadlcore_3_0.DocumentRoot#getXMLNSPrefixMap
  ...
  /**
   * Returns the meta object for the map '
   * {@link org.archstudio.xadl3.xadlcore_3_0.DocumentRoot#getXSISchemaLocation
   ...
   * {@link org.archstudio.xadl3.xadlcore_3_0.DocumentRoot#getTopLevelElement
   * <em>Top Level Element</em>}'. <!-- begin-user-doc --> <!-- end-user-doc -->
   * 
  ...
  /**
   * Returns the meta object for the containment reference '
   * {@link org.archstudio.xadl3.xadlcore_3_0.DocumentRoot#getXADL <em>XADL</em>}'. <!--
   * begin-user-doc --> <!-- end-user-doc -->
   * 
  ...
  /**
   * Returns the meta object for class '{@link org.archstudio.xadl3.xadlcore_3_0.Extension
  ...
  /**
   * Returns the meta object for class '{@link org.archstudio.xadl3.xadlcore_3_0.SimpleLink
   * <em>Simple Link</em>}'. <!-- begin-user-doc --> <!-- end-user-doc -->
   * 
   ...
   * {@link org.archstudio.xadl3.xadlcore_3_0.SimpleLink#getHref <em>Href</em>}'. <!--
   * begin-user-doc --> <!-- end-user-doc -->
   * 
  ...
  /**
   * Returns the meta object for the attribute '
   * {@link org.archstudio.xadl3.xadlcore_3_0.SimpleLink#getId <em>Id</em>}'. <!-- begin-user-doc
   * --> <!-- end-user-doc -->
   * 
  ...
  /**
   * Returns the meta object for the attribute '
   * {@link org.archstudio.xadl3.xadlcore_3_0.SimpleLink#getType <em>Type</em>}'. <!--
   * begin-user-doc --> <!-- end-user-doc -->
   * 
  ...
  /**
   * Returns the meta object for class '{@link org.archstudio.xadl3.xadlcore_3_0.XADLType
   * <em>XADL Type</em>}'. <!-- begin-user-doc --> <!-- end-user-doc -->
   * 
  ...
  interface Literals {
     ...
     * {@link org.archstudio.xadl3.xadlcore_3_0.impl.DocumentRootImpl <em>Document Root</em>}'
    ...
    /**
     * The meta object literal for the '<em><b>Top Level Element</b></em>' containment reference
    ...
    /**
     * The meta object literal for the '<em><b>XADL</b></em>' containment reference feature. <!--
     * begin-user-doc --> <!-- end-user-doc -->
     * 
     * @generated
     */
