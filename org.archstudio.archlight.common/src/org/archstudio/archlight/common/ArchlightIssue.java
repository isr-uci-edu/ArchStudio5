...
public class ArchlightIssue implements java.io.Serializable{
	...
	public ArchlightIssue(String testUID, ObjRef documentRootRef, String toolID,
		int severity, String headline, String detailedDescription, String iconHref,
		Collection<ArchlightElementIdentifier> elementIdentifiers){
		super();
	...
	public void setElementIdentifiers(Collection<ArchlightElementIdentifier> elementIdentifiers){
		this.elementIdentifiers = Collections.unmodifiableCollection(new ArrayList<ArchlightElementIdentifier>(elementIdentifiers));
	}
	...
	public boolean equals(Object o){
		...
		return nulleq(testUID, otherIssue.testUID) &&
			nulleq(documentRootRef, otherIssue.documentRootRef) &&
			...
			elementIdentifiers.containsAll(otherIssue.elementIdentifiers) && otherIssue.elementIdentifiers.containsAll(elementIdentifiers);
	}
