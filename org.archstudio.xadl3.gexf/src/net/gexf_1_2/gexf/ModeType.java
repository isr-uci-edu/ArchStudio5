 ...
 * <em><b>Mode Type</b></em>', and utility methods for working with them. <!-- end-user-doc -->
 * 
...
public enum ModeType implements Enumerator {
   ...
   * <p>
   * If the meaning of '<em><b>Static</b></em>' literal object isn't clear, there really should be
   ...
   * <p>
   * If the meaning of '<em><b>Dynamic</b></em>' literal object isn't clear, there really should be
   * more of a description here...
   * </p>
   * <!-- end-user-doc -->
   * 
  ...
  /**
   * An array of all the '<em><b>Mode Type</b></em>' enumerators. <!-- begin-user-doc --> <!--
   * end-user-doc -->
   * 
   * @generated
   */
