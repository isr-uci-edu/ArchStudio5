...
/**
 * <!-- begin-user-doc --> A representation of the model object '<em><b>Nodes Content</b></em>'.
 * <!-- end-user-doc -->
 *
 * <p>
...
public interface NodesContent extends EObject {
  /**
   * Returns the value of the '<em><b>Node</b></em>' containment reference list. The list contents
   * are of type {@link net.gexf_1_2.gexf.NodeContent}. <!-- begin-user-doc -->
   * <p>
   * If the meaning of the '<em>Node</em>' containment reference list isn't clear, there really
  ...
  /**
   * Sets the value of the '{@link net.gexf_1_2.gexf.NodesContent#getCount <em>Count</em>}'
