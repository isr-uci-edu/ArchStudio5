...
public interface NodesContent extends EObject {
	 ...
	 * list. The list contents are of type {@link net.gexf_1_2.gexf.NodeContent}
	 * . <!-- begin-user-doc -->
	 * <p>
	 * If the meaning of the '<em>Node</em>' containment reference list isn't
	...
	/**
	 * Sets the value of the '{@link net.gexf_1_2.gexf.NodesContent#getCount
