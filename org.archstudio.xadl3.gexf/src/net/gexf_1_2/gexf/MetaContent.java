...
/**
 * <!-- begin-user-doc --> A representation of the model object '<em><b>Meta Content</b></em>'. <!--
 * end-user-doc -->
 *
 * <p>
...
public interface MetaContent extends EObject {
  ...
  /**
   * Returns the value of the '<em><b>Creator</b></em>' attribute list. The list contents are of
   * type {@link java.lang.String}. <!-- begin-user-doc -->
   * <p>
   * If the meaning of the '<em>Creator</em>' attribute list isn't clear, there really should be
  ...
  /**
   * Returns the value of the '<em><b>Keywords</b></em>' attribute list. The list contents are of
   * type {@link java.lang.String}. <!-- begin-user-doc -->
   * <p>
   * If the meaning of the '<em>Keywords</em>' attribute list isn't clear, there really should be
   * more of a description here...
   * </p>
   * <!-- end-user-doc -->
   * 
  ...
  /**
   * Returns the value of the '<em><b>Description</b></em>' attribute list. The list contents are of
   * type {@link java.lang.String}. <!-- begin-user-doc -->
   * <p>
   * If the meaning of the '<em>Description</em>' attribute list isn't clear, there really should be
   * more of a description here...
   * </p>
   * <!-- end-user-doc -->
   * 
   ...
   * <p>
   * If the meaning of the '<em>Lastmodifieddate</em>' attribute isn't clear, there really should be
   * more of a description here...
   * </p>
   * <!-- end-user-doc -->
   * 
   ...
   *        "kind='attribute' name='lastmodifieddate'"
   * @generated
   */
  XMLGregorianCalendar getLastmodifieddate();

  /**
   * Sets the value of the '{@link net.gexf_1_2.gexf.MetaContent#getLastmodifieddate
   * <em>Lastmodifieddate</em>}' attribute. <!-- begin-user-doc --> <!-- end-user-doc -->
   * 
   * @param value the new value of the '<em>Lastmodifieddate</em>' attribute.
