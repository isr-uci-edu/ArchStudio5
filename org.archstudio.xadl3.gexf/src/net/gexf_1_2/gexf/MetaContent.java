...
/**
 * <!-- begin-user-doc -->
 * A representation of the model object '<em><b>Meta Content</b></em>'.
 * <!-- end-user-doc -->
 *
 * <p>
...
public interface MetaContent extends EObject
{
  ...
  /**
   * Returns the value of the '<em><b>Creator</b></em>' attribute list.
   * The list contents are of type {@link java.lang.String}.
   * <!-- begin-user-doc -->
   * <p>
   * If the meaning of the '<em>Creator</em>' attribute list isn't clear,
   * there really should be more of a description here...
   * </p>
   * <!-- end-user-doc -->
  ...
  /**
   * Returns the value of the '<em><b>Lastmodifieddate</b></em>' attribute.
   * <!-- begin-user-doc -->
   * <p>
   * If the meaning of the '<em>Lastmodifieddate</em>' attribute isn't clear,
   * there really should be more of a description here...
   * </p>
   * <!-- end-user-doc -->
   ...
   *        extendedMetaData="kind='attribute' name='lastmodifieddate'"
   * @generated
   */
  XMLGregorianCalendar getLastmodifieddate();

  /**
   * Sets the value of the '{@link net.gexf_1_2.gexf.MetaContent#getLastmodifieddate <em>Lastmodifieddate</em>}' attribute.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
