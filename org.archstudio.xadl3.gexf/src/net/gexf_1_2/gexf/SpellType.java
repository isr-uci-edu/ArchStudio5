...
/**
 * <!-- begin-user-doc --> A representation of the model object '<em><b>Spell Type</b></em>'. <!--
 * end-user-doc -->
 *
 * <p>
...
public interface SpellType extends EObject {
  ...
  /**
   * Sets the value of the '{@link net.gexf_1_2.gexf.SpellType#getEndopen <em>Endopen</em>}'
  ...
  /**
   * Sets the value of the '{@link net.gexf_1_2.gexf.SpellType#getStartopen <em>Startopen</em>}'
   * attribute. <!-- begin-user-doc --> <!-- end-user-doc -->
   * 
