...
/**
 * <!-- begin-user-doc -->
 * A representation of the model object '<em><b>Graph Content</b></em>'.
 * <!-- end-user-doc -->
 *
 * <p>
...
public interface GraphContent extends EObject
{
   ...
   * The list contents are of type {@link net.gexf_1_2.gexf.AttributesContent}.
   * <!-- begin-user-doc -->
   * <p>
  ...
  /**
   * Returns the value of the '<em><b>Defaultedgetype</b></em>' attribute.
   * The literals are from the enumeration {@link net.gexf_1_2.gexf.DefaultedgetypeType}.
   * <!-- begin-user-doc -->
   * <p>
  ...
  /**
   * Sets the value of the '{@link net.gexf_1_2.gexf.GraphContent#getDefaultedgetype <em>Defaultedgetype</em>}' attribute.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
  ...
  /**
   * Unsets the value of the '{@link net.gexf_1_2.gexf.GraphContent#getDefaultedgetype <em>Defaultedgetype</em>}' attribute.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * @see #isSetDefaultedgetype()
   * @see #getDefaultedgetype()
  ...
  /**
   * Returns whether the value of the '{@link net.gexf_1_2.gexf.GraphContent#getDefaultedgetype <em>Defaultedgetype</em>}' attribute is set.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
  ...
  /**
   * Returns the value of the '<em><b>Idtype</b></em>' attribute.
   * The literals are from the enumeration {@link net.gexf_1_2.gexf.IdtypeType}.
   * <!-- begin-user-doc -->
   * <p>
   * If the meaning of the '<em>Idtype</em>' attribute isn't clear,
   * there really should be more of a description here...
   * </p>
   * <!-- end-user-doc -->
  ...
  /**
   * Returns whether the value of the '{@link net.gexf_1_2.gexf.GraphContent#getIdtype <em>Idtype</em>}' attribute is set.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   ...
   * The literals are from the enumeration {@link net.gexf_1_2.gexf.TimeformatType}.
   * <!-- begin-user-doc -->
   * <p>
  ...
  /**
   * Returns whether the value of the '{@link net.gexf_1_2.gexf.GraphContent#getTimeformat <em>Timeformat</em>}' attribute is set.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
