...
/**
 * <!-- begin-user-doc --> A representation of the model object '<em><b>Graph Content</b></em>'.
 * <!-- end-user-doc -->
 *
 * <p>
...
public interface GraphContent extends EObject {
  ...
  /**
   * Returns the value of the '<em><b>Attributes</b></em>' containment reference list. The list
   * contents are of type {@link net.gexf_1_2.gexf.AttributesContent}. <!-- begin-user-doc -->
   * <p>
   * If the meaning of the '<em>Attributes</em>' containment reference list isn't clear, there
   ...
   * are of type {@link net.gexf_1_2.gexf.NodesContent}. <!-- begin-user-doc -->
   * <p>
   * If the meaning of the '<em>Nodes</em>' containment reference list isn't clear, there really
  ...
  /**
   * Returns the value of the '<em><b>Edges</b></em>' containment reference list. The list contents
   * are of type {@link net.gexf_1_2.gexf.EdgesContent}. <!-- begin-user-doc -->
   * <p>
   * If the meaning of the '<em>Edges</em>' containment reference list isn't clear, there really
   * should be more of a description here...
   * </p>
   * <!-- end-user-doc -->
   * 
  ...
  /**
   * Returns the value of the '<em><b>Defaultedgetype</b></em>' attribute. The literals are from the
   * enumeration {@link net.gexf_1_2.gexf.DefaultedgetypeType}. <!-- begin-user-doc -->
   * <p>
   * If the meaning of the '<em>Defaultedgetype</em>' attribute isn't clear, there really should be
  ...
  /**
   * Sets the value of the '{@link net.gexf_1_2.gexf.GraphContent#getDefaultedgetype
   * <em>Defaultedgetype</em>}' attribute. <!-- begin-user-doc --> <!-- end-user-doc -->
   * 
   * @param value the new value of the '<em>Defaultedgetype</em>' attribute.
   * @see net.gexf_1_2.gexf.DefaultedgetypeType
   * @see #isSetDefaultedgetype()
   * @see #unsetDefaultedgetype()
  ...
  /**
   * Unsets the value of the '{@link net.gexf_1_2.gexf.GraphContent#getDefaultedgetype
   * <em>Defaultedgetype</em>}' attribute. <!-- begin-user-doc --> <!-- end-user-doc -->
   * 
   * @see #isSetDefaultedgetype()
   * @see #getDefaultedgetype()
  ...
  /**
   * Sets the value of the '{@link net.gexf_1_2.gexf.GraphContent#getEnd <em>End</em>}' attribute.
   ...
   * <p>
   * If the meaning of the '<em>Endopen</em>' attribute isn't clear, there really should be more of
   * a description here...
   * </p>
   * <!-- end-user-doc -->
   * 
  ...
  /**
   * Sets the value of the '{@link net.gexf_1_2.gexf.GraphContent#getEndopen <em>Endopen</em>}'
  ...
  /**
   * Returns the value of the '<em><b>Idtype</b></em>' attribute. The literals are from the
   * enumeration {@link net.gexf_1_2.gexf.IdtypeType}. <!-- begin-user-doc -->
   * <p>
   * If the meaning of the '<em>Idtype</em>' attribute isn't clear, there really should be more of a
   * description here...
   * </p>
   * <!-- end-user-doc -->
   * 
  ...
  /**
   * Sets the value of the '{@link net.gexf_1_2.gexf.GraphContent#getIdtype <em>Idtype</em>}'
   * attribute. <!-- begin-user-doc --> <!-- end-user-doc -->
   * 
   * @param value the new value of the '<em>Idtype</em>' attribute.
   * @see net.gexf_1_2.gexf.IdtypeType
   * @see #isSetIdtype()
   * @see #unsetIdtype()
   * @see #getIdtype()
  ...
  /**
   * Unsets the value of the '{@link net.gexf_1_2.gexf.GraphContent#getIdtype <em>Idtype</em>}'
   * attribute. <!-- begin-user-doc --> <!-- end-user-doc -->
   * 
   * @see #isSetIdtype()
   * @see #getIdtype()
  ...
  /**
   * Returns whether the value of the '{@link net.gexf_1_2.gexf.GraphContent#getIdtype
   * <em>Idtype</em>}' attribute is set. <!-- begin-user-doc --> <!-- end-user-doc -->
   * 
   ...
   * enumeration {@link net.gexf_1_2.gexf.ModeType}. <!-- begin-user-doc -->
   * <p>
  ...
  /**
   * Unsets the value of the '{@link net.gexf_1_2.gexf.GraphContent#getMode <em>Mode</em>}'
   * attribute. <!-- begin-user-doc --> <!-- end-user-doc -->
   * 
   * @see #isSetMode()
   * @see #getMode()
  ...
  /**
   * Returns whether the value of the '{@link net.gexf_1_2.gexf.GraphContent#getMode <em>Mode</em>}'
  ...
  /**
   * Sets the value of the '{@link net.gexf_1_2.gexf.GraphContent#getStart <em>Start</em>}'
   * attribute. <!-- begin-user-doc --> <!-- end-user-doc -->
   * 
   ...
   * <p>
   * If the meaning of the '<em>Startopen</em>' attribute isn't clear, there really should be more
   * of a description here...
   * </p>
   * <!-- end-user-doc -->
   * 
   ...
   * @model dataType="net.gexf_1_2.gexf.TimeType" extendedMetaData=
   *        "kind='attribute' name='startopen'"
   * @generated
   */
  Object getStartopen();

  /**
   * Sets the value of the '{@link net.gexf_1_2.gexf.GraphContent#getStartopen <em>Startopen</em>}'
   * attribute. <!-- begin-user-doc --> <!-- end-user-doc -->
   * 
  ...
  /**
   * Returns the value of the '<em><b>Timeformat</b></em>' attribute. The literals are from the
   * enumeration {@link net.gexf_1_2.gexf.TimeformatType}. <!-- begin-user-doc -->
   * <p>
   * If the meaning of the '<em>Timeformat</em>' attribute isn't clear, there really should be more
   * of a description here...
   * </p>
   * <!-- end-user-doc -->
   * 
  ...
  /**
   * Sets the value of the '{@link net.gexf_1_2.gexf.GraphContent#getTimeformat <em>Timeformat</em>}
   * ' attribute. <!-- begin-user-doc --> <!-- end-user-doc -->
   * 
  ...
  /**
   * Unsets the value of the '{@link net.gexf_1_2.gexf.GraphContent#getTimeformat
   * <em>Timeformat</em>}' attribute. <!-- begin-user-doc --> <!-- end-user-doc -->
   * 
   * @see #isSetTimeformat()
   * @see #getTimeformat()
   * @see #setTimeformat(TimeformatType)
  ...
  /**
   * Returns whether the value of the '{@link net.gexf_1_2.gexf.GraphContent#getTimeformat
   * <em>Timeformat</em>}' attribute is set. <!-- begin-user-doc --> <!-- end-user-doc -->
   * 
