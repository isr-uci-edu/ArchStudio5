...
/**
 * <!-- begin-user-doc --> A representation of the model object '<em><b>Parents Content</b></em>'.
 * <!-- end-user-doc -->
 *
 * <p>
...
public interface ParentsContent extends EObject {
  /**
   * Returns the value of the '<em><b>Parent</b></em>' containment reference list. The list contents
   * are of type {@link net.gexf_1_2.gexf.ParentType}. <!-- begin-user-doc -->
   * <p>
   * If the meaning of the '<em>Parent</em>' containment reference list isn't clear, there really
