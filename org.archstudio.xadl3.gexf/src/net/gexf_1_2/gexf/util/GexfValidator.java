...
public class GexfValidator extends EObjectValidator {
   ...
   * @generated
   */
  public boolean validateAttributeContent(AttributeContent attributeContent,
   ...
   * @generated
   */
  public boolean validateAttributesContent(AttributesContent attributesContent,
      DiagnosticChain diagnostics, Map<Object, Object> context) {
   ...
   * @generated
   */
  public boolean validateAttvaluesContent(AttvaluesContent attvaluesContent,
      DiagnosticChain diagnostics, Map<Object, Object> context) {
   ...
   * @generated
   */
  public boolean validateParentType(ParentType parentType, DiagnosticChain diagnostics,
      Map<Object, Object> context) {
   ...
   * @generated
   */
  public boolean validateSpellType(SpellType spellType, DiagnosticChain diagnostics,
      Map<Object, Object> context) {
   ...
   * @generated
   */
  public boolean validateClassType(ClassType classType, DiagnosticChain diagnostics,
      Map<Object, Object> context) {
    return true;
  }
   ...
   * @generated
   */
  public boolean validateDefaultedgetypeType(DefaultedgetypeType defaultedgetypeType,
      DiagnosticChain diagnostics, Map<Object, Object> context) {
    return true;
  }
   ...
   * @generated
   */
  public boolean validateIdtypeType(IdtypeType idtypeType, DiagnosticChain diagnostics,
      Map<Object, Object> context) {
    return true;
  }
   ...
   * @generated
   */
  public boolean validateModeType(ModeType modeType, DiagnosticChain diagnostics,
      Map<Object, Object> context) {
    return true;
  }
   ...
   * @generated
   */
  public boolean validateAttrtypeTypeObject(AttrtypeType attrtypeTypeObject,
      DiagnosticChain diagnostics, Map<Object, Object> context) {
    return true;
  }
   ...
   * @generated
   */
  public boolean validateEdgetypeTypeObject(EdgetypeType edgetypeTypeObject,
      DiagnosticChain diagnostics, Map<Object, Object> context) {
    return true;
  }
   ...
   * @generated
   */
  public boolean validateIdType(Object idType, DiagnosticChain diagnostics,
      Map<Object, Object> context) {
  ...
  /**
   * Validates the MemberTypes constraint of '<em>Id Type</em>'. <!-- begin-user-doc --> <!--
   * end-user-doc -->
   * 
   * @generated
   */
  public boolean validateIdType_MemberTypes(Object idType, DiagnosticChain diagnostics,
      Map<Object, Object> context) {
    if (diagnostics != null) {
   ...
   * @generated
   */
  public boolean validateTimeformatTypeObject(TimeformatType timeformatTypeObject,
      DiagnosticChain diagnostics, Map<Object, Object> context) {
    return true;
  }
   ...
   * @generated
   */
  public boolean validateTimeType(Object timeType, DiagnosticChain diagnostics,
      Map<Object, Object> context) {
  ...
  /**
   * Validates the MemberTypes constraint of '<em>Time Type</em>'. <!-- begin-user-doc --> <!--
   * end-user-doc -->
   * 
   * @generated
   */
  public boolean validateTimeType_MemberTypes(Object timeType, DiagnosticChain diagnostics,
    ...
    if (diagnostics != null) {
      ...
      if (XMLTypePackage.Literals.DATE.isInstance(timeType)) {
        if (xmlTypeValidator.validateDate((XMLGregorianCalendar) timeType, tempDiagnostics,
            context)) {
          return true;
        }
      }
      if (XMLTypePackage.Literals.DATE_TIME.isInstance(timeType)) {
        if (xmlTypeValidator.validateDateTime((XMLGregorianCalendar) timeType, tempDiagnostics,
            context)) {
          return true;
        }
      }
   ...
   * @generated
   */
  public boolean validateVersionTypeObject(VersionType versionTypeObject,
      DiagnosticChain diagnostics, Map<Object, Object> context) {
    return true;
  }
   ...
   * @generated
   */
  public boolean validateWeightType(float weightType, DiagnosticChain diagnostics,
      Map<Object, Object> context) {
    return true;
  }
