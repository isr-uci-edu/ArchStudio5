...
public class GexfValidator extends EObjectValidator
{
   ...
   * @generated
   */
  public boolean validateAttributesContent(AttributesContent attributesContent, DiagnosticChain diagnostics, Map<Object, Object> context)
  {
   ...
   * @generated
   */
  public boolean validateAttvaluesContent(AttvaluesContent attvaluesContent, DiagnosticChain diagnostics, Map<Object, Object> context)
  {
   ...
   * @generated
   */
  public boolean validateAttvalueType(AttvalueType attvalueType, DiagnosticChain diagnostics, Map<Object, Object> context)
  {
   ...
   * @generated
   */
  public boolean validateEdgesContent(EdgesContent edgesContent, DiagnosticChain diagnostics, Map<Object, Object> context)
  {
   ...
   * @generated
   */
  public boolean validateGraphContent(GraphContent graphContent, DiagnosticChain diagnostics, Map<Object, Object> context)
  {
   ...
   * @generated
   */
  public boolean validateNodesContent(NodesContent nodesContent, DiagnosticChain diagnostics, Map<Object, Object> context)
  {
   ...
   * @generated
   */
  public boolean validateParentsContent(ParentsContent parentsContent, DiagnosticChain diagnostics, Map<Object, Object> context)
  {
   ...
   * @generated
   */
  public boolean validateSpellsContent(SpellsContent spellsContent, DiagnosticChain diagnostics, Map<Object, Object> context)
  {
   ...
   * @generated
   */
  public boolean validateAttrtypeType(AttrtypeType attrtypeType, DiagnosticChain diagnostics, Map<Object, Object> context)
  {
    return true;
  }
   ...
   * @generated
   */
  public boolean validateDefaultedgetypeType(DefaultedgetypeType defaultedgetypeType, DiagnosticChain diagnostics, Map<Object, Object> context)
  {
    return true;
  }
   ...
   * @generated
   */
  public boolean validateEdgetypeType(EdgetypeType edgetypeType, DiagnosticChain diagnostics, Map<Object, Object> context)
  {
    return true;
  }
   ...
   * @generated
   */
  public boolean validateTimeformatType(TimeformatType timeformatType, DiagnosticChain diagnostics, Map<Object, Object> context)
  {
    return true;
  }
   ...
   * @generated
   */
  public boolean validateAttrtypeTypeObject(AttrtypeType attrtypeTypeObject, DiagnosticChain diagnostics, Map<Object, Object> context)
  {
    return true;
  }
   ...
   * @generated
   */
  public boolean validateDefaultedgetypeTypeObject(DefaultedgetypeType defaultedgetypeTypeObject, DiagnosticChain diagnostics, Map<Object, Object> context)
  {
    return true;
  }
   ...
   * @generated
   */
  public boolean validateEdgetypeTypeObject(EdgetypeType edgetypeTypeObject, DiagnosticChain diagnostics, Map<Object, Object> context)
  {
    return true;
  }
  ...
  public boolean validateIdType_MemberTypes(Object idType, DiagnosticChain diagnostics, Map<Object, Object> context)
  {
    if (diagnostics != null)
    {
      ...
      {
        if (xmlTypeValidator.validateString((String)idType, tempDiagnostics, context)) return true;
      }
      if (XMLTypePackage.Literals.INTEGER.isInstance(idType))
      {
        if (xmlTypeValidator.validateInteger((BigInteger)idType, tempDiagnostics, context)) return true;
      }
    ...
    else
    {
      if (XMLTypePackage.Literals.STRING.isInstance(idType))
      {
        if (xmlTypeValidator.validateString((String)idType, null, context)) return true;
      }
      if (XMLTypePackage.Literals.INTEGER.isInstance(idType))
      {
        if (xmlTypeValidator.validateInteger((BigInteger)idType, null, context)) return true;
      }
    }
    return false;
  }
   ...
   * @generated
   */
  public boolean validateTimeformatTypeObject(TimeformatType timeformatTypeObject, DiagnosticChain diagnostics, Map<Object, Object> context)
  {
    return true;
  }
   ...
   * @generated
   */
  public boolean validateTimeType_MemberTypes(Object timeType, DiagnosticChain diagnostics, Map<Object, Object> context)
  {
    if (diagnostics != null)
    {
      BasicDiagnostic tempDiagnostics = new BasicDiagnostic();
      ...
      {
        if (xmlTypeValidator.validateInteger((BigInteger)timeType, tempDiagnostics, context)) return true;
      }
      if (XMLTypePackage.Literals.DOUBLE.isInstance(timeType))
      {
        if (xmlTypeValidator.validateDouble((Double)timeType, tempDiagnostics, context)) return true;
      }
      if (XMLTypePackage.Literals.DATE.isInstance(timeType))
      {
        if (xmlTypeValidator.validateDate((XMLGregorianCalendar)timeType, tempDiagnostics, context)) return true;
      }
      if (XMLTypePackage.Literals.DATE_TIME.isInstance(timeType))
      {
        if (xmlTypeValidator.validateDateTime((XMLGregorianCalendar)timeType, tempDiagnostics, context)) return true;
      }
      for (Diagnostic diagnostic : tempDiagnostics.getChildren())
      {
        diagnostics.add(diagnostic);
    ...
    else
    {
      if (XMLTypePackage.Literals.INTEGER.isInstance(timeType))
      {
        if (xmlTypeValidator.validateInteger((BigInteger)timeType, null, context)) return true;
      }
      if (XMLTypePackage.Literals.DOUBLE.isInstance(timeType))
      {
        if (xmlTypeValidator.validateDouble((Double)timeType, null, context)) return true;
      }
      if (XMLTypePackage.Literals.DATE.isInstance(timeType))
      {
        if (xmlTypeValidator.validateDate((XMLGregorianCalendar)timeType, null, context)) return true;
      }
      if (XMLTypePackage.Literals.DATE_TIME.isInstance(timeType))
      {
        if (xmlTypeValidator.validateDateTime((XMLGregorianCalendar)timeType, null, context)) return true;
      }
    }
    return false;
  }
   ...
   * @generated
   */
  public boolean validateWeightTypeObject(Float weightTypeObject, DiagnosticChain diagnostics, Map<Object, Object> context)
  {
    return true;
  }
