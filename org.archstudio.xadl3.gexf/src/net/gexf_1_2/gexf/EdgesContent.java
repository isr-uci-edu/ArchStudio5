...
/**
 * <!-- begin-user-doc --> A representation of the model object '<em><b>Edges Content</b></em>'.
 * <!-- end-user-doc -->
 *
 * <p>
...
public interface EdgesContent extends EObject {
  /**
   * Returns the value of the '<em><b>Edge</b></em>' containment reference list. The list contents
   * are of type {@link net.gexf_1_2.gexf.EdgeContent}. <!-- begin-user-doc -->
   * <p>
   * If the meaning of the '<em>Edge</em>' containment reference list isn't clear, there really
   ...
   * @model dataType="org.eclipse.emf.ecore.xml.type.NonNegativeInteger" extendedMetaData=
  ...
  /**
   * Sets the value of the '{@link net.gexf_1_2.gexf.EdgesContent#getCount <em>Count</em>}'
