...
public interface EdgesContent extends EObject {
	 ...
	 * list. The list contents are of type {@link net.gexf_1_2.gexf.EdgeContent}
	 * . <!-- begin-user-doc -->
	 * <p>
	 * If the meaning of the '<em>Edge</em>' containment reference list isn't
	...
	/**
	 * Sets the value of the '{@link net.gexf_1_2.gexf.EdgesContent#getCount
