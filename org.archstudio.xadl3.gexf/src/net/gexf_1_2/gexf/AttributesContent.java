...
/**
 * <!-- begin-user-doc --> A representation of the model object '<em><b>Attributes Content</b></em>
 * '. <!-- end-user-doc -->
 *
 * <p>
...
public interface AttributesContent extends EObject {
  ...
  /**
   * Returns the value of the '<em><b>Class</b></em>' attribute. The literals are from the
   * enumeration {@link net.gexf_1_2.gexf.ClassType}. <!-- begin-user-doc -->
   * <p>
   * If the meaning of the '<em>Class</em>' attribute isn't clear, there really should be more of a
   * description here...
   * </p>
   * <!-- end-user-doc -->
   * 
  ...
  /**
   * Sets the value of the '{@link net.gexf_1_2.gexf.AttributesContent#getClass_ <em>Class</em>}'
  ...
  /**
   * Unsets the value of the '{@link net.gexf_1_2.gexf.AttributesContent#getClass_ <em>Class</em>}'
   * attribute. <!-- begin-user-doc --> <!-- end-user-doc -->
   * 
   * @see #isSetClass()
   * @see #getClass_()
  ...
  /**
   * Returns whether the value of the '{@link net.gexf_1_2.gexf.AttributesContent#getClass_
   * <em>Class</em>}' attribute is set. <!-- begin-user-doc --> <!-- end-user-doc -->
   * 
  ...
  /**
   * Sets the value of the '{@link net.gexf_1_2.gexf.AttributesContent#getEnd <em>End</em>}'
   * attribute. <!-- begin-user-doc --> <!-- end-user-doc -->
   * 
  ...
  /**
   * Sets the value of the '{@link net.gexf_1_2.gexf.AttributesContent#getEndopen <em>Endopen</em>}'
   * attribute. <!-- begin-user-doc --> <!-- end-user-doc -->
   * 
  ...
  /**
   * Sets the value of the '{@link net.gexf_1_2.gexf.AttributesContent#getMode <em>Mode</em>}'
   * attribute. <!-- begin-user-doc --> <!-- end-user-doc -->
   * 
  ...
  /**
   * Unsets the value of the '{@link net.gexf_1_2.gexf.AttributesContent#getMode <em>Mode</em>}'
   * attribute. <!-- begin-user-doc --> <!-- end-user-doc -->
   * 
   * @see #isSetMode()
   * @see #getMode()
  ...
  /**
   * Returns whether the value of the '{@link net.gexf_1_2.gexf.AttributesContent#getMode
   * <em>Mode</em>}' attribute is set. <!-- begin-user-doc --> <!-- end-user-doc -->
   * 
  ...
  /**
   * Sets the value of the '{@link net.gexf_1_2.gexf.AttributesContent#getStart <em>Start</em>}'
   * attribute. <!-- begin-user-doc --> <!-- end-user-doc -->
   * 
  ...
  /**
   * Sets the value of the '{@link net.gexf_1_2.gexf.AttributesContent#getStartopen
