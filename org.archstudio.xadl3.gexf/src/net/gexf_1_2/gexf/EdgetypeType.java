 ...
 * <em><b>Edgetype Type</b></em>', and utility methods for working with them. <!-- end-user-doc -->
 * 
...
public enum EdgetypeType implements Enumerator {
  ...
  /**
   * An array of all the '<em><b>Edgetype Type</b></em>' enumerators. <!-- begin-user-doc --> <!--
   * end-user-doc -->
   * 
   * @generated
   */
  private static final EdgetypeType[] VALUES_ARRAY =
      new EdgetypeType[] {DIRECTED, UNDIRECTED, MUTUAL,};
   ...
   * @generated
   */
  public static final List<EdgetypeType> VALUES =
  ...
  public static EdgetypeType get(String literal) {
    for (EdgetypeType result : VALUES_ARRAY) {
