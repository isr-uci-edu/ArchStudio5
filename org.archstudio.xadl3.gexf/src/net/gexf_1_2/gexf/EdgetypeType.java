...
/**
 * <!-- begin-user-doc --> A representation of the literals of the enumeration '<em><b>Edgetype Type</b></em>', and
...
public enum EdgetypeType implements Enumerator {
	...
	/**
	 * An array of all the '<em><b>Edgetype Type</b></em>' enumerators. <!-- begin-user-doc --> <!-- end-user-doc -->
	 * 
	 * @generated
	 */
	private static final EdgetypeType[] VALUES_ARRAY = new EdgetypeType[] { DIRECTED, UNDIRECTED, MUTUAL, };

	/**
	 * A public read-only list of all the '<em><b>Edgetype Type</b></em>' enumerators. <!-- begin-user-doc --> <!--
	 * end-user-doc -->
	 * 
	 * @generated
	 */
