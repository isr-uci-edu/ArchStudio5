 ...
 * <em><b>Timeformat Type</b></em>', and utility methods for working with them. <!-- end-user-doc
 * -->
 * 
...
public enum TimeformatType implements Enumerator {
   ...
   * <p>
   * If the meaning of '<em><b>Date</b></em>' literal object isn't clear, there really should be
   * more of a description here...
   * </p>
   * <!-- end-user-doc -->
   * 
   ...
   * <p>
   * If the meaning of '<em><b>Date Time</b></em>' literal object isn't clear, there really should
  ...
  /**
   * An array of all the '<em><b>Timeformat Type</b></em>' enumerators. <!-- begin-user-doc --> <!--
   * end-user-doc -->
   * 
   * @generated
   */
  private static final TimeformatType[] VALUES_ARRAY =
      new TimeformatType[] {INTEGER, DOUBLE, DATE, DATE_TIME,};
   ...
   * @generated
   */
  public static final List<TimeformatType> VALUES =
