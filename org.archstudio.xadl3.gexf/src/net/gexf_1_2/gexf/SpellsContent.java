...
/**
 * <!-- begin-user-doc --> A representation of the model object '<em><b>Spells Content</b></em>'.
 * <!-- end-user-doc -->
 *
 * <p>
...
public interface SpellsContent extends EObject {
  /**
   * Returns the value of the '<em><b>Spell</b></em>' containment reference list. The list contents
   * are of type {@link net.gexf_1_2.gexf.SpellType}. <!-- begin-user-doc -->
   * <p>
   * If the meaning of the '<em>Spell</em>' containment reference list isn't clear, there really
