 ...
 * <em><b>Class Type</b></em>', and utility methods for working with them. <!-- end-user-doc -->
 * 
...
public enum ClassType implements Enumerator {
   ...
   * <p>
   * If the meaning of '<em><b>Node</b></em>' literal object isn't clear, there really should be
   ...
   * <p>
   * If the meaning of '<em><b>Edge</b></em>' literal object isn't clear, there really should be
   * more of a description here...
   * </p>
   * <!-- end-user-doc -->
   * 
  ...
  /**
   * An array of all the '<em><b>Class Type</b></em>' enumerators. <!-- begin-user-doc --> <!--
   * end-user-doc -->
   * 
   * @generated
   */
   ...
   * @generated
   */
  public static final List<ClassType> VALUES =
