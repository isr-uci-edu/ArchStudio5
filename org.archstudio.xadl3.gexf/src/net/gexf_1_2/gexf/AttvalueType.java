...
/**
 * <!-- begin-user-doc --> A representation of the model object '<em><b>Attvalue Type</b></em>'.
 * <!-- end-user-doc -->
 *
 * <p>
...
public interface AttvalueType extends EObject {
  ...
  /**
   * Sets the value of the '{@link net.gexf_1_2.gexf.AttvalueType#getEnd <em>End</em>}' attribute.
  ...
  /**
   * Sets the value of the '{@link net.gexf_1_2.gexf.AttvalueType#getEndopen <em>Endopen</em>}'
   ...
   * <p>
   * If the meaning of the '<em>For</em>' attribute isn't clear, there really should be more of a
   * description here...
   * </p>
   * <!-- end-user-doc -->
   * 
   ...
   *        "kind='attribute' name='for'"
   * @generated
   */
  Object getFor();

  /**
   * Sets the value of the '{@link net.gexf_1_2.gexf.AttvalueType#getFor <em>For</em>}' attribute.
   * <!-- begin-user-doc --> <!-- end-user-doc -->
   * 
  ...
  /**
   * Sets the value of the '{@link net.gexf_1_2.gexf.AttvalueType#getStart <em>Start</em>}'
   * attribute. <!-- begin-user-doc --> <!-- end-user-doc -->
   * 
  ...
  /**
   * Sets the value of the '{@link net.gexf_1_2.gexf.AttvalueType#getStartopen <em>Startopen</em>}'
   * attribute. <!-- begin-user-doc --> <!-- end-user-doc -->
   * 
  ...
  /**
   * Sets the value of the '{@link net.gexf_1_2.gexf.AttvalueType#getValue <em>Value</em>}'
   * attribute. <!-- begin-user-doc --> <!-- end-user-doc -->
   * 
