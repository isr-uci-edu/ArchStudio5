 ...
 * <em><b>Attrtype Type</b></em>', and utility methods for working with them. <!-- end-user-doc -->
 * 
...
public enum AttrtypeType implements Enumerator {
   ...
   * <p>
   * If the meaning of '<em><b>Float</b></em>' literal object isn't clear, there really should be
   * more of a description here...
   * </p>
   * <!-- end-user-doc -->
   * 
   ...
   * <p>
   * If the meaning of '<em><b>Boolean</b></em>' literal object isn't clear, there really should be
   * more of a description here...
   * </p>
   * <!-- end-user-doc -->
   * 
   ...
   * <p>
   * If the meaning of '<em><b>Liststring</b></em>' literal object isn't clear, there really should
   ...
   * <p>
   * If the meaning of '<em><b>Any URI</b></em>' literal object isn't clear, there really should be
   * more of a description here...
   * </p>
   * <!-- end-user-doc -->
   * 
  ...
  /**
   * An array of all the '<em><b>Attrtype Type</b></em>' enumerators. <!-- begin-user-doc --> <!--
   * end-user-doc -->
   * 
   * @generated
   */
  ...
  /**
   * A public read-only list of all the '<em><b>Attrtype Type</b></em>' enumerators. <!--
   * begin-user-doc --> <!-- end-user-doc -->
   * 
   * @generated
   */
  public static final List<AttrtypeType> VALUES =
      Collections.unmodifiableList(Arrays.asList(VALUES_ARRAY));

  /**
   * Returns the '<em><b>Attrtype Type</b></em>' literal with the specified literal value. <!--
   * begin-user-doc --> <!-- end-user-doc -->
   * 
  ...
  /**
   * Returns the '<em><b>Attrtype Type</b></em>' literal with the specified name. <!--
   * begin-user-doc --> <!-- end-user-doc -->
   * 
   * @param name the name.
   * @return the matching enumerator or <code>null</code>.
  ...
  /**
   * Returns the '<em><b>Attrtype Type</b></em>' literal with the specified integer value. <!--
   * begin-user-doc --> <!-- end-user-doc -->
   * 
