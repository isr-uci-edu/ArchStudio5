...
/**
 * <!-- begin-user-doc -->
 * A representation of the literals of the enumeration '<em><b>Attrtype Type</b></em>',
...
public enum AttrtypeType implements Enumerator
{
  ...
  /**
   * The '<em><b>Liststring</b></em>' literal object.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
  ...
  /**
   * The '<em><b>Liststring</b></em>' literal value.
   * <!-- begin-user-doc -->
   * <p>
   * If the meaning of '<em><b>Liststring</b></em>' literal object isn't clear,
   * there really should be more of a description here...
   * </p>
   * <!-- end-user-doc -->
   * @see #LISTSTRING
  ...
  public static AttrtypeType get(String literal)
  {
    ...
    {
      AttrtypeType result = VALUES_ARRAY[i];
  ...
  public static AttrtypeType get(int value)
  {
    switch (value)
    {
      ...
      case LISTSTRING_VALUE: return LISTSTRING;
