...
/**
 * <!-- begin-user-doc --> A representation of the model object '<em><b>Edge Content</b></em>'. <!--
 * end-user-doc -->
 *
 * <p>
...
public interface EdgeContent extends EObject {
  ...
  /**
   * Returns the value of the '<em><b>Attvalues</b></em>' containment reference list. The list
   * contents are of type {@link net.gexf_1_2.gexf.AttvaluesContent}. <!-- begin-user-doc -->
   * <p>
   * If the meaning of the '<em>Attvalues</em>' containment reference list isn't clear, there really
  ...
  /**
   * Returns the value of the '<em><b>Spells</b></em>' containment reference list. The list contents
   * are of type {@link net.gexf_1_2.gexf.SpellsContent}. <!-- begin-user-doc -->
   * <p>
   * If the meaning of the '<em>Spells</em>' containment reference list isn't clear, there really
   * should be more of a description here...
   * </p>
   * <!-- end-user-doc -->
   * 
  ...
  /**
   * Returns the value of the '<em><b>Color</b></em>' containment reference list. The list contents
   * are of type {@link net.gexf_1_2.viz.ColorContent}. <!-- begin-user-doc -->
   * <p>
   * If the meaning of the '<em>Color</em>' containment reference list isn't clear, there really
   * should be more of a description here...
   * </p>
   * <!-- end-user-doc -->
   * 
  ...
  /**
   * Returns the value of the '<em><b>Thickness</b></em>' containment reference list. The list
   * contents are of type {@link net.gexf_1_2.viz.ThicknessContent}. <!-- begin-user-doc -->
   * <p>
   * If the meaning of the '<em>Thickness</em>' containment reference list isn't clear, there really
   * should be more of a description here...
   * </p>
   * <!-- end-user-doc -->
   * 
  ...
  /**
   * Returns the value of the '<em><b>Shape</b></em>' containment reference list. The list contents
   * are of type {@link net.gexf_1_2.viz.EdgeShapeContent}. <!-- begin-user-doc -->
   * <p>
   * If the meaning of the '<em>Shape</em>' containment reference list isn't clear, there really
   * should be more of a description here...
   * </p>
   * <!-- end-user-doc -->
   * 
  ...
  /**
   * Sets the value of the '{@link net.gexf_1_2.gexf.EdgeContent#getEnd <em>End</em>}' attribute.
  ...
  /**
   * Sets the value of the '{@link net.gexf_1_2.gexf.EdgeContent#getEndopen <em>Endopen</em>}'
   ...
   * @model dataType="net.gexf_1_2.gexf.IdType" required="true" extendedMetaData=
  ...
  /**
   * Sets the value of the '{@link net.gexf_1_2.gexf.EdgeContent#getId <em>Id</em>}' attribute. <!--
   * begin-user-doc --> <!-- end-user-doc -->
   * 
   ...
   * @model dataType="org.eclipse.emf.ecore.xml.type.Token" extendedMetaData=
  ...
  /**
   * Sets the value of the '{@link net.gexf_1_2.gexf.EdgeContent#getLabel <em>Label</em>}'
   * attribute. <!-- begin-user-doc --> <!-- end-user-doc -->
   * 
   ...
   * <p>
   * If the meaning of the '<em>Source</em>' attribute isn't clear, there really should be more of a
   * description here...
   * </p>
   * <!-- end-user-doc -->
   * 
  ...
  /**
   * Sets the value of the '{@link net.gexf_1_2.gexf.EdgeContent#getSource <em>Source</em>}'
   * attribute. <!-- begin-user-doc --> <!-- end-user-doc -->
   * 
  ...
  /**
   * Sets the value of the '{@link net.gexf_1_2.gexf.EdgeContent#getStart <em>Start</em>}'
   * attribute. <!-- begin-user-doc --> <!-- end-user-doc -->
   * 
  ...
  /**
   * Sets the value of the '{@link net.gexf_1_2.gexf.EdgeContent#getStartopen <em>Startopen</em>}'
   * attribute. <!-- begin-user-doc --> <!-- end-user-doc -->
   * 
  ...
  /**
   * Sets the value of the '{@link net.gexf_1_2.gexf.EdgeContent#getTarget <em>Target</em>}'
   * attribute. <!-- begin-user-doc --> <!-- end-user-doc -->
   * 
   ...
   * enumeration {@link net.gexf_1_2.gexf.EdgetypeType}. <!-- begin-user-doc -->
   * <p>
  ...
  /**
   * Unsets the value of the '{@link net.gexf_1_2.gexf.EdgeContent#getType <em>Type</em>}'
   * attribute. <!-- begin-user-doc --> <!-- end-user-doc -->
   * 
   * @see #isSetType()
   * @see #getType()
  ...
  /**
   * Returns whether the value of the '{@link net.gexf_1_2.gexf.EdgeContent#getType <em>Type</em>}'
   ...
   * <p>
   * If the meaning of the '<em>Weight</em>' attribute isn't clear, there really should be more of a
   * description here...
   * </p>
   * <!-- end-user-doc -->
   * 
  ...
  /**
   * Sets the value of the '{@link net.gexf_1_2.gexf.EdgeContent#getWeight <em>Weight</em>}'
   * attribute. <!-- begin-user-doc --> <!-- end-user-doc -->
   * 
  ...
  /**
   * Unsets the value of the '{@link net.gexf_1_2.gexf.EdgeContent#getWeight <em>Weight</em>}'
   * attribute. <!-- begin-user-doc --> <!-- end-user-doc -->
   * 
   * @see #isSetWeight()
   * @see #getWeight()
  ...
  /**
   * Returns whether the value of the '{@link net.gexf_1_2.gexf.EdgeContent#getWeight
   * <em>Weight</em>}' attribute is set. <!-- begin-user-doc --> <!-- end-user-doc -->
   * 
