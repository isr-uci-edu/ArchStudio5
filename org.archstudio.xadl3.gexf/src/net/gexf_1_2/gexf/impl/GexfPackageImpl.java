...
public class GexfPackageImpl extends EPackageImpl implements GexfPackage {
   ...
   * 
   * <p>
   * This method is used to initialize {@link GexfPackage#eINSTANCE} when that field is accessed.
  ...
  public static GexfPackage init() {
    ...
    VizPackageImpl theVizPackage = (VizPackageImpl) (EPackage.Registry.INSTANCE
        .getEPackage(VizPackage.eNS_URI) instanceof VizPackageImpl
  ...
  public void initializePackageContents() {
    ...
    VizPackage theVizPackage =
        (VizPackage) EPackage.Registry.INSTANCE.getEPackage(VizPackage.eNS_URI);
    ...
    initEClass(attributeContentEClass, AttributeContent.class, "AttributeContent", !IS_ABSTRACT,
        !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
    initEAttribute(getAttributeContent_Group(), ecorePackage.getEFeatureMapEntry(), "group", null,
        0, -1, AttributeContent.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE,
        !IS_ID, !IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
    initEAttribute(getAttributeContent_Default(), theXMLTypePackage.getString(), "default", null, 0,
        -1, AttributeContent.class, IS_TRANSIENT, IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE,
        !IS_ID, !IS_UNIQUE, IS_DERIVED, IS_ORDERED);
    initEAttribute(getAttributeContent_Options(), theXMLTypePackage.getString(), "options", null, 0,
        -1, AttributeContent.class, IS_TRANSIENT, IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE,
        !IS_ID, !IS_UNIQUE, IS_DERIVED, IS_ORDERED);
    initEAttribute(getAttributeContent_Id(), this.getIdType(), "id", null, 1, 1,
        AttributeContent.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID,
        IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
    initEAttribute(getAttributeContent_Title(), theXMLTypePackage.getString(), "title", null, 1, 1,
        AttributeContent.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID,
        IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
    initEAttribute(getAttributeContent_Type(), this.getAttrtypeType(), "type", null, 1, 1,
        AttributeContent.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_UNSETTABLE, !IS_ID,
        IS_UNIQUE, !IS_DERIVED, IS_ORDERED);

    initEClass(attributesContentEClass, AttributesContent.class, "AttributesContent", !IS_ABSTRACT,
        !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
    initEReference(getAttributesContent_Attribute(), this.getAttributeContent(), null, "attribute",
        null, 0, -1, AttributesContent.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE,
        IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
    initEAttribute(getAttributesContent_Class(), this.getClassType(), "class", null, 1, 1,
        AttributesContent.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_UNSETTABLE, !IS_ID,
        IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
    initEAttribute(getAttributesContent_End(), this.getTimeType(), "end", null, 0, 1,
        AttributesContent.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID,
        IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
    initEAttribute(getAttributesContent_Endopen(), this.getTimeType(), "endopen", null, 0, 1,
        AttributesContent.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID,
        IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
    initEAttribute(getAttributesContent_Mode(), this.getModeType(), "mode", null, 0, 1,
        AttributesContent.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_UNSETTABLE, !IS_ID,
        IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
    initEAttribute(getAttributesContent_Start(), this.getTimeType(), "start", null, 0, 1,
        AttributesContent.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID,
        IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
    ...
    initEClass(attvaluesContentEClass, AttvaluesContent.class, "AttvaluesContent", !IS_ABSTRACT,
        !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
    initEReference(getAttvaluesContent_Attvalue(), this.getAttvalueType(), null, "attvalue", null,
        0, -1, AttvaluesContent.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE,
        !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);

    initEClass(attvalueTypeEClass, AttvalueType.class, "AttvalueType", !IS_ABSTRACT, !IS_INTERFACE,
        IS_GENERATED_INSTANCE_CLASS);
    initEAttribute(getAttvalueType_End(), this.getTimeType(), "end", null, 0, 1, AttvalueType.class,
        !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED,
        IS_ORDERED);
    initEAttribute(getAttvalueType_Endopen(), this.getTimeType(), "endopen", null, 0, 1,
        AttvalueType.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID,
        IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
    initEAttribute(getAttvalueType_For(), this.getIdType(), "for", null, 1, 1, AttvalueType.class,
        !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED,
        IS_ORDERED);
    initEAttribute(getAttvalueType_Start(), this.getTimeType(), "start", null, 0, 1,
        AttvalueType.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID,
        IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
    initEAttribute(getAttvalueType_Startopen(), this.getTimeType(), "startopen", null, 0, 1,
        AttvalueType.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID,
        IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
    initEAttribute(getAttvalueType_Value(), theXMLTypePackage.getString(), "value", null, 1, 1,
        AttvalueType.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID,
        IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
    ...
    initEReference(getDocumentRoot_XSISchemaLocation(), ecorePackage.getEStringToStringMapEntry(),
        ...
        IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
    initEReference(getDocumentRoot_Attribute(), this.getAttributeContent(), null, "attribute", null,
        0, -2, null, IS_TRANSIENT, IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES,
        !IS_UNSETTABLE, IS_UNIQUE, IS_DERIVED, IS_ORDERED);
    initEReference(getDocumentRoot_Attributes(), this.getAttributesContent(), null, "attributes",
        null, 0, -2, null, IS_TRANSIENT, IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE,
        !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, IS_DERIVED, IS_ORDERED);
    initEReference(getDocumentRoot_Attvalue(), this.getAttvalueType(), null, "attvalue", null, 0,
        -2, null, IS_TRANSIENT, IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES,
        !IS_UNSETTABLE, IS_UNIQUE, IS_DERIVED, IS_ORDERED);
    initEReference(getDocumentRoot_Attvalues(), this.getAttvaluesContent(), null, "attvalues", null,
        0, -2, null, IS_TRANSIENT, IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES,
        !IS_UNSETTABLE, IS_UNIQUE, IS_DERIVED, IS_ORDERED);
    initEReference(getDocumentRoot_Color(), theVizPackage.getColorContent(), null, "color", null, 0,
        -2, null, IS_TRANSIENT, IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES,
        !IS_UNSETTABLE, IS_UNIQUE, IS_DERIVED, IS_ORDERED);
    initEAttribute(getDocumentRoot_Creator(), theXMLTypePackage.getString(), "creator", null, 0, -2,
        null, IS_TRANSIENT, IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, !IS_UNIQUE,
        IS_DERIVED, IS_ORDERED);
    initEAttribute(getDocumentRoot_Default(), theXMLTypePackage.getString(), "default", null, 0, -2,
        null, IS_TRANSIENT, IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, !IS_UNIQUE,
        IS_DERIVED, IS_ORDERED);
    initEAttribute(getDocumentRoot_Description(), theXMLTypePackage.getString(), "description",
        null, 0, -2, null, IS_TRANSIENT, IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID,
        !IS_UNIQUE, IS_DERIVED, IS_ORDERED);
    initEReference(getDocumentRoot_Edge(), this.getEdgeContent(), null, "edge", null, 0, -2, null,
        IS_TRANSIENT, IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE,
        IS_UNIQUE, IS_DERIVED, IS_ORDERED);
    initEReference(getDocumentRoot_Edges(), this.getEdgesContent(), null, "edges", null, 0, -2,
        null, IS_TRANSIENT, IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES,
        !IS_UNSETTABLE, IS_UNIQUE, IS_DERIVED, IS_ORDERED);
    initEReference(getDocumentRoot_Gexf(), this.getGexfContent(), null, "gexf", null, 0, -2, null,
        IS_TRANSIENT, IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE,
        IS_UNIQUE, IS_DERIVED, IS_ORDERED);
    initEReference(getDocumentRoot_Graph(), this.getGraphContent(), null, "graph", null, 0, -2,
        null, IS_TRANSIENT, IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES,
        !IS_UNSETTABLE, IS_UNIQUE, IS_DERIVED, IS_ORDERED);
    initEAttribute(getDocumentRoot_Keywords(), theXMLTypePackage.getString(), "keywords", null, 0,
        -2, null, IS_TRANSIENT, IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, !IS_UNIQUE,
        IS_DERIVED, IS_ORDERED);
    initEReference(getDocumentRoot_Meta(), this.getMetaContent(), null, "meta", null, 0, -2, null,
        IS_TRANSIENT, IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE,
        IS_UNIQUE, IS_DERIVED, IS_ORDERED);
    initEReference(getDocumentRoot_Node(), this.getNodeContent(), null, "node", null, 0, -2, null,
        IS_TRANSIENT, IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE,
        IS_UNIQUE, IS_DERIVED, IS_ORDERED);
    initEReference(getDocumentRoot_Nodes(), this.getNodesContent(), null, "nodes", null, 0, -2,
        null, IS_TRANSIENT, IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES,
        !IS_UNSETTABLE, IS_UNIQUE, IS_DERIVED, IS_ORDERED);
    initEAttribute(getDocumentRoot_Options(), theXMLTypePackage.getString(), "options", null, 0, -2,
        null, IS_TRANSIENT, IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, !IS_UNIQUE,
        IS_DERIVED, IS_ORDERED);
    initEReference(getDocumentRoot_Parent(), this.getParentType(), null, "parent", null, 0, -2,
        null, IS_TRANSIENT, IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES,
        !IS_UNSETTABLE, IS_UNIQUE, IS_DERIVED, IS_ORDERED);
    initEReference(getDocumentRoot_Parents(), this.getParentsContent(), null, "parents", null, 0,
        -2, null, IS_TRANSIENT, IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES,
        !IS_UNSETTABLE, IS_UNIQUE, IS_DERIVED, IS_ORDERED);
    initEReference(getDocumentRoot_Position(), theVizPackage.getPositionContent(), null, "position",
        null, 0, -2, null, IS_TRANSIENT, IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE,
        !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, IS_DERIVED, IS_ORDERED);
    initEReference(getDocumentRoot_Size(), theVizPackage.getSizeContent(), null, "size", null, 0,
        -2, null, IS_TRANSIENT, IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES,
        !IS_UNSETTABLE, IS_UNIQUE, IS_DERIVED, IS_ORDERED);
    initEReference(getDocumentRoot_Spell(), this.getSpellType(), null, "spell", null, 0, -2, null,
        IS_TRANSIENT, IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE,
        IS_UNIQUE, IS_DERIVED, IS_ORDERED);
    initEReference(getDocumentRoot_Spells(), this.getSpellsContent(), null, "spells", null, 0, -2,
        null, IS_TRANSIENT, IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES,
        !IS_UNSETTABLE, IS_UNIQUE, IS_DERIVED, IS_ORDERED);
    initEReference(getDocumentRoot_Thickness(), theVizPackage.getThicknessContent(), null,
        "thickness", null, 0, -2, null, IS_TRANSIENT, IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE,
        !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, IS_DERIVED, IS_ORDERED);
    ...
    initEAttribute(getEdgeContent_Group(), ecorePackage.getEFeatureMapEntry(), "group", null, 0, -1,
        EdgeContent.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID,
        !IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
    initEReference(getEdgeContent_Attvalues(), this.getAttvaluesContent(), null, "attvalues", null,
        0, -1, EdgeContent.class, IS_TRANSIENT, IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE,
        !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, IS_DERIVED, IS_ORDERED);
    initEReference(getEdgeContent_Spells(), this.getSpellsContent(), null, "spells", null, 0, -1,
        EdgeContent.class, IS_TRANSIENT, IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE,
        !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, IS_DERIVED, IS_ORDERED);
    initEReference(getEdgeContent_Color(), theVizPackage.getColorContent(), null, "color", null, 0,
        -1, EdgeContent.class, IS_TRANSIENT, IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE,
        !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, IS_DERIVED, IS_ORDERED);
    initEReference(getEdgeContent_Thickness(), theVizPackage.getThicknessContent(), null,
        "thickness", null, 0, -1, EdgeContent.class, IS_TRANSIENT, IS_VOLATILE, IS_CHANGEABLE,
        IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, IS_DERIVED, IS_ORDERED);
    initEReference(getEdgeContent_Shape(), theVizPackage.getEdgeShapeContent(), null, "shape", null,
        0, -1, EdgeContent.class, IS_TRANSIENT, IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE,
        !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, IS_DERIVED, IS_ORDERED);
    initEAttribute(getEdgeContent_End(), this.getTimeType(), "end", null, 0, 1, EdgeContent.class,
        !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED,
        IS_ORDERED);
    initEAttribute(getEdgeContent_Endopen(), this.getTimeType(), "endopen", null, 0, 1,
        EdgeContent.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID,
        IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
    initEAttribute(getEdgeContent_Id(), this.getIdType(), "id", null, 1, 1, EdgeContent.class,
        !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED,
        IS_ORDERED);
    initEAttribute(getEdgeContent_Label(), theXMLTypePackage.getToken(), "label", null, 0, 1,
        EdgeContent.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID,
        IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
    initEAttribute(getEdgeContent_Source(), this.getIdType(), "source", null, 1, 1,
        EdgeContent.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID,
        IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
    initEAttribute(getEdgeContent_Start(), this.getTimeType(), "start", null, 0, 1,
        EdgeContent.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID,
        IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
    initEAttribute(getEdgeContent_Startopen(), this.getTimeType(), "startopen", null, 0, 1,
        EdgeContent.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID,
        IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
    initEAttribute(getEdgeContent_Target(), this.getIdType(), "target", null, 1, 1,
        EdgeContent.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID,
        IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
    initEAttribute(getEdgeContent_Type(), this.getEdgetypeType(), "type", null, 0, 1,
        EdgeContent.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_UNSETTABLE, !IS_ID,
        IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
    initEAttribute(getEdgeContent_Weight(), this.getWeightType(), "weight", null, 0, 1,
        EdgeContent.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_UNSETTABLE, !IS_ID,
        IS_UNIQUE, !IS_DERIVED, IS_ORDERED);

    initEClass(edgesContentEClass, EdgesContent.class, "EdgesContent", !IS_ABSTRACT, !IS_INTERFACE,
        IS_GENERATED_INSTANCE_CLASS);
    initEReference(getEdgesContent_Edge(), this.getEdgeContent(), null, "edge", null, 0, -1,
        EdgesContent.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE,
        !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
    initEAttribute(getEdgesContent_Count(), theXMLTypePackage.getNonNegativeInteger(), "count",
        null, 0, 1, EdgesContent.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE,
        !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);

    initEClass(gexfContentEClass, GexfContent.class, "GexfContent", !IS_ABSTRACT, !IS_INTERFACE,
        IS_GENERATED_INSTANCE_CLASS);
    initEReference(getGexfContent_Meta(), this.getMetaContent(), null, "meta", null, 0, 1,
        GexfContent.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE,
        !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
    initEReference(getGexfContent_Graph(), this.getGraphContent(), null, "graph", null, 1, 1,
        GexfContent.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE,
        !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
    initEAttribute(getGexfContent_Variant(), theXMLTypePackage.getString(), "variant", null, 0, 1,
        GexfContent.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID,
        IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
    initEAttribute(getGexfContent_Version(), this.getVersionType(), "version", null, 1, 1,
        GexfContent.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_UNSETTABLE, !IS_ID,
        IS_UNIQUE, !IS_DERIVED, IS_ORDERED);

    initEClass(graphContentEClass, GraphContent.class, "GraphContent", !IS_ABSTRACT, !IS_INTERFACE,
        IS_GENERATED_INSTANCE_CLASS);
    initEAttribute(getGraphContent_Group(), ecorePackage.getEFeatureMapEntry(), "group", null, 0,
        -1, GraphContent.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID,
        !IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
    initEReference(getGraphContent_Attributes(), this.getAttributesContent(), null, "attributes",
        null, 0, -1, GraphContent.class, IS_TRANSIENT, IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE,
        !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, IS_DERIVED, IS_ORDERED);
    initEReference(getGraphContent_Nodes(), this.getNodesContent(), null, "nodes", null, 0, -1,
        GraphContent.class, IS_TRANSIENT, IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE,
        !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, IS_DERIVED, IS_ORDERED);
    initEReference(getGraphContent_Edges(), this.getEdgesContent(), null, "edges", null, 0, -1,
        GraphContent.class, IS_TRANSIENT, IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE,
        !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, IS_DERIVED, IS_ORDERED);
    initEAttribute(getGraphContent_Defaultedgetype(), this.getDefaultedgetypeType(),
        "defaultedgetype", null, 0, 1, GraphContent.class, !IS_TRANSIENT, !IS_VOLATILE,
        IS_CHANGEABLE, IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
    initEAttribute(getGraphContent_End(), this.getTimeType(), "end", null, 0, 1, GraphContent.class,
        !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED,
        IS_ORDERED);
    initEAttribute(getGraphContent_Endopen(), this.getTimeType(), "endopen", null, 0, 1,
        GraphContent.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID,
        IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
    initEAttribute(getGraphContent_Idtype(), this.getIdtypeType(), "idtype", null, 0, 1,
        GraphContent.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_UNSETTABLE, !IS_ID,
        IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
    initEAttribute(getGraphContent_Mode(), this.getModeType(), "mode", null, 0, 1,
        GraphContent.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_UNSETTABLE, !IS_ID,
        IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
    initEAttribute(getGraphContent_Start(), this.getTimeType(), "start", null, 0, 1,
        GraphContent.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID,
        IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
    initEAttribute(getGraphContent_Startopen(), this.getTimeType(), "startopen", null, 0, 1,
        GraphContent.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID,
        IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
    ...
    initEAttribute(getMetaContent_Group(), ecorePackage.getEFeatureMapEntry(), "group", null, 0, -1,
        MetaContent.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID,
        !IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
    initEAttribute(getMetaContent_Creator(), theXMLTypePackage.getString(), "creator", null, 0, -1,
        MetaContent.class, IS_TRANSIENT, IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID,
        !IS_UNIQUE, IS_DERIVED, IS_ORDERED);
    initEAttribute(getMetaContent_Keywords(), theXMLTypePackage.getString(), "keywords", null, 0,
        -1, MetaContent.class, IS_TRANSIENT, IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID,
        !IS_UNIQUE, IS_DERIVED, IS_ORDERED);
    initEAttribute(getMetaContent_Description(), theXMLTypePackage.getString(), "description", null,
        0, -1, MetaContent.class, IS_TRANSIENT, IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID,
        !IS_UNIQUE, IS_DERIVED, IS_ORDERED);
    initEAttribute(getMetaContent_Lastmodifieddate(), theXMLTypePackage.getDate(),
        "lastmodifieddate", null, 0, 1, MetaContent.class, !IS_TRANSIENT, !IS_VOLATILE,
        IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
    ...
    initEAttribute(getNodeContent_Group(), ecorePackage.getEFeatureMapEntry(), "group", null, 0, -1,
        NodeContent.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID,
        !IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
    initEReference(getNodeContent_Attvalues(), this.getAttvaluesContent(), null, "attvalues", null,
        0, -1, NodeContent.class, IS_TRANSIENT, IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE,
        !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, IS_DERIVED, IS_ORDERED);
    initEReference(getNodeContent_Spells(), this.getSpellsContent(), null, "spells", null, 0, -1,
        NodeContent.class, IS_TRANSIENT, IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE,
        !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, IS_DERIVED, IS_ORDERED);
    initEReference(getNodeContent_Nodes(), this.getNodesContent(), null, "nodes", null, 0, -1,
        NodeContent.class, IS_TRANSIENT, IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE,
        !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, IS_DERIVED, IS_ORDERED);
    initEReference(getNodeContent_Edges(), this.getEdgesContent(), null, "edges", null, 0, -1,
        NodeContent.class, IS_TRANSIENT, IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE,
        !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, IS_DERIVED, IS_ORDERED);
    initEReference(getNodeContent_Parents(), this.getParentsContent(), null, "parents", null, 0, -1,
        NodeContent.class, IS_TRANSIENT, IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE,
        !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, IS_DERIVED, IS_ORDERED);
    initEReference(getNodeContent_Color(), theVizPackage.getColorContent(), null, "color", null, 0,
        -1, NodeContent.class, IS_TRANSIENT, IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE,
        !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, IS_DERIVED, IS_ORDERED);
    initEReference(getNodeContent_Position(), theVizPackage.getPositionContent(), null, "position",
        null, 0, -1, NodeContent.class, IS_TRANSIENT, IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE,
        !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, IS_DERIVED, IS_ORDERED);
    initEReference(getNodeContent_Size(), theVizPackage.getSizeContent(), null, "size", null, 0, -1,
        NodeContent.class, IS_TRANSIENT, IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE,
        !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, IS_DERIVED, IS_ORDERED);
    initEReference(getNodeContent_Shape(), theVizPackage.getNodeShapeContent(), null, "shape", null,
        0, -1, NodeContent.class, IS_TRANSIENT, IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE,
        !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, IS_DERIVED, IS_ORDERED);
    initEAttribute(getNodeContent_End(), this.getTimeType(), "end", null, 0, 1, NodeContent.class,
        !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED,
        IS_ORDERED);
    initEAttribute(getNodeContent_Endopen(), this.getTimeType(), "endopen", null, 0, 1,
        NodeContent.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID,
        IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
    initEAttribute(getNodeContent_Id(), this.getIdType(), "id", null, 1, 1, NodeContent.class,
        !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED,
        IS_ORDERED);
    initEAttribute(getNodeContent_Label(), theXMLTypePackage.getToken(), "label", null, 0, 1,
        NodeContent.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID,
        IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
    initEAttribute(getNodeContent_Pid(), this.getIdType(), "pid", null, 0, 1, NodeContent.class,
        !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED,
        IS_ORDERED);
    initEAttribute(getNodeContent_Start(), this.getTimeType(), "start", null, 0, 1,
        NodeContent.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID,
        IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
    initEAttribute(getNodeContent_Startopen(), this.getTimeType(), "startopen", null, 0, 1,
        NodeContent.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID,
        IS_UNIQUE, !IS_DERIVED, IS_ORDERED);

    initEClass(nodesContentEClass, NodesContent.class, "NodesContent", !IS_ABSTRACT, !IS_INTERFACE,
        IS_GENERATED_INSTANCE_CLASS);
    initEReference(getNodesContent_Node(), this.getNodeContent(), null, "node", null, 0, -1,
        NodesContent.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE,
        !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
    initEAttribute(getNodesContent_Count(), theXMLTypePackage.getNonNegativeInteger(), "count",
        null, 0, 1, NodesContent.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE,
        !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);

    initEClass(parentsContentEClass, ParentsContent.class, "ParentsContent", !IS_ABSTRACT,
        !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
    initEReference(getParentsContent_Parent(), this.getParentType(), null, "parent", null, 0, -1,
        ParentsContent.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE,
        !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);

    initEClass(parentTypeEClass, ParentType.class, "ParentType", !IS_ABSTRACT, !IS_INTERFACE,
        IS_GENERATED_INSTANCE_CLASS);
    initEAttribute(getParentType_For(), this.getIdType(), "for", null, 1, 1, ParentType.class,
        !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED,
        IS_ORDERED);

    initEClass(spellsContentEClass, SpellsContent.class, "SpellsContent", !IS_ABSTRACT,
        !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
    initEReference(getSpellsContent_Spell(), this.getSpellType(), null, "spell", null, 1, -1,
        SpellsContent.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE,
        !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);

    initEClass(spellTypeEClass, SpellType.class, "SpellType", !IS_ABSTRACT, !IS_INTERFACE,
        IS_GENERATED_INSTANCE_CLASS);
    initEAttribute(getSpellType_End(), this.getTimeType(), "end", null, 0, 1, SpellType.class,
        !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED,
        IS_ORDERED);
    initEAttribute(getSpellType_Endopen(), this.getTimeType(), "endopen", null, 0, 1,
        SpellType.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID,
        IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
    initEAttribute(getSpellType_Start(), this.getTimeType(), "start", null, 0, 1, SpellType.class,
        !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED,
        IS_ORDERED);
    initEAttribute(getSpellType_Startopen(), this.getTimeType(), "startopen", null, 0, 1,
        SpellType.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID,
        IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
    ...
    initEDataType(attrtypeTypeObjectEDataType, AttrtypeType.class, "AttrtypeTypeObject",
        IS_SERIALIZABLE, IS_GENERATED_INSTANCE_CLASS);
    initEDataType(classTypeObjectEDataType, ClassType.class, "ClassTypeObject", IS_SERIALIZABLE,
        IS_GENERATED_INSTANCE_CLASS);
    initEDataType(defaultedgetypeTypeObjectEDataType, DefaultedgetypeType.class,
        "DefaultedgetypeTypeObject", IS_SERIALIZABLE, IS_GENERATED_INSTANCE_CLASS);
    initEDataType(edgetypeTypeObjectEDataType, EdgetypeType.class, "EdgetypeTypeObject",
        IS_SERIALIZABLE, IS_GENERATED_INSTANCE_CLASS);
    initEDataType(idTypeEDataType, Object.class, "IdType", IS_SERIALIZABLE,
        !IS_GENERATED_INSTANCE_CLASS);
    ...
    initEDataType(modeTypeObjectEDataType, ModeType.class, "ModeTypeObject", IS_SERIALIZABLE,
        IS_GENERATED_INSTANCE_CLASS);
    initEDataType(timeformatTypeObjectEDataType, TimeformatType.class, "TimeformatTypeObject",
        IS_SERIALIZABLE, IS_GENERATED_INSTANCE_CLASS);
    initEDataType(timeTypeEDataType, Object.class, "TimeType", IS_SERIALIZABLE,
        !IS_GENERATED_INSTANCE_CLASS);
    initEDataType(versionTypeObjectEDataType, VersionType.class, "VersionTypeObject",
        IS_SERIALIZABLE, IS_GENERATED_INSTANCE_CLASS);
    initEDataType(weightTypeEDataType, float.class, "WeightType", IS_SERIALIZABLE,
        !IS_GENERATED_INSTANCE_CLASS);
  ...
  protected void createExtendedMetaDataAnnotations() {
    ...
    addAnnotation(getAttributeContent_Group(), source,
        new String[] {"kind", "group", "name", "group:0"});
    addAnnotation(getAttributeContent_Default(), source, new String[] {"kind", "element", "name",
        "default", "namespace", "##targetNamespace", "group", "#group:0"});
    addAnnotation(getAttributeContent_Options(), source, new String[] {"kind", "element", "name",
        "options", "namespace", "##targetNamespace", "group", "#group:0"});
    addAnnotation(getAttributeContent_Id(), source,
        new String[] {"kind", "attribute", "name", "id"});
    addAnnotation(getAttributeContent_Title(), source,
        new String[] {"kind", "attribute", "name", "title"});
    addAnnotation(getAttributeContent_Type(), source,
    ...
    addAnnotation(getAttributesContent_Class(), source,
        new String[] {"kind", "attribute", "name", "class"});
    addAnnotation(getAttributesContent_End(), source,
        new String[] {"kind", "attribute", "name", "end"});
    addAnnotation(getAttributesContent_Endopen(), source,
        new String[] {"kind", "attribute", "name", "endopen"});
    addAnnotation(getAttributesContent_Mode(), source,
        new String[] {"kind", "attribute", "name", "mode"});
    addAnnotation(getAttributesContent_Start(), source,
        new String[] {"kind", "attribute", "name", "start"});
    ...
    addAnnotation(attvalueTypeEClass, source,
        new String[] {"name", "attvalue_._type", "kind", "empty"});
    addAnnotation(getAttvalueType_End(), source, new String[] {"kind", "attribute", "name", "end"});
    addAnnotation(getAttvalueType_Endopen(), source,
        new String[] {"kind", "attribute", "name", "endopen"});
    addAnnotation(getAttvalueType_For(), source, new String[] {"kind", "attribute", "name", "for"});
    addAnnotation(getAttvalueType_Start(), source,
        new String[] {"kind", "attribute", "name", "start"});
    addAnnotation(getAttvalueType_Startopen(), source,
        new String[] {"kind", "attribute", "name", "startopen"});
    addAnnotation(getAttvalueType_Value(), source,
    ...
    addAnnotation(edgeContentEClass, source,
        new String[] {"name", "edge-content", "kind", "elementOnly"});
    addAnnotation(getEdgeContent_Group(), source,
        new String[] {"kind", "group", "name", "group:0"});
    addAnnotation(getEdgeContent_Attvalues(), source, new String[] {"kind", "element", "name",
        "attvalues", "namespace", "##targetNamespace", "group", "#group:0"});
    addAnnotation(getEdgeContent_Spells(), source, new String[] {"kind", "element", "name",
        "spells", "namespace", "##targetNamespace", "group", "#group:0"});
    addAnnotation(getEdgeContent_Color(), source, new String[] {"kind", "element", "name", "color",
        "namespace", "##targetNamespace", "group", "#group:0"});
    addAnnotation(getEdgeContent_Thickness(), source, new String[] {"kind", "element", "name",
        "thickness", "namespace", "##targetNamespace", "group", "#group:0"});
    addAnnotation(getEdgeContent_Shape(), source, new String[] {"kind", "element", "name", "shape",
        "namespace", "##targetNamespace", "group", "#group:0"});
    addAnnotation(getEdgeContent_End(), source, new String[] {"kind", "attribute", "name", "end"});
    addAnnotation(getEdgeContent_Endopen(), source,
        new String[] {"kind", "attribute", "name", "endopen"});
    addAnnotation(getEdgeContent_Id(), source, new String[] {"kind", "attribute", "name", "id"});
    addAnnotation(getEdgeContent_Label(), source,
        new String[] {"kind", "attribute", "name", "label"});
    addAnnotation(getEdgeContent_Source(), source,
        new String[] {"kind", "attribute", "name", "source"});
    addAnnotation(getEdgeContent_Start(), source,
        new String[] {"kind", "attribute", "name", "start"});
    addAnnotation(getEdgeContent_Startopen(), source,
        new String[] {"kind", "attribute", "name", "startopen"});
    addAnnotation(getEdgeContent_Target(), source,
        new String[] {"kind", "attribute", "name", "target"});
    addAnnotation(getEdgeContent_Type(), source,
        new String[] {"kind", "attribute", "name", "type"});
    addAnnotation(getEdgeContent_Weight(), source,
        new String[] {"kind", "attribute", "name", "weight"});
    addAnnotation(edgesContentEClass, source,
        new String[] {"name", "edges-content", "kind", "elementOnly"});
    addAnnotation(getEdgesContent_Edge(), source,
        new String[] {"kind", "element", "name", "edge", "namespace", "##targetNamespace"});
    addAnnotation(getEdgesContent_Count(), source,
        new String[] {"kind", "attribute", "name", "count"});
    ...
    addAnnotation(gexfContentEClass, source,
        new String[] {"name", "gexf-content", "kind", "elementOnly"});
    addAnnotation(getGexfContent_Meta(), source,
        new String[] {"kind", "element", "name", "meta", "namespace", "##targetNamespace"});
    addAnnotation(getGexfContent_Graph(), source,
        new String[] {"kind", "element", "name", "graph", "namespace", "##targetNamespace"});
    addAnnotation(getGexfContent_Variant(), source,
        new String[] {"kind", "attribute", "name", "variant"});
    addAnnotation(getGexfContent_Version(), source,
        new String[] {"kind", "attribute", "name", "version"});
    addAnnotation(graphContentEClass, source,
        new String[] {"name", "graph-content", "kind", "elementOnly"});
    addAnnotation(getGraphContent_Group(), source,
        new String[] {"kind", "group", "name", "group:0"});
    addAnnotation(getGraphContent_Attributes(), source, new String[] {"kind", "element", "name",
        "attributes", "namespace", "##targetNamespace", "group", "#group:0"});
    addAnnotation(getGraphContent_Nodes(), source, new String[] {"kind", "element", "name", "nodes",
        "namespace", "##targetNamespace", "group", "#group:0"});
    addAnnotation(getGraphContent_Edges(), source, new String[] {"kind", "element", "name", "edges",
        "namespace", "##targetNamespace", "group", "#group:0"});
    ...
    addAnnotation(getGraphContent_Endopen(), source,
        new String[] {"kind", "attribute", "name", "endopen"});
    addAnnotation(getGraphContent_Idtype(), source,
        new String[] {"kind", "attribute", "name", "idtype"});
    addAnnotation(getGraphContent_Mode(), source,
        new String[] {"kind", "attribute", "name", "mode"});
    addAnnotation(getGraphContent_Start(), source,
        new String[] {"kind", "attribute", "name", "start"});
    addAnnotation(getGraphContent_Startopen(), source,
        new String[] {"kind", "attribute", "name", "startopen"});
    addAnnotation(getGraphContent_Timeformat(), source,
        new String[] {"kind", "attribute", "name", "timeformat"});
    ...
    addAnnotation(metaContentEClass, source,
        new String[] {"name", "meta-content", "kind", "elementOnly"});
    addAnnotation(getMetaContent_Group(), source,
        new String[] {"kind", "group", "name", "group:0"});
    addAnnotation(getMetaContent_Creator(), source, new String[] {"kind", "element", "name",
        "creator", "namespace", "##targetNamespace", "group", "#group:0"});
    addAnnotation(getMetaContent_Keywords(), source, new String[] {"kind", "element", "name",
        "keywords", "namespace", "##targetNamespace", "group", "#group:0"});
    addAnnotation(getMetaContent_Description(), source, new String[] {"kind", "element", "name",
        "description", "namespace", "##targetNamespace", "group", "#group:0"});
    ...
    addAnnotation(nodeContentEClass, source,
        new String[] {"name", "node-content", "kind", "elementOnly"});
    addAnnotation(getNodeContent_Group(), source,
        new String[] {"kind", "group", "name", "group:0"});
    addAnnotation(getNodeContent_Attvalues(), source, new String[] {"kind", "element", "name",
        "attvalues", "namespace", "##targetNamespace", "group", "#group:0"});
    addAnnotation(getNodeContent_Spells(), source, new String[] {"kind", "element", "name",
        "spells", "namespace", "##targetNamespace", "group", "#group:0"});
    addAnnotation(getNodeContent_Nodes(), source, new String[] {"kind", "element", "name", "nodes",
        "namespace", "##targetNamespace", "group", "#group:0"});
    addAnnotation(getNodeContent_Edges(), source, new String[] {"kind", "element", "name", "edges",
        "namespace", "##targetNamespace", "group", "#group:0"});
    addAnnotation(getNodeContent_Parents(), source, new String[] {"kind", "element", "name",
        "parents", "namespace", "##targetNamespace", "group", "#group:0"});
    addAnnotation(getNodeContent_Color(), source, new String[] {"kind", "element", "name", "color",
        "namespace", "##targetNamespace", "group", "#group:0"});
    addAnnotation(getNodeContent_Position(), source, new String[] {"kind", "element", "name",
        "position", "namespace", "##targetNamespace", "group", "#group:0"});
    addAnnotation(getNodeContent_Size(), source, new String[] {"kind", "element", "name", "size",
        "namespace", "##targetNamespace", "group", "#group:0"});
    addAnnotation(getNodeContent_Shape(), source, new String[] {"kind", "element", "name", "shape",
        "namespace", "##targetNamespace", "group", "#group:0"});
    addAnnotation(getNodeContent_End(), source, new String[] {"kind", "attribute", "name", "end"});
    addAnnotation(getNodeContent_Endopen(), source,
        new String[] {"kind", "attribute", "name", "endopen"});
    addAnnotation(getNodeContent_Id(), source, new String[] {"kind", "attribute", "name", "id"});
    addAnnotation(getNodeContent_Label(), source,
        new String[] {"kind", "attribute", "name", "label"});
    addAnnotation(getNodeContent_Pid(), source, new String[] {"kind", "attribute", "name", "pid"});
    addAnnotation(getNodeContent_Start(), source,
        new String[] {"kind", "attribute", "name", "start"});
    addAnnotation(getNodeContent_Startopen(), source,
        new String[] {"kind", "attribute", "name", "startopen"});
    addAnnotation(nodesContentEClass, source,
        new String[] {"name", "nodes-content", "kind", "elementOnly"});
    addAnnotation(getNodesContent_Node(), source,
        new String[] {"kind", "element", "name", "node", "namespace", "##targetNamespace"});
    addAnnotation(getNodesContent_Count(), source,
        new String[] {"kind", "attribute", "name", "count"});
    addAnnotation(parentsContentEClass, source,
        new String[] {"name", "parents-content", "kind", "elementOnly"});
    addAnnotation(getParentsContent_Parent(), source,
        new String[] {"kind", "element", "name", "parent", "namespace", "##targetNamespace"});
    addAnnotation(parentTypeEClass, source,
        new String[] {"name", "parent_._type", "kind", "empty"});
    addAnnotation(getParentType_For(), source, new String[] {"kind", "attribute", "name", "for"});
    addAnnotation(spellsContentEClass, source,
        new String[] {"name", "spells-content", "kind", "elementOnly"});
    ...
    addAnnotation(getSpellType_Endopen(), source,
        new String[] {"kind", "attribute", "name", "endopen"});
    addAnnotation(getSpellType_Start(), source,
        new String[] {"kind", "attribute", "name", "start"});
    addAnnotation(getSpellType_Startopen(), source,
        new String[] {"kind", "attribute", "name", "startopen"});
