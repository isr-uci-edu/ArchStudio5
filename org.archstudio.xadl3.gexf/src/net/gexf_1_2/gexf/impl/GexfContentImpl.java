...
/**
 * <!-- begin-user-doc --> An implementation of the model object '<em><b>Content</b></em>'. <!--
 * end-user-doc -->
 * <p>
...
public class GexfContentImpl extends MinimalEObjectImpl.Container implements GexfContent {
  ...
  public void setMeta(MetaContent newMeta) {
    if (newMeta != meta) {
      ...
      eNotify(new ENotificationImpl(this, Notification.SET, GexfPackage.GEXF_CONTENT__META, newMeta,
          newMeta));
    }
  }
  ...
  public void setGraph(GraphContent newGraph) {
    if (newGraph != graph) {
      ...
      eNotify(new ENotificationImpl(this, Notification.SET, GexfPackage.GEXF_CONTENT__GRAPH,
          newGraph, newGraph));
    }
  }
  ...
  public void setVariant(String newVariant) {
    ...
    variant = newVariant;
    if (eNotificationRequired()) {
      eNotify(new ENotificationImpl(this, Notification.SET, GexfPackage.GEXF_CONTENT__VARIANT,
          oldVariant, variant));
    }
  }
  ...
  public void setVersion(VersionType newVersion) {
    ...
    versionESet = true;
    if (eNotificationRequired()) {
      eNotify(new ENotificationImpl(this, Notification.SET, GexfPackage.GEXF_CONTENT__VERSION,
  ...
  public void unsetVersion() {
    ...
    versionESet = false;
    if (eNotificationRequired()) {
      eNotify(new ENotificationImpl(this, Notification.UNSET, GexfPackage.GEXF_CONTENT__VERSION,
