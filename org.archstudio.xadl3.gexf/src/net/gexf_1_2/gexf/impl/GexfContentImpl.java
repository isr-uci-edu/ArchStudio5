...
public class GexfContentImpl extends EObjectImpl implements GexfContent
{
  ...
  public NotificationChain basicSetMeta(MetaContent newMeta, NotificationChain msgs)
  {
    ...
    {
      ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, GexfPackage.GEXF_CONTENT__META, oldMeta, newMeta);
  ...
  public void setMeta(MetaContent newMeta)
  {
    if (newMeta != meta)
    {
      ...
      if (meta != null)
        msgs = ((InternalEObject)meta).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - GexfPackage.GEXF_CONTENT__META, null, msgs);
      if (newMeta != null)
        msgs = ((InternalEObject)newMeta).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - GexfPackage.GEXF_CONTENT__META, null, msgs);
  ...
  public NotificationChain basicSetGraph(GraphContent newGraph, NotificationChain msgs)
  {
    ...
    if (eNotificationRequired())
    {
      ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, GexfPackage.GEXF_CONTENT__GRAPH, oldGraph, newGraph);
      if (msgs == null) msgs = notification; else msgs.add(notification);
    }
    return msgs;
  }
  ...
  public void setGraph(GraphContent newGraph)
  {
    if (newGraph != graph)
    {
      NotificationChain msgs = null;
      if (graph != null)
        msgs = ((InternalEObject)graph).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - GexfPackage.GEXF_CONTENT__GRAPH, null, msgs);
      if (newGraph != null)
        msgs = ((InternalEObject)newGraph).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - GexfPackage.GEXF_CONTENT__GRAPH, null, msgs);
  ...
  public void setVariant(String newVariant)
  {
    ...
    variant = newVariant;
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, GexfPackage.GEXF_CONTENT__VARIANT, oldVariant, variant));
  }
  ...
  public void setVersion(VersionType newVersion)
  {
    ...
    versionESet = true;
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, GexfPackage.GEXF_CONTENT__VERSION, oldVersion, version, !oldVersionESet));
  }
  ...
  public void unsetVersion()
  {
    ...
    versionESet = false;
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.UNSET, GexfPackage.GEXF_CONTENT__VERSION, oldVersion, VERSION_EDEFAULT, oldVersionESet));
  }
