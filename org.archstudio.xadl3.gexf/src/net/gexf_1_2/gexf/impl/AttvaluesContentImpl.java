...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>Attvalues Content</b></em>'.
 * <!-- end-user-doc -->
 * <p>
...
public class AttvaluesContentImpl extends EObjectImpl implements AttvaluesContent
{
  ...
  public EList<AttvalueType> getAttvalue()
  {
    if (attvalue == null)
    {
      attvalue = new EObjectContainmentEList<AttvalueType>(AttvalueType.class, this, GexfPackage.ATTVALUES_CONTENT__ATTVALUE);
    }
    return attvalue;
  }
