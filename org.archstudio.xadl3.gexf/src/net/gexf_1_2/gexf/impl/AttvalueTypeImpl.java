...
/**
 * <!-- begin-user-doc --> An implementation of the model object '<em><b>Attvalue Type</b></em>'.
 * <!-- end-user-doc -->
 * <p>
...
public class AttvalueTypeImpl extends MinimalEObjectImpl.Container implements AttvalueType {
  ...
  /**
   * The default value of the '{@link #getFor() <em>For</em>}' attribute. <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * 
   * @see #getFor()
   * @generated
  ...
  /**
   * The cached value of the '{@link #getFor() <em>For</em>}' attribute. <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * 
   * @see #getFor()
   * @generated
  ...
  public void setEnd(Object newEnd) {
    ...
    if (eNotificationRequired()) {
      eNotify(new ENotificationImpl(this, Notification.SET, GexfPackage.ATTVALUE_TYPE__END, oldEnd,
          end));
    }
  }
  ...
  public void setEndopen(Object newEndopen) {
    ...
    endopen = newEndopen;
    if (eNotificationRequired()) {
      eNotify(new ENotificationImpl(this, Notification.SET, GexfPackage.ATTVALUE_TYPE__ENDOPEN,
          oldEndopen, endopen));
    }
  }
  ...
  public void setFor(Object newFor) {
    ...
    for_ = newFor;
    if (eNotificationRequired()) {
      eNotify(new ENotificationImpl(this, Notification.SET, GexfPackage.ATTVALUE_TYPE__FOR, oldFor,
          for_));
    }
  }
  ...
  public void setStart(Object newStart) {
    ...
    start = newStart;
    if (eNotificationRequired()) {
      eNotify(new ENotificationImpl(this, Notification.SET, GexfPackage.ATTVALUE_TYPE__START,
          oldStart, start));
    }
  }
  ...
  public void setStartopen(Object newStartopen) {
    ...
    if (eNotificationRequired()) {
      eNotify(new ENotificationImpl(this, Notification.SET, GexfPackage.ATTVALUE_TYPE__STARTOPEN,
  ...
  public void setValue(String newValue) {
    ...
    value = newValue;
    if (eNotificationRequired()) {
      eNotify(new ENotificationImpl(this, Notification.SET, GexfPackage.ATTVALUE_TYPE__VALUE,
          oldValue, value));
    }
  }
