...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>Attvalue Type</b></em>'.
 * <!-- end-user-doc -->
 * <p>
...
public class AttvalueTypeImpl extends EObjectImpl implements AttvalueType
{
  ...
  public void setEndopen(Object newEndopen)
  {
    ...
    endopen = newEndopen;
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, GexfPackage.ATTVALUE_TYPE__ENDOPEN, oldEndopen, endopen));
  }
  ...
  public void setStartopen(Object newStartopen)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, GexfPackage.ATTVALUE_TYPE__STARTOPEN, oldStartopen, startopen));
  }
