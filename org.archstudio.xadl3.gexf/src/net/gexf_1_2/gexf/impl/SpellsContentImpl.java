...
/**
 * <!-- begin-user-doc --> An implementation of the model object '<em><b>Spells Content</b></em>'.
 * <!-- end-user-doc -->
 * <p>
...
public class SpellsContentImpl extends MinimalEObjectImpl.Container implements SpellsContent {
  /**
   * The cached value of the '{@link #getSpell() <em>Spell</em>}' containment reference list. <!--
  ...
  public EList<SpellType> getSpell() {
    if (spell == null) {
      spell = new EObjectContainmentEList<SpellType>(SpellType.class, this,
          GexfPackage.SPELLS_CONTENT__SPELL);
    }
    return spell;
  }
