...
/**
 * <!-- begin-user-doc --> An implementation of the model object '<em><b>Edges Content</b></em>'.
 * <!-- end-user-doc -->
 * <p>
...
public class EdgesContentImpl extends MinimalEObjectImpl.Container implements EdgesContent {
  ...
  public EList<EdgeContent> getEdge() {
    if (edge == null) {
      edge = new EObjectContainmentEList<EdgeContent>(EdgeContent.class, this,
          GexfPackage.EDGES_CONTENT__EDGE);
    }
    return edge;
  }
  ...
  public void setCount(BigInteger newCount) {
    ...
    if (eNotificationRequired()) {
      eNotify(new ENotificationImpl(this, Notification.SET, GexfPackage.EDGES_CONTENT__COUNT,
          oldCount, count));
    }
  }
