...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>Node Content</b></em>'.
 * <!-- end-user-doc -->
 * <p>
...
public class NodeContentImpl extends EObjectImpl implements NodeContent
{
  ...
  public void setEndopen(Object newEndopen)
  {
    ...
    endopen = newEndopen;
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, GexfPackage.NODE_CONTENT__ENDOPEN, oldEndopen, endopen));
  }
  ...
  public void setStartopen(Object newStartopen)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, GexfPackage.NODE_CONTENT__STARTOPEN, oldStartopen, startopen));
  }
