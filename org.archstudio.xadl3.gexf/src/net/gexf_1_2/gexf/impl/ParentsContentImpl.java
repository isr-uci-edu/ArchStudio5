...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>Parents Content</b></em>'.
 * <!-- end-user-doc -->
 * <p>
...
public class ParentsContentImpl extends EObjectImpl implements ParentsContent
{
  ...
  public EList<ParentType> getParent()
  {
    if (parent == null)
    {
      parent = new EObjectContainmentEList<ParentType>(ParentType.class, this, GexfPackage.PARENTS_CONTENT__PARENT);
    }
    return parent;
  }
