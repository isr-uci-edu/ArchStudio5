...
/**
 * <!-- begin-user-doc --> An implementation of the model object '<em><b>Spell Type</b></em>'. <!--
 * end-user-doc -->
 * <p>
...
public class SpellTypeImpl extends MinimalEObjectImpl.Container implements SpellType {
  ...
  public void setEnd(Object newEnd) {
    ...
    if (eNotificationRequired()) {
      eNotify(
          new ENotificationImpl(this, Notification.SET, GexfPackage.SPELL_TYPE__END, oldEnd, end));
    }
  }
  ...
  public void setEndopen(Object newEndopen) {
    ...
    endopen = newEndopen;
    if (eNotificationRequired()) {
      eNotify(new ENotificationImpl(this, Notification.SET, GexfPackage.SPELL_TYPE__ENDOPEN,
          oldEndopen, endopen));
    }
  }
  ...
  public void setStart(Object newStart) {
    ...
    start = newStart;
    if (eNotificationRequired()) {
      eNotify(new ENotificationImpl(this, Notification.SET, GexfPackage.SPELL_TYPE__START, oldStart,
          start));
    }
  }
  ...
  public void setStartopen(Object newStartopen) {
    ...
    if (eNotificationRequired()) {
      eNotify(new ENotificationImpl(this, Notification.SET, GexfPackage.SPELL_TYPE__STARTOPEN,
