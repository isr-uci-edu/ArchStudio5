...
public class GexfFactoryImpl extends EFactoryImpl implements GexfFactory
{
  ...
  public static GexfFactory init()
  {
    try
    {
      GexfFactory theGexfFactory = (GexfFactory)EPackage.Registry.INSTANCE.getEFactory("http://www.gexf.net/1.2draft"); 
  ...
  public EObject create(EClass eClass)
  {
    ...
    {
      case GexfPackage.ATTRIBUTE_CONTENT: return createAttributeContent();
      case GexfPackage.ATTRIBUTES_CONTENT: return createAttributesContent();
      case GexfPackage.ATTVALUES_CONTENT: return createAttvaluesContent();
      case GexfPackage.ATTVALUE_TYPE: return createAttvalueType();
      case GexfPackage.DOCUMENT_ROOT: return createDocumentRoot();
      case GexfPackage.EDGE_CONTENT: return createEdgeContent();
      case GexfPackage.EDGES_CONTENT: return createEdgesContent();
      case GexfPackage.GEXF_CONTENT: return createGexfContent();
      case GexfPackage.GRAPH_CONTENT: return createGraphContent();
      case GexfPackage.META_CONTENT: return createMetaContent();
      case GexfPackage.NODE_CONTENT: return createNodeContent();
      case GexfPackage.NODES_CONTENT: return createNodesContent();
      case GexfPackage.PARENTS_CONTENT: return createParentsContent();
      case GexfPackage.PARENT_TYPE: return createParentType();
      case GexfPackage.SPELLS_CONTENT: return createSpellsContent();
      case GexfPackage.SPELL_TYPE: return createSpellType();
      default:
