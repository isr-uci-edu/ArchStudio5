...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>Edge Content</b></em>'.
 * <!-- end-user-doc -->
 * <p>
...
public class EdgeContentImpl extends EObjectImpl implements EdgeContent
{
  ...
  public void setEndopen(Object newEndopen)
  {
    ...
    endopen = newEndopen;
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, GexfPackage.EDGE_CONTENT__ENDOPEN, oldEndopen, endopen));
  }
  ...
  public void setStartopen(Object newStartopen)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, GexfPackage.EDGE_CONTENT__STARTOPEN, oldStartopen, startopen));
  }
  ...
  public void setType(EdgetypeType newType)
  {
    ...
    typeESet = true;
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, GexfPackage.EDGE_CONTENT__TYPE, oldType, type, !oldTypeESet));
  }
  ...
  public void unsetType()
  {
    ...
    typeESet = false;
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.UNSET, GexfPackage.EDGE_CONTENT__TYPE, oldType, TYPE_EDEFAULT, oldTypeESet));
  }
  ...
  public void setWeight(float newWeight)
  {
    ...
    weightESet = true;
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, GexfPackage.EDGE_CONTENT__WEIGHT, oldWeight, weight, !oldWeightESet));
  }
  ...
  public void unsetWeight()
  {
    ...
    weightESet = false;
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.UNSET, GexfPackage.EDGE_CONTENT__WEIGHT, oldWeight, WEIGHT_EDEFAULT, oldWeightESet));
  }
