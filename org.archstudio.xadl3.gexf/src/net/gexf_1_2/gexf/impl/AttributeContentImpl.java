...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>Attribute Content</b></em>'.
 * <!-- end-user-doc -->
 * <p>
...
public class AttributeContentImpl extends EObjectImpl implements AttributeContent
{
  ...
  public void setType(AttrtypeType newType)
  {
    ...
    typeESet = true;
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, GexfPackage.ATTRIBUTE_CONTENT__TYPE, oldType, type, !oldTypeESet));
  }
  ...
  public void unsetType()
  {
    ...
    typeESet = false;
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.UNSET, GexfPackage.ATTRIBUTE_CONTENT__TYPE, oldType, TYPE_EDEFAULT, oldTypeESet));
  }
