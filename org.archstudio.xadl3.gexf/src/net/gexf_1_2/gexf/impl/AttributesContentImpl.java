...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>Attributes Content</b></em>'.
 * <!-- end-user-doc -->
 * <p>
...
public class AttributesContentImpl extends EObjectImpl implements AttributesContent
{
  ...
  public EList<AttributeContent> getAttribute()
  {
    if (attribute == null)
    {
      attribute = new EObjectContainmentEList<AttributeContent>(AttributeContent.class, this, GexfPackage.ATTRIBUTES_CONTENT__ATTRIBUTE);
    }
    return attribute;
  }
  ...
  public void setClass(ClassType newClass)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, GexfPackage.ATTRIBUTES_CONTENT__CLASS, oldClass, class_, !oldClassESet));
  }
  ...
  public void unsetClass()
  {
    ...
    classESet = false;
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.UNSET, GexfPackage.ATTRIBUTES_CONTENT__CLASS, oldClass, CLASS_EDEFAULT, oldClassESet));
  }
  ...
  public void setEndopen(Object newEndopen)
  {
    ...
    endopen = newEndopen;
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, GexfPackage.ATTRIBUTES_CONTENT__ENDOPEN, oldEndopen, endopen));
  }
  ...
  public void setMode(ModeType newMode)
  {
    ...
    modeESet = true;
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, GexfPackage.ATTRIBUTES_CONTENT__MODE, oldMode, mode, !oldModeESet));
  }
  ...
  public void unsetMode()
  {
    ...
    modeESet = false;
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.UNSET, GexfPackage.ATTRIBUTES_CONTENT__MODE, oldMode, MODE_EDEFAULT, oldModeESet));
  }
  ...
  public void setStart(Object newStart)
  {
    ...
    start = newStart;
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, GexfPackage.ATTRIBUTES_CONTENT__START, oldStart, start));
  }
  ...
  public void setStartopen(Object newStartopen)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, GexfPackage.ATTRIBUTES_CONTENT__STARTOPEN, oldStartopen, startopen));
  }
