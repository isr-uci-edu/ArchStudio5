...
/**
 * <!-- begin-user-doc --> An implementation of the model object '<em><b>Graph Content</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 ...
 * <li>{@link net.gexf_1_2.gexf.impl.GraphContentImpl#getDefaultedgetype <em>Defaultedgetype</em>}
 * </li>
...
public class GraphContentImpl extends MinimalEObjectImpl.Container implements GraphContent {
   ...
   * @ordered
   */
  protected static final DefaultedgetypeType DEFAULTEDGETYPE_EDEFAULT =
      DefaultedgetypeType.DIRECTED;
  ...
  /**
   * This is true if the Defaultedgetype attribute has been set. <!-- begin-user-doc --> <!--
   * end-user-doc -->
   * 
   * @generated
   * @ordered
  ...
  /**
   * This is true if the Timeformat attribute has been set. <!-- begin-user-doc --> <!--
   * end-user-doc -->
   * 
   * @generated
   * @ordered
  ...
  public void setDefaultedgetype(DefaultedgetypeType newDefaultedgetype) {
    ...
    if (eNotificationRequired()) {
      eNotify(
          new ENotificationImpl(this, Notification.SET, GexfPackage.GRAPH_CONTENT__DEFAULTEDGETYPE,
  ...
  public void unsetDefaultedgetype() {
    ...
    if (eNotificationRequired()) {
      eNotify(new ENotificationImpl(this, Notification.UNSET,
          GexfPackage.GRAPH_CONTENT__DEFAULTEDGETYPE, oldDefaultedgetype, DEFAULTEDGETYPE_EDEFAULT,
          oldDefaultedgetypeESet));
    }
  }
  ...
  public void setEnd(Object newEnd) {
    ...
    if (eNotificationRequired()) {
      eNotify(new ENotificationImpl(this, Notification.SET, GexfPackage.GRAPH_CONTENT__END, oldEnd,
          end));
    }
  }
  ...
  public void setEndopen(Object newEndopen) {
    ...
    endopen = newEndopen;
    if (eNotificationRequired()) {
      eNotify(new ENotificationImpl(this, Notification.SET, GexfPackage.GRAPH_CONTENT__ENDOPEN,
          oldEndopen, endopen));
    }
  }
  ...
  public void setIdtype(IdtypeType newIdtype) {
    ...
    idtypeESet = true;
    if (eNotificationRequired()) {
      eNotify(new ENotificationImpl(this, Notification.SET, GexfPackage.GRAPH_CONTENT__IDTYPE,
          oldIdtype, idtype, !oldIdtypeESet));
    }
  }
  ...
  public void unsetIdtype() {
    ...
    idtypeESet = false;
    if (eNotificationRequired()) {
      eNotify(new ENotificationImpl(this, Notification.UNSET, GexfPackage.GRAPH_CONTENT__IDTYPE,
          oldIdtype, IDTYPE_EDEFAULT, oldIdtypeESet));
    }
  }
  ...
  public void setMode(ModeType newMode) {
    ...
    modeESet = true;
    if (eNotificationRequired()) {
      eNotify(new ENotificationImpl(this, Notification.SET, GexfPackage.GRAPH_CONTENT__MODE,
  ...
  public void unsetMode() {
    ...
    modeESet = false;
    if (eNotificationRequired()) {
      eNotify(new ENotificationImpl(this, Notification.UNSET, GexfPackage.GRAPH_CONTENT__MODE,
  ...
  public void setStart(Object newStart) {
    ...
    start = newStart;
    if (eNotificationRequired()) {
      eNotify(new ENotificationImpl(this, Notification.SET, GexfPackage.GRAPH_CONTENT__START,
          oldStart, start));
    }
  }
  ...
  public void setStartopen(Object newStartopen) {
    ...
    if (eNotificationRequired()) {
      eNotify(new ENotificationImpl(this, Notification.SET, GexfPackage.GRAPH_CONTENT__STARTOPEN,
  ...
  public void setTimeformat(TimeformatType newTimeformat) {
    ...
    timeformatESet = true;
    if (eNotificationRequired()) {
      eNotify(new ENotificationImpl(this, Notification.SET, GexfPackage.GRAPH_CONTENT__TIMEFORMAT,
          oldTimeformat, timeformat, !oldTimeformatESet));
    }
  }
  ...
  public boolean eIsSet(int featureID) {
    switch (featureID) {
      ...
      case GexfPackage.GRAPH_CONTENT__STARTOPEN:
        return STARTOPEN_EDEFAULT == null ? startopen != null
            : !STARTOPEN_EDEFAULT.equals(startopen);
      case GexfPackage.GRAPH_CONTENT__TIMEFORMAT:
