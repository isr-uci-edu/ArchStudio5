...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>Graph Content</b></em>'.
 * <!-- end-user-doc -->
 * <p>
...
public class GraphContentImpl extends EObjectImpl implements GraphContent
{
  ...
  /**
   * The default value of the '{@link #getDefaultedgetype() <em>Defaultedgetype</em>}' attribute.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
  ...
  /**
   * The cached value of the '{@link #getDefaultedgetype() <em>Defaultedgetype</em>}' attribute.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * @see #getDefaultedgetype()
   * @generated
  ...
  /**
   * The default value of the '{@link #getIdtype() <em>Idtype</em>}' attribute.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * @see #getIdtype()
   * @generated
  ...
  /**
   * This is true if the Idtype attribute has been set.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * @generated
   * @ordered
  ...
  public void setDefaultedgetype(DefaultedgetypeType newDefaultedgetype)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, GexfPackage.GRAPH_CONTENT__DEFAULTEDGETYPE, oldDefaultedgetype, defaultedgetype, !oldDefaultedgetypeESet));
  }
  ...
  public void unsetDefaultedgetype()
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.UNSET, GexfPackage.GRAPH_CONTENT__DEFAULTEDGETYPE, oldDefaultedgetype, DEFAULTEDGETYPE_EDEFAULT, oldDefaultedgetypeESet));
  }
  ...
  public void setEndopen(Object newEndopen)
  {
    ...
    endopen = newEndopen;
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, GexfPackage.GRAPH_CONTENT__ENDOPEN, oldEndopen, endopen));
  }
  ...
  public void setIdtype(IdtypeType newIdtype)
  {
    ...
    idtypeESet = true;
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, GexfPackage.GRAPH_CONTENT__IDTYPE, oldIdtype, idtype, !oldIdtypeESet));
  }
  ...
  public void unsetIdtype()
  {
    ...
    idtypeESet = false;
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.UNSET, GexfPackage.GRAPH_CONTENT__IDTYPE, oldIdtype, IDTYPE_EDEFAULT, oldIdtypeESet));
  }
  ...
  public void setMode(ModeType newMode)
  {
    ...
    modeESet = true;
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, GexfPackage.GRAPH_CONTENT__MODE, oldMode, mode, !oldModeESet));
  }
  ...
  public void unsetMode()
  {
    ...
    modeESet = false;
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.UNSET, GexfPackage.GRAPH_CONTENT__MODE, oldMode, MODE_EDEFAULT, oldModeESet));
  }
  ...
  public void setStartopen(Object newStartopen)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, GexfPackage.GRAPH_CONTENT__STARTOPEN, oldStartopen, startopen));
  }
  ...
  public void setTimeformat(TimeformatType newTimeformat)
  {
    ...
    timeformatESet = true;
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, GexfPackage.GRAPH_CONTENT__TIMEFORMAT, oldTimeformat, timeformat, !oldTimeformatESet));
  }
  ...
  public void unsetTimeformat()
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.UNSET, GexfPackage.GRAPH_CONTENT__TIMEFORMAT, oldTimeformat, TIMEFORMAT_EDEFAULT, oldTimeformatESet));
  }
  ...
  public String toString()
  {
    ...
    if (defaultedgetypeESet) result.append(defaultedgetype); else result.append("<unset>");
    result.append(", end: ");
    result.append(end);
    ...
    if (timeformatESet) result.append(timeformat); else result.append("<unset>");
    result.append(')');
