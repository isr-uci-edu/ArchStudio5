 ...
 * <em><b>Idtype Type</b></em>', and utility methods for working with them. <!-- end-user-doc -->
 * 
...
public enum IdtypeType implements Enumerator {
  ...
  /**
   * An array of all the '<em><b>Idtype Type</b></em>' enumerators. <!-- begin-user-doc --> <!--
   * end-user-doc -->
   * 
   * @generated
   */
  ...
  /**
   * A public read-only list of all the '<em><b>Idtype Type</b></em>' enumerators. <!--
   * begin-user-doc --> <!-- end-user-doc -->
   * 
   * @generated
   */
  public static final List<IdtypeType> VALUES =
      Collections.unmodifiableList(Arrays.asList(VALUES_ARRAY));

  /**
   * Returns the '<em><b>Idtype Type</b></em>' literal with the specified literal value. <!--
   * begin-user-doc --> <!-- end-user-doc -->
   * 
  ...
  /**
   * Returns the '<em><b>Idtype Type</b></em>' literal with the specified integer value. <!--
   * begin-user-doc --> <!-- end-user-doc -->
   * 
