...
public interface GexfContent extends EObject {
  ...
  /**
   * Sets the value of the '{@link net.gexf_1_2.gexf.GexfContent#getMeta <em>Meta</em>}' containment
  ...
  /**
   * Sets the value of the '{@link net.gexf_1_2.gexf.GexfContent#getGraph <em>Graph</em>}'
   ...
   * <p>
   * If the meaning of the '<em>Variant</em>' attribute isn't clear, there really should be more of
   * a description here...
   * </p>
   * <!-- end-user-doc -->
   * 
   ...
   *        "kind='attribute' name='variant'"
   * @generated
   */
  String getVariant();

  /**
   * Sets the value of the '{@link net.gexf_1_2.gexf.GexfContent#getVariant <em>Variant</em>}'
  ...
  /**
   * Returns the value of the '<em><b>Version</b></em>' attribute. The literals are from the
   * enumeration {@link net.gexf_1_2.gexf.VersionType}. <!-- begin-user-doc -->
   * <p>
  ...
  /**
   * Sets the value of the '{@link net.gexf_1_2.gexf.GexfContent#getVersion <em>Version</em>}'
   * attribute. <!-- begin-user-doc --> <!-- end-user-doc -->
   * 
  ...
  /**
   * Unsets the value of the '{@link net.gexf_1_2.gexf.GexfContent#getVersion <em>Version</em>}'
   * attribute. <!-- begin-user-doc --> <!-- end-user-doc -->
   * 
   * @see #isSetVersion()
   * @see #getVersion()
  ...
  /**
   * Returns whether the value of the '{@link net.gexf_1_2.gexf.GexfContent#getVersion
   * <em>Version</em>}' attribute is set. <!-- begin-user-doc --> <!-- end-user-doc -->
   * 
