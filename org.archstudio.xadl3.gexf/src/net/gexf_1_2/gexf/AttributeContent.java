...
/**
 * <!-- begin-user-doc --> A representation of the model object '<em><b>Attribute Content</b></em>'.
 * <!-- end-user-doc -->
 *
 * <p>
...
public interface AttributeContent extends EObject {
  ...
  /**
   * Returns the value of the '<em><b>Default</b></em>' attribute list. The list contents are of
   * type {@link java.lang.String}. <!-- begin-user-doc -->
   * <p>
   * If the meaning of the '<em>Default</em>' attribute list isn't clear, there really should be
  ...
  /**
   * Returns the value of the '<em><b>Options</b></em>' attribute list. The list contents are of
   * type {@link java.lang.String}. <!-- begin-user-doc -->
   * <p>
   * If the meaning of the '<em>Options</em>' attribute list isn't clear, there really should be
   * more of a description here...
   * </p>
   * <!-- end-user-doc -->
   * 
  ...
  /**
   * Sets the value of the '{@link net.gexf_1_2.gexf.AttributeContent#getTitle <em>Title</em>}'
   ...
   * enumeration {@link net.gexf_1_2.gexf.AttrtypeType}. <!-- begin-user-doc -->
   * <p>
  ...
  /**
   * Sets the value of the '{@link net.gexf_1_2.gexf.AttributeContent#getType <em>Type</em>}'
   * attribute. <!-- begin-user-doc --> <!-- end-user-doc -->
   * 
  ...
  /**
   * Unsets the value of the '{@link net.gexf_1_2.gexf.AttributeContent#getType <em>Type</em>}'
   * attribute. <!-- begin-user-doc --> <!-- end-user-doc -->
   * 
   * @see #isSetType()
   * @see #getType()
  ...
  /**
   * Returns whether the value of the '{@link net.gexf_1_2.gexf.AttributeContent#getType
