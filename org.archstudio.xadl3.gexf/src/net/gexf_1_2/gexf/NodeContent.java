...
/**
 * <!-- begin-user-doc --> A representation of the model object '<em><b>Node Content</b></em>'. <!--
 * end-user-doc -->
 *
 * <p>
...
public interface NodeContent extends EObject {
  ...
  /**
   * Returns the value of the '<em><b>Parents</b></em>' containment reference list. The list
   * contents are of type {@link net.gexf_1_2.gexf.ParentsContent}. <!-- begin-user-doc -->
   * <p>
   * If the meaning of the '<em>Parents</em>' containment reference list isn't clear, there really
   * should be more of a description here...
   * </p>
   * <!-- end-user-doc -->
   * 
  ...
  /**
   * Returns the value of the '<em><b>Position</b></em>' containment reference list. The list
   * contents are of type {@link net.gexf_1_2.viz.PositionContent}. <!-- begin-user-doc -->
   * <p>
   * If the meaning of the '<em>Position</em>' containment reference list isn't clear, there really
   * should be more of a description here...
   * </p>
   * <!-- end-user-doc -->
   * 
  ...
  /**
   * Returns the value of the '<em><b>Size</b></em>' containment reference list. The list contents
   * are of type {@link net.gexf_1_2.viz.SizeContent}. <!-- begin-user-doc -->
   * <p>
   * If the meaning of the '<em>Size</em>' containment reference list isn't clear, there really
   * should be more of a description here...
   * </p>
   * <!-- end-user-doc -->
   * 
   ...
   * are of type {@link net.gexf_1_2.viz.NodeShapeContent}. <!-- begin-user-doc -->
   * <p>
  ...
  /**
   * Sets the value of the '{@link net.gexf_1_2.gexf.NodeContent#getEndopen <em>Endopen</em>}'
  ...
  /**
   * Sets the value of the '{@link net.gexf_1_2.gexf.NodeContent#getLabel <em>Label</em>}'
   * attribute. <!-- begin-user-doc --> <!-- end-user-doc -->
   * 
   ...
   * <p>
   * If the meaning of the '<em>Pid</em>' attribute isn't clear, there really should be more of a
   * description here...
   * </p>
   * <!-- end-user-doc -->
   * 
  ...
  /**
   * Sets the value of the '{@link net.gexf_1_2.gexf.NodeContent#getStart <em>Start</em>}'
   * attribute. <!-- begin-user-doc --> <!-- end-user-doc -->
   * 
  ...
  /**
   * Sets the value of the '{@link net.gexf_1_2.gexf.NodeContent#getStartopen <em>Startopen</em>}'
   * attribute. <!-- begin-user-doc --> <!-- end-user-doc -->
   * 
