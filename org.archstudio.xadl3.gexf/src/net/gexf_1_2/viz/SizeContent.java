...
/**
 * <!-- begin-user-doc --> A representation of the model object '<em><b>Size Content</b></em>'. <!--
 * end-user-doc -->
 *
 * <p>
...
public interface SizeContent extends EObject {
  ...
  /**
   * Sets the value of the '{@link net.gexf_1_2.viz.SizeContent#getSpells <em>Spells</em>}'
  ...
  /**
   * Sets the value of the '{@link net.gexf_1_2.viz.SizeContent#getEnd <em>End</em>}' attribute.
  ...
  /**
   * Sets the value of the '{@link net.gexf_1_2.viz.SizeContent#getEndopen <em>Endopen</em>}'
  ...
  /**
   * Sets the value of the '{@link net.gexf_1_2.viz.SizeContent#getStartopen <em>Startopen</em>}'
   * attribute. <!-- begin-user-doc --> <!-- end-user-doc -->
   * 
   ...
   * @model unsettable="true" dataType="net.gexf_1_2.viz.SizeType" required="true" extendedMetaData=
  ...
  /**
   * Unsets the value of the '{@link net.gexf_1_2.viz.SizeContent#getValue <em>Value</em>}'
   * attribute. <!-- begin-user-doc --> <!-- end-user-doc -->
   * 
   * @see #isSetValue()
   * @see #getValue()
  ...
  /**
   * Returns whether the value of the '{@link net.gexf_1_2.viz.SizeContent#getValue <em>Value</em>}'
