 ...
 * <em><b>Edge Shape Type</b></em>', and utility methods for working with them. <!-- end-user-doc
 * -->
 * 
...
public enum EdgeShapeType implements Enumerator {
  ...
  /**
   * An array of all the '<em><b>Edge Shape Type</b></em>' enumerators. <!-- begin-user-doc --> <!--
   * end-user-doc -->
   * 
   * @generated
   */
  private static final EdgeShapeType[] VALUES_ARRAY =
      new EdgeShapeType[] {SOLID, DOTTED, DASHED, DOUBLE,};
   ...
   * @generated
   */
  public static final List<EdgeShapeType> VALUES =
