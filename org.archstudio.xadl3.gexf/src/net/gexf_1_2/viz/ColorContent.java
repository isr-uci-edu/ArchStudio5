...
/**
 * <!-- begin-user-doc --> A representation of the model object '<em><b>Color Content</b></em>'.
 * <!-- end-user-doc -->
 *
 * <p>
...
public interface ColorContent extends EObject {
  ...
  /**
   * Sets the value of the '{@link net.gexf_1_2.viz.ColorContent#getSpells <em>Spells</em>}'
   ...
   * <p>
   * If the meaning of the '<em>A</em>' attribute isn't clear, there really should be more of a
   * description here...
   * </p>
   * <!-- end-user-doc -->
   * 
   ...
   * @model unsettable="true" dataType="net.gexf_1_2.viz.AlphaChannel" extendedMetaData=
  ...
  /**
   * Sets the value of the '{@link net.gexf_1_2.viz.ColorContent#getA <em>A</em>}' attribute. <!--
  ...
  /**
   * Unsets the value of the '{@link net.gexf_1_2.viz.ColorContent#getA <em>A</em>}' attribute. <!--
   * begin-user-doc --> <!-- end-user-doc -->
   * 
   * @see #isSetA()
   * @see #getA()
  ...
  /**
   * Returns whether the value of the '{@link net.gexf_1_2.viz.ColorContent#getA <em>A</em>}'
   ...
   * @model dataType="net.gexf_1_2.viz.ColorChannel" required="true" extendedMetaData=
   *        "kind='attribute' name='b'"
   * @generated
   */
  BigInteger getB();

  /**
   * Sets the value of the '{@link net.gexf_1_2.viz.ColorContent#getB <em>B</em>}' attribute. <!--
   * begin-user-doc --> <!-- end-user-doc -->
   * 
  ...
  /**
   * Sets the value of the '{@link net.gexf_1_2.viz.ColorContent#getEnd <em>End</em>}' attribute.
   * <!-- begin-user-doc --> <!-- end-user-doc -->
   * 
  ...
  /**
   * Sets the value of the '{@link net.gexf_1_2.viz.ColorContent#getEndopen <em>Endopen</em>}'
   ...
   * @model dataType="net.gexf_1_2.viz.ColorChannel" required="true" extendedMetaData=
   *        "kind='attribute' name='g'"
   * @generated
   */
  BigInteger getG();

  /**
   * Sets the value of the '{@link net.gexf_1_2.viz.ColorContent#getG <em>G</em>}' attribute. <!--
   * begin-user-doc --> <!-- end-user-doc -->
   * 
   ...
   * <p>
   * If the meaning of the '<em>R</em>' attribute isn't clear, there really should be more of a
   * description here...
   * </p>
   * <!-- end-user-doc -->
   * 
   ...
   * @model dataType="net.gexf_1_2.viz.ColorChannel" required="true" extendedMetaData=
   *        "kind='attribute' name='r'"
   * @generated
   */
  BigInteger getR();

  /**
   * Sets the value of the '{@link net.gexf_1_2.viz.ColorContent#getR <em>R</em>}' attribute. <!--
   * begin-user-doc --> <!-- end-user-doc -->
   * 
  ...
  /**
   * Sets the value of the '{@link net.gexf_1_2.viz.ColorContent#getStart <em>Start</em>}'
   * attribute. <!-- begin-user-doc --> <!-- end-user-doc -->
   * 
  ...
  /**
   * Sets the value of the '{@link net.gexf_1_2.viz.ColorContent#getStartopen <em>Startopen</em>}'
   * attribute. <!-- begin-user-doc --> <!-- end-user-doc -->
   * 
