...
public interface VizFactory extends EFactory {
	...
	/**
	 * Returns a new object of class '<em>Color Content</em>'. <!--
	...
	/**
	 * Returns a new object of class '<em>Edge Shape Content</em>'. <!--
	 * begin-user-doc --> <!-- end-user-doc -->
	 * 
	...
	/**
	 * Returns a new object of class '<em>Node Shape Content</em>'. <!--
	 * begin-user-doc --> <!-- end-user-doc -->
	 * 
	...
	/**
	 * Returns a new object of class '<em>Position Content</em>'. <!--
	 * begin-user-doc --> <!-- end-user-doc -->
	 * 
	...
	/**
	 * Returns a new object of class '<em>Size Content</em>'. <!--
	 * begin-user-doc --> <!-- end-user-doc -->
	 * 
	...
	/**
	 * Returns a new object of class '<em>Thickness Content</em>'. <!--
	 * begin-user-doc --> <!-- end-user-doc -->
	 * 
