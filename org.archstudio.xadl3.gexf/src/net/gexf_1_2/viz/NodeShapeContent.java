...
/**
 * <!-- begin-user-doc --> A representation of the model object '<em><b>Node Shape Content</b></em>
 * '. <!-- end-user-doc -->
 *
 * <p>
...
public interface NodeShapeContent extends EObject {
  ...
  /**
   * Sets the value of the '{@link net.gexf_1_2.viz.NodeShapeContent#getSpells <em>Spells</em>}'
  ...
  /**
   * Sets the value of the '{@link net.gexf_1_2.viz.NodeShapeContent#getEnd <em>End</em>}'
  ...
  /**
   * Sets the value of the '{@link net.gexf_1_2.viz.NodeShapeContent#getEndopen <em>Endopen</em>}'
   * attribute. <!-- begin-user-doc --> <!-- end-user-doc -->
   * 
  ...
  /**
   * Sets the value of the '{@link net.gexf_1_2.viz.NodeShapeContent#getStart <em>Start</em>}'
   * attribute. <!-- begin-user-doc --> <!-- end-user-doc -->
   * 
  ...
  /**
   * Sets the value of the '{@link net.gexf_1_2.viz.NodeShapeContent#getStartopen <em>Startopen</em>
   * }' attribute. <!-- begin-user-doc --> <!-- end-user-doc -->
   * 
   ...
   *        "kind='attribute' name='uri'"
   * @generated
   */
  String getUri();

  /**
   * Sets the value of the '{@link net.gexf_1_2.viz.NodeShapeContent#getUri <em>Uri</em>}'
   * attribute. <!-- begin-user-doc --> <!-- end-user-doc -->
   * 
   ...
   * enumeration {@link net.gexf_1_2.viz.NodeShapeType}. <!-- begin-user-doc -->
   * <p>
  ...
  /**
   * Sets the value of the '{@link net.gexf_1_2.viz.NodeShapeContent#getValue <em>Value</em>}'
   * attribute. <!-- begin-user-doc --> <!-- end-user-doc -->
   * 
  ...
  /**
   * Unsets the value of the '{@link net.gexf_1_2.viz.NodeShapeContent#getValue <em>Value</em>}'
   * attribute. <!-- begin-user-doc --> <!-- end-user-doc -->
   * 
   * @see #isSetValue()
   * @see #getValue()
  ...
  /**
   * Returns whether the value of the '{@link net.gexf_1_2.viz.NodeShapeContent#getValue
