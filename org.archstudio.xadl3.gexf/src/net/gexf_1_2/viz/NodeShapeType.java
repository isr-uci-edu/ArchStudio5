 ...
 * <em><b>Node Shape Type</b></em>', and utility methods for working with them. <!-- end-user-doc
 * -->
 * 
...
public enum NodeShapeType implements Enumerator {
   ...
   * <p>
   * If the meaning of '<em><b>Disc</b></em>' literal object isn't clear, there really should be
   ...
   * <p>
   * If the meaning of '<em><b>Image</b></em>' literal object isn't clear, there really should be
   * more of a description here...
   * </p>
   * <!-- end-user-doc -->
   * 
  ...
  /**
   * An array of all the '<em><b>Node Shape Type</b></em>' enumerators. <!-- begin-user-doc --> <!--
   * end-user-doc -->
   * 
   * @generated
   */
  private static final NodeShapeType[] VALUES_ARRAY =
      new NodeShapeType[] {DISC, SQUARE, TRIANGLE, DIAMOND, IMAGE,};

  /**
   * A public read-only list of all the '<em><b>Node Shape Type</b></em>' enumerators. <!--
   * begin-user-doc --> <!-- end-user-doc -->
   * 
   * @generated
   */
  public static final List<NodeShapeType> VALUES =
      Collections.unmodifiableList(Arrays.asList(VALUES_ARRAY));

  /**
   * Returns the '<em><b>Node Shape Type</b></em>' literal with the specified literal value. <!--
   * begin-user-doc --> <!-- end-user-doc -->
   * 
  ...
  /**
   * Returns the '<em><b>Node Shape Type</b></em>' literal with the specified name. <!--
   * begin-user-doc --> <!-- end-user-doc -->
   * 
   * @param name the name.
   * @return the matching enumerator or <code>null</code>.
  ...
  /**
   * Returns the '<em><b>Node Shape Type</b></em>' literal with the specified integer value. <!--
   * begin-user-doc --> <!-- end-user-doc -->
   * 
