...
/**
 * <!-- begin-user-doc --> A representation of the model object '<em><b>Position Content</b></em>'.
 * <!-- end-user-doc -->
 *
 * <p>
...
public interface PositionContent extends EObject {
  ...
  /**
   * Sets the value of the '{@link net.gexf_1_2.viz.PositionContent#getSpells <em>Spells</em>}'
  ...
  /**
   * Sets the value of the '{@link net.gexf_1_2.viz.PositionContent#getEndopen <em>Endopen</em>}'
  ...
  /**
   * Sets the value of the '{@link net.gexf_1_2.viz.PositionContent#getStart <em>Start</em>}'
   * attribute. <!-- begin-user-doc --> <!-- end-user-doc -->
   * 
  ...
  /**
   * Sets the value of the '{@link net.gexf_1_2.viz.PositionContent#getStartopen <em>Startopen</em>}
   * ' attribute. <!-- begin-user-doc --> <!-- end-user-doc -->
   * 
  ...
  /**
   * Returns whether the value of the '{@link net.gexf_1_2.viz.PositionContent#getX <em>X</em>}'
  ...
  /**
   * Returns whether the value of the '{@link net.gexf_1_2.viz.PositionContent#getY <em>Y</em>}'
   * attribute is set. <!-- begin-user-doc --> <!-- end-user-doc -->
   * 
   ...
   * <p>
   * If the meaning of the '<em>Z</em>' attribute isn't clear, there really should be more of a
   * description here...
   * </p>
   * <!-- end-user-doc -->
   * 
  ...
  /**
   * Returns whether the value of the '{@link net.gexf_1_2.viz.PositionContent#getZ <em>Z</em>}'
   * attribute is set. <!-- begin-user-doc --> <!-- end-user-doc -->
   * 
