 ...
 * <li>{@link net.gexf_1_2.viz.DocumentRoot#getXMLNSPrefixMap <em>XMLNS Prefix Map</em>}</li>
 * <li>{@link net.gexf_1_2.viz.DocumentRoot#getXSISchemaLocation <em>XSI Schema Location</em>}</li>
...
public interface DocumentRoot extends EObject {
  ...
  /**
   * Sets the value of the '{@link net.gexf_1_2.viz.DocumentRoot#getSpells <em>Spells</em>}'
