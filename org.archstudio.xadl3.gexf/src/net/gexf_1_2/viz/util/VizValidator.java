...
public class VizValidator extends EObjectValidator
{
   ...
   * @generated
   */
  public boolean validateColorContent(ColorContent colorContent, DiagnosticChain diagnostics, Map<Object, Object> context)
  {
   ...
   * @generated
   */
  public boolean validateEdgeShapeContent(EdgeShapeContent edgeShapeContent, DiagnosticChain diagnostics, Map<Object, Object> context)
  {
   ...
   * @generated
   */
  public boolean validateNodeShapeContent(NodeShapeContent nodeShapeContent, DiagnosticChain diagnostics, Map<Object, Object> context)
  {
   ...
   * @generated
   */
  public boolean validatePositionContent(PositionContent positionContent, DiagnosticChain diagnostics, Map<Object, Object> context)
  {
   ...
   * @generated
   */
  public boolean validateThicknessContent(ThicknessContent thicknessContent, DiagnosticChain diagnostics, Map<Object, Object> context)
  {
   ...
   * @generated
   */
  public boolean validateEdgeShapeType(EdgeShapeType edgeShapeType, DiagnosticChain diagnostics, Map<Object, Object> context)
  {
    return true;
  }
   ...
   * @generated
   */
  public boolean validateNodeShapeType(NodeShapeType nodeShapeType, DiagnosticChain diagnostics, Map<Object, Object> context)
  {
    return true;
  }
  ...
  public boolean validateAlphaChannel(float alphaChannel, DiagnosticChain diagnostics, Map<Object, Object> context)
  {
    ...
    if (result || diagnostics != null) result &= validateAlphaChannel_Max(alphaChannel, diagnostics, context);
    return result;
  }
  ...
  public boolean validateAlphaChannel_Min(float alphaChannel, DiagnosticChain diagnostics, Map<Object, Object> context)
  {
    ...
    if (!result && diagnostics != null)
      reportMinViolation(VizPackage.Literals.ALPHA_CHANNEL, alphaChannel, ALPHA_CHANNEL__MIN__VALUE, true, diagnostics, context);
    return result;
  }
  ...
  public boolean validateAlphaChannel_Max(float alphaChannel, DiagnosticChain diagnostics, Map<Object, Object> context)
  {
    ...
    if (!result && diagnostics != null)
      reportMaxViolation(VizPackage.Literals.ALPHA_CHANNEL, alphaChannel, ALPHA_CHANNEL__MAX__VALUE, true, diagnostics, context);
    return result;
  }
   ...
   * @generated
   */
  public boolean validateAlphaChannelObject(Float alphaChannelObject, DiagnosticChain diagnostics, Map<Object, Object> context)
  {
    boolean result = validateAlphaChannel_Min(alphaChannelObject, diagnostics, context);
    if (result || diagnostics != null) result &= validateAlphaChannel_Max(alphaChannelObject, diagnostics, context);
    return result;
  }
   ...
   * @generated
   */
  public boolean validateColorChannel(BigInteger colorChannel, DiagnosticChain diagnostics, Map<Object, Object> context)
  {
    boolean result = xmlTypeValidator.validateNonNegativeInteger_Min(colorChannel, diagnostics, context);
    if (result || diagnostics != null) result &= validateColorChannel_Max(colorChannel, diagnostics, context);
    return result;
  }
   ...
   * @generated
   */
  public boolean validateColorChannel_Max(BigInteger colorChannel, DiagnosticChain diagnostics, Map<Object, Object> context)
  {
    boolean result = colorChannel.compareTo(COLOR_CHANNEL__MAX__VALUE) <= 0;
    if (!result && diagnostics != null)
      reportMaxViolation(VizPackage.Literals.COLOR_CHANNEL, colorChannel, COLOR_CHANNEL__MAX__VALUE, true, diagnostics, context);
    return result;
  }
   ...
   * @generated
   */
  public boolean validateEdgeShapeTypeObject(EdgeShapeType edgeShapeTypeObject, DiagnosticChain diagnostics, Map<Object, Object> context)
  {
    return true;
  }
   ...
   * @generated
   */
  public boolean validateNodeShapeTypeObject(NodeShapeType nodeShapeTypeObject, DiagnosticChain diagnostics, Map<Object, Object> context)
  {
    return true;
  }
  ...
  /**
   * Validates the Min constraint of '<em>Size Type</em>'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * @generated
   */
  public boolean validateSizeType_Min(float sizeType, DiagnosticChain diagnostics, Map<Object, Object> context)
  {
    ...
    if (!result && diagnostics != null)
      reportMinViolation(VizPackage.Literals.SIZE_TYPE, sizeType, SIZE_TYPE__MIN__VALUE, true, diagnostics, context);
    return result;
  }
   ...
   * @generated
   */
  public boolean validateSpacePointObject(Float spacePointObject, DiagnosticChain diagnostics, Map<Object, Object> context)
  {
    return true;
  }
   ...
   * @generated
   */
  public boolean validateThicknessType_Min(float thicknessType, DiagnosticChain diagnostics, Map<Object, Object> context)
  {
    boolean result = thicknessType >= THICKNESS_TYPE__MIN__VALUE;
    if (!result && diagnostics != null)
      reportMinViolation(VizPackage.Literals.THICKNESS_TYPE, thicknessType, THICKNESS_TYPE__MIN__VALUE, true, diagnostics, context);
    return result;
  }
   ...
   * @generated
   */
  public boolean validateThicknessTypeObject(Float thicknessTypeObject, DiagnosticChain diagnostics, Map<Object, Object> context)
  {
