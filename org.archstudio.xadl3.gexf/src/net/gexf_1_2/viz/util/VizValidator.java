...
public class VizValidator extends EObjectValidator {
   ...
   * @generated
   */
  public boolean validateEdgeShapeContent(EdgeShapeContent edgeShapeContent,
   ...
   * @generated
   */
  public boolean validateNodeShapeContent(NodeShapeContent nodeShapeContent,
      DiagnosticChain diagnostics, Map<Object, Object> context) {
   ...
   * @generated
   */
  public boolean validatePositionContent(PositionContent positionContent,
      DiagnosticChain diagnostics, Map<Object, Object> context) {
   ...
   * @generated
   */
  public boolean validateThicknessContent(ThicknessContent thicknessContent,
      DiagnosticChain diagnostics, Map<Object, Object> context) {
   ...
   * @generated
   */
  public boolean validateAlphaChannel(float alphaChannel, DiagnosticChain diagnostics,
      Map<Object, Object> context) {
  ...
  /**
   * Validates the Min constraint of '<em>Alpha Channel</em>'. <!-- begin-user-doc --> <!--
   * end-user-doc -->
   * 
   * @generated
   */
  public boolean validateAlphaChannel_Min(float alphaChannel, DiagnosticChain diagnostics,
    ...
    if (!result && diagnostics != null) {
      reportMinViolation(VizPackage.Literals.ALPHA_CHANNEL, alphaChannel, ALPHA_CHANNEL__MIN__VALUE,
  ...
  /**
   * Validates the Max constraint of '<em>Alpha Channel</em>'. <!-- begin-user-doc --> <!--
   * end-user-doc -->
   * 
   * @generated
   */
  public boolean validateAlphaChannel_Max(float alphaChannel, DiagnosticChain diagnostics,
    ...
    if (!result && diagnostics != null) {
      reportMaxViolation(VizPackage.Literals.ALPHA_CHANNEL, alphaChannel, ALPHA_CHANNEL__MAX__VALUE,
          true, diagnostics, context);
    }
    return result;
  }
  ...
  public boolean validateColorChannel(BigInteger colorChannel, DiagnosticChain diagnostics,
      Map<Object, Object> context) {
    boolean result =
        xmlTypeValidator.validateNonNegativeInteger_Min(colorChannel, diagnostics, context);
    if (result || diagnostics != null) {
  ...
  /**
   * Validates the Max constraint of '<em>Color Channel</em>'. <!-- begin-user-doc --> <!--
   * end-user-doc -->
   * 
   * @generated
   */
  public boolean validateColorChannel_Max(BigInteger colorChannel, DiagnosticChain diagnostics,
    ...
    if (!result && diagnostics != null) {
      reportMaxViolation(VizPackage.Literals.COLOR_CHANNEL, colorChannel, COLOR_CHANNEL__MAX__VALUE,
          true, diagnostics, context);
    }
    return result;
  }
   ...
   * @generated
   */
  public boolean validateEdgeShapeTypeObject(EdgeShapeType edgeShapeTypeObject,
      DiagnosticChain diagnostics, Map<Object, Object> context) {
    return true;
  }
   ...
   * @generated
   */
  public boolean validateNodeShapeTypeObject(NodeShapeType nodeShapeTypeObject,
      DiagnosticChain diagnostics, Map<Object, Object> context) {
    return true;
  }
   ...
   * @generated
   */
  public boolean validateSizeType(float sizeType, DiagnosticChain diagnostics,
      Map<Object, Object> context) {
   ...
   * @generated
   */
  public boolean validateSizeType_Min(float sizeType, DiagnosticChain diagnostics,
      Map<Object, Object> context) {
    boolean result = sizeType >= SIZE_TYPE__MIN__VALUE;
    if (!result && diagnostics != null) {
      reportMinViolation(VizPackage.Literals.SIZE_TYPE, sizeType, SIZE_TYPE__MIN__VALUE, true,
          diagnostics, context);
    }
    return result;
  }
   ...
   * @generated
   */
  public boolean validateSpacePoint(float spacePoint, DiagnosticChain diagnostics,
      Map<Object, Object> context) {
    return true;
  }
  ...
  /**
   * Validates the Min constraint of '<em>Thickness Type</em>'. <!-- begin-user-doc --> <!--
   * end-user-doc -->
   * 
   * @generated
   */
  public boolean validateThicknessType_Min(float thicknessType, DiagnosticChain diagnostics,
    ...
    if (!result && diagnostics != null) {
      reportMinViolation(VizPackage.Literals.THICKNESS_TYPE, thicknessType,
          THICKNESS_TYPE__MIN__VALUE, true, diagnostics, context);
    }
    return result;
  }
