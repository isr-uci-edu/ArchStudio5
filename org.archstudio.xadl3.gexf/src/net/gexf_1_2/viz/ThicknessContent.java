...
/**
 * <!-- begin-user-doc --> A representation of the model object '<em><b>Thickness Content</b></em>'.
 * <!-- end-user-doc -->
 *
 * <p>
...
public interface ThicknessContent extends EObject {
  ...
  /**
   * Sets the value of the '{@link net.gexf_1_2.viz.ThicknessContent#getSpells <em>Spells</em>}'
  ...
  /**
   * Sets the value of the '{@link net.gexf_1_2.viz.ThicknessContent#getEnd <em>End</em>}'
  ...
  /**
   * Sets the value of the '{@link net.gexf_1_2.viz.ThicknessContent#getEndopen <em>Endopen</em>}'
   * attribute. <!-- begin-user-doc --> <!-- end-user-doc -->
   * 
  ...
  /**
   * Sets the value of the '{@link net.gexf_1_2.viz.ThicknessContent#getStart <em>Start</em>}'
   * attribute. <!-- begin-user-doc --> <!-- end-user-doc -->
   * 
  ...
  /**
   * Sets the value of the '{@link net.gexf_1_2.viz.ThicknessContent#getStartopen <em>Startopen</em>
   * }' attribute. <!-- begin-user-doc --> <!-- end-user-doc -->
   * 
  ...
  /**
   * Sets the value of the '{@link net.gexf_1_2.viz.ThicknessContent#getValue <em>Value</em>}'
   * attribute. <!-- begin-user-doc --> <!-- end-user-doc -->
   * 
  ...
  /**
   * Unsets the value of the '{@link net.gexf_1_2.viz.ThicknessContent#getValue <em>Value</em>}'
   * attribute. <!-- begin-user-doc --> <!-- end-user-doc -->
   * 
   * @see #isSetValue()
   * @see #getValue()
  ...
  /**
   * Returns whether the value of the '{@link net.gexf_1_2.viz.ThicknessContent#getValue
