...
/**
 * <!-- begin-user-doc --> An implementation of the model object '<em><b>Color Content</b></em>'.
 * <!-- end-user-doc -->
 * <p>
...
public class ColorContentImpl extends MinimalEObjectImpl.Container implements ColorContent {
  ...
  /**
   * The default value of the '{@link #getB() <em>B</em>}' attribute. <!-- begin-user-doc --> <!--
   * end-user-doc -->
   * 
   * @see #getB()
   * @generated
  ...
  /**
   * The cached value of the '{@link #getB() <em>B</em>}' attribute. <!-- begin-user-doc --> <!--
   * end-user-doc -->
   * 
   * @see #getB()
   * @generated
  ...
  /**
   * The default value of the '{@link #getR() <em>R</em>}' attribute. <!-- begin-user-doc --> <!--
   * end-user-doc -->
   * 
   * @see #getR()
   * @generated
  ...
  /**
   * The cached value of the '{@link #getR() <em>R</em>}' attribute. <!-- begin-user-doc --> <!--
   * end-user-doc -->
   * 
   * @see #getR()
   * @generated
  ...
  public NotificationChain basicSetSpells(SpellsContent newSpells, NotificationChain msgs) {
    ...
    if (eNotificationRequired()) {
      ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
          VizPackage.COLOR_CONTENT__SPELLS, oldSpells, newSpells);
      if (msgs == null) {
        msgs = notification;
      } else {
  ...
  public void setSpells(SpellsContent newSpells) {
    if (newSpells != spells) {
      ...
      eNotify(new ENotificationImpl(this, Notification.SET, VizPackage.COLOR_CONTENT__SPELLS,
          newSpells, newSpells));
    }
  }
  ...
  public void setA(float newA) {
    ...
    aESet = true;
    if (eNotificationRequired()) {
      eNotify(new ENotificationImpl(this, Notification.SET, VizPackage.COLOR_CONTENT__A, oldA, a,
          !oldAESet));
    }
  }
  ...
  public void unsetA() {
    ...
    aESet = false;
    if (eNotificationRequired()) {
      eNotify(new ENotificationImpl(this, Notification.UNSET, VizPackage.COLOR_CONTENT__A, oldA,
          A_EDEFAULT, oldAESet));
    }
  }
  ...
  public void setEnd(Object newEnd) {
    ...
    if (eNotificationRequired()) {
      eNotify(new ENotificationImpl(this, Notification.SET, VizPackage.COLOR_CONTENT__END, oldEnd,
          end));
    }
  }
  ...
  public void setEndopen(Object newEndopen) {
    ...
    endopen = newEndopen;
    if (eNotificationRequired()) {
      eNotify(new ENotificationImpl(this, Notification.SET, VizPackage.COLOR_CONTENT__ENDOPEN,
          oldEndopen, endopen));
    }
  }
  ...
  public void setStart(Object newStart) {
    ...
    start = newStart;
    if (eNotificationRequired()) {
      eNotify(new ENotificationImpl(this, Notification.SET, VizPackage.COLOR_CONTENT__START,
          oldStart, start));
    }
  }
  ...
  public void setStartopen(Object newStartopen) {
    ...
    if (eNotificationRequired()) {
      eNotify(new ENotificationImpl(this, Notification.SET, VizPackage.COLOR_CONTENT__STARTOPEN,
