...
public class ColorContentImpl extends EObjectImpl implements ColorContent {
	...
	public void setSpells(SpellsContent newSpells) {
		if (newSpells != spells) {
			...
			eNotify(new ENotificationImpl(this, Notification.SET, VizPackage.COLOR_CONTENT__SPELLS, newSpells,
					newSpells));
		}
	}
	...
	public void unsetA() {
		...
		aESet = false;
		if (eNotificationRequired()) {
			eNotify(new ENotificationImpl(this, Notification.UNSET, VizPackage.COLOR_CONTENT__A, oldA, A_EDEFAULT,
					oldAESet));
		}
	}
	...
	public void setEndopen(Object newEndopen) {
		...
		endopen = newEndopen;
		if (eNotificationRequired()) {
			eNotify(new ENotificationImpl(this, Notification.SET, VizPackage.COLOR_CONTENT__ENDOPEN, oldEndopen,
					endopen));
		}
	}
	...
	public void setStartopen(Object newStartopen) {
		...
		if (eNotificationRequired()) {
			eNotify(new ENotificationImpl(this, Notification.SET, VizPackage.COLOR_CONTENT__STARTOPEN, oldStartopen,
					startopen));
		}
	}
