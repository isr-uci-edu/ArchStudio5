...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>Position Content</b></em>'.
 * <!-- end-user-doc -->
 * <p>
...
public class PositionContentImpl extends EObjectImpl implements PositionContent
{
  ...
  public NotificationChain basicSetSpells(SpellsContent newSpells, NotificationChain msgs)
  {
    ...
    {
      ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, VizPackage.POSITION_CONTENT__SPELLS, oldSpells, newSpells);
  ...
  public void setSpells(SpellsContent newSpells)
  {
    if (newSpells != spells)
    {
      ...
      if (spells != null)
        msgs = ((InternalEObject)spells).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - VizPackage.POSITION_CONTENT__SPELLS, null, msgs);
      if (newSpells != null)
        msgs = ((InternalEObject)newSpells).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - VizPackage.POSITION_CONTENT__SPELLS, null, msgs);
      msgs = basicSetSpells(newSpells, msgs);
      if (msgs != null) msgs.dispatch();
    }
    else if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, VizPackage.POSITION_CONTENT__SPELLS, newSpells, newSpells));
  }
  ...
  public void setEndopen(Object newEndopen)
  {
    ...
    endopen = newEndopen;
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, VizPackage.POSITION_CONTENT__ENDOPEN, oldEndopen, endopen));
  }
  ...
  public void setStartopen(Object newStartopen)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, VizPackage.POSITION_CONTENT__STARTOPEN, oldStartopen, startopen));
  }
  ...
  public void unsetX()
  {
    ...
    xESet = false;
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.UNSET, VizPackage.POSITION_CONTENT__X, oldX, X_EDEFAULT, oldXESet));
  }
  ...
  public void unsetY()
  {
    ...
    yESet = false;
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.UNSET, VizPackage.POSITION_CONTENT__Y, oldY, Y_EDEFAULT, oldYESet));
  }
  ...
  public void unsetZ()
  {
    ...
    zESet = false;
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.UNSET, VizPackage.POSITION_CONTENT__Z, oldZ, Z_EDEFAULT, oldZESet));
  }
