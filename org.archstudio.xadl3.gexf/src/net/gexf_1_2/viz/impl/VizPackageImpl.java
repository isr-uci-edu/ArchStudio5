...
public class VizPackageImpl extends EPackageImpl implements VizPackage
{
  ...
  public static VizPackage init()
  {
    ...
    VizPackageImpl theVizPackage = (VizPackageImpl)(EPackage.Registry.INSTANCE.get(eNS_URI) instanceof VizPackageImpl ? EPackage.Registry.INSTANCE.get(eNS_URI) : new VizPackageImpl());
    ...
    GexfPackageImpl theGexfPackage = (GexfPackageImpl)(EPackage.Registry.INSTANCE.getEPackage(GexfPackage.eNS_URI) instanceof GexfPackageImpl ? EPackage.Registry.INSTANCE.getEPackage(GexfPackage.eNS_URI) : GexfPackage.eINSTANCE);
  ...
  public void initializePackageContents()
  {
    ...
    initEClass(colorContentEClass, ColorContent.class, "ColorContent", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
    initEReference(getColorContent_Spells(), theGexfPackage.getSpellsContent(), null, "spells", null, 0, 1, ColorContent.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
    initEAttribute(getColorContent_A(), this.getAlphaChannel(), "a", null, 0, 1, ColorContent.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
    initEAttribute(getColorContent_B(), this.getColorChannel(), "b", null, 1, 1, ColorContent.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
    initEAttribute(getColorContent_End(), theGexfPackage.getTimeType(), "end", null, 0, 1, ColorContent.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
    initEAttribute(getColorContent_Endopen(), theGexfPackage.getTimeType(), "endopen", null, 0, 1, ColorContent.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
    initEAttribute(getColorContent_G(), this.getColorChannel(), "g", null, 1, 1, ColorContent.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
    initEAttribute(getColorContent_R(), this.getColorChannel(), "r", null, 1, 1, ColorContent.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
    initEAttribute(getColorContent_Start(), theGexfPackage.getTimeType(), "start", null, 0, 1, ColorContent.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
    initEAttribute(getColorContent_Startopen(), theGexfPackage.getTimeType(), "startopen", null, 0, 1, ColorContent.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);

    initEClass(edgeShapeContentEClass, EdgeShapeContent.class, "EdgeShapeContent", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
    initEReference(getEdgeShapeContent_Spells(), theGexfPackage.getSpellsContent(), null, "spells", null, 0, 1, EdgeShapeContent.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
    initEAttribute(getEdgeShapeContent_End(), theGexfPackage.getTimeType(), "end", null, 0, 1, EdgeShapeContent.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
    initEAttribute(getEdgeShapeContent_Endopen(), theGexfPackage.getTimeType(), "endopen", null, 0, 1, EdgeShapeContent.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
    initEAttribute(getEdgeShapeContent_Start(), theGexfPackage.getTimeType(), "start", null, 0, 1, EdgeShapeContent.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
    initEAttribute(getEdgeShapeContent_Startopen(), theGexfPackage.getTimeType(), "startopen", null, 0, 1, EdgeShapeContent.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
    initEAttribute(getEdgeShapeContent_Value(), this.getEdgeShapeType(), "value", null, 1, 1, EdgeShapeContent.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);

    initEClass(nodeShapeContentEClass, NodeShapeContent.class, "NodeShapeContent", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
    initEReference(getNodeShapeContent_Spells(), theGexfPackage.getSpellsContent(), null, "spells", null, 0, 1, NodeShapeContent.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
    initEAttribute(getNodeShapeContent_End(), theGexfPackage.getTimeType(), "end", null, 0, 1, NodeShapeContent.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
    initEAttribute(getNodeShapeContent_Endopen(), theGexfPackage.getTimeType(), "endopen", null, 0, 1, NodeShapeContent.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
    initEAttribute(getNodeShapeContent_Start(), theGexfPackage.getTimeType(), "start", null, 0, 1, NodeShapeContent.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
    initEAttribute(getNodeShapeContent_Startopen(), theGexfPackage.getTimeType(), "startopen", null, 0, 1, NodeShapeContent.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
    initEAttribute(getNodeShapeContent_Uri(), theXMLTypePackage.getAnyURI(), "uri", null, 0, 1, NodeShapeContent.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
    initEAttribute(getNodeShapeContent_Value(), this.getNodeShapeType(), "value", null, 1, 1, NodeShapeContent.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);

    initEClass(positionContentEClass, PositionContent.class, "PositionContent", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
    initEReference(getPositionContent_Spells(), theGexfPackage.getSpellsContent(), null, "spells", null, 0, 1, PositionContent.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
    initEAttribute(getPositionContent_End(), theGexfPackage.getTimeType(), "end", null, 0, 1, PositionContent.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
    initEAttribute(getPositionContent_Endopen(), theGexfPackage.getTimeType(), "endopen", null, 0, 1, PositionContent.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
    initEAttribute(getPositionContent_Start(), theGexfPackage.getTimeType(), "start", null, 0, 1, PositionContent.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
    initEAttribute(getPositionContent_Startopen(), theGexfPackage.getTimeType(), "startopen", null, 0, 1, PositionContent.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
    initEAttribute(getPositionContent_X(), this.getSpacePoint(), "x", null, 1, 1, PositionContent.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
    initEAttribute(getPositionContent_Y(), this.getSpacePoint(), "y", null, 1, 1, PositionContent.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
    initEAttribute(getPositionContent_Z(), this.getSpacePoint(), "z", null, 1, 1, PositionContent.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);

    initEClass(sizeContentEClass, SizeContent.class, "SizeContent", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
    initEReference(getSizeContent_Spells(), theGexfPackage.getSpellsContent(), null, "spells", null, 0, 1, SizeContent.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
    initEAttribute(getSizeContent_End(), theGexfPackage.getTimeType(), "end", null, 0, 1, SizeContent.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
    initEAttribute(getSizeContent_Endopen(), theGexfPackage.getTimeType(), "endopen", null, 0, 1, SizeContent.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
    initEAttribute(getSizeContent_Start(), theGexfPackage.getTimeType(), "start", null, 0, 1, SizeContent.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
    initEAttribute(getSizeContent_Startopen(), theGexfPackage.getTimeType(), "startopen", null, 0, 1, SizeContent.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
    initEAttribute(getSizeContent_Value(), this.getSizeType(), "value", null, 1, 1, SizeContent.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);

    initEClass(thicknessContentEClass, ThicknessContent.class, "ThicknessContent", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
    initEReference(getThicknessContent_Spells(), theGexfPackage.getSpellsContent(), null, "spells", null, 0, 1, ThicknessContent.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
    initEAttribute(getThicknessContent_End(), theGexfPackage.getTimeType(), "end", null, 0, 1, ThicknessContent.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
    initEAttribute(getThicknessContent_Endopen(), theGexfPackage.getTimeType(), "endopen", null, 0, 1, ThicknessContent.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
    initEAttribute(getThicknessContent_Start(), theGexfPackage.getTimeType(), "start", null, 0, 1, ThicknessContent.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
    initEAttribute(getThicknessContent_Startopen(), theGexfPackage.getTimeType(), "startopen", null, 0, 1, ThicknessContent.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
    initEAttribute(getThicknessContent_Value(), this.getThicknessType(), "value", null, 1, 1, ThicknessContent.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
    ...
    initEReference(getDocumentRoot_Spells(), theGexfPackage.getSpellsContent(), null, "spells", null, 0, -2, null, IS_TRANSIENT, IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, IS_DERIVED, IS_ORDERED);
    ...
    initEDataType(alphaChannelObjectEDataType, Float.class, "AlphaChannelObject", IS_SERIALIZABLE, !IS_GENERATED_INSTANCE_CLASS);
    initEDataType(colorChannelEDataType, BigInteger.class, "ColorChannel", IS_SERIALIZABLE, !IS_GENERATED_INSTANCE_CLASS);
    initEDataType(edgeShapeTypeObjectEDataType, EdgeShapeType.class, "EdgeShapeTypeObject", IS_SERIALIZABLE, IS_GENERATED_INSTANCE_CLASS);
    initEDataType(nodeShapeTypeObjectEDataType, NodeShapeType.class, "NodeShapeTypeObject", IS_SERIALIZABLE, IS_GENERATED_INSTANCE_CLASS);
    initEDataType(sizeTypeEDataType, float.class, "SizeType", IS_SERIALIZABLE, !IS_GENERATED_INSTANCE_CLASS);
    initEDataType(sizeTypeObjectEDataType, Float.class, "SizeTypeObject", IS_SERIALIZABLE, !IS_GENERATED_INSTANCE_CLASS);
    initEDataType(spacePointEDataType, float.class, "SpacePoint", IS_SERIALIZABLE, !IS_GENERATED_INSTANCE_CLASS);
    initEDataType(spacePointObjectEDataType, Float.class, "SpacePointObject", IS_SERIALIZABLE, !IS_GENERATED_INSTANCE_CLASS);
    initEDataType(thicknessTypeEDataType, float.class, "ThicknessType", IS_SERIALIZABLE, !IS_GENERATED_INSTANCE_CLASS);
    initEDataType(thicknessTypeObjectEDataType, Float.class, "ThicknessTypeObject", IS_SERIALIZABLE, !IS_GENERATED_INSTANCE_CLASS);
  ...
  protected void createExtendedMetaDataAnnotations()
  {
    ...
    addAnnotation
      (alphaChannelObjectEDataType, 
       source, 
       new String[] 
       {
       "name", "alpha-channel:Object",
       "baseType", "alpha-channel"
       });		
    addAnnotation
      (colorChannelEDataType, 
       source, 
       new String[] 
       {
       "name", "color-channel",
    ...
    addAnnotation
      (edgeShapeTypeEEnum, 
       ...
       new String[] 
       {
       "name", "edge-shape-type"
       });		
    addAnnotation
      (edgeShapeTypeObjectEDataType, 
       source, 
       new String[] 
       {
       "name", "edge-shape-type:Object",
       "baseType", "edge-shape-type"
       });		
    addAnnotation
      (nodeShapeContentEClass, 
       source, 
       new String[] 
       {
    ...
    addAnnotation
      (nodeShapeTypeEEnum, 
       ...
       new String[] 
       {
       "name", "node-shape-type"
       });		
    addAnnotation
      (nodeShapeTypeObjectEDataType, 
       source, 
       new String[] 
       {
       "name", "node-shape-type:Object",
       "baseType", "node-shape-type"
       });		
    addAnnotation
      (positionContentEClass, 
       source, 
       new String[] 
       {
    ...
    addAnnotation
      (spacePointObjectEDataType, 
       source, 
       new String[] 
       {
       "name", "space-point:Object",
       "baseType", "space-point"
       });		
    addAnnotation
      (thicknessContentEClass, 
       source, 
       new String[] 
       {
    ...
    addAnnotation
      (thicknessTypeObjectEDataType, 
       source, 
       new String[] 
       {
       "name", "thickness-type:Object",
       "baseType", "thickness-type"
       });		
    addAnnotation
      (documentRootEClass, 
       source, 
