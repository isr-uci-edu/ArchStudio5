...
public class VizFactoryImpl extends EFactoryImpl implements VizFactory
{
  ...
  public static VizFactory init()
  {
    try
    {
      VizFactory theVizFactory = (VizFactory)EPackage.Registry.INSTANCE.getEFactory("http://www.gexf.net/1.2draft/viz"); 
  ...
  public EObject create(EClass eClass)
  {
    ...
    {
      case VizPackage.COLOR_CONTENT: return createColorContent();
      case VizPackage.EDGE_SHAPE_CONTENT: return createEdgeShapeContent();
      case VizPackage.NODE_SHAPE_CONTENT: return createNodeShapeContent();
      case VizPackage.POSITION_CONTENT: return createPositionContent();
      case VizPackage.SIZE_CONTENT: return createSizeContent();
      case VizPackage.THICKNESS_CONTENT: return createThicknessContent();
      case VizPackage.DOCUMENT_ROOT: return createDocumentRoot();
      default:
