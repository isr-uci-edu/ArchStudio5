...
public class VizFactoryImpl extends EFactoryImpl implements VizFactory {
  ...
  public static VizFactory init() {
    try {
      VizFactory theVizFactory =
          (VizFactory) EPackage.Registry.INSTANCE.getEFactory(VizPackage.eNS_URI);
  ...
  public BigInteger createColorChannelFromString(EDataType eDataType, String initialValue) {
    return (BigInteger) XMLTypeFactory.eINSTANCE
        .createFromString(XMLTypePackage.Literals.NON_NEGATIVE_INTEGER, initialValue);
  }
  ...
  public String convertColorChannelToString(EDataType eDataType, Object instanceValue) {
    return XMLTypeFactory.eINSTANCE.convertToString(XMLTypePackage.Literals.NON_NEGATIVE_INTEGER,
        instanceValue);
  }
   ...
   * @generated
   */
  public EdgeShapeType createEdgeShapeTypeObjectFromString(EDataType eDataType,
      String initialValue) {
   ...
   * @generated
   */
  public NodeShapeType createNodeShapeTypeObjectFromString(EDataType eDataType,
      String initialValue) {
