...
public class NodeShapeContentImpl extends MinimalEObjectImpl.Container implements NodeShapeContent {
	...
	public void setSpells(SpellsContent newSpells) {
		if (newSpells != spells) {
			...
			eNotify(new ENotificationImpl(this, Notification.SET, VizPackage.NODE_SHAPE_CONTENT__SPELLS, newSpells,
					newSpells));
		}
	}
	...
	public void setEndopen(Object newEndopen) {
		...
		endopen = newEndopen;
		if (eNotificationRequired()) {
			eNotify(new ENotificationImpl(this, Notification.SET, VizPackage.NODE_SHAPE_CONTENT__ENDOPEN, oldEndopen,
					endopen));
		}
	}
	...
	public void setStartopen(Object newStartopen) {
		...
		if (eNotificationRequired()) {
			eNotify(new ENotificationImpl(this, Notification.SET, VizPackage.NODE_SHAPE_CONTENT__STARTOPEN,
	...
	public void unsetValue() {
		...
		valueESet = false;
		if (eNotificationRequired()) {
			eNotify(new ENotificationImpl(this, Notification.UNSET, VizPackage.NODE_SHAPE_CONTENT__VALUE, oldValue,
