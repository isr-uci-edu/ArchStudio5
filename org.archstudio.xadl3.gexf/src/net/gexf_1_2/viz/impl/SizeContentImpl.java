...
/**
 * <!-- begin-user-doc --> An implementation of the model object '<em><b>Size Content</b></em>'.
 * <!-- end-user-doc -->
 * <p>
...
public class SizeContentImpl extends MinimalEObjectImpl.Container implements SizeContent {
    ...
    if (newSpells != spells) {
      ...
      if (spells != null) {
        msgs = ((InternalEObject) spells).eInverseRemove(this,
            EOPPOSITE_FEATURE_BASE - VizPackage.SIZE_CONTENT__SPELLS, null, msgs);
      }
      if (newSpells != null) {
      ...
      eNotify(new ENotificationImpl(this, Notification.SET, VizPackage.SIZE_CONTENT__SPELLS,
          newSpells, newSpells));
    }
  }
  ...
  public void setEnd(Object newEnd) {
    ...
    if (eNotificationRequired()) {
      eNotify(
          new ENotificationImpl(this, Notification.SET, VizPackage.SIZE_CONTENT__END, oldEnd, end));
    }
  }
  ...
  public void setEndopen(Object newEndopen) {
    ...
    endopen = newEndopen;
    if (eNotificationRequired()) {
      eNotify(new ENotificationImpl(this, Notification.SET, VizPackage.SIZE_CONTENT__ENDOPEN,
          oldEndopen, endopen));
    }
  }
  ...
  public void setStart(Object newStart) {
    ...
    start = newStart;
    if (eNotificationRequired()) {
      eNotify(new ENotificationImpl(this, Notification.SET, VizPackage.SIZE_CONTENT__START,
          oldStart, start));
    }
  }
  ...
  public void setStartopen(Object newStartopen) {
    ...
    if (eNotificationRequired()) {
      eNotify(new ENotificationImpl(this, Notification.SET, VizPackage.SIZE_CONTENT__STARTOPEN,
  ...
  public void setValue(float newValue) {
    ...
    valueESet = true;
    if (eNotificationRequired()) {
      eNotify(new ENotificationImpl(this, Notification.SET, VizPackage.SIZE_CONTENT__VALUE,
  ...
  public void unsetValue() {
    ...
    valueESet = false;
    if (eNotificationRequired()) {
      eNotify(new ENotificationImpl(this, Notification.UNSET, VizPackage.SIZE_CONTENT__VALUE,
