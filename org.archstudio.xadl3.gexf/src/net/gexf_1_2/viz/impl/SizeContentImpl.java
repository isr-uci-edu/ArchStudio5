...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>Size Content</b></em>'.
 * <!-- end-user-doc -->
 * <p>
...
public class SizeContentImpl extends EObjectImpl implements SizeContent
{
  ...
  public NotificationChain basicSetSpells(SpellsContent newSpells, NotificationChain msgs)
  {
    ...
    {
      ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, VizPackage.SIZE_CONTENT__SPELLS, oldSpells, newSpells);
  ...
  public void setSpells(SpellsContent newSpells)
  {
    if (newSpells != spells)
    {
      ...
      if (spells != null)
        msgs = ((InternalEObject)spells).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - VizPackage.SIZE_CONTENT__SPELLS, null, msgs);
      if (newSpells != null)
        msgs = ((InternalEObject)newSpells).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - VizPackage.SIZE_CONTENT__SPELLS, null, msgs);
  ...
  public void setStartopen(Object newStartopen)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, VizPackage.SIZE_CONTENT__STARTOPEN, oldStartopen, startopen));
  }
  ...
  public void setValue(float newValue)
  {
    ...
    valueESet = true;
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, VizPackage.SIZE_CONTENT__VALUE, oldValue, value, !oldValueESet));
  }
  ...
  public void unsetValue()
  {
    ...
    valueESet = false;
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.UNSET, VizPackage.SIZE_CONTENT__VALUE, oldValue, VALUE_EDEFAULT, oldValueESet));
  }
