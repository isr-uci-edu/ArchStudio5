...
public class ThicknessContentImpl extends EObjectImpl implements ThicknessContent {
	...
	public void setSpells(SpellsContent newSpells) {
		if (newSpells != spells) {
			...
			eNotify(new ENotificationImpl(this, Notification.SET, VizPackage.THICKNESS_CONTENT__SPELLS, newSpells,
					newSpells));
		}
	}
	...
	public void setEndopen(Object newEndopen) {
		...
		endopen = newEndopen;
		if (eNotificationRequired()) {
			eNotify(new ENotificationImpl(this, Notification.SET, VizPackage.THICKNESS_CONTENT__ENDOPEN, oldEndopen,
					endopen));
		}
	}
	...
	public void setValue(float newValue) {
		...
		valueESet = true;
		if (eNotificationRequired()) {
			eNotify(new ENotificationImpl(this, Notification.SET, VizPackage.THICKNESS_CONTENT__VALUE, oldValue, value,
					!oldValueESet));
		}
	}
	...
	public void unsetValue() {
		...
		valueESet = false;
		if (eNotificationRequired()) {
			eNotify(new ENotificationImpl(this, Notification.UNSET, VizPackage.THICKNESS_CONTENT__VALUE, oldValue,
