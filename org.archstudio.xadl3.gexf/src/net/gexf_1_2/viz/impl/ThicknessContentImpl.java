...
/**
 * <!-- begin-user-doc --> An implementation of the model object '<em><b>Thickness Content</b></em>
 * '. <!-- end-user-doc -->
 * <p>
...
public class ThicknessContentImpl extends MinimalEObjectImpl.Container implements ThicknessContent {
  ...
  public NotificationChain basicSetSpells(SpellsContent newSpells, NotificationChain msgs) {
    ...
    if (eNotificationRequired()) {
      ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
          VizPackage.THICKNESS_CONTENT__SPELLS, oldSpells, newSpells);
      if (msgs == null) {
        msgs = notification;
      } else {
  ...
  public void setSpells(SpellsContent newSpells) {
    if (newSpells != spells) {
      ...
      eNotify(new ENotificationImpl(this, Notification.SET, VizPackage.THICKNESS_CONTENT__SPELLS,
          newSpells, newSpells));
    }
  }
  ...
  public void setEnd(Object newEnd) {
    ...
    if (eNotificationRequired()) {
      eNotify(new ENotificationImpl(this, Notification.SET, VizPackage.THICKNESS_CONTENT__END,
          oldEnd, end));
    }
  }
  ...
  public void setEndopen(Object newEndopen) {
    ...
    endopen = newEndopen;
    if (eNotificationRequired()) {
      eNotify(new ENotificationImpl(this, Notification.SET, VizPackage.THICKNESS_CONTENT__ENDOPEN,
          oldEndopen, endopen));
    }
  }
  ...
  public void setStart(Object newStart) {
    ...
    start = newStart;
    if (eNotificationRequired()) {
      eNotify(new ENotificationImpl(this, Notification.SET, VizPackage.THICKNESS_CONTENT__START,
          oldStart, start));
    }
  }
  ...
  public void setValue(float newValue) {
    ...
    valueESet = true;
    if (eNotificationRequired()) {
      eNotify(new ENotificationImpl(this, Notification.SET, VizPackage.THICKNESS_CONTENT__VALUE,
  ...
  public void unsetValue() {
    ...
    valueESet = false;
    if (eNotificationRequired()) {
      eNotify(new ENotificationImpl(this, Notification.UNSET, VizPackage.THICKNESS_CONTENT__VALUE,
