...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>Edge Shape Content</b></em>'.
 * <!-- end-user-doc -->
 * <p>
...
public class EdgeShapeContentImpl extends EObjectImpl implements EdgeShapeContent
{
  ...
  public NotificationChain basicSetSpells(SpellsContent newSpells, NotificationChain msgs)
  {
    ...
    {
      ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, VizPackage.EDGE_SHAPE_CONTENT__SPELLS, oldSpells, newSpells);
  ...
  public void setSpells(SpellsContent newSpells)
  {
    if (newSpells != spells)
    {
      ...
      if (spells != null)
        msgs = ((InternalEObject)spells).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - VizPackage.EDGE_SHAPE_CONTENT__SPELLS, null, msgs);
      if (newSpells != null)
        msgs = ((InternalEObject)newSpells).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - VizPackage.EDGE_SHAPE_CONTENT__SPELLS, null, msgs);
      msgs = basicSetSpells(newSpells, msgs);
      if (msgs != null) msgs.dispatch();
    }
    else if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, VizPackage.EDGE_SHAPE_CONTENT__SPELLS, newSpells, newSpells));
  }
  ...
  public void setEndopen(Object newEndopen)
  {
    ...
    endopen = newEndopen;
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, VizPackage.EDGE_SHAPE_CONTENT__ENDOPEN, oldEndopen, endopen));
  }
  ...
  public void setStartopen(Object newStartopen)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, VizPackage.EDGE_SHAPE_CONTENT__STARTOPEN, oldStartopen, startopen));
  }
  ...
  public void setValue(EdgeShapeType newValue)
  {
    ...
    valueESet = true;
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, VizPackage.EDGE_SHAPE_CONTENT__VALUE, oldValue, value, !oldValueESet));
  }
  ...
  public void unsetValue()
  {
    ...
    valueESet = false;
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.UNSET, VizPackage.EDGE_SHAPE_CONTENT__VALUE, oldValue, VALUE_EDEFAULT, oldValueESet));
  }
