 ...
 * <li>{@link net.gexf_1_2.viz.impl.DocumentRootImpl#getXMLNSPrefixMap <em>XMLNS Prefix Map</em>}
 * </li>
 * <li>{@link net.gexf_1_2.viz.impl.DocumentRootImpl#getXSISchemaLocation
...
public class DocumentRootImpl extends MinimalEObjectImpl.Container implements DocumentRoot {
  ...
  public EMap<String, String> getXSISchemaLocation() {
    if (xSISchemaLocation == null) {
      xSISchemaLocation = new EcoreEMap<String, String>(
          ...
          this, VizPackage.DOCUMENT_ROOT__XSI_SCHEMA_LOCATION);
    }
  ...
  public NotificationChain basicSetSpells(SpellsContent newSpells, NotificationChain msgs) {
    return ((FeatureMap.Internal) getMixed()).basicAdd(VizPackage.Literals.DOCUMENT_ROOT__SPELLS,
        newSpells, msgs);
  }
