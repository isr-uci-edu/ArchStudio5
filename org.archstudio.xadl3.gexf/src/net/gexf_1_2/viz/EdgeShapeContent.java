...
/**
 * <!-- begin-user-doc -->
 * A representation of the model object '<em><b>Edge Shape Content</b></em>'.
 * <!-- end-user-doc -->
 *
 * <p>
...
public interface EdgeShapeContent extends EObject
{
  ...
  /**
   * Sets the value of the '{@link net.gexf_1_2.viz.EdgeShapeContent#getSpells <em>Spells</em>}' containment reference.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
  ...
  /**
   * Sets the value of the '{@link net.gexf_1_2.viz.EdgeShapeContent#getEnd <em>End</em>}' attribute.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
  ...
  /**
   * Sets the value of the '{@link net.gexf_1_2.viz.EdgeShapeContent#getEndopen <em>Endopen</em>}' attribute.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
  ...
  /**
   * Sets the value of the '{@link net.gexf_1_2.viz.EdgeShapeContent#getStart <em>Start</em>}' attribute.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
  ...
  /**
   * Sets the value of the '{@link net.gexf_1_2.viz.EdgeShapeContent#getStartopen <em>Startopen</em>}' attribute.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   ...
   * The literals are from the enumeration {@link net.gexf_1_2.viz.EdgeShapeType}.
   * <!-- begin-user-doc -->
   * <p>
  ...
  /**
   * Sets the value of the '{@link net.gexf_1_2.viz.EdgeShapeContent#getValue <em>Value</em>}' attribute.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
  ...
  /**
   * Unsets the value of the '{@link net.gexf_1_2.viz.EdgeShapeContent#getValue <em>Value</em>}' attribute.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * @see #isSetValue()
   * @see #getValue()
  ...
  /**
   * Returns whether the value of the '{@link net.gexf_1_2.viz.EdgeShapeContent#getValue <em>Value</em>}' attribute is set.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
