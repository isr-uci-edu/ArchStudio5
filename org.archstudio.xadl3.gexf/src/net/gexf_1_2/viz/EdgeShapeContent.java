...
/**
 * <!-- begin-user-doc --> A representation of the model object '<em><b>Edge Shape Content</b></em>
 * '. <!-- end-user-doc -->
 *
 * <p>
 ...
 * <li>{@link net.gexf_1_2.viz.EdgeShapeContent#getStartopen <em>Startopen</em>}</li>
...
public interface EdgeShapeContent extends EObject {
  ...
  /**
   * Sets the value of the '{@link net.gexf_1_2.viz.EdgeShapeContent#getSpells <em>Spells</em>}'
  ...
  /**
   * Sets the value of the '{@link net.gexf_1_2.viz.EdgeShapeContent#getEnd <em>End</em>}'
  ...
  /**
   * Sets the value of the '{@link net.gexf_1_2.viz.EdgeShapeContent#getEndopen <em>Endopen</em>}'
   * attribute. <!-- begin-user-doc --> <!-- end-user-doc -->
   * 
  ...
  /**
   * Sets the value of the '{@link net.gexf_1_2.viz.EdgeShapeContent#getStart <em>Start</em>}'
   * attribute. <!-- begin-user-doc --> <!-- end-user-doc -->
   * 
  ...
  /**
   * Sets the value of the '{@link net.gexf_1_2.viz.EdgeShapeContent#getStartopen <em>Startopen</em>
   * }' attribute. <!-- begin-user-doc --> <!-- end-user-doc -->
   * 
   ...
   * enumeration {@link net.gexf_1_2.viz.EdgeShapeType}. <!-- begin-user-doc -->
   * <p>
  ...
  /**
   * Sets the value of the '{@link net.gexf_1_2.viz.EdgeShapeContent#getValue <em>Value</em>}'
   * attribute. <!-- begin-user-doc --> <!-- end-user-doc -->
   * 
  ...
  /**
   * Unsets the value of the '{@link net.gexf_1_2.viz.EdgeShapeContent#getValue <em>Value</em>}'
   * attribute. <!-- begin-user-doc --> <!-- end-user-doc -->
   * 
   * @see #isSetValue()
   * @see #getValue()
  ...
  /**
   * Returns whether the value of the '{@link net.gexf_1_2.viz.EdgeShapeContent#getValue
