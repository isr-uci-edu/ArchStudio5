...
public class Prolog_3_0PackageImpl extends EPackageImpl implements Prolog_3_0Package {
   ...
   * 
   * <p>
   * This method is used to initialize {@link Prolog_3_0Package#eINSTANCE} when that field is
  ...
  public static Prolog_3_0Package init() {
    ...
    Prolog_3_0PackageImpl theProlog_3_0Package = (Prolog_3_0PackageImpl) (EPackage.Registry.INSTANCE
        .get(eNS_URI) instanceof Prolog_3_0PackageImpl ? EPackage.Registry.INSTANCE.get(eNS_URI)
            : new Prolog_3_0PackageImpl());
  ...
  public void initializePackageContents() {
    ...
    initEClass(prologExtensionEClass, PrologExtension.class, "PrologExtension", !IS_ABSTRACT,
        !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
    initEReference(getPrologExtension_Statement(), this.getStatement(), null, "statement", null, 0,
        -1, PrologExtension.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE,
        !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);

    initEClass(statementEClass, Statement.class, "Statement", !IS_ABSTRACT, !IS_INTERFACE,
        IS_GENERATED_INSTANCE_CLASS);
    initEAttribute(getStatement_Value(), theXMLTypePackage.getString(), "value", null, 0, 1,
  ...
  protected void createExtendedMetaDataAnnotations() {
    ...
    addAnnotation(prologExtensionEClass, source,
        new String[] {"name", "PrologExtension", "kind", "elementOnly"});
