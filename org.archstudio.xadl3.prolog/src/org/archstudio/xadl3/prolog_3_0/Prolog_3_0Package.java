...
public interface Prolog_3_0Package extends EPackage {
  ...
  /**
   * The number of operations of the '<em>Prolog Extension</em>' class. <!-- begin-user-doc --> <!--
   * end-user-doc -->
   * 
   * @generated
   * @ordered
  ...
  /**
   * The meta object id for the '{@link org.archstudio.xadl3.prolog_3_0.impl.StatementImpl
  ...
  /**
   * The number of operations of the '<em>Statement</em>' class. <!-- begin-user-doc --> <!--
   * end-user-doc -->
   * 
   * @generated
   * @ordered
   ...
   * {@link org.archstudio.xadl3.prolog_3_0.PrologExtension#getStatement <em>Statement</em>}'. <!--
   * begin-user-doc --> <!-- end-user-doc -->
   * 
  ...
  /**
   * Returns the meta object for class '{@link org.archstudio.xadl3.prolog_3_0.Statement
   ...
   * {@link org.archstudio.xadl3.prolog_3_0.Statement#getValue <em>Value</em>}'. <!-- begin-user-doc
   * --> <!-- end-user-doc -->
   * 
  ...
  interface Literals {
     ...
     * {@link org.archstudio.xadl3.prolog_3_0.impl.PrologExtensionImpl <em>Prolog Extension</em>}'
    ...
    /**
     * The meta object literal for the '<em><b>Statement</b></em>' containment reference list
