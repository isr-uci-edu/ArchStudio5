 ...
 * @generated
 */
public class Prolog_3_0AdapterFactory extends AdapterFactoryImpl {
  /**
   * The cached model package. <!-- begin-user-doc --> <!-- end-user-doc -->
   * 
   * @generated
   */
  protected static Prolog_3_0Package modelPackage;
   ...
   * @generated
   */
  public Prolog_3_0AdapterFactory() {
    if (modelPackage == null) {
      modelPackage = Prolog_3_0Package.eINSTANCE;
    }
  }
   ...
   * @generated
   */
  protected Prolog_3_0Switch<Adapter> modelSwitch = new Prolog_3_0Switch<Adapter>() {
    @Override
    public Adapter casePrologExtension(PrologExtension object) {
      return createPrologExtensionAdapter();
    }
   ...
   * {@link org.archstudio.xadl3.prolog_3_0.PrologExtension <em>Prolog Extension</em>}'. <!--
   ...
   * @generated
   */
  public Adapter createPrologExtensionAdapter() {
    return null;
  }

  /**
   * Creates a new adapter for an object of class '{@link org.archstudio.xadl3.prolog_3_0.Statement
   * <em>Statement</em>}'. <!-- begin-user-doc --> This default implementation returns null so that
