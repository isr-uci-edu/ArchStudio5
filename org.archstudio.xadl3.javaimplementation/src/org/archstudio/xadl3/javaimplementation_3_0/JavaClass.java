 ...
 * <ul>
 *   <li>{@link org.archstudio.xadl3.javaimplementation_3_0.JavaClass#getClassPathEntry <em>Class Path Entry</em>}</li>
 *   <li>{@link org.archstudio.xadl3.javaimplementation_3_0.JavaClass#getInitializationParameter <em>Initialization Parameter</em>}</li>
 *   <li>{@link org.archstudio.xadl3.javaimplementation_3_0.JavaClass#getExt <em>Ext</em>}</li>
 *   <li>{@link org.archstudio.xadl3.javaimplementation_3_0.JavaClass#getClassName <em>Class Name</em>}</li>
...
{
  /**
   * Returns the value of the '<em><b>Class Path Entry</b></em>' containment reference list.
   * The list contents are of type {@link org.archstudio.xadl3.javaimplementation_3_0.ClassPathEntry}.
   * <!-- begin-user-doc -->
   * <p>
   * If the meaning of the '<em>Class Path Entry</em>' containment reference list isn't clear,
  ...
  /**
   * Returns the value of the '<em><b>Initialization Parameter</b></em>' containment reference list.
   * The list contents are of type {@link org.archstudio.xadl3.javaimplementation_3_0.InitializationParameter}.
   * <!-- begin-user-doc -->
   * <p>
   * If the meaning of the '<em>Initialization Parameter</em>' containment reference list isn't clear,
   * there really should be more of a description here...
   * </p>
   * <!-- end-user-doc -->
   * @return the value of the '<em>Initialization Parameter</em>' containment reference list.
   * @see org.archstudio.xadl3.javaimplementation_3_0.Javaimplementation_3_0Package#getJavaClass_InitializationParameter()
   * @model containment="true"
   *        extendedMetaData="kind='element' name='initializationParameter' namespace='##targetNamespace'"
   * @generated
   */
  ...
  /**
   * Sets the value of the '{@link org.archstudio.xadl3.javaimplementation_3_0.JavaClass#getClassName <em>Class Name</em>}' attribute.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
  ...
  /**
   * Sets the value of the '{@link org.archstudio.xadl3.javaimplementation_3_0.JavaClass#getId <em>Id</em>}' attribute.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
