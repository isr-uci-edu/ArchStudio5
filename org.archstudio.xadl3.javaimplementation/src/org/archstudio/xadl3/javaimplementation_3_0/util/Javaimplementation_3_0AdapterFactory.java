...
public class Javaimplementation_3_0AdapterFactory extends AdapterFactoryImpl
{
   ...
   * @generated
   */
  protected Javaimplementation_3_0Switch<Adapter> modelSwitch =
    new Javaimplementation_3_0Switch<Adapter>()
    {
      @Override
  ...
  /**
   * Creates a new adapter for an object of class '{@link org.archstudio.xadl3.javaimplementation_3_0.ClassPathEntry <em>Class Path Entry</em>}'.
   * <!-- begin-user-doc -->
  ...
  /**
   * Creates a new adapter for an object of class '{@link org.archstudio.xadl3.javaimplementation_3_0.InitializationParameter <em>Initialization Parameter</em>}'.
   * <!-- begin-user-doc -->
   * This default implementation returns null so that we can easily ignore cases;
   * it's useful to ignore a case when inheritance will catch all the cases anyway.
   * <!-- end-user-doc -->
  ...
  /**
   * Creates a new adapter for an object of class '{@link org.archstudio.xadl3.javaimplementation_3_0.JavaClass <em>Java Class</em>}'.
   * <!-- begin-user-doc -->
   * This default implementation returns null so that we can easily ignore cases;
   * it's useful to ignore a case when inheritance will catch all the cases anyway.
   * <!-- end-user-doc -->
  ...
  /**
   * Creates a new adapter for an object of class '{@link org.archstudio.xadl3.javaimplementation_3_0.JavaImplementation <em>Java Implementation</em>}'.
   * <!-- begin-user-doc -->
   * This default implementation returns null so that we can easily ignore cases;
   * it's useful to ignore a case when inheritance will catch all the cases anyway.
   * <!-- end-user-doc -->
