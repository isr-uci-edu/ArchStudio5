...
public class Javaimplementation_3_0FactoryImpl extends EFactoryImpl implements Javaimplementation_3_0Factory
{
  ...
  public static Javaimplementation_3_0Factory init()
  {
    try
    {
      Javaimplementation_3_0Factory theJavaimplementation_3_0Factory = (Javaimplementation_3_0Factory)EPackage.Registry.INSTANCE.getEFactory("http://www.archstudio.org/xadl3/schemas/javaimplementation-3.0.xsd"); 
  ...
  public EObject create(EClass eClass)
  {
    ...
    {
      case Javaimplementation_3_0Package.CLASS_PATH_ENTRY: return createClassPathEntry();
      case Javaimplementation_3_0Package.INITIALIZATION_PARAMETER: return createInitializationParameter();
      case Javaimplementation_3_0Package.JAVA_CLASS: return createJavaClass();
      case Javaimplementation_3_0Package.JAVA_IMPLEMENTATION: return createJavaImplementation();
      default:
