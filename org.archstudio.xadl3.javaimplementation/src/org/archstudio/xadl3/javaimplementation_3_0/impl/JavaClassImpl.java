 ...
 * <ul>
 *   <li>{@link org.archstudio.xadl3.javaimplementation_3_0.impl.JavaClassImpl#getClassPathEntry <em>Class Path Entry</em>}</li>
 *   <li>{@link org.archstudio.xadl3.javaimplementation_3_0.impl.JavaClassImpl#getInitializationParameter <em>Initialization Parameter</em>}</li>
...
public class JavaClassImpl extends EObjectImpl implements JavaClass
{
  ...
  /**
   * The cached value of the '{@link #getInitializationParameter() <em>Initialization Parameter</em>}' containment reference list.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
  ...
  public EList<ClassPathEntry> getClassPathEntry()
  {
    ...
    {
      classPathEntry = new EObjectContainmentEList<ClassPathEntry>(ClassPathEntry.class, this, Javaimplementation_3_0Package.JAVA_CLASS__CLASS_PATH_ENTRY);
    }
  ...
  public EList<InitializationParameter> getInitializationParameter()
  {
    ...
    {
      initializationParameter = new EObjectContainmentEList<InitializationParameter>(InitializationParameter.class, this, Javaimplementation_3_0Package.JAVA_CLASS__INITIALIZATION_PARAMETER);
    }
  ...
  public EList<Extension> getExt()
  {
    if (ext == null)
    {
      ext = new EObjectContainmentEList<Extension>(Extension.class, this, Javaimplementation_3_0Package.JAVA_CLASS__EXT);
    }
    return ext;
  }
  ...
  public void setClassName(String newClassName)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, Javaimplementation_3_0Package.JAVA_CLASS__CLASS_NAME, oldClassName, className));
  }
  ...
  public void setId(String newId)
  {
    ...
    id = newId;
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, Javaimplementation_3_0Package.JAVA_CLASS__ID, oldId, id));
  }
  ...
  public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs)
  {
    switch (featureID)
    {
      ...
      case Javaimplementation_3_0Package.JAVA_CLASS__INITIALIZATION_PARAMETER:
