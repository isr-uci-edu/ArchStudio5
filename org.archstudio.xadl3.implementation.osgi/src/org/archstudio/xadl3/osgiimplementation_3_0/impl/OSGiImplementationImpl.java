...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>OS Gi Implementation</b></em>'.
 * <!-- end-user-doc -->
 * <p>
...
public class OSGiImplementationImpl extends ImplementationImpl implements OSGiImplementation
{
  ...
  public EList<Extension> getExt()
  {
    if (ext == null)
    {
      ext = new EObjectContainmentEList<Extension>(Extension.class, this, Osgiimplementation_3_0Package.OS_GI_IMPLEMENTATION__EXT);
    }
    return ext;
  }
  ...
  public void setBundle(String newBundle)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, Osgiimplementation_3_0Package.OS_GI_IMPLEMENTATION__BUNDLE, oldBundle, bundle));
  }
