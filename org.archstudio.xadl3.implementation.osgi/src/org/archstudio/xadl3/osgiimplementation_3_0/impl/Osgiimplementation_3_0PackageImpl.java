 ...
 * @generated
 */
public class Osgiimplementation_3_0PackageImpl extends EPackageImpl
   ...
   * 
   * <p>
   * This method is used to initialize {@link Osgiimplementation_3_0Package#eINSTANCE} when that
  ...
  public static Osgiimplementation_3_0Package init() {
    if (isInited) {
      return (Osgiimplementation_3_0Package) EPackage.Registry.INSTANCE
          .getEPackage(Osgiimplementation_3_0Package.eNS_URI);
    }
    ...
    EPackage.Registry.INSTANCE.put(Osgiimplementation_3_0Package.eNS_URI,
        theOsgiimplementation_3_0Package);
  ...
  public void initializePackageContents() {
    ...
    initEClass(osGiImplementationEClass, OSGiImplementation.class, "OSGiImplementation",
        !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
    initEReference(getOSGiImplementation_Ext(), theXadlcore_3_0Package.getExtension(), null, "ext",
        null, 0, -1, OSGiImplementation.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE,
        IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
    initEAttribute(getOSGiImplementation_Bundle(), theXMLTypePackage.getString(), "bundle", null, 0,
        1, OSGiImplementation.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE,
