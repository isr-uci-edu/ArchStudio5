...
public interface Osgiimplementation_3_0Package extends EPackage {
   ...
   * @generated
   */
  Osgiimplementation_3_0Package eINSTANCE =
      org.archstudio.xadl3.osgiimplementation_3_0.impl.Osgiimplementation_3_0PackageImpl.init();
  ...
  /**
   * The number of structural features of the '<em>OS Gi Implementation</em>' class. <!--
   * begin-user-doc --> <!-- end-user-doc -->
   * 
   * @generated
   * @ordered
   */
  int OS_GI_IMPLEMENTATION_FEATURE_COUNT =
      Implementation_3_0Package.IMPLEMENTATION_FEATURE_COUNT + 2;

  /**
   * The number of operations of the '<em>OS Gi Implementation</em>' class. <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * 
   * @generated
   * @ordered
   */
  int OS_GI_IMPLEMENTATION_OPERATION_COUNT =
   ...
   * {@link org.archstudio.xadl3.osgiimplementation_3_0.OSGiImplementation#getExt <em>Ext</em>}'.
   * <!-- begin-user-doc --> <!-- end-user-doc -->
   * 
