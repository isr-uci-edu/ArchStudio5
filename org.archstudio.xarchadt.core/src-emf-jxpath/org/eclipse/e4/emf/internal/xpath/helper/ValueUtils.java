...
public class ValueUtils {
	...
	/**
	 * If the parameter is a container, opens the container and return the
	 * contents. The method is recursive.
	 * 
	 * @param object
	 *            to read
	 * @return Object
	...
	/**
	 * Returns the length of the supplied collection. If the supplied object is
	 * not a collection, returns 1. If collection is null, returns 0.
	 * 
	 * @param collection
	 *            to check
	 * @return int
