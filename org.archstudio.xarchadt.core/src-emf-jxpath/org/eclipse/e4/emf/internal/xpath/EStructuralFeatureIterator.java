...
/**
 * Iterates property values of an object pointed at with a {@link EStructuralFeatureOwnerPointer}. Examples of such
 * objects are JavaBeans and objects with Dynamic Properties.
 */
public class EStructuralFeatureIterator implements NodeIterator {
	...
	public EStructuralFeatureIterator(EStructuralFeatureOwnerPointer pointer, String name, boolean reverse,
		...
		if (startWith != null) {
			...
			if (startWith == null) {
				throw new JXPathException("PropertyIerator startWith parameter is "
	...
	public NodePointer getNodePointer() {
		...
		try {
			...
			ex.printStackTrace();
			NullEStructuralFeaturePointer npp = new NullEStructuralFeaturePointer(
