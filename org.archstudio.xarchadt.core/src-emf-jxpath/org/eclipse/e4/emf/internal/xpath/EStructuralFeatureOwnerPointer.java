...
public abstract class EStructuralFeatureOwnerPointer extends NodePointer {
	...
	public NodeIterator childIterator(NodeTest test, boolean reverse, NodePointer startWith) {
		...
		return test instanceof NodeTypeTest && ((NodeTypeTest) test).getNodeType() == Compiler.NODE_TYPE_NODE ? createNodeIterator(
				null, reverse, startWith) : null;
	}
		...
		if (parent != null) {
			if (parent.isContainer()) {
				...
				if (index == WHOLE_COLLECTION) {
					throw new UnsupportedOperationException("Cannot setValue of an object that is not "
	...
	public void remove() {
		...
		if (parent != null) {
			...
			throw new UnsupportedOperationException("Cannot remove an object that is not "
