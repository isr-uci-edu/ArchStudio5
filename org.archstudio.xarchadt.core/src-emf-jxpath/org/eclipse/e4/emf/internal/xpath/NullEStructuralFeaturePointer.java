...
public class NullEStructuralFeaturePointer extends EStructuralFeaturePointer {
	...
	public void setValue(Object value) {
		...
		if (parent instanceof EStructuralFeatureOwnerPointer
			...
			throw new JXPathInvalidAccessException("Cannot set property " + asPath()
	...
	/**
	 * Create a "bad factory" JXPathAbstractFactoryException for the specified
	 * AbstractFactory.
	 * 
	 * @param factory
	 *            AbstractFactory
	...
	private JXPathAbstractFactoryException createBadFactoryException(AbstractFactory factory) {
		return new JXPathAbstractFactoryException("Factory " + factory + " reported success creating object for path: "
				+ asPath() + " but object was null.  Terminating to avoid stack recursion.");
	}
}
