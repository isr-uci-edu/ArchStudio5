...
/**
 * An iterator of attributes of a JavaBean. Returns bean properties as well as
...
public class EObjectAttributeIterator extends EStructuralFeatureIterator {
	...
	public EObjectAttributeIterator(EStructuralFeatureOwnerPointer parent, QName name) {
		super(parent, name.getPrefix() == null && (name.getName() == null || name.getName().equals("*")) ? null : name
				.toString(), false, null);
		this.parent = parent;
