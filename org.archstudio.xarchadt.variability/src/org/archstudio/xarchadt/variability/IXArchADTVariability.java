...
public interface IXArchADTVariability extends IXArchADT {
	...
	public enum ChangeStatus {
		...
		/**
		 * Indicates that the objRef is added by an explicit change set, but
		 * would normally not be present in the model because it was also
		 * removed elsewhere.
		 */
		...
		/**
		 * Indicates that the objRef is modified by an explicit change set, but
		 * would normally not be present in the model because it was also
		 * removed elsewhere.
		 */
		...
		/**
		 * Indicates that the objRef is removed by an explicit change set, but
		 * it is not removed by the applied change sets
		 */
		...
		/**
		 * Indicates whether the objRef would be part of a normal model (i.e.,
		 * when not in overview mode and without any explicit change sets)
		 */
