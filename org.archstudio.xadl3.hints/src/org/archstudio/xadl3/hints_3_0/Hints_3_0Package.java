 ...
 * xADL 3 Hints Schema
 * 
 * This schema defines the concept of rendering hints that can be applied to different objects to
 * permit them to be hinted.
 * 
...
public interface Hints_3_0Package extends EPackage {
  ...
  /**
   * The meta object id for the '{@link org.archstudio.xadl3.hints_3_0.impl.HintImpl <em>Hint</em>}'
  ...
  /**
   * The number of structural features of the '<em>Hint</em>' class. <!-- begin-user-doc --> <!--
   * end-user-doc -->
   * 
   * @generated
   * @ordered
  ...
  /**
   * The number of operations of the '<em>Hint</em>' class. <!-- begin-user-doc --> <!--
   * end-user-doc -->
   * 
   * @generated
   * @ordered
  ...
  /**
   * The number of operations of the '<em>Hints Extension</em>' class. <!-- begin-user-doc --> <!--
   * end-user-doc -->
   * 
   * @generated
   * @ordered
  ...
  /**
   * The meta object id for the '{@link org.archstudio.xadl3.hints_3_0.impl.ValueImpl <em>Value</em>
   * }' class. <!-- begin-user-doc --> <!-- end-user-doc -->
   * 
  ...
  /**
   * The number of structural features of the '<em>Value</em>' class. <!-- begin-user-doc --> <!--
   * end-user-doc -->
   * 
   * @generated
   * @ordered
  ...
  /**
   * The number of operations of the '<em>Value</em>' class. <!-- begin-user-doc --> <!--
   * end-user-doc -->
   * 
   * @generated
   * @ordered
   ...
   * {@link org.archstudio.xadl3.hints_3_0.Hint#getValue <em>Value</em>}'. <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * 
  ...
  /**
   * Returns the meta object for the attribute '{@link org.archstudio.xadl3.hints_3_0.Hint#getHint
  ...
  /**
   * Returns the meta object for the attribute '{@link org.archstudio.xadl3.hints_3_0.Hint#getName
  ...
  /**
   * Returns the meta object for class '{@link org.archstudio.xadl3.hints_3_0.HintsExtension
   ...
   * {@link org.archstudio.xadl3.hints_3_0.HintsExtension#getHint <em>Hint</em>}'. <!--
   * begin-user-doc --> <!-- end-user-doc -->
   * 
  ...
  /**
   * Returns the meta object for the containment reference list '
   * {@link org.archstudio.xadl3.hints_3_0.Value#getValue <em>Value</em>}'. <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * 
  ...
  /**
   * Returns the meta object for the attribute '{@link org.archstudio.xadl3.hints_3_0.Value#getData
  ...
  /**
   * Returns the meta object for the attribute '{@link org.archstudio.xadl3.hints_3_0.Value#getType
  ...
  interface Literals {
    /**
     * The meta object literal for the '{@link org.archstudio.xadl3.hints_3_0.impl.HintImpl
     * <em>Hint</em>}' class. <!-- begin-user-doc --> <!-- end-user-doc -->
     * 
     * @see org.archstudio.xadl3.hints_3_0.impl.HintImpl
     * @see org.archstudio.xadl3.hints_3_0.impl.Hints_3_0PackageImpl#getHint()
     * @generated
     ...
     * {@link org.archstudio.xadl3.hints_3_0.impl.HintsExtensionImpl <em>Hints Extension</em>}'
     * class. <!-- begin-user-doc --> <!-- end-user-doc -->
     * 
     * @see org.archstudio.xadl3.hints_3_0.impl.HintsExtensionImpl
     * @see org.archstudio.xadl3.hints_3_0.impl.Hints_3_0PackageImpl#getHintsExtension()
    ...
    /**
     * The meta object literal for the '{@link org.archstudio.xadl3.hints_3_0.impl.ValueImpl
