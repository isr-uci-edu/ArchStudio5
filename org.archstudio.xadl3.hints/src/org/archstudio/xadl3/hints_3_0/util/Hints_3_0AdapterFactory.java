...
public class Hints_3_0AdapterFactory extends AdapterFactoryImpl {
  ...
  /**
   * Creates a new adapter for an object of class '{@link org.archstudio.xadl3.hints_3_0.Hint
   * <em>Hint</em>}'. <!-- begin-user-doc --> This default implementation returns null so that we
   ...
   * {@link org.archstudio.xadl3.hints_3_0.HintsExtension <em>Hints Extension</em>}'. <!--
  ...
  /**
   * Creates a new adapter for an object of class '{@link org.archstudio.xadl3.hints_3_0.Value
   * <em>Value</em>}'. <!-- begin-user-doc --> This default implementation returns null so that we
   * can easily ignore cases; it's useful to ignore a case when inheritance will catch all the cases
   * anyway. <!-- end-user-doc -->
   * 
   * @return the new adapter.
