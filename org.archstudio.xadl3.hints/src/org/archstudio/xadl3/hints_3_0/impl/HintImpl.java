...
/**
 * <!-- begin-user-doc --> An implementation of the model object '<em><b>Hint</b></em>'. <!--
 * end-user-doc -->
 * <p>
...
public class HintImpl extends MinimalEObjectImpl.Container implements Hint {
  ...
  /**
   * The default value of the '{@link #getHint() <em>Hint</em>}' attribute. <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * 
   * @see #getHint()
   * @generated
  ...
  /**
   * The cached value of the '{@link #getHint() <em>Hint</em>}' attribute. <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * 
   * @see #getHint()
   * @generated
  ...
  public void setValue(Value newValue) {
    if (newValue != value) {
      ...
      eNotify(new ENotificationImpl(this, Notification.SET, Hints_3_0Package.HINT__VALUE, newValue,
          newValue));
    }
  }
  ...
  public void setHint(String newHint) {
    ...
    hint = newHint;
    if (eNotificationRequired()) {
      eNotify(new ENotificationImpl(this, Notification.SET, Hints_3_0Package.HINT__HINT, oldHint,
          hint));
    }
  }
  ...
  public void setName(String newName) {
    ...
    name = newName;
    if (eNotificationRequired()) {
      eNotify(new ENotificationImpl(this, Notification.SET, Hints_3_0Package.HINT__NAME, oldName,
          name));
    }
  }
