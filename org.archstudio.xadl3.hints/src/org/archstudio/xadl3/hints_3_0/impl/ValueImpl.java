...
public class ValueImpl extends MinimalEObjectImpl.Container implements Value {
  ...
  /**
   * The cached value of the '{@link #getData() <em>Data</em>}' attribute. <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * 
   * @see #getData()
   * @generated
  ...
  public void setData(String newData) {
    ...
    if (eNotificationRequired()) {
      eNotify(new ENotificationImpl(this, Notification.SET, Hints_3_0Package.VALUE__DATA, oldData,
          data));
    }
  }
  ...
  public void setType(String newType) {
    ...
    type = newType;
    if (eNotificationRequired()) {
      eNotify(new ENotificationImpl(this, Notification.SET, Hints_3_0Package.VALUE__TYPE, oldType,
          type));
    }
  }
