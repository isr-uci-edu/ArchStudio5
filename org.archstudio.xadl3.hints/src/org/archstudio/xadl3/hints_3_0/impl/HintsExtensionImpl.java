...
/**
 * <!-- begin-user-doc --> An implementation of the model object '<em><b>Hints Extension</b></em>'.
 * <!-- end-user-doc -->
 * <p>
...
public class HintsExtensionImpl extends ExtensionImpl implements HintsExtension {
  ...
  public EList<Hint> getHint() {
    if (hint == null) {
      hint = new EObjectContainmentEList<Hint>(Hint.class, this,
          Hints_3_0Package.HINTS_EXTENSION__HINT);
    }
    return hint;
  }
