...
public class Hints_3_0PackageImpl extends EPackageImpl implements Hints_3_0Package {
   ...
   * 
   * <p>
   * This method is used to initialize {@link Hints_3_0Package#eINSTANCE} when that field is
  ...
  public static Hints_3_0Package init() {
    ...
    Hints_3_0PackageImpl theHints_3_0Package = (Hints_3_0PackageImpl) (EPackage.Registry.INSTANCE
        .get(eNS_URI) instanceof Hints_3_0PackageImpl ? EPackage.Registry.INSTANCE.get(eNS_URI)
            : new Hints_3_0PackageImpl());
  ...
  public void initializePackageContents() {
    ...
    initEClass(hintEClass, Hint.class, "Hint", !IS_ABSTRACT, !IS_INTERFACE,
        IS_GENERATED_INSTANCE_CLASS);
    initEReference(getHint_Value(), this.getValue(), null, "value", null, 1, 1, Hint.class,
        !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES,
        !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
    initEAttribute(getHint_Hint(), theXMLTypePackage.getString(), "hint", null, 0, 1, Hint.class,
        !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED,
        IS_ORDERED);
    initEAttribute(getHint_Name(), theXMLTypePackage.getString(), "name", null, 0, 1, Hint.class,
        !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED,
        IS_ORDERED);

    initEClass(hintsExtensionEClass, HintsExtension.class, "HintsExtension", !IS_ABSTRACT,
        !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
    initEReference(getHintsExtension_Hint(), this.getHint(), null, "hint", null, 0, -1,
        HintsExtension.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE,
        !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);

    initEClass(valueEClass, Value.class, "Value", !IS_ABSTRACT, !IS_INTERFACE,
        IS_GENERATED_INSTANCE_CLASS);
    initEReference(getValue_Value(), this.getValue(), null, "value", null, 0, -1, Value.class,
        !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES,
        !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
    initEAttribute(getValue_Data(), theXMLTypePackage.getString(), "data", null, 0, 1, Value.class,
        !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED,
        IS_ORDERED);
    initEAttribute(getValue_Type(), theXMLTypePackage.getString(), "type", null, 0, 1, Value.class,
        !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED,
        IS_ORDERED);
  ...
  protected void createExtendedMetaDataAnnotations() {
    ...
    addAnnotation(hintsExtensionEClass, source,
        new String[] {"name", "HintsExtension", "kind", "elementOnly"});
