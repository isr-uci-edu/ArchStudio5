...
/* NOTE: This class probably isn't useful in Eclipse using the
 * default ObjectInputStream, but extended ObjectInputStreams
 * that can use alternate classloaders would work.  If
 * using this class, find one of those objectinputstreamloader
 * classes under license, and use that instead.
 */
