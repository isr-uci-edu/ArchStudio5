...
public class ColorSelectorDialog extends Dialog{
	...
	*/
	...
	private static void setupSchemeButtons(Display d, Button[] buttons, ColorScheme colorScheme, ColorRegistry colorRegistry, ImageRegistry imageRegistry){
	...
	private static void setupHexButton(Display d, Button b, RGB rgb, ColorRegistry colorRegistry, ImageRegistry imageRegistry){
		String symbolicName = Integer.toHexString(rgb.red) + Integer.toHexString(rgb.green) + Integer.toHexString(rgb.blue);
		Color color = colorRegistry.get(symbolicName);
		if(color == null){
