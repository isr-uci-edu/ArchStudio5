 ...
 * 
 * Links are intended to have very limited semantics: they simply indicate an association between
 * two endpoints. If the connection needs to have deeper semantics, consider interposing a connector
 * between the endpoints, since connectors are intended to be semantically-rich elements.
 * 
 * <!-- end-model-doc -->
 *
 * <p>
 ...
 * </p>
 * <ul>
 * <li>{@link org.archstudio.xadl3.structure_3_0.Link#getPoint1 <em>Point1</em>}</li>
 * <li>{@link org.archstudio.xadl3.structure_3_0.Link#getPoint2 <em>Point2</em>}</li>
...
public interface Link extends EObject {
  ...
  /**
   * Sets the value of the '{@link org.archstudio.xadl3.structure_3_0.Link#getPoint1 <em>Point1</em>
   ...
   * <p>
   * If the meaning of the '<em>Point2</em>' reference isn't clear, there really should be more of a
   * description here...
   * </p>
   * <!-- end-user-doc -->
   * 
  ...
  /**
   * Sets the value of the '{@link org.archstudio.xadl3.structure_3_0.Link#getPoint2 <em>Point2</em>
   * }' reference. <!-- begin-user-doc --> <!-- end-user-doc -->
   * 
  ...
  /**
   * Sets the value of the '{@link org.archstudio.xadl3.structure_3_0.Link#getId <em>Id</em>}'
  ...
  /**
   * Sets the value of the '{@link org.archstudio.xadl3.structure_3_0.Link#getName <em>Name</em>}'
   * attribute. <!-- begin-user-doc --> <!-- end-user-doc -->
   * 
