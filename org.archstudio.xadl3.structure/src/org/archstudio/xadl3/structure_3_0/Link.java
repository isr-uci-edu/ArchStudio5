 ...
 * begin-model-doc --> A Link is an architectural construct that connects two elements. It connects two interfaces.
 * Links are intended to have very limited semantics: they simply indicate an association between two endpoints. If the
 * connection needs to have deeper semantics, consider interposing a connector between the endpoints, since connectors
 * are intended to be semantically-rich elements. <!-- end-model-doc -->
 * <p>
...
public interface Link extends EObject {
	 ...
	 * <p>
	 * If the meaning of the '<em>Point2</em>' reference isn't clear, there really should be more of a description
	 * here...
	 * </p>
	 * <!-- end-user-doc -->
	 * 
