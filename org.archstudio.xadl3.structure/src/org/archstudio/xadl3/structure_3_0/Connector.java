 ...
 * begin-model-doc --> Connectors are the loci of communication in an architecture. They inherit all the properties of a
 * Brick: ID, name, interfaces, and optional substructure. <!-- end-model-doc -->
 *
