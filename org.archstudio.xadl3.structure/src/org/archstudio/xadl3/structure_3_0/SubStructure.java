...
/**
 * <!-- begin-user-doc --> A representation of the model object '<em><b>Sub Structure</b></em>'.
 * <!-- end-user-doc -->
 *
 * <!-- begin-model-doc -->
 * 
 * This type allows the specification of sub-structure for a brick (component or connector); that
 * is, the internal structure of a Brick can also contain its own structure of components and
 * connectors. This allows for hierarchical (and possibly recursive) composition.
 * 
 * A subStructure consists of a link to the inner structure, along with zero or more interface
 * mappings. Interface mappings map (or connect) interfaces on the outer components and connectors
 * with interfaces on the inner components and connectors.
 * 
 * <!-- end-model-doc -->
 *
 * <p>
 ...
 * </p>
 * <ul>
 * <li>{@link org.archstudio.xadl3.structure_3_0.SubStructure#getInnerStructureLink
 * <em>Inner Structure Link</em>}</li>
 * <li>{@link org.archstudio.xadl3.structure_3_0.SubStructure#getInterfaceMapping
...
public interface SubStructure extends EObject {
   ...
   * -->
   * <p>
   * If the meaning of the '<em>Inner Structure Link</em>' reference isn't clear, there really
   ...
   * 
   * @param value the new value of the '<em>Inner Structure Link</em>' reference.
  ...
  /**
   * Returns the value of the '<em><b>Interface Mapping</b></em>' containment reference list. The
   * list contents are of type {@link org.archstudio.xadl3.structure_3_0.InterfaceMapping}. <!--
   * begin-user-doc -->
   * <p>
   * If the meaning of the '<em>Interface Mapping</em>' containment reference list isn't clear,
   ...
   *        "kind='element' name='interfaceMapping' namespace='##targetNamespace'"
   * @generated
   */
  EList<InterfaceMapping> getInterfaceMapping();

  /**
   * Returns the value of the '<em><b>Ext</b></em>' containment reference list. The list contents
   * are of type {@link org.archstudio.xadl3.xadlcore_3_0.Extension}. <!-- begin-user-doc -->
   * <p>
   * If the meaning of the '<em>Ext</em>' containment reference list isn't clear, there really
   * should be more of a description here...
   * </p>
   * <!-- end-user-doc -->
   * 
  ...
  /**
   * Sets the value of the '{@link org.archstudio.xadl3.structure_3_0.SubStructure#getId <em>Id</em>
