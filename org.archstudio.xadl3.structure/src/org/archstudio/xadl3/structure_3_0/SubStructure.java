 ...
 * <!-- begin-model-doc -->
 * 
 * This type allows the specification of sub-structure for a brick (component or
 * connector); that is, the internal structure of a Brick can also contain its
 * own structure of components and connectors. This allows for hierarchical (and
 * possibly recursive) composition.
 * 
 * A subStructure consists of a link to the inner structure, along with zero or
 * more interface mappings. Interface mappings map (or connect) interfaces on
 * the outer components and connectors with interfaces on the inner components
 * and connectors.
 * 
 * <!-- end-model-doc -->
 * 
 ...
 * <li>{@link org.archstudio.xadl3.structure_3_0.SubStructure#getExt <em>Ext
 * </em>}</li>
 * <li>{@link org.archstudio.xadl3.structure_3_0.SubStructure#getId <em>Id</em>}
 * </li>
 * </ul>
 * </p>
 * 
...
public interface SubStructure extends EObject {
	/**
	 * Returns the value of the '<em><b>Inner Structure Link</b></em>'
	 * reference. <!-- begin-user-doc -->
	 * <p>
	 * If the meaning of the '<em>Inner Structure Link</em>' reference isn't
	 ...
	 * 
	 * @param value
	 *            the new value of the '<em>Inner Structure Link</em>'
	 *            reference.
	...
	/**
	 * Returns the value of the '<em><b>Interface Mapping</b></em>' containment
	 * reference list. The list contents are of type
	 * {@link org.archstudio.xadl3.structure_3_0.InterfaceMapping}. <!--
	 * begin-user-doc -->
	 * <p>
	 * If the meaning of the '<em>Interface Mapping</em>' containment reference
	 * list isn't clear, there really should be more of a description here...
	 * </p>
	 * <!-- end-user-doc -->
	 * 
	 * @return the value of the '<em>Interface Mapping</em>' containment
	 *         reference list.
