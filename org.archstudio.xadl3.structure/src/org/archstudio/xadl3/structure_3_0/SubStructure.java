 ...
 * <!-- begin-model-doc --> This type allows the specification of sub-structure for a brick (component or connector);
 * that is, the internal structure of a Brick can also contain its own structure of components and connectors. This
 * allows for hierarchical (and possibly recursive) composition. A subStructure consists of a link to the inner
 * structure, along with zero or more interface mappings. Interface mappings map (or connect) interfaces on the outer
 * components and connectors with interfaces on the inner components and connectors. <!-- end-model-doc -->
 * <p>
