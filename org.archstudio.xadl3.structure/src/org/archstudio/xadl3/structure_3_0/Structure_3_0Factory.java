...
public interface Structure_3_0Factory extends EFactory {
   ...
   * @generated
   */
  Structure_3_0Factory eINSTANCE =
      org.archstudio.xadl3.structure_3_0.impl.Structure_3_0FactoryImpl.init();
  ...
  /**
   * Returns a new object of class '<em>Interface Mapping</em>'. <!-- begin-user-doc --> <!--
   * end-user-doc -->
   * 
  ...
  /**
   * Returns a new object of class '<em>Sub Structure</em>'. <!-- begin-user-doc --> <!--
   * end-user-doc -->
   * 
