 ...
 * <li>{@link org.archstudio.xadl3.structure_3_0.DocumentRoot#getXSISchemaLocation
...
public interface DocumentRoot extends EObject {
   ...
   * 
   * This element is a top-level xADL element containing an architectural structure. A single
   * document may contain more than one structure, and structures may be connected to one another
   * via links in substructure relationships.
   * 
   * <!-- end-model-doc -->
   * 
  ...
  /**
   * Sets the value of the '{@link org.archstudio.xadl3.structure_3_0.DocumentRoot#getStructure
   * <em>Structure</em>}' containment reference. <!-- begin-user-doc --> <!-- end-user-doc -->
   * 
