...
public interface DocumentRoot extends EObject
{
   ...
   *        extendedMetaData="kind='element' name='structure' namespace='##targetNamespace' affiliation='http://www.archstudio.org/xadl3/schemas/xadlcore-3.0.xsd#topLevelElement'"
   * @generated
   */
  Structure getStructure();

  /**
   * Sets the value of the '{@link org.archstudio.xadl3.structure_3_0.DocumentRoot#getStructure <em>Structure</em>}' containment reference.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
