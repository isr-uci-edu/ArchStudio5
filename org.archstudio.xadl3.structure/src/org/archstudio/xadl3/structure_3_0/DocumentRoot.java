...
public interface DocumentRoot extends
	 ...
	 * end-user-doc --> <!-- begin-model-doc --> This element is a top-level xADL element containing an architectural
	 * structure. A single document may contain more than one structure, and structures may be connected to one another
	 * via links in substructure relationships. <!-- end-model-doc -->
	 * 
