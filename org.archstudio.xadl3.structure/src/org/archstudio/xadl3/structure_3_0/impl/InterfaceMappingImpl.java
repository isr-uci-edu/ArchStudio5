...
/**
 * <!-- begin-user-doc --> An implementation of the model object '<em><b>Interface Mapping</b></em>
 * '. <!-- end-user-doc -->
 * <p>
 ...
 * <li>{@link org.archstudio.xadl3.structure_3_0.impl.InterfaceMappingImpl#getName <em>Name</em>}
 * </li>
 * </ul>
 *
 * @generated
...
public class InterfaceMappingImpl extends MinimalEObjectImpl.Container implements InterfaceMapping {
  /**
   * The cached value of the '{@link #getOuterInterfaceLink() <em>Outer Interface Link</em>}'
  ...
  /**
   * The cached value of the '{@link #getInnerInterfaceLink() <em>Inner Interface Link</em>}'
   * reference. <!-- begin-user-doc --> <!-- end-user-doc -->
   * 
  ...
  public void setId(String newId) {
    ...
    if (eNotificationRequired()) {
      eNotify(new ENotificationImpl(this, Notification.SET,
          Structure_3_0Package.INTERFACE_MAPPING__ID, oldId, id));
    }
  }
  ...
  public void setName(String newName) {
    ...
    if (eNotificationRequired()) {
      eNotify(new ENotificationImpl(this, Notification.SET,
          Structure_3_0Package.INTERFACE_MAPPING__NAME, oldName, name));
    }
  }
