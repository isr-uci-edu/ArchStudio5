 ...
 * <ul>
 *   <li>{@link org.archstudio.xadl3.structure_3_0.impl.InterfaceMappingImpl#getOuterInterfaceLink <em>Outer Interface Link</em>}</li>
 *   <li>{@link org.archstudio.xadl3.structure_3_0.impl.InterfaceMappingImpl#getInnerInterfaceLink <em>Inner Interface Link</em>}</li>
...
public class InterfaceMappingImpl extends EObjectImpl implements InterfaceMapping
{
  ...
  public void setOuterInterfaceLink(Interface newOuterInterfaceLink)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, Structure_3_0Package.INTERFACE_MAPPING__OUTER_INTERFACE_LINK, oldOuterInterfaceLink, outerInterfaceLink));
  }
  ...
  public void setInnerInterfaceLink(Interface newInnerInterfaceLink)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, Structure_3_0Package.INTERFACE_MAPPING__INNER_INTERFACE_LINK, oldInnerInterfaceLink, innerInterfaceLink));
  }
  ...
  public EList<Extension> getExt()
  {
    if (ext == null)
    {
      ext = new EObjectContainmentEList<Extension>(Extension.class, this, Structure_3_0Package.INTERFACE_MAPPING__EXT);
    }
    return ext;
  }
  ...
  public void setName(String newName)
  {
    ...
    name = newName;
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, Structure_3_0Package.INTERFACE_MAPPING__NAME, oldName, name));
  }
