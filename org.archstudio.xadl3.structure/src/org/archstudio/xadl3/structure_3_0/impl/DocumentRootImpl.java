...
public class DocumentRootImpl extends MinimalEObjectImpl.Container implements DocumentRoot {
  ...
  public EMap<String, String> getXMLNSPrefixMap() {
    if (xMLNSPrefixMap == null) {
      xMLNSPrefixMap = new EcoreEMap<String, String>(
          ...
          this, Structure_3_0Package.DOCUMENT_ROOT__XMLNS_PREFIX_MAP);
    }
  ...
  public EMap<String, String> getXSISchemaLocation() {
    if (xSISchemaLocation == null) {
      xSISchemaLocation = new EcoreEMap<String, String>(
          EcorePackage.Literals.ESTRING_TO_STRING_MAP_ENTRY, EStringToStringMapEntryImpl.class,
          this, Structure_3_0Package.DOCUMENT_ROOT__XSI_SCHEMA_LOCATION);
    }
  ...
  public NotificationChain basicSetStructure(Structure newStructure, NotificationChain msgs) {
    return ((FeatureMap.Internal) getMixed())
        .basicAdd(Structure_3_0Package.Literals.DOCUMENT_ROOT__STRUCTURE, newStructure, msgs);
  }
  ...
  public void setStructure(Structure newStructure) {
    ((FeatureMap.Internal) getMixed()).set(Structure_3_0Package.Literals.DOCUMENT_ROOT__STRUCTURE,
        newStructure);
  }
