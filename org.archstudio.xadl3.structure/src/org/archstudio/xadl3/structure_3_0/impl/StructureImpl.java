...
public class StructureImpl extends EObjectImpl implements Structure
{
  ...
  public EList<Component> getComponent()
  {
    if (component == null)
    {
      component = new EObjectContainmentEList<Component>(Component.class, this, Structure_3_0Package.STRUCTURE__COMPONENT);
    }
    return component;
  }
  ...
  public EList<Connector> getConnector()
  {
    if (connector == null)
    {
      connector = new EObjectContainmentEList<Connector>(Connector.class, this, Structure_3_0Package.STRUCTURE__CONNECTOR);
    }
    return connector;
  }
