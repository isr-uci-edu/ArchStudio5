...
/**
 * <!-- begin-user-doc --> An implementation of the model object '<em><b>Structure</b></em>'. <!--
 * end-user-doc -->
 * <p>
 * The following features are implemented:
 * </p>
 * <ul>
 * <li>{@link org.archstudio.xadl3.structure_3_0.impl.StructureImpl#getComponent <em>Component</em>}
 * </li>
 * <li>{@link org.archstudio.xadl3.structure_3_0.impl.StructureImpl#getConnector <em>Connector</em>}
 * </li>
...
public class StructureImpl extends MinimalEObjectImpl.Container implements Structure {
  ...
  public EList<Link> getLink() {
    if (link == null) {
      link =
          new EObjectContainmentEList<Link>(Link.class, this, Structure_3_0Package.STRUCTURE__LINK);
    }
    return link;
  }
  ...
  public EList<Extension> getExt() {
    if (ext == null) {
      ext = new EObjectContainmentEList<Extension>(Extension.class, this,
          Structure_3_0Package.STRUCTURE__EXT);
    }
    return ext;
  }
  ...
  public void setId(String newId) {
    ...
    if (eNotificationRequired()) {
      eNotify(new ENotificationImpl(this, Notification.SET, Structure_3_0Package.STRUCTURE__ID,
          oldId, id));
    }
  }
  ...
  public void setName(String newName) {
    ...
    name = newName;
    if (eNotificationRequired()) {
      eNotify(new ENotificationImpl(this, Notification.SET, Structure_3_0Package.STRUCTURE__NAME,
          oldName, name));
    }
  }
