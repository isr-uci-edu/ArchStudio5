 ...
 * <li>{@link org.archstudio.xadl3.structure_3_0.impl.InterfaceImpl#getDirection <em>Direction</em>}
 * </li>
...
public class InterfaceImpl extends MinimalEObjectImpl.Container implements Interface {
  ...
  public EList<Extension> getExt() {
    if (ext == null) {
      ext = new EObjectContainmentEList<Extension>(Extension.class, this,
          Structure_3_0Package.INTERFACE__EXT);
    }
    return ext;
  }
  ...
  public void setDirection(Direction newDirection) {
    ...
    if (eNotificationRequired()) {
      eNotify(new ENotificationImpl(this, Notification.SET,
          Structure_3_0Package.INTERFACE__DIRECTION, oldDirection, direction, !oldDirectionESet));
    }
  }
  ...
  public void unsetDirection() {
    ...
    if (eNotificationRequired()) {
      eNotify(
          new ENotificationImpl(this, Notification.UNSET, Structure_3_0Package.INTERFACE__DIRECTION,
  ...
  public void setId(String newId) {
    ...
    id = newId;
    if (eNotificationRequired()) {
      eNotify(new ENotificationImpl(this, Notification.SET, Structure_3_0Package.INTERFACE__ID,
          oldId, id));
    }
  }
  ...
  public void setName(String newName) {
    ...
    name = newName;
    if (eNotificationRequired()) {
      eNotify(new ENotificationImpl(this, Notification.SET, Structure_3_0Package.INTERFACE__NAME,
          oldName, name));
    }
  }
