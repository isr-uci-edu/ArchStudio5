...
public abstract class BrickImpl extends EObjectImpl implements Brick
{
  ...
  public EList<Interface> getInterface()
  {
    if (interface_ == null)
    {
      interface_ = new EObjectContainmentEList<Interface>(Interface.class, this, Structure_3_0Package.BRICK__INTERFACE);
    }
    return interface_;
  }
  ...
  public NotificationChain basicSetSubStructure(SubStructure newSubStructure, NotificationChain msgs)
  {
    ...
    {
      ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, Structure_3_0Package.BRICK__SUB_STRUCTURE, oldSubStructure, newSubStructure);
  ...
  public void setSubStructure(SubStructure newSubStructure)
  {
    if (newSubStructure != subStructure)
    {
      ...
      if (subStructure != null)
        msgs = ((InternalEObject)subStructure).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - Structure_3_0Package.BRICK__SUB_STRUCTURE, null, msgs);
      if (newSubStructure != null)
        msgs = ((InternalEObject)newSubStructure).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - Structure_3_0Package.BRICK__SUB_STRUCTURE, null, msgs);
      msgs = basicSetSubStructure(newSubStructure, msgs);
      if (msgs != null) msgs.dispatch();
    }
    else if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, Structure_3_0Package.BRICK__SUB_STRUCTURE, newSubStructure, newSubStructure));
  }
