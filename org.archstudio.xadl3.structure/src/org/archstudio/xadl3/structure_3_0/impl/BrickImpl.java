...
/**
 * <!-- begin-user-doc --> An implementation of the model object '<em><b>Brick</b></em>'. <!--
 * end-user-doc -->
 * <p>
 * The following features are implemented:
 * </p>
 * <ul>
 * <li>{@link org.archstudio.xadl3.structure_3_0.impl.BrickImpl#getInterface <em>Interface</em>}
 * </li>
...
public abstract class BrickImpl extends MinimalEObjectImpl.Container implements Brick {
  ...
  /**
   * The cached value of the '{@link #getSubStructure() <em>Sub Structure</em>}' containment
   ...
   * @generated
   */
  public NotificationChain basicSetSubStructure(SubStructure newSubStructure,
  ...
  public void setSubStructure(SubStructure newSubStructure) {
    if (newSubStructure != subStructure) {
      ...
      eNotify(new ENotificationImpl(this, Notification.SET,
          Structure_3_0Package.BRICK__SUB_STRUCTURE, newSubStructure, newSubStructure));
    }
  }
  ...
  public EList<Extension> getExt() {
    if (ext == null) {
      ext = new EObjectContainmentEList<Extension>(Extension.class, this,
          Structure_3_0Package.BRICK__EXT);
    }
    return ext;
  }
  ...
  public void setId(String newId) {
    ...
    if (eNotificationRequired()) {
      eNotify(
          new ENotificationImpl(this, Notification.SET, Structure_3_0Package.BRICK__ID, oldId, id));
    }
  }
  ...
  public void setName(String newName) {
    ...
    name = newName;
    if (eNotificationRequired()) {
      eNotify(new ENotificationImpl(this, Notification.SET, Structure_3_0Package.BRICK__NAME,
          oldName, name));
    }
  }
