...
/**
 * <!-- begin-user-doc --> An implementation of the model object '<em><b>Sub Structure</b></em>'.
 * <!-- end-user-doc -->
 * <p>
...
public class SubStructureImpl extends MinimalEObjectImpl.Container implements SubStructure {
  /**
   * The cached value of the '{@link #getInnerStructureLink() <em>Inner Structure Link</em>}'
  ...
  /**
   * The cached value of the '{@link #getInterfaceMapping() <em>Interface Mapping</em>}' containment
  ...
  public void setId(String newId) {
    ...
    id = newId;
    if (eNotificationRequired()) {
      eNotify(new ENotificationImpl(this, Notification.SET, Structure_3_0Package.SUB_STRUCTURE__ID,
          oldId, id));
    }
  }
