...
public class Structure_3_0PackageImpl extends EPackageImpl implements Structure_3_0Package {
   ...
   * 
   * <p>
   * This method is used to initialize {@link Structure_3_0Package#eINSTANCE} when that field is
  ...
  public static Structure_3_0Package init() {
    if (isInited) {
      return (Structure_3_0Package) EPackage.Registry.INSTANCE
          .getEPackage(Structure_3_0Package.eNS_URI);
    }

    // Obtain or create and register package
    Structure_3_0PackageImpl theStructure_3_0Package =
        (Structure_3_0PackageImpl) (EPackage.Registry.INSTANCE
            .get(eNS_URI) instanceof Structure_3_0PackageImpl
    ...
    Xadlcore_3_0PackageImpl theXadlcore_3_0Package =
        (Xadlcore_3_0PackageImpl) (EPackage.Registry.INSTANCE
  ...
  public void initializePackageContents() {
    ...
    initEClass(brickEClass, Brick.class, "Brick", IS_ABSTRACT, !IS_INTERFACE,
        IS_GENERATED_INSTANCE_CLASS);
    initEReference(getBrick_Interface(), this.getInterface(), null, "interface", null, 0, -1,
        Brick.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES,
        !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
    initEReference(getBrick_SubStructure(), this.getSubStructure(), null, "subStructure", null, 0,
        1, Brick.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE,
        !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
    initEReference(getBrick_Ext(), theXadlcore_3_0Package.getExtension(), null, "ext", null, 0, -1,
        Brick.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES,
        !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
    initEAttribute(getBrick_Id(), theXMLTypePackage.getID(), "id", null, 0, 1, Brick.class,
        !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, IS_ID, IS_UNIQUE, !IS_DERIVED,
        IS_ORDERED);
    initEAttribute(getBrick_Name(), theXMLTypePackage.getString(), "name", null, 0, 1, Brick.class,
        !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED,
        IS_ORDERED);
    ...
    initEReference(getDocumentRoot_XSISchemaLocation(), ecorePackage.getEStringToStringMapEntry(),
        ...
        IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
    initEReference(getDocumentRoot_Structure(), this.getStructure(), null, "structure", null, 0, -2,
    ...
    initEClass(interfaceEClass, Interface.class, "Interface", !IS_ABSTRACT, !IS_INTERFACE,
        IS_GENERATED_INSTANCE_CLASS);
    initEReference(getInterface_Ext(), theXadlcore_3_0Package.getExtension(), null, "ext", null, 0,
        -1, Interface.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE,
        !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
    initEAttribute(getInterface_Direction(), this.getDirection(), "direction", null, 0, 1,
        Interface.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_UNSETTABLE, !IS_ID,
        IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
    initEAttribute(getInterface_Id(), theXMLTypePackage.getID(), "id", null, 0, 1, Interface.class,
        !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, IS_ID, IS_UNIQUE, !IS_DERIVED,
        IS_ORDERED);
    initEAttribute(getInterface_Name(), theXMLTypePackage.getString(), "name", null, 0, 1,
        Interface.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID,
        IS_UNIQUE, !IS_DERIVED, IS_ORDERED);

    initEClass(interfaceMappingEClass, InterfaceMapping.class, "InterfaceMapping", !IS_ABSTRACT,
        !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
    initEReference(getInterfaceMapping_OuterInterfaceLink(), this.getInterface(), null,
        "outerInterfaceLink", null, 1, 1, InterfaceMapping.class, !IS_TRANSIENT, !IS_VOLATILE,
        IS_CHANGEABLE, !IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED,
        IS_ORDERED);
    initEReference(getInterfaceMapping_InnerInterfaceLink(), this.getInterface(), null,
        "innerInterfaceLink", null, 1, 1, InterfaceMapping.class, !IS_TRANSIENT, !IS_VOLATILE,
        IS_CHANGEABLE, !IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED,
        IS_ORDERED);
    initEReference(getInterfaceMapping_Ext(), theXadlcore_3_0Package.getExtension(), null, "ext",
        null, 0, -1, InterfaceMapping.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE,
        IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
    initEAttribute(getInterfaceMapping_Id(), theXMLTypePackage.getID(), "id", null, 1, 1,
        InterfaceMapping.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, IS_ID,
        IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
    ...
    initEClass(linkEClass, Link.class, "Link", !IS_ABSTRACT, !IS_INTERFACE,
        IS_GENERATED_INSTANCE_CLASS);
    initEReference(getLink_Point1(), this.getInterface(), null, "point1", null, 1, 1, Link.class,
        !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, !IS_RESOLVE_PROXIES,
        !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
    initEReference(getLink_Point2(), this.getInterface(), null, "point2", null, 1, 1, Link.class,
        !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, !IS_RESOLVE_PROXIES,
        !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
    initEReference(getLink_Ext(), theXadlcore_3_0Package.getExtension(), null, "ext", null, 0, -1,
        Link.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES,
        !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
    initEAttribute(getLink_Id(), theXMLTypePackage.getID(), "id", null, 1, 1, Link.class,
        !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, IS_ID, IS_UNIQUE, !IS_DERIVED,
        IS_ORDERED);
    initEAttribute(getLink_Name(), theXMLTypePackage.getString(), "name", null, 0, 1, Link.class,
        !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED,
        IS_ORDERED);

    initEClass(structureEClass, Structure.class, "Structure", !IS_ABSTRACT, !IS_INTERFACE,
        IS_GENERATED_INSTANCE_CLASS);
    initEReference(getStructure_Component(), this.getComponent(), null, "component", null, 0, -1,
        Structure.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE,
        !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
    initEReference(getStructure_Connector(), this.getConnector(), null, "connector", null, 0, -1,
        Structure.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE,
        !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
    initEReference(getStructure_Link(), this.getLink(), null, "link", null, 0, -1, Structure.class,
        !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES,
        !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
    initEReference(getStructure_Ext(), theXadlcore_3_0Package.getExtension(), null, "ext", null, 0,
        -1, Structure.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE,
        !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
    initEAttribute(getStructure_Id(), theXMLTypePackage.getID(), "id", null, 0, 1, Structure.class,
        !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, IS_ID, IS_UNIQUE, !IS_DERIVED,
        IS_ORDERED);
    initEAttribute(getStructure_Name(), theXMLTypePackage.getString(), "name", null, 0, 1,
        Structure.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID,
        IS_UNIQUE, !IS_DERIVED, IS_ORDERED);

    initEClass(subStructureEClass, SubStructure.class, "SubStructure", !IS_ABSTRACT, !IS_INTERFACE,
        IS_GENERATED_INSTANCE_CLASS);
    initEReference(getSubStructure_InnerStructureLink(), this.getStructure(), null,
        "innerStructureLink", null, 1, 1, SubStructure.class, !IS_TRANSIENT, !IS_VOLATILE,
        IS_CHANGEABLE, !IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED,
        IS_ORDERED);
    initEReference(getSubStructure_InterfaceMapping(), this.getInterfaceMapping(), null,
        "interfaceMapping", null, 0, -1, SubStructure.class, !IS_TRANSIENT, !IS_VOLATILE,
        IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED,
        IS_ORDERED);
    initEReference(getSubStructure_Ext(), theXadlcore_3_0Package.getExtension(), null, "ext", null,
        0, -1, SubStructure.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE,
        !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
    initEAttribute(getSubStructure_Id(), theXMLTypePackage.getID(), "id", null, 1, 1,
        SubStructure.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, IS_ID,
        IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
  ...
  protected void createExtendedMetaDataAnnotations() {
    ...
    addAnnotation(componentEClass, source,
        new String[] {"name", "Component", "kind", "elementOnly"});
    addAnnotation(connectorEClass, source,
        new String[] {"name", "Connector", "kind", "elementOnly"});
    ...
    addAnnotation(getDocumentRoot_Structure(), source,
        new String[] {"kind", "element", "name", "structure", "namespace", "##targetNamespace",
            "affiliation",
            "http://www.archstudio.org/xadl3/schemas/xadlcore-3.0.xsd#topLevelElement"});
    addAnnotation(interfaceEClass, source,
        new String[] {"name", "Interface", "kind", "elementOnly"});
    ...
    addAnnotation(getInterfaceMapping_OuterInterfaceLink(), source, new String[] {"kind", "element",
        "name", "outerInterfaceLink", "namespace", "##targetNamespace"});
    addAnnotation(getInterfaceMapping_InnerInterfaceLink(), source, new String[] {"kind", "element",
        "name", "innerInterfaceLink", "namespace", "##targetNamespace"});
    ...
    addAnnotation(getLink_Name(), source,
        new String[] {"kind", "attribute", "name", "name", "namespace", "##targetNamespace"});
    addAnnotation(structureEClass, source,
        new String[] {"name", "Structure", "kind", "elementOnly"});
    ...
    addAnnotation(getStructure_Name(), source,
        new String[] {"kind", "attribute", "name", "name", "namespace", "##targetNamespace"});
    addAnnotation(subStructureEClass, source,
        new String[] {"name", "SubStructure", "kind", "elementOnly"});
    addAnnotation(getSubStructure_InnerStructureLink(), source, new String[] {"kind", "element",
        "name", "innerStructureLink", "namespace", "##targetNamespace"});
    addAnnotation(getSubStructure_InterfaceMapping(), source, new String[] {"kind", "element",
        "name", "interfaceMapping", "namespace", "##targetNamespace"});
