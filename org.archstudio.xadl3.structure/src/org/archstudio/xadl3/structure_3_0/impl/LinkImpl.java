...
public class LinkImpl extends MinimalEObjectImpl.Container implements Link {
  ...
  public void setPoint1(Interface newPoint1) {
    ...
    if (eNotificationRequired()) {
      eNotify(new ENotificationImpl(this, Notification.SET, Structure_3_0Package.LINK__POINT1,
          oldPoint1, point1));
    }
  }
  ...
  public void setPoint2(Interface newPoint2) {
    ...
    point2 = newPoint2;
    if (eNotificationRequired()) {
      eNotify(new ENotificationImpl(this, Notification.SET, Structure_3_0Package.LINK__POINT2,
          oldPoint2, point2));
    }
  }
  ...
  public EList<Extension> getExt() {
    if (ext == null) {
      ext = new EObjectContainmentEList<Extension>(Extension.class, this,
          Structure_3_0Package.LINK__EXT);
    }
    return ext;
  }
  ...
  public void setId(String newId) {
    ...
    if (eNotificationRequired()) {
      eNotify(
          new ENotificationImpl(this, Notification.SET, Structure_3_0Package.LINK__ID, oldId, id));
    }
  }
  ...
  public void setName(String newName) {
    ...
    name = newName;
    if (eNotificationRequired()) {
      eNotify(new ENotificationImpl(this, Notification.SET, Structure_3_0Package.LINK__NAME,
          oldName, name));
    }
  }
