 ...
 * <!-- begin-model-doc -->
 * 
 * Interface mappings are used in the specification of sub-structure for a Brick
 * (Component or Connector). An interface mapping maps (or connects) an
 * interface on the outer Brick to an interface on an inner Brick. The
 * outerInterfaceLink is a link to the interface on the outer brick. The
 * innerInterfaceLink is a link to the interface on the inner brick.
 * 
 * <!-- end-model-doc -->
 * 
 * <p>
 ...
 * <li>{@link org.archstudio.xadl3.structure_3_0.InterfaceMapping#getExt <em>Ext
 * </em>}</li>
 * <li>{@link org.archstudio.xadl3.structure_3_0.InterfaceMapping#getId <em>Id
 * </em>}</li>
 * <li>{@link org.archstudio.xadl3.structure_3_0.InterfaceMapping#getName <em>
 * Name</em>}</li>
 * </ul>
 * </p>
 * 
...
public interface InterfaceMapping extends EObject {
	/**
	 * Returns the value of the '<em><b>Outer Interface Link</b></em>'
	 * reference. <!-- begin-user-doc -->
	 * <p>
	 * If the meaning of the '<em>Outer Interface Link</em>' reference isn't
	 ...
	 * 
	 * @param value
	 *            the new value of the '<em>Outer Interface Link</em>'
	 *            reference.
	...
	/**
	 * Returns the value of the '<em><b>Inner Interface Link</b></em>'
	 * reference. <!-- begin-user-doc -->
	 * <p>
	 * If the meaning of the '<em>Inner Interface Link</em>' reference isn't
	 * clear, there really should be more of a description here...
	 * </p>
	 * <!-- end-user-doc -->
	 * 
	 ...
	 * 
	 * @param value
	 *            the new value of the '<em>Inner Interface Link</em>'
	 *            reference.
