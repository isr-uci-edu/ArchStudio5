 ...
 * --> <!-- begin-model-doc --> Interface mappings are used in the specification of sub-structure for a Brick (Component
 * or Connector). An interface mapping maps (or connects) an interface on the outer Brick to an interface on an inner
 * Brick. The outerInterfaceLink is a link to the interface on the outer brick. The innerInterfaceLink is a link to the
 * interface on the inner brick. <!-- end-model-doc -->
 * <p>
 * The following features are supported:
 * </p>
 * <ul>
 * <li>{@link org.archstudio.xadl3.structure_3_0.InterfaceMapping#getOuterInterfaceLink <em>Outer Interface Link</em>}
 * </li>
 * <li>{@link org.archstudio.xadl3.structure_3_0.InterfaceMapping#getInnerInterfaceLink <em>Inner Interface Link</em>}
 * </li>
