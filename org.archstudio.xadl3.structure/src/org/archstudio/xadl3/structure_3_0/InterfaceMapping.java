...
/**
 * <!-- begin-user-doc --> A representation of the model object '<em><b>Interface Mapping</b></em>'.
 * <!-- end-user-doc -->
 *
 * <!-- begin-model-doc -->
 * 
 * Interface mappings are used in the specification of sub-structure for a Brick (Component or
 * Connector). An interface mapping maps (or connects) an interface on the outer Brick to an
 * interface on an inner Brick. The outerInterfaceLink is a link to the interface on the outer
 * brick. The innerInterfaceLink is a link to the interface on the inner brick.
 * 
 * <!-- end-model-doc -->
 *
 * <p>
 ...
 * </p>
 * <ul>
 * <li>{@link org.archstudio.xadl3.structure_3_0.InterfaceMapping#getOuterInterfaceLink
 * <em>Outer Interface Link</em>}</li>
 * <li>{@link org.archstudio.xadl3.structure_3_0.InterfaceMapping#getInnerInterfaceLink
...
public interface InterfaceMapping extends EObject {
   ...
   * -->
   * <p>
   * If the meaning of the '<em>Outer Interface Link</em>' reference isn't clear, there really
   ...
   * 
   * @param value the new value of the '<em>Outer Interface Link</em>' reference.
   ...
   * -->
   * <p>
   * If the meaning of the '<em>Inner Interface Link</em>' reference isn't clear, there really
   * should be more of a description here...
   * </p>
   * <!-- end-user-doc -->
   * 
   ...
   * 
   * @param value the new value of the '<em>Inner Interface Link</em>' reference.
  ...
  /**
   * Sets the value of the '{@link org.archstudio.xadl3.structure_3_0.InterfaceMapping#getId
  ...
  /**
   * Sets the value of the '{@link org.archstudio.xadl3.structure_3_0.InterfaceMapping#getName
