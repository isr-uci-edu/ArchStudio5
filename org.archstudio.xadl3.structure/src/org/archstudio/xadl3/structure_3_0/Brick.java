 ...
 * human-readable name, and zero or more interfaces. Additionally, a brick may have internal substructure. This type is
 * defined so that, on a basic level, components and connectors can be treated equally. However, no Brick extension is
 * defined, since we assume that there will be very semantically different extensions for components, connectors, and
...
public interface Brick extends EObject {
	 ...
	 * 
	 * @param value
	 *            the new value of the '<em>Sub Structure</em>' containment reference.
	 * @see #getSubStructure()
	 * @generated
	 */
