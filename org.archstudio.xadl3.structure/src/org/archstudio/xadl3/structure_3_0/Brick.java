 ...
 * begin-model-doc --> Brick is the abstract base type for components and connectors. A brick is a logical element that
 * has an ID, a human-readable name, and zero or more interfaces. Additionally, a brick may have internal substructure.
 * This type is defined so that, on a basic level, components and connectors can be treated equally. However, no Brick
 * extension is defined, since we assume that there will be very semantically different extensions for components,
 * connectors, and future types of bricks. <!-- end-model-doc -->
 * <p>
...
public interface Brick extends EObject {
	 ...
	 * <p>
	 * If the meaning of the '<em>Sub Structure</em>' containment reference isn't clear, there really should be more of
	 * a description here...
	 * </p>
	 * <!-- end-user-doc -->
	 * 
