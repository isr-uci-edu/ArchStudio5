...
/**
 * <!-- begin-user-doc --> A representation of the model object '<em><b>Brick</b></em>'. <!--
 * end-user-doc -->
 *
 * <!-- begin-model-doc -->
 * 
 * Brick is the abstract base type for components and connectors. A brick is a logical element that
 * has an ID, a human-readable name, and zero or more interfaces. Additionally, a brick may have
 * internal substructure. This type is defined so that, on a basic level, components and connectors
 * can be treated equally. However, no Brick extension is defined, since we assume that there will
 * be very semantically different extensions for components, connectors, and future types of bricks.
 * 
 * <!-- end-model-doc -->
 *
 * <p>
...
public interface Brick extends EObject {
   ...
   * contents are of type {@link org.archstudio.xadl3.structure_3_0.Interface}. <!-- begin-user-doc
   * -->
   * <p>
   * If the meaning of the '<em>Interface</em>' containment reference list isn't clear, there really
   ...
   * begin-user-doc -->
   * <p>
   * If the meaning of the '<em>Sub Structure</em>' containment reference isn't clear, there really
   * should be more of a description here...
   * </p>
   * <!-- end-user-doc -->
   * 
   ...
   * @model containment="true" extendedMetaData=
   *        "kind='element' name='subStructure' namespace='##targetNamespace'"
   * @generated
   */
  SubStructure getSubStructure();

  /**
   * Sets the value of the '{@link org.archstudio.xadl3.structure_3_0.Brick#getSubStructure
   * <em>Sub Structure</em>}' containment reference. <!-- begin-user-doc --> <!-- end-user-doc -->
   * 
  ...
  /**
   * Sets the value of the '{@link org.archstudio.xadl3.structure_3_0.Brick#getId <em>Id</em>}'
  ...
  /**
   * Sets the value of the '{@link org.archstudio.xadl3.structure_3_0.Brick#getName <em>Name</em>}'
   * attribute. <!-- begin-user-doc --> <!-- end-user-doc -->
   * 
