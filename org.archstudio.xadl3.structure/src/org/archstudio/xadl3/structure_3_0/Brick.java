 ...
 * <!-- begin-model-doc -->
 * 
 * Brick is the abstract base type for components and connectors. A brick is a
 * logical element that has an ID, a human-readable name, and zero or more
 * interfaces. Additionally, a brick may have internal substructure. This type
 * is defined so that, on a basic level, components and connectors can be
 * treated equally. However, no Brick extension is defined, since we assume that
 * there will be very semantically different extensions for components,
 * connectors, and future types of bricks.
 * 
 * <!-- end-model-doc -->
 * 
 * <p>
 ...
 * <ul>
 * <li>{@link org.archstudio.xadl3.structure_3_0.Brick#getInterface <em>
 * Interface</em>}</li>
 * <li>{@link org.archstudio.xadl3.structure_3_0.Brick#getSubStructure <em>Sub
 * Structure</em>}</li>
...
public interface Brick extends EObject {
	 ...
	 * -->
	 * <p>
	 * If the meaning of the '<em>Interface</em>' containment reference list
	...
	/**
	 * Returns the value of the '<em><b>Sub Structure</b></em>' containment
	 * reference. <!-- begin-user-doc -->
	 * <p>
	 * If the meaning of the '<em>Sub Structure</em>' containment reference
	 * isn't clear, there really should be more of a description here...
	 * </p>
	 * <!-- end-user-doc -->
	 * 
	 ...
	 * 
	 * @param value
	 *            the new value of the '<em>Sub Structure</em>' containment
	 *            reference.
	 * @see #getSubStructure()
	 * @generated
	 */
