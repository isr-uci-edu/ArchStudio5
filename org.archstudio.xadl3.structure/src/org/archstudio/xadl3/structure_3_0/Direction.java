 ...
 * 
 * They are: - none: No directionality selected or implied. - in: Incoming interface. Provided
 * services should be "in" interfaces. - out: Outgoing interface. Required services should be "out"
 * interfaces. - inout: Incoming AND outgoing interface. Endpoint both provides and requires a
 * service.
 * 
 * <!-- end-model-doc -->
 * 
...
public enum Direction implements Enumerator {
   ...
   * <p>
   * If the meaning of '<em><b>In</b></em>' literal object isn't clear, there really should be more
   ...
   * <p>
   * If the meaning of '<em><b>Out</b></em>' literal object isn't clear, there really should be more
   * of a description here...
   * </p>
   * <!-- end-user-doc -->
   * 
