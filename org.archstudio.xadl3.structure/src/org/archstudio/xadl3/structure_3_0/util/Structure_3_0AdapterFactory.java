...
public class Structure_3_0AdapterFactory extends AdapterFactoryImpl {
  ...
  /**
   * Creates a new adapter for an object of class '{@link org.archstudio.xadl3.structure_3_0.Brick
   * <em>Brick</em>}'. <!-- begin-user-doc --> This default implementation returns null so that we
   ...
   * {@link org.archstudio.xadl3.structure_3_0.Component <em>Component</em>}'. <!-- begin-user-doc
  ...
  /**
   * Creates a new adapter for an object of class '
   * {@link org.archstudio.xadl3.structure_3_0.Connector <em>Connector</em>}'. <!-- begin-user-doc
   * --> This default implementation returns null so that we can easily ignore cases; it's useful to
   * ignore a case when inheritance will catch all the cases anyway. <!-- end-user-doc -->
   * 
   * @return the new adapter.
  ...
  /**
   * Creates a new adapter for an object of class '
   * {@link org.archstudio.xadl3.structure_3_0.DocumentRoot <em>Document Root</em>}'. <!--
  ...
  /**
   * Creates a new adapter for an object of class '
   * {@link org.archstudio.xadl3.structure_3_0.Interface <em>Interface</em>}'. <!-- begin-user-doc
   * --> This default implementation returns null so that we can easily ignore cases; it's useful to
   * ignore a case when inheritance will catch all the cases anyway. <!-- end-user-doc -->
   * 
   * @return the new adapter.
  ...
  /**
   * Creates a new adapter for an object of class '
   * {@link org.archstudio.xadl3.structure_3_0.InterfaceMapping <em>Interface Mapping</em>}'. <!--
   * begin-user-doc --> This default implementation returns null so that we can easily ignore cases;
   * it's useful to ignore a case when inheritance will catch all the cases anyway. <!--
   * end-user-doc -->
   * 
  ...
  /**
   * Creates a new adapter for an object of class '{@link org.archstudio.xadl3.structure_3_0.Link
   * <em>Link</em>}'. <!-- begin-user-doc --> This default implementation returns null so that we
   * can easily ignore cases; it's useful to ignore a case when inheritance will catch all the cases
   * anyway. <!-- end-user-doc -->
   * 
   * @return the new adapter.
  ...
  /**
   * Creates a new adapter for an object of class '
   * {@link org.archstudio.xadl3.structure_3_0.Structure <em>Structure</em>}'. <!-- begin-user-doc
   * --> This default implementation returns null so that we can easily ignore cases; it's useful to
   * ignore a case when inheritance will catch all the cases anyway. <!-- end-user-doc -->
   * 
   * @return the new adapter.
  ...
  /**
   * Creates a new adapter for an object of class '
   * {@link org.archstudio.xadl3.structure_3_0.SubStructure <em>Sub Structure</em>}'. <!--
   * begin-user-doc --> This default implementation returns null so that we can easily ignore cases;
   * it's useful to ignore a case when inheritance will catch all the cases anyway. <!--
   * end-user-doc -->
   * 
