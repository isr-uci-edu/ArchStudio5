...
/**
 * <!-- begin-user-doc --> A representation of the model object '<em><b>Structure</b></em>'. <!--
 * end-user-doc -->
 *
 * <!-- begin-model-doc -->
 * 
 * This type defines an architectural structure. A structure consists of components, connectors, and
 * links. Components and connectors internally contain interfaces. It is possible for one structure
 * to be nested within a component or connector by reference through the use of the subStructure
 * element on components or connectors.
 * 
 * <!-- end-model-doc -->
 *
 * <p>
...
public interface Structure extends EObject {
  /**
   * Returns the value of the '<em><b>Component</b></em>' containment reference list. The list
   * contents are of type {@link org.archstudio.xadl3.structure_3_0.Component}. <!-- begin-user-doc
   * -->
   * <p>
   * If the meaning of the '<em>Component</em>' containment reference list isn't clear, there really
  ...
  /**
   * Returns the value of the '<em><b>Connector</b></em>' containment reference list. The list
   * contents are of type {@link org.archstudio.xadl3.structure_3_0.Connector}. <!-- begin-user-doc
   * -->
   * <p>
   * If the meaning of the '<em>Connector</em>' containment reference list isn't clear, there really
   * should be more of a description here...
   * </p>
   * <!-- end-user-doc -->
   * 
   ...
   * @model containment="true" extendedMetaData=
   *        "kind='element' name='connector' namespace='##targetNamespace'"
   * @generated
   */
   ...
   * are of type {@link org.archstudio.xadl3.structure_3_0.Link}. <!-- begin-user-doc -->
   * <p>
   ...
   * @model containment="true" extendedMetaData=
   *        "kind='element' name='link' namespace='##targetNamespace'"
   * @generated
   */
  EList<Link> getLink();
  ...
  /**
   * Sets the value of the '{@link org.archstudio.xadl3.structure_3_0.Structure#getId <em>Id</em>}'
  ...
  /**
   * Sets the value of the '{@link org.archstudio.xadl3.structure_3_0.Structure#getName
