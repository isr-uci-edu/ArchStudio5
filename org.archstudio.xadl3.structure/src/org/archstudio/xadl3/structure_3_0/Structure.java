 ...
 * <!-- begin-model-doc -->
 * 
 * This type defines an architectural structure. A structure consists of
 * components, connectors, and links. Components and connectors internally
 * contain interfaces. It is possible for one structure to be nested within a
 * component or connector by reference through the use of the subStructure
 ...
 * <ul>
 * <li>{@link org.archstudio.xadl3.structure_3_0.Structure#getComponent <em>
 * Component</em>}</li>
 * <li>{@link org.archstudio.xadl3.structure_3_0.Structure#getConnector <em>
 * Connector</em>}</li>
 * <li>{@link org.archstudio.xadl3.structure_3_0.Structure#getLink <em>Link
 * </em>}</li>
 ...
 * <li>{@link org.archstudio.xadl3.structure_3_0.Structure#getName <em>Name
 * </em>}</li>
 * </ul>
 * </p>
 * 
...
public interface Structure extends EObject {
	...
	/**
	 * Returns the value of the '<em><b>Connector</b></em>' containment
	 * reference list. The list contents are of type
	 * {@link org.archstudio.xadl3.structure_3_0.Connector}. <!-- begin-user-doc
	 * -->
	 * <p>
	 * If the meaning of the '<em>Connector</em>' containment reference list
	 * isn't clear, there really should be more of a description here...
	 * </p>
	 * <!-- end-user-doc -->
	 * 
