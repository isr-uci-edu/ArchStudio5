...
public class XadlUtils {
  ...
  @Nullable
  public static ObjRef getExt(IXArchADTQuery xarch, ObjRef ref, String extensionNsURI,
  ...
  public static @Nullable <T extends Extension> T getExt(IXArchADT xarch, EObject eObject,
      EClass extClass) {
    return (T) XArchADTProxy.proxy(xarch, getExt(xarch, XArchADTProxy.unproxy(eObject),
        extClass.getEPackage().getNsURI(), extClass.getName()));
  }

  public static ObjRef createExt(IXArchADT xarch, ObjRef ref, String extensionNsURI,
      String extensionTypeName) {
  ...
  @SuppressWarnings("unchecked")
  public static <T extends Extension> T createExt(IXArchADT xarch, EObject eObject,
      EClass extClass) {
    return (T) XArchADTProxy.proxy(xarch, createExt(xarch, XArchADTProxy.unproxy(eObject),
        extClass.getEPackage().getNsURI(), extClass.getName()));
  }
  ...
  public static @Nullable ObjRef getImplementation(IXArchADTQuery xarch, ObjRef ref, EClass type) {
    EClass extClass = Implementation_3_0Package.Literals.IMPLEMENTATION_EXTENSION;
    ObjRef implementationExtRef =
        XadlUtils.getExt(xarch, ref, extClass.getEPackage().getNsURI(), extClass.getName());
    if (implementationExtRef != null) {
      for (ObjRef implementationRef : Iterables
          .filter(xarch.getAll(implementationExtRef, "implementation"), ObjRef.class)) {
  ...
  public static @Nullable IXArchADTFeature getFeatureByName(IXArchADTQuery xarch, ObjRef ref,
      String name) {
  ...
  public static <DOCUMENT_ROOT extends EObject> DOCUMENT_ROOT createDocument(IXArchADT xarch,
      URI uri, EReference documentRootReference) {
  ...
  public static boolean isInstanceOf(IXArchADTQuery xarch, Object object, EClass eClass) {
    if (object instanceof Serializable) {
      return xarch.isInstanceOf((Serializable) object, eClass.getEPackage().getNsURI(),
          eClass.getName());
    }
    return false;
  }

  public static boolean isInstanceOf(IXArchADTQuery xarch, IXArchADTFeature feature,
      EClass eClass) {
    return xarch.isAssignable(feature.getNsURI(), feature.getTypeName(),
  ...
  public static boolean isInstanceOf(IXArchADTQuery xarch, EClass objectEClass, EClass eClass) {
    return xarch.isAssignable(objectEClass.getEPackage().getNsURI(), objectEClass.getName(),
        eClass.getEPackage().getNsURI(), eClass.getName());
  }

  /**
   * Returns <code>true</code> if an instance of the thing referred to by typeMetadata could be
   * assigned to the feature, <code>false</code> otherwise.
   *
   ...
   * @return <code>true</code> if an instance of the thing referred to by typeMetadata could be
   *         assigned to the feature, <code>false</code> otherwise.
   */
