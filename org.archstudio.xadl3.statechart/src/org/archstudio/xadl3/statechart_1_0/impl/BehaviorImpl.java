...
/**
 * <!-- begin-user-doc --> An implementation of the model object '<em><b>Behavior</b></em>'. <!--
 * end-user-doc -->
 * <p>
...
public class BehaviorImpl extends MinimalEObjectImpl.Container implements Behavior {
  ...
  public EList<Extension> getExt() {
    if (ext == null) {
      ext = new EObjectContainmentEList<Extension>(Extension.class, this,
          Statechart_1_0Package.BEHAVIOR__EXT);
    }
    return ext;
  }
  ...
  public void setId(String newId) {
    ...
    if (eNotificationRequired()) {
      eNotify(new ENotificationImpl(this, Notification.SET, Statechart_1_0Package.BEHAVIOR__ID,
          oldId, id));
    }
  }
