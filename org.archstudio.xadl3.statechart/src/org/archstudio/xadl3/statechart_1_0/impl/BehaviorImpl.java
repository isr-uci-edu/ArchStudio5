 ...
 * <ul>
 * <li>{@link org.archstudio.xadl3.statechart_1_0.impl.BehaviorImpl#getExt <em>
 * Ext</em>}</li>
 * <li>{@link org.archstudio.xadl3.statechart_1_0.impl.BehaviorImpl#getId <em>Id
 * </em>}</li>
 * </ul>
 * </p>
 * 
...
public class BehaviorImpl extends EObjectImpl implements Behavior {
	...
	protected EClass eStaticClass() {
		return Statechart_1_0Package.Literals.BEHAVIOR;
	}
	...
	public EList<Extension> getExt() {
		if (ext == null) {
			ext = new EObjectContainmentEList<Extension>(Extension.class, this, Statechart_1_0Package.BEHAVIOR__EXT);
		}
		return ext;
	}
	...
	public void setId(String newId) {
		...
		if (eNotificationRequired()) {
			eNotify(new ENotificationImpl(this, Notification.SET, Statechart_1_0Package.BEHAVIOR__ID, oldId, id));
		}
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
		case Statechart_1_0Package.BEHAVIOR__EXT:
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		...
		case Statechart_1_0Package.BEHAVIOR__EXT:
			return getExt();
		case Statechart_1_0Package.BEHAVIOR__ID:
			return getId();
		}
