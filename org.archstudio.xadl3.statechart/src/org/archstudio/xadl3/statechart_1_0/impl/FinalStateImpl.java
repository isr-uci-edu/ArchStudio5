...
/**
 * <!-- begin-user-doc --> An implementation of the model object '<em><b>Final State</b></em>'. <!--
 * end-user-doc -->
 * <p>
...
public class FinalStateImpl extends PseudoStateImpl implements FinalState {
  ...
  public void setType(StateType newType) {
    ...
    if (eNotificationRequired()) {
      eNotify(new ENotificationImpl(this, Notification.SET, Statechart_1_0Package.FINAL_STATE__TYPE,
  ...
  public void unsetType() {
    ...
    if (eNotificationRequired()) {
      eNotify(new ENotificationImpl(this, Notification.UNSET,
          Statechart_1_0Package.FINAL_STATE__TYPE, oldType, TYPE_EDEFAULT, oldTypeESet));
    }
  }
