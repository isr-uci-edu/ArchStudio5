...
/**
 * <!-- begin-user-doc --> An implementation of the model object '<em><b>Statechart</b></em>'. <!--
 * end-user-doc -->
 * <p>
 ...
 * <li>{@link org.archstudio.xadl3.statechart_1_0.impl.StatechartImpl#getTransition
 * <em>Transition</em>}</li>
...
public class StatechartImpl extends MinimalEObjectImpl.Container implements Statechart {
  ...
  public EList<Extension> getExt() {
    if (ext == null) {
      ext = new EObjectContainmentEList<Extension>(Extension.class, this,
          Statechart_1_0Package.STATECHART__EXT);
    }
    return ext;
  }
  ...
  public void setId(String newId) {
    ...
    if (eNotificationRequired()) {
      eNotify(new ENotificationImpl(this, Notification.SET, Statechart_1_0Package.STATECHART__ID,
          oldId, id));
    }
  }
  ...
  public void setName(String newName) {
    ...
    name = newName;
    if (eNotificationRequired()) {
      eNotify(new ENotificationImpl(this, Notification.SET, Statechart_1_0Package.STATECHART__NAME,
          oldName, name));
    }
  }
