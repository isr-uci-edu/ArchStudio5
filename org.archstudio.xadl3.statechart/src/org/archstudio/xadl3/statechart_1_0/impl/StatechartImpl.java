...
public class StatechartImpl extends EObjectImpl implements Statechart
{
  ...
  public EList<PseudoState> getState()
  {
    if (state == null)
    {
      state = new EObjectContainmentEList<PseudoState>(PseudoState.class, this, Statechart_1_0Package.STATECHART__STATE);
    }
    return state;
  }
  ...
  public EList<Transition> getTransition()
  {
    if (transition == null)
    {
      transition = new EObjectContainmentEList<Transition>(Transition.class, this, Statechart_1_0Package.STATECHART__TRANSITION);
    }
    return transition;
  }
