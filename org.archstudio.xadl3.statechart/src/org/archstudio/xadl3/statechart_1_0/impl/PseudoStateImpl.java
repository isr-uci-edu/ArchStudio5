...
/**
 * <!-- begin-user-doc --> An implementation of the model object '<em><b>Pseudo State</b></em>'.
 * <!-- end-user-doc -->
 * <p>
...
public class PseudoStateImpl extends MinimalEObjectImpl.Container implements PseudoState {
  ...
  public void setId(String newId) {
    ...
    if (eNotificationRequired()) {
      eNotify(new ENotificationImpl(this, Notification.SET, Statechart_1_0Package.PSEUDO_STATE__ID,
          oldId, id));
    }
  }
  ...
  public void setName(String newName) {
    ...
    if (eNotificationRequired()) {
      eNotify(new ENotificationImpl(this, Notification.SET,
          Statechart_1_0Package.PSEUDO_STATE__NAME, oldName, name));
    }
  }
