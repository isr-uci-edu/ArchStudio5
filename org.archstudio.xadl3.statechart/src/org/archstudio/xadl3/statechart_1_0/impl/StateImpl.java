 ...
 * <li>{@link org.archstudio.xadl3.statechart_1_0.impl.StateImpl#getSubStatechart
...
public class StateImpl extends PseudoStateImpl implements State {
  ...
  /**
   * The cached value of the '{@link #getSubStatechart() <em>Sub Statechart</em>}' containment
  ...
  public EList<Behavior> getEntry() {
    if (entry == null) {
      entry = new EObjectContainmentEList<Behavior>(Behavior.class, this,
          Statechart_1_0Package.STATE__ENTRY);
    }
    return entry;
  }
  ...
  public EList<Behavior> getExit() {
    if (exit == null) {
      exit = new EObjectContainmentEList<Behavior>(Behavior.class, this,
          Statechart_1_0Package.STATE__EXIT);
    }
    return exit;
  }
   ...
   * @generated
   */
  public NotificationChain basicSetSubStatechart(SubStatechart newSubStatechart,
  ...
  public void setSubStatechart(SubStatechart newSubStatechart) {
    if (newSubStatechart != subStatechart) {
      ...
      eNotify(new ENotificationImpl(this, Notification.SET,
          Statechart_1_0Package.STATE__SUB_STATECHART, newSubStatechart, newSubStatechart));
    }
  }
  ...
  public void setType(StateType newType) {
    ...
    typeESet = true;
    if (eNotificationRequired()) {
      eNotify(new ENotificationImpl(this, Notification.SET, Statechart_1_0Package.STATE__TYPE,
  ...
  public void unsetType() {
    ...
    typeESet = false;
    if (eNotificationRequired()) {
      eNotify(new ENotificationImpl(this, Notification.UNSET, Statechart_1_0Package.STATE__TYPE,
