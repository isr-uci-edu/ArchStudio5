...
public class StateImpl extends PseudoStateImpl implements State
{
  ...
  public NotificationChain basicSetSubStatechart(SubStatechart newSubStatechart, NotificationChain msgs)
  {
    ...
    {
      ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, Statechart_1_0Package.STATE__SUB_STATECHART, oldSubStatechart, newSubStatechart);
  ...
  public void setSubStatechart(SubStatechart newSubStatechart)
  {
    if (newSubStatechart != subStatechart)
    {
      ...
      if (subStatechart != null)
        msgs = ((InternalEObject)subStatechart).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - Statechart_1_0Package.STATE__SUB_STATECHART, null, msgs);
      if (newSubStatechart != null)
        msgs = ((InternalEObject)newSubStatechart).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - Statechart_1_0Package.STATE__SUB_STATECHART, null, msgs);
      msgs = basicSetSubStatechart(newSubStatechart, msgs);
      if (msgs != null) msgs.dispatch();
    }
    else if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, Statechart_1_0Package.STATE__SUB_STATECHART, newSubStatechart, newSubStatechart));
  }
  ...
  public void setType(StateType newType)
  {
    ...
    typeESet = true;
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, Statechart_1_0Package.STATE__TYPE, oldType, type, !oldTypeESet));
  }
  ...
  public void unsetType()
  {
    ...
    typeESet = false;
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.UNSET, Statechart_1_0Package.STATE__TYPE, oldType, TYPE_EDEFAULT, oldTypeESet));
  }
