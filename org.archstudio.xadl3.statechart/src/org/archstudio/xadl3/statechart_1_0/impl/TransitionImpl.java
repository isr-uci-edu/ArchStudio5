 ...
 * <li>{@link org.archstudio.xadl3.statechart_1_0.impl.TransitionImpl#getConstraint
 * <em>Constraint</em>}</li>
...
public class TransitionImpl extends MinimalEObjectImpl.Container implements Transition {
  /**
   * The cached value of the '{@link #getFrom() <em>From</em>}' reference. <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * 
   * @see #getFrom()
   * @generated
  ...
  /**
   * The cached value of the '{@link #getTo() <em>To</em>}' reference. <!-- begin-user-doc --> <!--
   * end-user-doc -->
   * 
   * @see #getTo()
   * @generated
  ...
  public void setFrom(PseudoState newFrom) {
    ...
    if (eNotificationRequired()) {
      eNotify(new ENotificationImpl(this, Notification.SET, Statechart_1_0Package.TRANSITION__FROM,
          oldFrom, from));
    }
  }
  ...
  public void setTo(PseudoState newTo) {
    ...
    to = newTo;
    if (eNotificationRequired()) {
      eNotify(new ENotificationImpl(this, Notification.SET, Statechart_1_0Package.TRANSITION__TO,
          oldTo, to));
    }
  }
  ...
  public NotificationChain basicSetConstraint(Constraint newConstraint, NotificationChain msgs) {
    ...
    if (eNotificationRequired()) {
      ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
          Statechart_1_0Package.TRANSITION__CONSTRAINT, oldConstraint, newConstraint);
      if (msgs == null) {
        msgs = notification;
      } else {
  ...
  public void setConstraint(Constraint newConstraint) {
    if (newConstraint != constraint) {
      ...
      eNotify(new ENotificationImpl(this, Notification.SET,
          Statechart_1_0Package.TRANSITION__CONSTRAINT, newConstraint, newConstraint));
    }
  }
  ...
  public EList<Extension> getExt() {
    if (ext == null) {
      ext = new EObjectContainmentEList<Extension>(Extension.class, this,
          Statechart_1_0Package.TRANSITION__EXT);
    }
    return ext;
  }
  ...
  public void setId(String newId) {
    ...
    id = newId;
    if (eNotificationRequired()) {
      eNotify(new ENotificationImpl(this, Notification.SET, Statechart_1_0Package.TRANSITION__ID,
          oldId, id));
    }
  }
  ...
  public void setName(String newName) {
    ...
    name = newName;
    if (eNotificationRequired()) {
      eNotify(new ENotificationImpl(this, Notification.SET, Statechart_1_0Package.TRANSITION__NAME,
          oldName, name));
    }
  }
