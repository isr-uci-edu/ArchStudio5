...
public class InitialStateImpl extends PseudoStateImpl implements InitialState
{
  ...
  public void setType(StateType newType)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, Statechart_1_0Package.INITIAL_STATE__TYPE, oldType, type, !oldTypeESet));
  }
  ...
  public void unsetType()
  {
    ...
    typeESet = false;
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.UNSET, Statechart_1_0Package.INITIAL_STATE__TYPE, oldType, TYPE_EDEFAULT, oldTypeESet));
  }
