...
/**
 * <!-- begin-user-doc --> A representation of the model object '<em><b>Statechart</b></em>'. <!--
 * end-user-doc -->
 *
 * <p>
...
public interface Statechart extends EObject {
  /**
   * Returns the value of the '<em><b>State</b></em>' containment reference list. The list contents
   * are of type {@link org.archstudio.xadl3.statechart_1_0.PseudoState}. <!-- begin-user-doc -->
   * <p>
   * If the meaning of the '<em>State</em>' containment reference list isn't clear, there really
  ...
  /**
   * Returns the value of the '<em><b>Transition</b></em>' containment reference list. The list
   * contents are of type {@link org.archstudio.xadl3.statechart_1_0.Transition}. <!--
   * begin-user-doc -->
   * <p>
   * If the meaning of the '<em>Transition</em>' containment reference list isn't clear, there
  ...
  /**
   * Sets the value of the '{@link org.archstudio.xadl3.statechart_1_0.Statechart#getId <em>Id</em>}
  ...
  /**
   * Sets the value of the '{@link org.archstudio.xadl3.statechart_1_0.Statechart#getName
