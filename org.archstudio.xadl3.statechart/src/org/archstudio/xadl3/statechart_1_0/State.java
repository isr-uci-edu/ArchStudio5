 ...
 * <li>{@link org.archstudio.xadl3.statechart_1_0.State#getSubStatechart <em>Sub Statechart</em>}
 * </li>
...
public interface State extends PseudoState {
  /**
   * Returns the value of the '<em><b>Entry</b></em>' containment reference list. The list contents
   * are of type {@link org.archstudio.xadl3.statechart_1_0.Behavior}. <!-- begin-user-doc -->
   * <p>
   * If the meaning of the '<em>Entry</em>' containment reference list isn't clear, there really
  ...
  /**
   * Returns the value of the '<em><b>Exit</b></em>' containment reference list. The list contents
   * are of type {@link org.archstudio.xadl3.statechart_1_0.Behavior}. <!-- begin-user-doc -->
   * <p>
   * If the meaning of the '<em>Exit</em>' containment reference list isn't clear, there really
   * should be more of a description here...
   * </p>
   * <!-- end-user-doc -->
   * 
   ...
   * @model containment="true" extendedMetaData=
   *        "kind='element' name='exit' namespace='##targetNamespace'"
   * @generated
   */
  EList<Behavior> getExit();

  /**
   * Returns the value of the '<em><b>Sub Statechart</b></em>' containment reference. <!--
   * begin-user-doc -->
   * <p>
   * If the meaning of the '<em>Sub Statechart</em>' containment reference isn't clear, there really
   * should be more of a description here...
   * </p>
   * <!-- end-user-doc -->
   * 
   ...
   * @model containment="true" extendedMetaData=
   *        "kind='element' name='subStatechart' namespace='##targetNamespace'"
   * @generated
   */
  SubStatechart getSubStatechart();

  /**
   * Sets the value of the '{@link org.archstudio.xadl3.statechart_1_0.State#getSubStatechart
   * <em>Sub Statechart</em>}' containment reference. <!-- begin-user-doc --> <!-- end-user-doc -->
   * 
   * @param value the new value of the '<em>Sub Statechart</em>' containment reference.
   ...
   * <code>"state"</code>. The literals are from the enumeration
   ...
   * @model default="state" unsettable="true" extendedMetaData=
  ...
  /**
   * Sets the value of the '{@link org.archstudio.xadl3.statechart_1_0.State#getType <em>Type</em>}'
  ...
  /**
   * Unsets the value of the '{@link org.archstudio.xadl3.statechart_1_0.State#getType <em>Type</em>
   * }' attribute. <!-- begin-user-doc --> <!-- end-user-doc -->
   * 
   * @see #isSetType()
   * @see #getType()
  ...
  /**
   * Returns whether the value of the '{@link org.archstudio.xadl3.statechart_1_0.State#getType
