 ...
 * <ul>
 * <li>{@link org.archstudio.xadl3.statechart_1_0.State#getEntry <em>Entry</em>}
 * </li>
 * <li>{@link org.archstudio.xadl3.statechart_1_0.State#getExit <em>Exit</em>}</li>
 * <li>{@link org.archstudio.xadl3.statechart_1_0.State#getSubStatechart <em>Sub
 * Statechart</em>}</li>
...
public interface State extends PseudoState {
	 ...
	 * -->
	 * <p>
	 * If the meaning of the '<em>Exit</em>' containment reference list isn't
	 * clear, there really should be more of a description here...
	 * </p>
	 * <!-- end-user-doc -->
	 * 
	...
	/**
	 * Returns the value of the '<em><b>Sub Statechart</b></em>' containment
	 * reference. <!-- begin-user-doc -->
	 * <p>
	 * If the meaning of the '<em>Sub Statechart</em>' containment reference
	 ...
	 * 
	 * @param value
	 *            the new value of the '<em>Sub Statechart</em>' containment
	 *            reference.
	 ...
	 * value is <code>"state"</code>. The literals are from the enumeration
