...
public interface State extends PseudoState
{
   ...
   * The list contents are of type {@link org.archstudio.xadl3.statechart_1_0.Behavior}.
   * <!-- begin-user-doc -->
   * <p>
   ...
   * <!-- begin-user-doc -->
   * <p>
   * If the meaning of the '<em>Sub Statechart</em>' containment reference isn't clear,
   * there really should be more of a description here...
   * </p>
   * <!-- end-user-doc -->
   ...
   * @model containment="true"
   *        extendedMetaData="kind='element' name='subStatechart' namespace='##targetNamespace'"
   * @generated
   */
  SubStatechart getSubStatechart();

  /**
   * Sets the value of the '{@link org.archstudio.xadl3.statechart_1_0.State#getSubStatechart <em>Sub Statechart</em>}' containment reference.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   ...
   * The literals are from the enumeration {@link org.archstudio.xadl3.statechart_1_0.StateType}.
   * <!-- begin-user-doc -->
   * <p>
  ...
  /**
   * Returns whether the value of the '{@link org.archstudio.xadl3.statechart_1_0.State#getType <em>Type</em>}' attribute is set.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
