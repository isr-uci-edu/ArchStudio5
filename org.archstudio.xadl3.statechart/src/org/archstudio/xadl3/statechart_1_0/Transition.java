...
public interface Transition extends EObject {
  ...
  /**
   * Sets the value of the '{@link org.archstudio.xadl3.statechart_1_0.Transition#getFrom
   ...
   * <p>
   * If the meaning of the '<em>To</em>' reference isn't clear, there really should be more of a
   * description here...
   * </p>
   * <!-- end-user-doc -->
   * 
  ...
  /**
   * Sets the value of the '{@link org.archstudio.xadl3.statechart_1_0.Transition#getTo <em>To</em>}
   ...
   * begin-user-doc -->
   * <p>
   * If the meaning of the '<em>Constraint</em>' containment reference isn't clear, there really
   ...
   *        "kind='element' name='constraint' namespace='##targetNamespace'"
   * @generated
   */
  Constraint getConstraint();

  /**
   * Sets the value of the '{@link org.archstudio.xadl3.statechart_1_0.Transition#getConstraint
   * <em>Constraint</em>}' containment reference. <!-- begin-user-doc --> <!-- end-user-doc -->
   * 
  ...
  /**
   * Sets the value of the '{@link org.archstudio.xadl3.statechart_1_0.Transition#getId <em>Id</em>}
  ...
  /**
   * Sets the value of the '{@link org.archstudio.xadl3.statechart_1_0.Transition#getName
