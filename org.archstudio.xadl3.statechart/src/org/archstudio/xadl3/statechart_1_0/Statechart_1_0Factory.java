...
public interface Statechart_1_0Factory extends EFactory {
   ...
   * @generated
   */
  Statechart_1_0Factory eINSTANCE =
      org.archstudio.xadl3.statechart_1_0.impl.Statechart_1_0FactoryImpl.init();
  ...
  /**
   * Returns a new object of class '<em>Initial State</em>'. <!-- begin-user-doc --> <!--
   * end-user-doc -->
   * 
  ...
  /**
   * Returns a new object of class '<em>Pseudo State</em>'. <!-- begin-user-doc --> <!--
   * end-user-doc -->
   * 
  ...
  /**
   * Returns a new object of class '<em>Statechart Specification</em>'. <!-- begin-user-doc --> <!--
   * end-user-doc -->
   * 
  ...
  /**
   * Returns a new object of class '<em>Sub Statechart</em>'. <!-- begin-user-doc --> <!--
   * end-user-doc -->
   * 
