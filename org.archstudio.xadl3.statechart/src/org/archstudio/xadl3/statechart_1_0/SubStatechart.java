...
/**
 * <!-- begin-user-doc -->
 * A representation of the model object '<em><b>Sub Statechart</b></em>'.
 * <!-- end-user-doc -->
 *
 * <p>
...
{
  /**
   * Returns the value of the '<em><b>Inner Statechart</b></em>' reference.
   * <!-- begin-user-doc -->
   * <p>
   * If the meaning of the '<em>Inner Statechart</em>' reference isn't clear,
  ...
  /**
   * Sets the value of the '{@link org.archstudio.xadl3.statechart_1_0.SubStatechart#getInnerStatechart <em>Inner Statechart</em>}' reference.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * @param value the new value of the '<em>Inner Statechart</em>' reference.
