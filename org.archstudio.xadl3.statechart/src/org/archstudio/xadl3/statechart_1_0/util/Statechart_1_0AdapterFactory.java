...
public class Statechart_1_0AdapterFactory extends AdapterFactoryImpl {
   ...
   * {@link org.archstudio.xadl3.statechart_1_0.Behavior <em>Behavior</em>}'. <!-- begin-user-doc
  ...
  /**
   * Creates a new adapter for an object of class '
   * {@link org.archstudio.xadl3.statechart_1_0.Constraint <em>Constraint</em>}'. <!--
  ...
  /**
   * Creates a new adapter for an object of class '
   * {@link org.archstudio.xadl3.statechart_1_0.DocumentRoot <em>Document Root</em>}'. <!--
   * begin-user-doc --> This default implementation returns null so that we can easily ignore cases;
   * it's useful to ignore a case when inheritance will catch all the cases anyway. <!--
   * end-user-doc -->
   * 
  ...
  /**
   * Creates a new adapter for an object of class '
   * {@link org.archstudio.xadl3.statechart_1_0.FinalState <em>Final State</em>}'. <!--
   * begin-user-doc --> This default implementation returns null so that we can easily ignore cases;
   * it's useful to ignore a case when inheritance will catch all the cases anyway. <!--
   * end-user-doc -->
   * 
  ...
  /**
   * Creates a new adapter for an object of class '
   * {@link org.archstudio.xadl3.statechart_1_0.InitialState <em>Initial State</em>}'. <!--
   * begin-user-doc --> This default implementation returns null so that we can easily ignore cases;
   * it's useful to ignore a case when inheritance will catch all the cases anyway. <!--
   * end-user-doc -->
   * 
  ...
  /**
   * Creates a new adapter for an object of class '
   * {@link org.archstudio.xadl3.statechart_1_0.PseudoState <em>Pseudo State</em>}'. <!--
   * begin-user-doc --> This default implementation returns null so that we can easily ignore cases;
   * it's useful to ignore a case when inheritance will catch all the cases anyway. <!--
   * end-user-doc -->
   * 
  ...
  /**
   * Creates a new adapter for an object of class '{@link org.archstudio.xadl3.statechart_1_0.State
  ...
  /**
   * Creates a new adapter for an object of class '
   * {@link org.archstudio.xadl3.statechart_1_0.Statechart <em>Statechart</em>}'. <!--
   * begin-user-doc --> This default implementation returns null so that we can easily ignore cases;
   * it's useful to ignore a case when inheritance will catch all the cases anyway. <!--
   * end-user-doc -->
   * 
   ...
   * <em>Statechart Specification</em>}'. <!-- begin-user-doc --> This default implementation
  ...
  /**
   * Creates a new adapter for an object of class '
   * {@link org.archstudio.xadl3.statechart_1_0.SubStatechart <em>Sub Statechart</em>}'. <!--
   * begin-user-doc --> This default implementation returns null so that we can easily ignore cases;
   * it's useful to ignore a case when inheritance will catch all the cases anyway. <!--
   * end-user-doc -->
   * 
  ...
  /**
   * Creates a new adapter for an object of class '
   * {@link org.archstudio.xadl3.statechart_1_0.Transition <em>Transition</em>}'. <!--
   * begin-user-doc --> This default implementation returns null so that we can easily ignore cases;
   * it's useful to ignore a case when inheritance will catch all the cases anyway. <!--
   * end-user-doc -->
   * 
  ...
  /**
   * Creates a new adapter for an object of class '
   * {@link org.archstudio.xadl3.xadlcore_3_0.Extension <em>Extension</em>}'. <!-- begin-user-doc
   * --> This default implementation returns null so that we can easily ignore cases; it's useful to
   * ignore a case when inheritance will catch all the cases anyway. <!-- end-user-doc -->
   * 
   * @return the new adapter.
