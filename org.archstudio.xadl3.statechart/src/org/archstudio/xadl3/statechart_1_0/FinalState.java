...
/**
 * <!-- begin-user-doc --> A representation of the model object '<em><b>Final State</b></em>'. <!--
 * end-user-doc -->
 *
 * <p>
...
public interface FinalState extends PseudoState {
   ...
   * <code>"final"</code>. The literals are from the enumeration
   ...
   * @model default="final" unsettable="true" extendedMetaData=
  ...
  /**
   * Sets the value of the '{@link org.archstudio.xadl3.statechart_1_0.FinalState#getType
  ...
  /**
   * Unsets the value of the '{@link org.archstudio.xadl3.statechart_1_0.FinalState#getType
   * <em>Type</em>}' attribute. <!-- begin-user-doc --> <!-- end-user-doc -->
   * 
   * @see #isSetType()
   * @see #getType()
  ...
  /**
   * Returns whether the value of the '{@link org.archstudio.xadl3.statechart_1_0.FinalState#getType
