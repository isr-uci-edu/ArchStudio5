 ...
 *
 * To modify, update the "Abstract ArchStudio Editor Component Impl" MyxGen extension in the
 * org.archstudio.eclipse.ui plugin.
 */
...
public abstract class AbstractArchStudioEditorMyxComponentStub
   ...
   * org.archstudio.eclipse.ui.IFocusEditorListener.
   * 
   ...
   * automatically delegated to all service objects in the MyxRegistry of type
   * org.archstudio.filemanager.IFileManagerListener.
   * 
  ...
  protected final org.archstudio.xarchadt.variability.IXArchADTVariabilityListener variabilityEventsProxy =
      (org.archstudio.xarchadt.variability.IXArchADTVariabilityListener) java.lang.reflect.Proxy
          .newProxyInstance(
  ...
  public void interfaceConnected(IMyxName interfaceName, Object serviceObject) {
    ...
    if (interfaceName.equals(OUT_RESOURCES)) {
      if (resources != null) {
        throw new IllegalStateException(
            "Only a single connection is supported on interface: resources");
      }
    ...
    if (interfaceName.equals(OUT_EDITOR_MANAGER)) {
      if (editorManager != null) {
        throw new IllegalStateException(
            "Only a single connection is supported on interface: editorManager");
      }
    ...
    if (interfaceName.equals(OUT_FILE_MANAGER)) {
      if (fileManager != null) {
        throw new IllegalStateException(
            "Only a single connection is supported on interface: fileManager");
      }
    ...
    if (interfaceName.equals(OUT_XARCH)) {
      if (xarch != null) {
        throw new IllegalStateException(
            "Only a single connection is supported on interface: xarch");
      }
