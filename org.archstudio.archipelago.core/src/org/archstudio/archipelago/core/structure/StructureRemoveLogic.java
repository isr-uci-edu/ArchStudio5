...
import org.archstudio.archipelago.core.util.AbstractRemoveLogic;
...
public class StructureRemoveLogic extends AbstractRemoveLogic{

	public StructureRemoveLogic(ArchipelagoServices AS, ObjRef xArchRef){
		super(AS, xArchRef);
	}
