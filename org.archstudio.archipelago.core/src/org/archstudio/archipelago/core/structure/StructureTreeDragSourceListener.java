...
public class StructureTreeDragSourceListener implements DragSourceListener {
	...
	public void dragStart(DragSourceEvent event){
		if((event.data != null) && (event.data instanceof ObjRef)){
			if(AS.xarch.isInstanceOf((ObjRef)event.data, "edu.uci.isr.xadl3.structure_3_0.Structure")){
					...
					if(view != null){
						...
						if(m != null){
							...
							if(editingXArchID != null){
								...
								if(editingRef != null){
									if(AS.xarch.isInstanceOf(editingRef, "edu.uci.isr.xadl3.structure_3_0.Structure")){
										event.doit = true;
