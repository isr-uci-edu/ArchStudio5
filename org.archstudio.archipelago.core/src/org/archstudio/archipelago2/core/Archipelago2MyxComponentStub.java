 ...
 *
 * To modify, update the "Archipelago v2.0 Impl" MyxGen extension in the
 * org.archstudio.archipelago.core plugin.
 */

/**
 * Abstract Myx brick: Archipelago v2.0 Impl
 *
 * @generated
 */
public abstract class Archipelago2MyxComponentStub
   ...
   * @generated
   */
  protected Archipelago2MyxComponentStub(java.lang.String editorName,
      java.lang.String eclipseEditorID, boolean registerWithEditorManager) {
    ...
    if (interfaceName.equals(OUT_GRAPH_LAYOUT)) {
      if (graphLayout != null) {
        throw new IllegalStateException(
            "Only a single connection is supported on interface: graphLayout");
      }
