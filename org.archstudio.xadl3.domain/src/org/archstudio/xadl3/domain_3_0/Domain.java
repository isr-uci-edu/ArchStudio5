 ...
 * begin-model-doc --> This type defines an element that can be added to another element to indicate its domain. <!--
 * end-model-doc -->
 * <p>
...
public interface Domain extends EObject {
	 ...
	 * @model unsettable="true" extendedMetaData="kind='attribute' name='type' namespace='##targetNamespace'"
	 * @generated
	 */
	DomainType getType();

	/**
	 * Sets the value of the '{@link org.archstudio.xadl3.domain_3_0.Domain#getType <em>Type</em>}' attribute. <!--
	...
	/**
	 * Unsets the value of the '{@link org.archstudio.xadl3.domain_3_0.Domain#getType <em>Type</em>}' attribute. <!--
	 * begin-user-doc --> <!-- end-user-doc -->
	 * 
	 * @see #isSetType()
	 * @see #getType()
	...
	/**
	 * Returns whether the value of the '{@link org.archstudio.xadl3.domain_3_0.Domain#getType <em>Type</em>}' attribute
