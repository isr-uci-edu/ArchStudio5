 ...
 * <em><b>Domain Type</b></em>', and utility methods for working with them. <!-- end-user-doc -->
 * <!-- begin-model-doc -->
 * 
 * This enumeration defines allowable domains for interfaces in styles that support the notion of
 * domains.
 * 
...
public enum DomainType implements Enumerator {
   ...
   * <p>
   * If the meaning of '<em><b>Top</b></em>' literal object isn't clear, there really should be more
   ...
   * <p>
   * If the meaning of '<em><b>Bottom</b></em>' literal object isn't clear, there really should be
  ...
  /**
   * An array of all the '<em><b>Domain Type</b></em>' enumerators. <!-- begin-user-doc --> <!--
   * end-user-doc -->
   * 
   * @generated
   */
   ...
   * @generated
   */
  public static final List<DomainType> VALUES =
