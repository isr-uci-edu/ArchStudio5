...
public class Domain_3_0PackageImpl extends EPackageImpl implements Domain_3_0Package {
   ...
   * 
   * <p>
   * This method is used to initialize {@link Domain_3_0Package#eINSTANCE} when that field is
  ...
  public static Domain_3_0Package init() {
    if (isInited) {
      return (Domain_3_0Package) EPackage.Registry.INSTANCE.getEPackage(Domain_3_0Package.eNS_URI);
    }

    // Obtain or create and register package
    Domain_3_0PackageImpl theDomain_3_0Package = (Domain_3_0PackageImpl) (EPackage.Registry.INSTANCE
        .get(eNS_URI) instanceof Domain_3_0PackageImpl ? EPackage.Registry.INSTANCE.get(eNS_URI)
            : new Domain_3_0PackageImpl());
  ...
  public void initializePackageContents() {
    ...
    initEAttribute(getDomain_Type(), this.getDomainType(), "type", null, 0, 1, Domain.class,
        !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED,
        IS_ORDERED);

    initEClass(domainExtensionEClass, DomainExtension.class, "DomainExtension", !IS_ABSTRACT,
        !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
    initEReference(getDomainExtension_Domain(), this.getDomain(), null, "domain", null, 1, 1,
        DomainExtension.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE,
    ...
    initEDataType(domainTypeObjectEDataType, DomainType.class, "DomainTypeObject", IS_SERIALIZABLE,
        IS_GENERATED_INSTANCE_CLASS);
  ...
  protected void createExtendedMetaDataAnnotations() {
    ...
    addAnnotation(domainExtensionEClass, source,
        new String[] {"name", "DomainExtension", "kind", "elementOnly"});
