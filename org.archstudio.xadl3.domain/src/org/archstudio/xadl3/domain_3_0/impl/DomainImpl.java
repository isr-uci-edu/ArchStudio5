...
public class DomainImpl extends MinimalEObjectImpl.Container implements Domain {
  ...
  public void setType(DomainType newType) {
    ...
    if (eNotificationRequired()) {
      eNotify(new ENotificationImpl(this, Notification.SET, Domain_3_0Package.DOMAIN__TYPE, oldType,
          type, !oldTypeESet));
    }
  }
  ...
  public void unsetType() {
    ...
    typeESet = false;
    if (eNotificationRequired()) {
      eNotify(new ENotificationImpl(this, Notification.UNSET, Domain_3_0Package.DOMAIN__TYPE,
