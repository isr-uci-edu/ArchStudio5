 ...
 * 
 * This schema defines the concept of a domain, usually applied to interfaces. In some architectural
 * styles, (Myx, C2) interfaces have different domains that establish dependency relationships and
 * topological layout.
 * 
...
public interface Domain_3_0Package extends EPackage {
  ...
  /**
   * The meta object id for the '{@link org.archstudio.xadl3.domain_3_0.impl.DomainImpl
  ...
  /**
   * The number of structural features of the '<em>Domain</em>' class. <!-- begin-user-doc --> <!--
   * end-user-doc -->
   * 
   * @generated
   * @ordered
  ...
  /**
   * The feature id for the '<em><b>Domain</b></em>' containment reference. <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * 
   * @generated
   * @ordered
  ...
  /**
   * The number of operations of the '<em>Domain Extension</em>' class. <!-- begin-user-doc --> <!--
   * end-user-doc -->
   * 
   * @generated
   * @ordered
  ...
  /**
   * The meta object id for the '{@link org.archstudio.xadl3.domain_3_0.DomainType
   * <em>Domain Type</em>}' enum. <!-- begin-user-doc --> <!-- end-user-doc -->
   * 
  ...
  /**
   * The meta object id for the '<em>Domain Type Object</em>' data type. <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * 
   * @see org.archstudio.xadl3.domain_3_0.DomainType
  ...
  /**
   * Returns the meta object for class '{@link org.archstudio.xadl3.domain_3_0.Domain
   ...
   * {@link org.archstudio.xadl3.domain_3_0.Domain#getType <em>Type</em>}'. <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * 
   ...
   * {@link org.archstudio.xadl3.domain_3_0.DomainExtension#getDomain <em>Domain</em>}'. <!--
  ...
  /**
   * Returns the meta object for enum '{@link org.archstudio.xadl3.domain_3_0.DomainType
   * <em>Domain Type</em>}'. <!-- begin-user-doc --> <!-- end-user-doc -->
   * 
  ...
  interface Literals {
    /**
     * The meta object literal for the '{@link org.archstudio.xadl3.domain_3_0.impl.DomainImpl
     * <em>Domain</em>}' class. <!-- begin-user-doc --> <!-- end-user-doc -->
     * 
     * @see org.archstudio.xadl3.domain_3_0.impl.DomainImpl
     * @see org.archstudio.xadl3.domain_3_0.impl.Domain_3_0PackageImpl#getDomain()
     ...
     * {@link org.archstudio.xadl3.domain_3_0.impl.DomainExtensionImpl <em>Domain Extension</em>}'
    ...
    /**
     * The meta object literal for the '{@link org.archstudio.xadl3.domain_3_0.DomainType
     * <em>Domain Type</em>}' enum. <!-- begin-user-doc --> <!-- end-user-doc -->
     * 
     * @see org.archstudio.xadl3.domain_3_0.DomainType
     * @see org.archstudio.xadl3.domain_3_0.impl.Domain_3_0PackageImpl#getDomainType()
