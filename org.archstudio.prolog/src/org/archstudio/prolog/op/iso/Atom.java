...
public class Atom extends ComplexTerm implements Operation {

	public Atom(String name, List<? extends Term> terms) {
		super(name, terms);
	...
	public Map<VariableTerm, Term> execute(ProofEngine proofEngine, ProofContext proofContext,
		...
		return t instanceof ConstantTerm ? variables : null;
	}
