...
class MyxBasicWeld implements IMyxWeld {
	...
	public MyxBasicWeld(List<? extends IMyxName> requiredPath, IMyxName requiredBrickName, IMyxName requiredInterfaceName,
	...
	public int hashCode() {
		return MyxUtils.hc(requiredPath) ^ MyxUtils.hc(requiredBrickName) ^ MyxUtils.hc(requiredInterfaceName) ^ MyxUtils.hc(providedPath)
		        ^ MyxUtils.hc(providedBrickName) ^ MyxUtils.hc(providedInterfaceName);
	}

	public boolean equals(Object o) {
		return (o == this) || MyxUtils.classeq(this, o) && MyxUtils.nulleq(this.requiredPath, ((MyxBasicWeld) o).requiredPath)
	...
	public String toString() {
		return "MyxBasicWeld{requiredPath=" + MyxUtils.pathToString(requiredPath) + "; requiredBrickName=" + requiredBrickName + "; requiredInterfaceName="
		        + requiredInterfaceName + "; providedPath=" + MyxUtils.pathToString(providedPath) + "; providedBrickName=" + providedBrickName
