...
public abstract class XArchADTVariabilityMyxComponentStub extends
   ...
   * delegated to all connections on the interface
   * 
   * @see #OUT_FILE_EVENTS
   * @generated
   */
   ...
   * automatically delegated to all connections on the interface
   * 
   * @see #OUT_MODEL_EVENTS
   * @generated
   */
   ...
   * @generated
   */
  protected final java.util.Collection<org.archstudio.xarchadt.variability.IXArchADTVariabilityListener> variabilityEvents =
      new java.util.concurrent.CopyOnWriteArrayList<org.archstudio.xarchadt.variability.IXArchADTVariabilityListener>();
  ...
  public void interfaceConnected(IMyxName interfaceName, Object serviceObject) {
    ...
    if (interfaceName.equals(OUT_VARIABILITY_EVENTS)) {
      variabilityEvents
          .add((org.archstudio.xarchadt.variability.IXArchADTVariabilityListener) serviceObject);
      return;
    }
