...
public class _jet_main implements JET2Template {
    ...
    private static final TagInfo _td_ws_folder_6_3 = new TagInfo("ws:folder", //$NON-NLS-1$
            ...
            new String[] {
                "{$org.archstudio.myxgen.src.folder}", //$NON-NLS-1$
            } );
    private static final TagInfo _td_java_class_7_3 = new TagInfo("java:class", //$NON-NLS-1$
            ...
            new String[] {
                "{$org.archstudio.myxgen.package}", //$NON-NLS-1$
    ...
    public void generate(final JET2Context context, final JET2Writer __out) {
        ...
        while (_jettag_ws_project_5_1.okToProcessBody()) {
            RuntimeTagElement _jettag_ws_folder_6_3 = context.getTagFactory().createRuntimeTag(_jetns_ws, "folder", "ws:folder", _td_ws_folder_6_3); //$NON-NLS-1$ //$NON-NLS-2$
            ...
            while (_jettag_ws_folder_6_3.okToProcessBody()) {
                out.write("  ");  //$NON-NLS-1$        
                RuntimeTagElement _jettag_java_class_7_3 = context.getTagFactory().createRuntimeTag(_jetns_java, "class", "java:class", _td_java_class_7_3); //$NON-NLS-1$ //$NON-NLS-2$
