...
public class _jet_MyxCompjava implements JET2Template {
    ...
    public void generate(final JET2Context context, final JET2Writer __out) {
        ...
        RuntimeTagElement _jettag_java_merge_5_1 = context.getTagFactory().createRuntimeTag(_jetns_java, "merge", "java:merge", _td_java_merge_5_1); //$NON-NLS-1$ //$NON-NLS-2$
