 ...
 * <ul>
 * <li>{@link org.archstudio.prolog.xtext.prolog.impl.ProgramImpl#getClauses
 * <em>Clauses</em>}</li>
 * <li>{@link org.archstudio.prolog.xtext.prolog.impl.ProgramImpl#getQuery <em>
 * Query</em>}</li>
 * </ul>
 * </p>
 * 
	...
	public NotificationChain basicSetQuery(Query newQuery, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
					PrologPackage.PROGRAM__QUERY, oldQuery, newQuery);
			if (msgs == null) {
				msgs = notification;
			}
			else {
		...
		if (newQuery != query) {
			...
			if (query != null) {
				msgs = ((InternalEObject) query).eInverseRemove(this, EOPPOSITE_FEATURE_BASE
						- PrologPackage.PROGRAM__QUERY, null, msgs);
			}
			if (newQuery != null) {
