...
public class ProgramImpl extends MinimalEObjectImpl.Container implements Program
{
   ...
   * @ordered
   */
  protected EList<SingleClause> clauses;
   ...
   * @generated
   */
  public EList<SingleClause> getClauses()
  {
    if (clauses == null)
    {
      clauses = new EObjectContainmentEList<SingleClause>(SingleClause.class, this, PrologPackage.PROGRAM__CLAUSES);
    }
    return clauses;
  }
  ...
  public void eSet(int featureID, Object newValue)
  {
    switch (featureID)
    {
      case PrologPackage.PROGRAM__CLAUSES:
        getClauses().clear();
        getClauses().addAll((Collection<? extends SingleClause>)newValue);
        return;
      case PrologPackage.PROGRAM__QUERY:
