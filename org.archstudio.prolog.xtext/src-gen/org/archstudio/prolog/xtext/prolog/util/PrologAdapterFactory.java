...
public class PrologAdapterFactory extends AdapterFactoryImpl
{
  ...
  protected PrologSwitch<Adapter> modelSwitch =
    new PrologSwitch<Adapter>()
    {
      ...
      @Override
      public Adapter caseSingleClause(SingleClause object)
      {
        return createSingleClauseAdapter();
      }
      @Override
      ...
      @Override
      public Adapter caseSingleTerm(SingleTerm object)
      {
        return createSingleTermAdapter();
      }
      @Override
  ...
  /**
   * Creates a new adapter for an object of class '{@link org.archstudio.prolog.xtext.prolog.SingleClause <em>Single Clause</em>}'.
   * <!-- begin-user-doc -->
   * This default implementation returns null so that we can easily ignore cases;
   * it's useful to ignore a case when inheritance will catch all the cases anyway.
   * <!-- end-user-doc -->
   ...
   * @generated
   */
  public Adapter createSingleClauseAdapter()
  {
    return null;
  }
  ...
  /**
   * Creates a new adapter for an object of class '{@link org.archstudio.prolog.xtext.prolog.Predicate <em>Predicate</em>}'.
   * <!-- begin-user-doc -->
   * This default implementation returns null so that we can easily ignore cases;
   * it's useful to ignore a case when inheritance will catch all the cases anyway.
   * <!-- end-user-doc -->
  ...
  /**
   * Creates a new adapter for an object of class '{@link org.archstudio.prolog.xtext.prolog.SingleTerm <em>Single Term</em>}'.
   * <!-- begin-user-doc -->
   * This default implementation returns null so that we can easily ignore cases;
   * it's useful to ignore a case when inheritance will catch all the cases anyway.
   * <!-- end-user-doc -->
   ...
   * @generated
   */
  public Adapter createSingleTermAdapter()
  {
    return null;
  }
