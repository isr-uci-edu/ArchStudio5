...
/**
 * <!-- begin-user-doc --> An implementation of the model object '<em><b>Test</b></em>'. <!--
 * end-user-doc -->
 * <p>
...
public class TestImpl extends MinimalEObjectImpl.Container implements Test {
  ...
  public EList<Extension> getExt() {
    if (ext == null) {
      ext = new EObjectContainmentEList<Extension>(Extension.class, this,
          Archlight_3_0Package.TEST__EXT);
    }
    return ext;
  }
  ...
  public void setEnabled(boolean newEnabled) {
    ...
    if (eNotificationRequired()) {
      eNotify(new ENotificationImpl(this, Notification.SET, Archlight_3_0Package.TEST__ENABLED,
  ...
  public void unsetEnabled() {
    ...
    enabledESet = false;
    if (eNotificationRequired()) {
      eNotify(new ENotificationImpl(this, Notification.UNSET, Archlight_3_0Package.TEST__ENABLED,
  ...
  public void setId(String newId) {
    ...
    if (eNotificationRequired()) {
      eNotify(
          new ENotificationImpl(this, Notification.SET, Archlight_3_0Package.TEST__ID, oldId, id));
    }
  }
  ...
  public void setName(String newName) {
    ...
    name = newName;
    if (eNotificationRequired()) {
      eNotify(new ENotificationImpl(this, Notification.SET, Archlight_3_0Package.TEST__NAME,
          oldName, name));
    }
  }
