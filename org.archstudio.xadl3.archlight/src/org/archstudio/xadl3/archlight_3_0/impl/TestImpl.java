...
public class TestImpl extends EObjectImpl implements Test {
	...
	public void setEnabled(boolean newEnabled) {
		...
		if (eNotificationRequired()) {
			eNotify(new ENotificationImpl(this, Notification.SET, Archlight_3_0Package.TEST__ENABLED, oldEnabled,
	...
	public void unsetEnabled() {
		...
		enabledESet = false;
		if (eNotificationRequired()) {
			eNotify(new ENotificationImpl(this, Notification.UNSET, Archlight_3_0Package.TEST__ENABLED, oldEnabled,
