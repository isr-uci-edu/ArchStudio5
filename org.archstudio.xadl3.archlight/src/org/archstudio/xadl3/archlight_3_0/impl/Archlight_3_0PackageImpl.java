...
public class Archlight_3_0PackageImpl extends EPackageImpl implements Archlight_3_0Package {
	 ...
	 * 
	 * <p>
	 * This method is used to initialize {@link Archlight_3_0Package#eINSTANCE}
	...
	public static Archlight_3_0Package init() {
		if (isInited) {
			return (Archlight_3_0Package) EPackage.Registry.INSTANCE.getEPackage(Archlight_3_0Package.eNS_URI);
		}
	...
	public void initializePackageContents() {
		...
		initEReference(getArchlight_Test(), this.getTest(), null, "test", null, 0, -1, Archlight.class, !IS_TRANSIENT,
				...
				IS_ORDERED);
		initEReference(getArchlight_Ext(), theXadlcore_3_0Package.getExtension(), null, "ext", null, 0, -1,
				Archlight.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES,
		...
		initEReference(getDocumentRoot_XSISchemaLocation(), ecorePackage.getEStringToStringMapEntry(), null,
				...
				!IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getDocumentRoot_Archlight(), this.getArchlight(), null, "archlight", null, 0, -2, null,
				IS_TRANSIENT, IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE,
				IS_DERIVED, IS_ORDERED);

		initEClass(testEClass, Test.class, "Test", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
		initEReference(getTest_Ext(), theXadlcore_3_0Package.getExtension(), null, "ext", null, 0, -1, Test.class,
				!IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE,
				IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getTest_Enabled(), theXMLTypePackage.getBoolean(), "enabled", null, 0, 1, Test.class,
				!IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getTest_Id(), theXMLTypePackage.getID(), "id", null, 0, 1, Test.class, !IS_TRANSIENT,
				!IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getTest_Name(), theXMLTypePackage.getString(), "name", null, 0, 1, Test.class, !IS_TRANSIENT,
				!IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
