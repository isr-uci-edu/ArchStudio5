...
public class Archlight_3_0PackageImpl extends EPackageImpl implements Archlight_3_0Package {
   ...
   * 
   * <p>
   * This method is used to initialize {@link Archlight_3_0Package#eINSTANCE} when that field is
  ...
  public static Archlight_3_0Package init() {
    if (isInited) {
      return (Archlight_3_0Package) EPackage.Registry.INSTANCE
          .getEPackage(Archlight_3_0Package.eNS_URI);
    }

    // Obtain or create and register package
    Archlight_3_0PackageImpl theArchlight_3_0Package =
        (Archlight_3_0PackageImpl) (EPackage.Registry.INSTANCE
            .get(eNS_URI) instanceof Archlight_3_0PackageImpl
  ...
  public void initializePackageContents() {
    ...
    initEReference(getArchlight_Test(), this.getTest(), null, "test", null, 0, -1, Archlight.class,
        !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES,
        !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
    initEReference(getArchlight_Ext(), theXadlcore_3_0Package.getExtension(), null, "ext", null, 0,
        -1, Archlight.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE,
    ...
    initEReference(getDocumentRoot_XSISchemaLocation(), ecorePackage.getEStringToStringMapEntry(),
        ...
        IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
    initEReference(getDocumentRoot_Archlight(), this.getArchlight(), null, "archlight", null, 0, -2,
    ...
    initEClass(testEClass, Test.class, "Test", !IS_ABSTRACT, !IS_INTERFACE,
        IS_GENERATED_INSTANCE_CLASS);
    initEReference(getTest_Ext(), theXadlcore_3_0Package.getExtension(), null, "ext", null, 0, -1,
        Test.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES,
        !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
    initEAttribute(getTest_Enabled(), theXMLTypePackage.getBoolean(), "enabled", null, 0, 1,
        Test.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_UNSETTABLE, !IS_ID, IS_UNIQUE,
        !IS_DERIVED, IS_ORDERED);
    initEAttribute(getTest_Id(), theXMLTypePackage.getID(), "id", null, 0, 1, Test.class,
        !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, IS_ID, IS_UNIQUE, !IS_DERIVED,
        IS_ORDERED);
    initEAttribute(getTest_Name(), theXMLTypePackage.getString(), "name", null, 0, 1, Test.class,
        !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED,
        IS_ORDERED);
  ...
  protected void createExtendedMetaDataAnnotations() {
    ...
    addAnnotation(archlightEClass, source,
        new String[] {"name", "Archlight", "kind", "elementOnly"});
    ...
    addAnnotation(getDocumentRoot_Archlight(), source,
        new String[] {"kind", "element", "name", "archlight", "namespace", "##targetNamespace",
            "affiliation",
