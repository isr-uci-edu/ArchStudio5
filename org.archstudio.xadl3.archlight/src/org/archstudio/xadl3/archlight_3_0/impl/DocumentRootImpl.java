 ...
 *   <li>{@link org.archstudio.xadl3.archlight_3_0.impl.DocumentRootImpl#getXSISchemaLocation <em>XSI Schema Location</em>}</li>
...
public class DocumentRootImpl extends EObjectImpl implements DocumentRoot
{
  ...
  public EMap<String, String> getXMLNSPrefixMap()
  {
    ...
    {
      xMLNSPrefixMap = new EcoreEMap<String,String>(EcorePackage.Literals.ESTRING_TO_STRING_MAP_ENTRY, EStringToStringMapEntryImpl.class, this, Archlight_3_0Package.DOCUMENT_ROOT__XMLNS_PREFIX_MAP);
    }
  ...
  public EMap<String, String> getXSISchemaLocation()
  {
    ...
    {
      xSISchemaLocation = new EcoreEMap<String,String>(EcorePackage.Literals.ESTRING_TO_STRING_MAP_ENTRY, EStringToStringMapEntryImpl.class, this, Archlight_3_0Package.DOCUMENT_ROOT__XSI_SCHEMA_LOCATION);
    }
  ...
  {
    return ((FeatureMap.Internal)getMixed()).basicAdd(Archlight_3_0Package.Literals.DOCUMENT_ROOT__ARCHLIGHT, newArchlight, msgs);
  }
