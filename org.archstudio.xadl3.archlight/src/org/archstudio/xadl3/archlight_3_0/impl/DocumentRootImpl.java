 ...
 * <li>{@link org.archstudio.xadl3.archlight_3_0.impl.DocumentRootImpl#getXMLNSPrefixMap
 * <em>XMLNS Prefix Map</em>}</li>
 * <li>{@link org.archstudio.xadl3.archlight_3_0.impl.DocumentRootImpl#getXSISchemaLocation
 * <em>XSI Schema Location</em>}</li>
 * <li>{@link org.archstudio.xadl3.archlight_3_0.impl.DocumentRootImpl#getArchlight
 * <em>Archlight</em>}</li>
 * </ul>
 *
 * @generated
...
public class DocumentRootImpl extends MinimalEObjectImpl.Container implements DocumentRoot {
  ...
  public EMap<String, String> getXMLNSPrefixMap() {
    if (xMLNSPrefixMap == null) {
      xMLNSPrefixMap = new EcoreEMap<String, String>(
          ...
          this, Archlight_3_0Package.DOCUMENT_ROOT__XMLNS_PREFIX_MAP);
    }
  ...
  public EMap<String, String> getXSISchemaLocation() {
    if (xSISchemaLocation == null) {
      xSISchemaLocation = new EcoreEMap<String, String>(
          EcorePackage.Literals.ESTRING_TO_STRING_MAP_ENTRY, EStringToStringMapEntryImpl.class,
          this, Archlight_3_0Package.DOCUMENT_ROOT__XSI_SCHEMA_LOCATION);
    }
  ...
  public NotificationChain basicSetArchlight(Archlight newArchlight, NotificationChain msgs) {
    return ((FeatureMap.Internal) getMixed())
        .basicAdd(Archlight_3_0Package.Literals.DOCUMENT_ROOT__ARCHLIGHT, newArchlight, msgs);
  }
  ...
  public void setArchlight(Archlight newArchlight) {
    ((FeatureMap.Internal) getMixed()).set(Archlight_3_0Package.Literals.DOCUMENT_ROOT__ARCHLIGHT,
        newArchlight);
  }
