...
/**
 * <!-- begin-user-doc --> An implementation of the model object '<em><b>Archlight</b></em>'. <!--
 * end-user-doc -->
 * <p>
...
public class ArchlightImpl extends MinimalEObjectImpl.Container implements Archlight {
  ...
  public EList<Test> getTest() {
    if (test == null) {
      test =
          new EObjectContainmentEList<Test>(Test.class, this, Archlight_3_0Package.ARCHLIGHT__TEST);
    }
    return test;
  }
  ...
  public EList<Extension> getExt() {
    if (ext == null) {
      ext = new EObjectContainmentEList<Extension>(Extension.class, this,
          Archlight_3_0Package.ARCHLIGHT__EXT);
    }
    return ext;
  }
