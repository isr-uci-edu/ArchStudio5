 ...
 * 
 * This schema defines a set of test references that can be added to a xADL document to indicate
 * what Archlight tests should be enabled on that document.
 * 
...
public interface Archlight_3_0Package extends EPackage {
   ...
   * @generated
   */
  Archlight_3_0Package eINSTANCE =
      org.archstudio.xadl3.archlight_3_0.impl.Archlight_3_0PackageImpl.init();

  /**
   * The meta object id for the '{@link org.archstudio.xadl3.archlight_3_0.impl.ArchlightImpl
  ...
  /**
   * The number of structural features of the '<em>Archlight</em>' class. <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * 
   * @generated
   * @ordered
  ...
  /**
   * The number of operations of the '<em>Archlight</em>' class. <!-- begin-user-doc --> <!--
   * end-user-doc -->
   * 
   * @generated
   * @ordered
  ...
  /**
   * The meta object id for the '{@link org.archstudio.xadl3.archlight_3_0.impl.TestImpl
  ...
  /**
   * The number of structural features of the '<em>Test</em>' class. <!-- begin-user-doc --> <!--
   * end-user-doc -->
   * 
   * @generated
   * @ordered
  ...
  /**
   * The number of operations of the '<em>Test</em>' class. <!-- begin-user-doc --> <!--
   * end-user-doc -->
   * 
   * @generated
   * @ordered
  ...
  /**
   * Returns the meta object for class '{@link org.archstudio.xadl3.archlight_3_0.Archlight
   ...
   * {@link org.archstudio.xadl3.archlight_3_0.Archlight#getTest <em>Test</em>}'. <!--
  ...
  /**
   * Returns the meta object for class '{@link org.archstudio.xadl3.archlight_3_0.DocumentRoot
   ...
   * {@link org.archstudio.xadl3.archlight_3_0.DocumentRoot#getMixed <em>Mixed</em>}'. <!--
   * begin-user-doc --> <!-- end-user-doc -->
   * 
   ...
   * {@link org.archstudio.xadl3.archlight_3_0.DocumentRoot#getArchlight <em>Archlight</em>}'. <!--
   * begin-user-doc --> <!-- end-user-doc -->
   * 
  ...
  /**
   * Returns the meta object for the containment reference list '
   * {@link org.archstudio.xadl3.archlight_3_0.Test#getExt <em>Ext</em>}'. <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * 
   * @return the meta object for the containment reference list '<em>Ext</em>'.
   ...
   * {@link org.archstudio.xadl3.archlight_3_0.Test#isEnabled <em>Enabled</em>}'. <!--
   * begin-user-doc --> <!-- end-user-doc -->
   * 
  ...
  /**
   * Returns the meta object for the attribute '{@link org.archstudio.xadl3.archlight_3_0.Test#getId
  ...
  /**
   * Returns the meta object for the attribute '
   * {@link org.archstudio.xadl3.archlight_3_0.Test#getName <em>Name</em>}'. <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * 
  ...
  interface Literals {
     ...
     * {@link org.archstudio.xadl3.archlight_3_0.impl.DocumentRootImpl <em>Document Root</em>}'
    ...
    /**
     * The meta object literal for the '{@link org.archstudio.xadl3.archlight_3_0.impl.TestImpl
     * <em>Test</em>}' class. <!-- begin-user-doc --> <!-- end-user-doc -->
     * 
     * @see org.archstudio.xadl3.archlight_3_0.impl.TestImpl
     * @see org.archstudio.xadl3.archlight_3_0.impl.Archlight_3_0PackageImpl#getTest()
