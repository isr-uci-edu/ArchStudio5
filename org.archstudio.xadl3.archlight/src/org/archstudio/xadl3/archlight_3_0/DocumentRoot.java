 ...
 * <li>{@link org.archstudio.xadl3.archlight_3_0.DocumentRoot#getXMLNSPrefixMap
 * <em>XMLNS Prefix Map</em>}</li>
 * <li>{@link org.archstudio.xadl3.archlight_3_0.DocumentRoot#getXSISchemaLocation
...
public interface DocumentRoot extends EObject {
  ...
  /**
   * Returns the value of the '<em><b>Archlight</b></em>' containment reference. <!-- begin-user-doc
   * --> <!-- end-user-doc --> <!-- begin-model-doc -->
   * 
   * This element is a top-level xADL element containing tests.
   * 
   * <!-- end-model-doc -->
   * 
   ...
   *        extendedMetaData=
   *        "kind='element' name='archlight' namespace='##targetNamespace' affiliation='http://www.archstudio.org/xadl3/schemas/xadlcore-3.0.xsd#topLevelElement'"
   * @generated
   */
  Archlight getArchlight();

  /**
   * Sets the value of the '{@link org.archstudio.xadl3.archlight_3_0.DocumentRoot#getArchlight
   * <em>Archlight</em>}' containment reference. <!-- begin-user-doc --> <!-- end-user-doc -->
   * 
