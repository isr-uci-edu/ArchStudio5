...
import org.archstudio.xadl3.archlight_3_0.*;
...
public class Archlight_3_0AdapterFactory extends AdapterFactoryImpl
{
   ...
   * @generated
   */
  protected Archlight_3_0Switch<Adapter> modelSwitch =
    new Archlight_3_0Switch<Adapter>()
    {
      @Override
  ...
  /**
   * Creates a new adapter for an object of class '{@link org.archstudio.xadl3.archlight_3_0.Archlight <em>Archlight</em>}'.
   * <!-- begin-user-doc -->
  ...
  /**
   * Creates a new adapter for an object of class '{@link org.archstudio.xadl3.archlight_3_0.DocumentRoot <em>Document Root</em>}'.
   * <!-- begin-user-doc -->
   * This default implementation returns null so that we can easily ignore cases;
   * it's useful to ignore a case when inheritance will catch all the cases anyway.
   * <!-- end-user-doc -->
  ...
  /**
   * Creates a new adapter for an object of class '{@link org.archstudio.xadl3.archlight_3_0.Test <em>Test</em>}'.
   * <!-- begin-user-doc -->
   * This default implementation returns null so that we can easily ignore cases;
   * it's useful to ignore a case when inheritance will catch all the cases anyway.
   * <!-- end-user-doc -->
