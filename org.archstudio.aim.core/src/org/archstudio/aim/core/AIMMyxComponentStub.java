 ...
 *
 * To modify, update the "AIM Myx Component Impl" MyxGen extension in the org.archstudio.aim.core
 * plugin.
 */
    ...
    if (interfaceName.equals(OUT_MYX_RUNTIME)) {
      if (myxRuntime != null) {
        throw new IllegalStateException(
            "Only a single connection is supported on interface: myxRuntime");
      }
