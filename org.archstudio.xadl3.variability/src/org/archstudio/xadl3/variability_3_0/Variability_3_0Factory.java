...
public interface Variability_3_0Factory extends EFactory {
   ...
   * @generated
   */
  Variability_3_0Factory eINSTANCE =
      org.archstudio.xadl3.variability_3_0.impl.Variability_3_0FactoryImpl.init();
  ...
  /**
   * Returns a new object of class '<em>Change Set Of Changes</em>'. <!-- begin-user-doc --> <!--
   * end-user-doc -->
   * 
  ...
  /**
   * Returns a new object of class '<em>Element Change</em>'. <!-- begin-user-doc --> <!--
   * end-user-doc -->
   * 
  ...
  /**
   * Returns a new object of class '<em>Element Many Change</em>'. <!-- begin-user-doc --> <!--
   * end-user-doc -->
   * 
  ...
  /**
   * Returns a new object of class '<em>Java Transform Change Set Of Changes</em>'. <!--
