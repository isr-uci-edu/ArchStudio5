...
public interface Variability_3_0Factory extends EFactory {
	...
	/**
	 * Returns a new object of class '<em>Attribute Change</em>'. <!-- begin-user-doc --> <!-- end-user-doc -->
	 * 
	...
	/**
	 * Returns a new object of class '<em>Change Set Of Changes</em>'. <!-- begin-user-doc --> <!-- end-user-doc -->
	 * 
	...
	/**
	 * Returns a new object of class '<em>Element Change</em>'. <!-- begin-user-doc --> <!-- end-user-doc -->
	 * 
	...
	/**
	 * Returns a new object of class '<em>Element Many Change</em>'. <!-- begin-user-doc --> <!-- end-user-doc -->
	 * 
	...
	/**
	 * Returns a new object of class '<em>Java Transform Change Set Of Changes</em>'. <!-- begin-user-doc --> <!--
	 * end-user-doc -->
	 * 
	 * @return a new object of class '<em>Java Transform Change Set Of Changes</em>'.
	 * @generated
	 */
	JavaTransformChangeSetOfChanges createJavaTransformChangeSetOfChanges();

	/**
	 * Returns a new object of class '<em>Transform Change Set Of Changes</em>'. <!-- begin-user-doc --> <!--
	 * end-user-doc -->
	 * 
	...
	/**
	 * Returns a new object of class '<em>Variability</em>'. <!-- begin-user-doc --> <!-- end-user-doc -->
	 * 
