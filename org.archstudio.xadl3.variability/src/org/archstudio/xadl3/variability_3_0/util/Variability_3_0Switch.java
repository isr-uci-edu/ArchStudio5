...
public class Variability_3_0Switch<T> extends Switch<T> {
  ...
  protected T doSwitch(int classifierID, EObject theEObject) {
    switch (classifierID) {
      ...
      case Variability_3_0Package.TRANSFORM_CHANGE_SET_OF_CHANGES: {
        TransformChangeSetOfChanges transformChangeSetOfChanges =
            (TransformChangeSetOfChanges) theEObject;
   ...
   * <em>Java Transform Change Set Of Changes</em>'. <!-- begin-user-doc --> This implementation
  ...
  /**
   * Returns the result of interpreting the object as an instance of '
   * <em>Transform Change Set Of Changes</em>'. <!-- begin-user-doc --> This implementation returns
