...
public class Variability_3_0Switch<T> extends Switch<T> {
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			...
			case Variability_3_0Package.JAVA_TRANSFORM_CHANGE_SET_OF_CHANGES: {
				JavaTransformChangeSetOfChanges javaTransformChangeSetOfChanges =
						(JavaTransformChangeSetOfChanges) theEObject;
	...
	/**
	 * Returns the result of interpreting the object as an instance of '<em>Attribute Change</em>'. <!-- begin-user-doc
	...
	/**
	 * Returns the result of interpreting the object as an instance of '<em>Element Change</em>'. <!-- begin-user-doc
	 * --> This implementation returns null; returning a non-null result will terminate the switch. <!-- end-user-doc
	 * -->
	 * 
	 * @param object the target of the switch.
	...
	/**
	 * Returns the result of interpreting the object as an instance of '<em>Variability</em>'. <!-- begin-user-doc -->
	 * This implementation returns null; returning a non-null result will terminate the switch. <!-- end-user-doc -->
	 * 
	 * @param object the target of the switch.
