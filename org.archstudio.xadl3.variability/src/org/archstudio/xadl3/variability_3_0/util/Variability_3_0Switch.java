...
public class Variability_3_0Switch<T> extends Switch<T>
{
  ...
  protected T doSwitch(int classifierID, EObject theEObject)
  {
    switch (classifierID)
    {
      ...
      case Variability_3_0Package.CHANGE_SET_OF_CHANGES:
      {
        ...
        if (result == null) result = caseChangeSet(changeSetOfChanges);
        if (result == null) result = defaultCase(theEObject);
        return result;
      }
      ...
      case Variability_3_0Package.ELEMENT_MANY_CHANGE:
      {
        ...
        if (result == null) result = caseChange(elementManyChange);
        if (result == null) result = defaultCase(theEObject);
        return result;
      }
      case Variability_3_0Package.JAVA_TRANSFORM_CHANGE_SET_OF_CHANGES:
      {
        ...
        if (result == null) result = caseTransformChangeSetOfChanges(javaTransformChangeSetOfChanges);
        if (result == null) result = caseChangeSetOfChanges(javaTransformChangeSetOfChanges);
        if (result == null) result = caseChangeSet(javaTransformChangeSetOfChanges);
        if (result == null) result = defaultCase(theEObject);
        return result;
      }
      ...
      case Variability_3_0Package.TRANSFORM_CHANGE_SET_OF_CHANGES:
      {
        ...
        if (result == null) result = caseChangeSetOfChanges(transformChangeSetOfChanges);
        if (result == null) result = caseChangeSet(transformChangeSetOfChanges);
        if (result == null) result = defaultCase(theEObject);
        return result;
      }
  ...
  /**
   * Returns the result of interpreting the object as an instance of '<em>Change Set Of Changes</em>'.
   * <!-- begin-user-doc -->
   * This implementation returns null;
   * returning a non-null result will terminate the switch.
   * <!-- end-user-doc -->
   * @param object the target of the switch.
   * @return the result of interpreting the object as an instance of '<em>Change Set Of Changes</em>'.
   * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
   * @generated
   */
  ...
  /**
   * Returns the result of interpreting the object as an instance of '<em>Element Many Change</em>'.
   * <!-- begin-user-doc -->
   * This implementation returns null;
   * returning a non-null result will terminate the switch.
   * <!-- end-user-doc -->
   * @param object the target of the switch.
   * @return the result of interpreting the object as an instance of '<em>Element Many Change</em>'.
   * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
   * @generated
   */
  ...
  /**
   * Returns the result of interpreting the object as an instance of '<em>Java Transform Change Set Of Changes</em>'.
   * <!-- begin-user-doc -->
   * This implementation returns null;
   * returning a non-null result will terminate the switch.
   * <!-- end-user-doc -->
   * @param object the target of the switch.
   * @return the result of interpreting the object as an instance of '<em>Java Transform Change Set Of Changes</em>'.
   * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
   * @generated
   */
  ...
  /**
   * Returns the result of interpreting the object as an instance of '<em>Transform Change Set Of Changes</em>'.
   * <!-- begin-user-doc -->
   * This implementation returns null;
   * returning a non-null result will terminate the switch.
   * <!-- end-user-doc -->
   * @param object the target of the switch.
   * @return the result of interpreting the object as an instance of '<em>Transform Change Set Of Changes</em>'.
   * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
   * @generated
   */
