...
public class Variability_3_0AdapterFactory extends AdapterFactoryImpl {
	...
	/**
	 * Creates a new adapter for an object of class '{@link org.archstudio.xadl3.variability_3_0.AttributeChange
	 * <em>Attribute Change</em>}'. <!-- begin-user-doc --> This default implementation returns null so that we can
	...
	/**
	 * Creates a new adapter for an object of class '{@link org.archstudio.xadl3.variability_3_0.Change <em>Change</em>}
	...
	/**
	 * Creates a new adapter for an object of class '{@link org.archstudio.xadl3.variability_3_0.ChangeSet
	...
	/**
	 * Creates a new adapter for an object of class '{@link org.archstudio.xadl3.variability_3_0.ChangeSetOfChanges
	 * <em>Change Set Of Changes</em>}'. <!-- begin-user-doc --> This default implementation returns null so that we can
	 * easily ignore cases; it's useful to ignore a case when inheritance will catch all the cases anyway. <!--
	 * end-user-doc -->
	 * 
	 * @return the new adapter.
	...
	/**
	 * Creates a new adapter for an object of class '{@link org.archstudio.xadl3.variability_3_0.DocumentRoot
	...
	/**
	 * Creates a new adapter for an object of class '{@link org.archstudio.xadl3.variability_3_0.ElementChange
	 * <em>Element Change</em>}'. <!-- begin-user-doc --> This default implementation returns null so that we can easily
	 * ignore cases; it's useful to ignore a case when inheritance will catch all the cases anyway. <!-- end-user-doc
	 * -->
	 * 
	 * @return the new adapter.
	...
	/**
	 * Creates a new adapter for an object of class '{@link org.archstudio.xadl3.variability_3_0.ElementManyChange
	 * <em>Element Many Change</em>}'. <!-- begin-user-doc --> This default implementation returns null so that we can
	 * easily ignore cases; it's useful to ignore a case when inheritance will catch all the cases anyway. <!--
	 * end-user-doc -->
	 * 
	 * @return the new adapter.
	 ...
	 * <em>Java Transform Change Set Of Changes</em>}'. <!-- begin-user-doc --> This default implementation returns null
	...
	/**
	 * Creates a new adapter for an object of class '{@link org.archstudio.xadl3.variability_3_0.Relationship
	...
	/**
	 * Creates a new adapter for an object of class '
	 * {@link org.archstudio.xadl3.variability_3_0.TransformChangeSetOfChanges <em>Transform Change Set Of Changes</em>}
	 * '. <!-- begin-user-doc --> This default implementation returns null so that we can easily ignore cases; it's
	 * useful to ignore a case when inheritance will catch all the cases anyway. <!-- end-user-doc -->
	 * 
	 * @return the new adapter.
	...
	/**
	 * Creates a new adapter for an object of class '{@link org.archstudio.xadl3.variability_3_0.Variability
	 * <em>Variability</em>}'. <!-- begin-user-doc --> This default implementation returns null so that we can easily
	 * ignore cases; it's useful to ignore a case when inheritance will catch all the cases anyway. <!-- end-user-doc
	 * -->
	 * 
	 * @return the new adapter.
