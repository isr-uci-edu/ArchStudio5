...
public class Variability_3_0AdapterFactory extends AdapterFactoryImpl {
   ...
   * {@link org.archstudio.xadl3.variability_3_0.AttributeChange <em>Attribute Change</em>}'. <!--
  ...
  /**
   * Creates a new adapter for an object of class '
   * {@link org.archstudio.xadl3.variability_3_0.Change <em>Change</em>}'. <!-- begin-user-doc -->
  ...
  /**
   * Creates a new adapter for an object of class '
   * {@link org.archstudio.xadl3.variability_3_0.ChangeSet <em>Change Set</em>}'. <!--
   * begin-user-doc --> This default implementation returns null so that we can easily ignore cases;
   * it's useful to ignore a case when inheritance will catch all the cases anyway. <!--
   * end-user-doc -->
   * 
  ...
  /**
   * Creates a new adapter for an object of class '
   * {@link org.archstudio.xadl3.variability_3_0.DocumentRoot <em>Document Root</em>}'. <!--
   * begin-user-doc --> This default implementation returns null so that we can easily ignore cases;
   * it's useful to ignore a case when inheritance will catch all the cases anyway. <!--
   * end-user-doc -->
   * 
  ...
  /**
   * Creates a new adapter for an object of class '
   * {@link org.archstudio.xadl3.variability_3_0.ElementChange <em>Element Change</em>}'. <!--
   * begin-user-doc --> This default implementation returns null so that we can easily ignore cases;
   * it's useful to ignore a case when inheritance will catch all the cases anyway. <!--
   * end-user-doc -->
   * 
   ...
   * <em>Java Transform Change Set Of Changes</em>}'. <!-- begin-user-doc --> This default
  ...
  /**
   * Creates a new adapter for an object of class '
   * {@link org.archstudio.xadl3.variability_3_0.Relationship <em>Relationship</em>}'. <!--
   * begin-user-doc --> This default implementation returns null so that we can easily ignore cases;
   * it's useful to ignore a case when inheritance will catch all the cases anyway. <!--
   * end-user-doc -->
   * 
   ...
   * <em>Transform Change Set Of Changes</em>}'. <!-- begin-user-doc --> This default implementation
  ...
  /**
   * Creates a new adapter for an object of class '
   * {@link org.archstudio.xadl3.variability_3_0.Variability <em>Variability</em>}'. <!--
   * begin-user-doc --> This default implementation returns null so that we can easily ignore cases;
   * it's useful to ignore a case when inheritance will catch all the cases anyway. <!--
   * end-user-doc -->
   * 
