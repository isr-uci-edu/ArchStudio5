...
/**
 * <!-- begin-user-doc -->
 * A representation of the model object '<em><b>Change Set Of Changes</b></em>'.
 * <!-- end-user-doc -->
 *
 * <p>
...
{
  /**
   * Returns the value of the '<em><b>Element Change</b></em>' containment reference.
   * <!-- begin-user-doc -->
   * <p>
   * If the meaning of the '<em>Element Change</em>' containment reference isn't clear,
   ...
   *        extendedMetaData="kind='element' name='elementChange' namespace='##targetNamespace'"
   * @generated
   */
  ElementChange getElementChange();

  /**
   * Sets the value of the '{@link org.archstudio.xadl3.variability_3_0.ChangeSetOfChanges#getElementChange <em>Element Change</em>}' containment reference.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * @param value the new value of the '<em>Element Change</em>' containment reference.
