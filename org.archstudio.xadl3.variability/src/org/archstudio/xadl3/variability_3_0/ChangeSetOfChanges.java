...
public interface ChangeSetOfChanges extends ChangeSet {
	/**
	 * Returns the value of the '<em><b>Element Change</b></em>' containment
	 * reference. <!-- begin-user-doc -->
	 * <p>
	 * If the meaning of the '<em>Element Change</em>' containment reference
	 ...
	 * 
	 * @param value
	 *            the new value of the '<em>Element Change</em>' containment
	 *            reference.
