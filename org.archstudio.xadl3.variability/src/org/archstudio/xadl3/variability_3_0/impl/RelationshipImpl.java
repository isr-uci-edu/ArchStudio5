...
public abstract class RelationshipImpl extends EObjectImpl implements Relationship
{
  ...
  public EList<Extension> getExt()
  {
    if (ext == null)
    {
      ext = new EObjectContainmentEList<Extension>(Extension.class, this, Variability_3_0Package.RELATIONSHIP__EXT);
    }
    return ext;
  }
  ...
  public void setName(String newName)
  {
    ...
    name = newName;
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, Variability_3_0Package.RELATIONSHIP__NAME, oldName, name));
  }
