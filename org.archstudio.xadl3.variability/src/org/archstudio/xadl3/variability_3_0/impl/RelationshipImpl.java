 ...
 * @generated
 */
public abstract class RelationshipImpl extends MinimalEObjectImpl.Container
  ...
  public void setId(String newId) {
    ...
    if (eNotificationRequired()) {
      eNotify(new ENotificationImpl(this, Notification.SET, Variability_3_0Package.RELATIONSHIP__ID,
          oldId, id));
    }
  }
  ...
  public void setName(String newName) {
    ...
    if (eNotificationRequired()) {
      eNotify(new ENotificationImpl(this, Notification.SET,
          Variability_3_0Package.RELATIONSHIP__NAME, oldName, name));
    }
  }
