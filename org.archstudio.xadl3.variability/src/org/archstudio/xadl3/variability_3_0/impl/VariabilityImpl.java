...
public class VariabilityImpl extends EObjectImpl implements Variability {
	...
	public void setOverview(boolean newOverview) {
		...
		overviewESet = true;
		if (eNotificationRequired()) {
			eNotify(new ENotificationImpl(this, Notification.SET, Variability_3_0Package.VARIABILITY__OVERVIEW,
					oldOverview, overview, !oldOverviewESet));
		}
	}
	...
	public void unsetOverview() {
		...
		overviewESet = false;
		if (eNotificationRequired()) {
			eNotify(new ENotificationImpl(this, Notification.UNSET, Variability_3_0Package.VARIABILITY__OVERVIEW,
					oldOverview, OVERVIEW_EDEFAULT, oldOverviewESet));
		}
	}
