...
/**
 * <!-- begin-user-doc --> An implementation of the model object '<em><b>Variability</b></em>'. <!--
 * end-user-doc -->
 * <p>
 * The following features are implemented:
 * </p>
 * <ul>
 * <li>{@link org.archstudio.xadl3.variability_3_0.impl.VariabilityImpl#getActiveChangeSet
 ...
 * <li>{@link org.archstudio.xadl3.variability_3_0.impl.VariabilityImpl#getChangeSet
 * <em>Change Set</em>}</li>
 * <li>{@link org.archstudio.xadl3.variability_3_0.impl.VariabilityImpl#getRelationship
 * <em>Relationship</em>}</li>
 * <li>{@link org.archstudio.xadl3.variability_3_0.impl.VariabilityImpl#isOverview <em>Overview</em>
 * }</li>
 * </ul>
 *
 * @generated
...
public class VariabilityImpl extends MinimalEObjectImpl.Container implements Variability {
  ...
  /**
   * The cached value of the '{@link #getAppliedChangeSets() <em>Applied Change Sets</em>}'
  ...
  /**
   * The cached value of the '{@link #getRelationship() <em>Relationship</em>}' containment
   * reference list. <!-- begin-user-doc --> <!-- end-user-doc -->
   * 
   * @see #getRelationship()
   * @generated
  ...
  public void setActiveChangeSet(ChangeSet newActiveChangeSet) {
    ...
    if (eNotificationRequired()) {
      eNotify(new ENotificationImpl(this, Notification.SET,
          Variability_3_0Package.VARIABILITY__ACTIVE_CHANGE_SET, oldActiveChangeSet,
          activeChangeSet));
    }
  }
  ...
  public EList<ChangeSet> getAppliedChangeSets() {
    if (appliedChangeSets == null) {
      appliedChangeSets = new EObjectEList<ChangeSet>(ChangeSet.class, this,
          Variability_3_0Package.VARIABILITY__APPLIED_CHANGE_SETS);
    }
  ...
  public EList<ChangeSet> getChangeSet() {
    if (changeSet == null) {
      changeSet = new EObjectContainmentEList<ChangeSet>(ChangeSet.class, this,
          Variability_3_0Package.VARIABILITY__CHANGE_SET);
    }
    return changeSet;
  }
  ...
  public EList<Relationship> getRelationship() {
    if (relationship == null) {
      relationship = new EObjectContainmentEList<Relationship>(Relationship.class, this,
          Variability_3_0Package.VARIABILITY__RELATIONSHIP);
    }
    return relationship;
  }
  ...
  public void setOverview(boolean newOverview) {
    ...
    if (eNotificationRequired()) {
      eNotify(new ENotificationImpl(this, Notification.SET,
          Variability_3_0Package.VARIABILITY__OVERVIEW, oldOverview, overview, !oldOverviewESet));
    }
  }
  ...
  public void unsetOverview() {
    ...
    if (eNotificationRequired()) {
      eNotify(new ENotificationImpl(this, Notification.UNSET,
          Variability_3_0Package.VARIABILITY__OVERVIEW, oldOverview, OVERVIEW_EDEFAULT,
          oldOverviewESet));
    }
  }
