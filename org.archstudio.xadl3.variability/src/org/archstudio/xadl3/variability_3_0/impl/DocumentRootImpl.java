 ...
 * </p>
 * <ul>
 * <li>{@link org.archstudio.xadl3.variability_3_0.impl.DocumentRootImpl#getMixed <em>Mixed</em>}
 * </li>
 * <li>{@link org.archstudio.xadl3.variability_3_0.impl.DocumentRootImpl#getXMLNSPrefixMap
 * <em>XMLNS Prefix Map</em>}</li>
 * <li>{@link org.archstudio.xadl3.variability_3_0.impl.DocumentRootImpl#getXSISchemaLocation
 * <em>XSI Schema Location</em>}</li>
 * <li>{@link org.archstudio.xadl3.variability_3_0.impl.DocumentRootImpl#getVariability
...
public class DocumentRootImpl extends MinimalEObjectImpl.Container implements DocumentRoot {
  ...
  public EMap<String, String> getXMLNSPrefixMap() {
    if (xMLNSPrefixMap == null) {
      xMLNSPrefixMap = new EcoreEMap<String, String>(
          ...
          this, Variability_3_0Package.DOCUMENT_ROOT__XMLNS_PREFIX_MAP);
    }
  ...
  public EMap<String, String> getXSISchemaLocation() {
    if (xSISchemaLocation == null) {
      xSISchemaLocation = new EcoreEMap<String, String>(
          EcorePackage.Literals.ESTRING_TO_STRING_MAP_ENTRY, EStringToStringMapEntryImpl.class,
          this, Variability_3_0Package.DOCUMENT_ROOT__XSI_SCHEMA_LOCATION);
    }
  ...
  public Variability getVariability() {
    return (Variability) getMixed().get(Variability_3_0Package.Literals.DOCUMENT_ROOT__VARIABILITY,
        true);
  }
  ...
  public NotificationChain basicSetVariability(Variability newVariability, NotificationChain msgs) {
    return ((FeatureMap.Internal) getMixed())
        .basicAdd(Variability_3_0Package.Literals.DOCUMENT_ROOT__VARIABILITY, newVariability, msgs);
  }
  ...
  public void setVariability(Variability newVariability) {
    ((FeatureMap.Internal) getMixed())
        .set(Variability_3_0Package.Literals.DOCUMENT_ROOT__VARIABILITY, newVariability);
  }
