...
public class ElementChangeImpl extends ChangeImpl implements ElementChange
{
  ...
  public EList<Change> getChange()
  {
    if (change == null)
    {
      change = new EObjectContainmentEList<Change>(Change.class, this, Variability_3_0Package.ELEMENT_CHANGE__CHANGE);
    }
    return change;
  }
  ...
  public void setType(String newType)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, Variability_3_0Package.ELEMENT_CHANGE__TYPE, oldType, type));
  }
