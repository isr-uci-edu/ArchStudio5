 ...
 * </p>
 * <ul>
 * <li>{@link org.archstudio.xadl3.variability_3_0.impl.ChangeSetOfChangesImpl#getElementChange
...
public class ChangeSetOfChangesImpl extends ChangeSetImpl implements ChangeSetOfChanges {
  /**
   * The cached value of the '{@link #getElementChange() <em>Element Change</em>}' containment
   ...
   * @generated
   */
  public NotificationChain basicSetElementChange(ElementChange newElementChange,
      NotificationChain msgs) {
    ElementChange oldElementChange = elementChange;
    elementChange = newElementChange;
    if (eNotificationRequired()) {
      ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
          Variability_3_0Package.CHANGE_SET_OF_CHANGES__ELEMENT_CHANGE, oldElementChange,
          newElementChange);
      if (msgs == null) {
        msgs = notification;
      } else {
    ...
    if (newElementChange != elementChange) {
      ...
      if (elementChange != null) {
        msgs = ((InternalEObject) elementChange).eInverseRemove(this,
            EOPPOSITE_FEATURE_BASE - Variability_3_0Package.CHANGE_SET_OF_CHANGES__ELEMENT_CHANGE,
            null, msgs);
      }
      ...
      eNotify(new ENotificationImpl(this, Notification.SET,
          Variability_3_0Package.CHANGE_SET_OF_CHANGES__ELEMENT_CHANGE, newElementChange,
          newElementChange));
    }
  }
