...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>Change Set Of Changes</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * <ul>
 *   <li>{@link org.archstudio.xadl3.variability_3_0.impl.ChangeSetOfChangesImpl#getElementChange <em>Element Change</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class ChangeSetOfChangesImpl extends ChangeSetImpl implements ChangeSetOfChanges
{
  ...
  public NotificationChain basicSetElementChange(ElementChange newElementChange, NotificationChain msgs)
  {
    ...
    {
      ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, Variability_3_0Package.CHANGE_SET_OF_CHANGES__ELEMENT_CHANGE, oldElementChange, newElementChange);
  ...
  public void setElementChange(ElementChange newElementChange)
  {
    if (newElementChange != elementChange)
    {
      ...
      if (elementChange != null)
        msgs = ((InternalEObject)elementChange).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - Variability_3_0Package.CHANGE_SET_OF_CHANGES__ELEMENT_CHANGE, null, msgs);
      if (newElementChange != null)
        msgs = ((InternalEObject)newElementChange).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - Variability_3_0Package.CHANGE_SET_OF_CHANGES__ELEMENT_CHANGE, null, msgs);
      msgs = basicSetElementChange(newElementChange, msgs);
      if (msgs != null) msgs.dispatch();
    }
    else if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, Variability_3_0Package.CHANGE_SET_OF_CHANGES__ELEMENT_CHANGE, newElementChange, newElementChange));
  }
