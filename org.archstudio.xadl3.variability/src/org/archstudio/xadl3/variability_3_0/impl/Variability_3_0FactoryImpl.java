...
public class Variability_3_0FactoryImpl extends EFactoryImpl implements Variability_3_0Factory {
  ...
  public static Variability_3_0Factory init() {
    try {
      Variability_3_0Factory theVariability_3_0Factory =
          (Variability_3_0Factory) EPackage.Registry.INSTANCE
  ...
  public JavaTransformChangeSetOfChanges createJavaTransformChangeSetOfChanges() {
    JavaTransformChangeSetOfChangesImpl javaTransformChangeSetOfChanges =
        new JavaTransformChangeSetOfChangesImpl();
  ...
  public TransformChangeSetOfChanges createTransformChangeSetOfChanges() {
    TransformChangeSetOfChangesImpl transformChangeSetOfChanges =
        new TransformChangeSetOfChangesImpl();
