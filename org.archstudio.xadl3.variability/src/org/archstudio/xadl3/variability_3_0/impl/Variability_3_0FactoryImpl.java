...
public class Variability_3_0FactoryImpl extends EFactoryImpl implements Variability_3_0Factory
{
  ...
  public static Variability_3_0Factory init()
  {
    try
    {
      Variability_3_0Factory theVariability_3_0Factory = (Variability_3_0Factory)EPackage.Registry.INSTANCE.getEFactory("http://www.archstudio.org/xadl3/schemas/variability-3.0.xsd"); 
  ...
  public EObject create(EClass eClass)
  {
    ...
    {
      case Variability_3_0Package.ATTRIBUTE_CHANGE: return createAttributeChange();
      case Variability_3_0Package.CHANGE: return createChange();
      case Variability_3_0Package.CHANGE_SET_OF_CHANGES: return createChangeSetOfChanges();
      case Variability_3_0Package.DOCUMENT_ROOT: return createDocumentRoot();
      case Variability_3_0Package.ELEMENT_CHANGE: return createElementChange();
      case Variability_3_0Package.ELEMENT_MANY_CHANGE: return createElementManyChange();
      case Variability_3_0Package.JAVA_TRANSFORM_CHANGE_SET_OF_CHANGES: return createJavaTransformChangeSetOfChanges();
      case Variability_3_0Package.TRANSFORM_CHANGE_SET_OF_CHANGES: return createTransformChangeSetOfChanges();
      case Variability_3_0Package.VARIABILITY: return createVariability();
      default:
