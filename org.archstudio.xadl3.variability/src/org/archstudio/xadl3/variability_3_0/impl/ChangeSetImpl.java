...
public abstract class ChangeSetImpl extends EObjectImpl implements ChangeSet
{
  ...
  public EList<Extension> getExt()
  {
    if (ext == null)
    {
      ext = new EObjectContainmentEList<Extension>(Extension.class, this, Variability_3_0Package.CHANGE_SET__EXT);
    }
    return ext;
  }
  ...
  public void setId(String newId)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, Variability_3_0Package.CHANGE_SET__ID, oldId, id));
  }
  ...
  public void setName(String newName)
  {
    ...
    name = newName;
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, Variability_3_0Package.CHANGE_SET__NAME, oldName, name));
  }
