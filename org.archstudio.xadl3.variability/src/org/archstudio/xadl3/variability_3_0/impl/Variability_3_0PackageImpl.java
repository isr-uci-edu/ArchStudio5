...
public class Variability_3_0PackageImpl extends EPackageImpl implements Variability_3_0Package
{
   ...
   * 
   * <p>This method is used to initialize {@link Variability_3_0Package#eINSTANCE} when that field is accessed.
  ...
  {
    if (isInited) return (Variability_3_0Package)EPackage.Registry.INSTANCE.getEPackage(Variability_3_0Package.eNS_URI);

    // Obtain or create and register package
    Variability_3_0PackageImpl theVariability_3_0Package = (Variability_3_0PackageImpl)(EPackage.Registry.INSTANCE.get(eNS_URI) instanceof Variability_3_0PackageImpl ? EPackage.Registry.INSTANCE.get(eNS_URI) : new Variability_3_0PackageImpl());
  ...
  public void initializePackageContents()
  {
    ...
    initEAttribute(getAttributeChange_Value(), theXMLTypePackage.getString(), "value", null, 0, 1, AttributeChange.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);

    initEClass(changeEClass, Change.class, "Change", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
    initEAttribute(getChange_Name(), theXMLTypePackage.getString(), "name", null, 0, 1, Change.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);

    initEClass(changeSetEClass, ChangeSet.class, "ChangeSet", IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
    initEReference(getChangeSet_Ext(), theXadlcore_3_0Package.getExtension(), null, "ext", null, 0, -1, ChangeSet.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
    initEAttribute(getChangeSet_Id(), theXMLTypePackage.getID(), "id", null, 0, 1, ChangeSet.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
    initEAttribute(getChangeSet_Name(), theXMLTypePackage.getString(), "name", null, 0, 1, ChangeSet.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);

    initEClass(changeSetOfChangesEClass, ChangeSetOfChanges.class, "ChangeSetOfChanges", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
    initEReference(getChangeSetOfChanges_ElementChange(), this.getElementChange(), null, "elementChange", null, 0, 1, ChangeSetOfChanges.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
    ...
    initEReference(getDocumentRoot_Variability(), this.getVariability(), null, "variability", null, 0, -2, null, IS_TRANSIENT, IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, IS_DERIVED, IS_ORDERED);

    initEClass(elementChangeEClass, ElementChange.class, "ElementChange", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
    initEReference(getElementChange_Change(), this.getChange(), null, "change", null, 0, -1, ElementChange.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
    initEAttribute(getElementChange_Type(), theXMLTypePackage.getString(), "type", null, 0, 1, ElementChange.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);

    initEClass(elementManyChangeEClass, ElementManyChange.class, "ElementManyChange", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
    initEReference(getElementManyChange_Change(), this.getElementChange(), null, "change", null, 0, -1, ElementManyChange.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);

    initEClass(javaTransformChangeSetOfChangesEClass, JavaTransformChangeSetOfChanges.class, "JavaTransformChangeSetOfChanges", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
    initEAttribute(getJavaTransformChangeSetOfChanges_Bundle(), theXMLTypePackage.getString(), "bundle", null, 0, 1, JavaTransformChangeSetOfChanges.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
    initEAttribute(getJavaTransformChangeSetOfChanges_Class(), theXMLTypePackage.getString(), "class", null, 0, 1, JavaTransformChangeSetOfChanges.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);

    initEClass(relationshipEClass, Relationship.class, "Relationship", IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
    initEReference(getRelationship_Ext(), theXadlcore_3_0Package.getExtension(), null, "ext", null, 0, -1, Relationship.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
    initEAttribute(getRelationship_Id(), theXMLTypePackage.getID(), "id", null, 0, 1, Relationship.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
    ...
    initEClass(transformChangeSetOfChangesEClass, TransformChangeSetOfChanges.class, "TransformChangeSetOfChanges", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);

    initEClass(variabilityEClass, Variability.class, "Variability", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
    initEReference(getVariability_ActiveChangeSet(), this.getChangeSet(), null, "activeChangeSet", null, 0, 1, Variability.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
    initEReference(getVariability_AppliedChangeSets(), this.getChangeSet(), null, "appliedChangeSets", null, 1, -1, Variability.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
    initEReference(getVariability_ChangeSet(), this.getChangeSet(), null, "changeSet", null, 0, -1, Variability.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
    initEReference(getVariability_Relationship(), this.getRelationship(), null, "relationship", null, 0, -1, Variability.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
    initEAttribute(getVariability_Overview(), theXMLTypePackage.getBoolean(), "overview", null, 0, 1, Variability.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
  ...
  protected void createExtendedMetaDataAnnotations()
  {
    ...
    addAnnotation
      (changeSetOfChangesEClass, 
       source, 
       new String[] 
       {
       "name", "ChangeSetOfChanges",
       "kind", "elementOnly"
       });		
    addAnnotation
      (getChangeSetOfChanges_ElementChange(), 
       source, 
       new String[] 
       {
       "kind", "element",
    ...
    addAnnotation
      (elementManyChangeEClass, 
       source, 
       new String[] 
       {
       "name", "ElementManyChange",
       "kind", "elementOnly"
       });		
    addAnnotation
      (getElementManyChange_Change(), 
       source, 
       new String[] 
       {
       "kind", "element",
    ...
    addAnnotation
      (javaTransformChangeSetOfChangesEClass, 
       source, 
       new String[] 
       {
       "name", "JavaTransformChangeSetOfChanges",
       "kind", "elementOnly"
       });		
    addAnnotation
      (getJavaTransformChangeSetOfChanges_Bundle(), 
       source, 
       new String[] 
       {
       "kind", "attribute",
    ...
    addAnnotation
      (getJavaTransformChangeSetOfChanges_Class(), 
       source, 
       new String[] 
       {
       "kind", "attribute",
    ...
    addAnnotation
      (transformChangeSetOfChangesEClass, 
       source, 
       new String[] 
       {
       "name", "TransformChangeSetOfChanges",
       "kind", "elementOnly"
       });		
    addAnnotation
      (variabilityEClass, 
    ...
    addAnnotation
      (getVariability_ActiveChangeSet(), 
       source, 
       new String[] 
       {
       "kind", "element",
    ...
    addAnnotation
      (getVariability_AppliedChangeSets(), 
       source, 
       new String[] 
       {
       "kind", "element",
       "name", "appliedChangeSets",
       "namespace", "##targetNamespace"
       });		
    addAnnotation
      (getVariability_ChangeSet(), 
       source, 
       new String[] 
       {
       "kind", "element",
