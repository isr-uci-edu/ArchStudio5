...
/**
 * <!-- begin-user-doc --> An implementation of the model object '<em><b>Change</b></em>'. <!--
 * end-user-doc -->
 * <p>
...
public class ChangeImpl extends MinimalEObjectImpl.Container implements Change {
  ...
  public void setName(String newName) {
    ...
    if (eNotificationRequired()) {
      eNotify(new ENotificationImpl(this, Notification.SET, Variability_3_0Package.CHANGE__NAME,
          oldName, name));
    }
  }
