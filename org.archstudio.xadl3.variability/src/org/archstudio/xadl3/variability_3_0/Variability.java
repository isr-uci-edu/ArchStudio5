...
public interface Variability extends EObject {
	 ...
	 * {@link org.archstudio.xadl3.variability_3_0.ChangeSet}. <!-- begin-user-doc -->
	 * <p>
	 * If the meaning of the '<em>Applied Change Sets</em>' reference list isn't clear, there really should be more of a
	 * description here...
	 * </p>
	 * <!-- end-user-doc -->
	 * 
	 ...
	 * {@link org.archstudio.xadl3.variability_3_0.ChangeSet}. <!-- begin-user-doc -->
	 * <p>
	 * If the meaning of the '<em>Change Set</em>' containment reference list isn't clear, there really should be more
	 ...
	 * {@link org.archstudio.xadl3.variability_3_0.Relationship}. <!-- begin-user-doc -->
	 * <p>
	 * If the meaning of the '<em>Relationship</em>' containment reference list isn't clear, there really should be more
	 * of a description here...
	 * </p>
	 * <!-- end-user-doc -->
	 * 
	 ...
	 * <p>
	 * If the meaning of the '<em>Overview</em>' attribute isn't clear, there really should be more of a description
	 * here...
	 * </p>
	 * <!-- end-user-doc -->
	 * 
	 ...
	 * <em>Overview</em>}' attribute is set. <!-- begin-user-doc --> <!-- end-user-doc -->
	 * 
