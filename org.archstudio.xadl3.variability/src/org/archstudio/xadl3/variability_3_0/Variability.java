...
/**
 * <!-- begin-user-doc --> A representation of the model object '<em><b>Variability</b></em>'. <!--
 * end-user-doc -->
 *
 * <p>
 ...
 * </p>
 * <ul>
 * <li>{@link org.archstudio.xadl3.variability_3_0.Variability#getActiveChangeSet
 * <em>Active Change Set</em>}</li>
 * <li>{@link org.archstudio.xadl3.variability_3_0.Variability#getAppliedChangeSets
 * <em>Applied Change Sets</em>}</li>
 * <li>{@link org.archstudio.xadl3.variability_3_0.Variability#getChangeSet <em>Change Set</em>}
 * </li>
 * <li>{@link org.archstudio.xadl3.variability_3_0.Variability#getRelationship <em>Relationship</em>
 * }</li>
...
public interface Variability extends EObject {
   ...
   * <p>
   * If the meaning of the '<em>Active Change Set</em>' reference isn't clear, there really should
   ...
   * <em>Active Change Set</em>}' reference. <!-- begin-user-doc --> <!-- end-user-doc -->
   * 
  ...
  /**
   * Returns the value of the '<em><b>Applied Change Sets</b></em>' reference list. The list
   * contents are of type {@link org.archstudio.xadl3.variability_3_0.ChangeSet}. <!--
   * begin-user-doc -->
   * <p>
   * If the meaning of the '<em>Applied Change Sets</em>' reference list isn't clear, there really
  ...
  /**
   * Returns the value of the '<em><b>Change Set</b></em>' containment reference list. The list
   * contents are of type {@link org.archstudio.xadl3.variability_3_0.ChangeSet}. <!--
   * begin-user-doc -->
   * <p>
   * If the meaning of the '<em>Change Set</em>' containment reference list isn't clear, there
   ...
   *        "kind='element' name='changeSet' namespace='##targetNamespace'"
   * @generated
   */
  EList<ChangeSet> getChangeSet();

  /**
   * Returns the value of the '<em><b>Relationship</b></em>' containment reference list. The list
   * contents are of type {@link org.archstudio.xadl3.variability_3_0.Relationship}. <!--
   * begin-user-doc -->
   * <p>
   * If the meaning of the '<em>Relationship</em>' containment reference list isn't clear, there
   * really should be more of a description here...
   * </p>
   * <!-- end-user-doc -->
   * 
   ...
   * @model containment="true" extendedMetaData=
   *        "kind='element' name='relationship' namespace='##targetNamespace'"
   * @generated
   */
   ...
   * <p>
   * If the meaning of the '<em>Overview</em>' attribute isn't clear, there really should be more of
   * a description here...
   * </p>
   * <!-- end-user-doc -->
   * 
   ...
   * @model unsettable="true" dataType="org.eclipse.emf.ecore.xml.type.Boolean" extendedMetaData=
  ...
  /**
   * Sets the value of the '{@link org.archstudio.xadl3.variability_3_0.Variability#isOverview
   * <em>Overview</em>}' attribute. <!-- begin-user-doc --> <!-- end-user-doc -->
   * 
  ...
  /**
   * Unsets the value of the '{@link org.archstudio.xadl3.variability_3_0.Variability#isOverview
   * <em>Overview</em>}' attribute. <!-- begin-user-doc --> <!-- end-user-doc -->
   * 
   * @see #isSetOverview()
   * @see #isOverview()
